  ...
  implements NotificationCenter.NotificationCenterDelegate
{
  ...
  private void checkContinueText()
  {
    ...
    String str2 = LocaleController.getSystemLocaleStringIso639().toLowerCase();
    String str1;
    String str3;
    int i;
    if (str2.contains("-"))
    {
      str1 = str2.split("-")[0];
      str3 = LocaleController.getLocaleAlias(str1);
      i = 0;
    }
    Object localObject4;
    Object localObject3;
    for (;;)
    {
      ...
      {
        localObject4 = (LocaleController.LocaleInfo)LocaleController.getInstance().languages.get(i);
        if (((LocaleController.LocaleInfo)localObject4).shortName.equals("en")) {
          localObject2 = localObject4;
        }
        if ((!((LocaleController.LocaleInfo)localObject4).shortName.replace("_", "-").equals(str2)) && (!((LocaleController.LocaleInfo)localObject4).shortName.equals(str1)))
        {
          localObject3 = localObject1;
          if (str3 != null)
          {
            localObject3 = localObject1;
            if (!((LocaleController.LocaleInfo)localObject4).shortName.equals(str3)) {}
          }
        }
        else
        {
      ...
      {
        if ((localObject4 != null) && (localObject3 != null) && (localObject4 != localObject3)) {
          break label208;
        }
        return;
        str1 = str2;
    ...
    label208:
    localObject1 = new TLRPC.TL_langpack_getStrings();
    if (localObject3 != localLocaleInfo) {
      ((TLRPC.TL_langpack_getStrings)localObject1).lang_code = ((LocaleController.LocaleInfo)localObject3).shortName.replace("_", "-");
    }
    for (this.localeInfo = ((LocaleController.LocaleInfo)localObject3);; this.localeInfo = ((LocaleController.LocaleInfo)localObject4))
    {
      ((TLRPC.TL_langpack_getStrings)localObject1).keys.add("ContinueOnThisLanguage");
      ConnectionsManager.getInstance(this.currentAccount).sendRequest((TLObject)localObject1, new RequestDelegate()
      {
        public void run(final TLObject paramAnonymousTLObject, TLRPC.TL_error paramAnonymousTL_error)
        {
          ...
          } while (!(paramAnonymousTLObject instanceof TLRPC.TL_langPackString));
      ...
      return;
      ((TLRPC.TL_langpack_getStrings)localObject1).lang_code = ((LocaleController.LocaleInfo)localObject4).shortName.replace("_", "-");
    }
  }
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.titles = new String[] { LocaleController.getString("Page1Title", 2131494051), LocaleController.getString("Page2Title", 2131494053), LocaleController.getString("Page3Title", 2131494055), LocaleController.getString("Page5Title", 2131494059), LocaleController.getString("Page4Title", 2131494057), LocaleController.getString("Page6Title", 2131494061) };
    this.messages = new String[] { LocaleController.getString("Page1Message", 2131494050), LocaleController.getString("Page2Message", 2131494052), LocaleController.getString("Page3Message", 2131494054), LocaleController.getString("Page5Message", 2131494058), LocaleController.getString("Page4Message", 2131494056), LocaleController.getString("Page6Message", 2131494060) };
    ...
    this.viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener()
    {
      public void onPageScrollStateChanged(int paramAnonymousInt)
      {
        ...
        do
        {
          ...
          {
            return;
          } while ((paramAnonymousInt != 0) && (paramAnonymousInt != 2));
        ...
        } while (IntroActivity.this.lastPage == IntroActivity.this.viewPager.getCurrentItem());
    ...
    ((TextView)localObject1).setText(LocaleController.getString("StartMessaging", 2131494422).toUpperCase());
    ((TextView)localObject1).setGravity(17);
    ((TextView)localObject1).setTextColor(-1);
    ((TextView)localObject1).setTextSize(1, 16.0F);
    ((TextView)localObject1).setBackgroundResource(2131165621);
    ...
    if (AndroidUtilities.isTablet())
    {
      ...
      localObject2 = (BitmapDrawable)getResources().getDrawable(2131165266);
      ...
      localFrameLayout.addView((View)localObject1, LayoutHelper.createFrame(-1, -1.0F));
      localObject1 = new FrameLayout(this);
      ((FrameLayout)localObject1).setBackgroundResource(2131165256);
      ((FrameLayout)localObject1).addView(paramBundle, LayoutHelper.createFrame(-1, -1.0F));
      localFrameLayout.addView((View)localObject1, LayoutHelper.createFrame(498, 528, 17));
    }
    for (;;)
    {
    ...
    extends DispatchQueue
  {
    ...
    private boolean initGL()
    {
      ...
      loadTexture(2131165431, 0);
      loadTexture(2131165430, 1);
      loadTexture(2131165432, 2);
      loadTexture(2131165433, 3);
      loadTexture(2131165435, 4);
      loadTexture(2131165434, 5);
      loadTexture(2131165437, 6);
      loadTexture(2131165436, 7);
      loadTexture(2131165438, 8);
      loadTexture(2131165439, 9);
      loadTexture(2131165441, 10);
      loadTexture(2131165440, 11);
      loadTexture(2131165442, 12);
      loadTexture(2131165443, 13);
      loadTexture(2131165444, 14);
      loadTexture(2131165446, 15);
      loadTexture(2131165445, 16);
      loadTexture(2131165447, 17);
      loadTexture(2131165448, 18);
      loadTexture(2131165449, 19);
      loadTexture(2131165450, 20);
      loadTexture(2131165451, 21);
      loadTexture(2131165452, 22);
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/IntroActivity.class
