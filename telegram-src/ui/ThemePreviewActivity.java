  ...
  implements NotificationCenter.NotificationCenterDelegate
{
  ...
  public View createView(Context paramContext)
  {
    ...
    this.actionBar.setTitle(LocaleController.getString("ThemePreview", 2131494485));
    this.page1 = new FrameLayout(paramContext)
    {
      ...
      protected void onMeasure(int paramAnonymousInt1, int paramAnonymousInt2)
      {
        ...
        int m = ThemePreviewActivity.this.actionBar.getMeasuredHeight();
        int i = j;
        if (ThemePreviewActivity.this.actionBar.getVisibility() == 0) {
          i = j - m;
        }
        ((FrameLayout.LayoutParams)ThemePreviewActivity.this.listView.getLayoutParams()).topMargin = m;
        ThemePreviewActivity.this.listView.measure(View.MeasureSpec.makeMeasureSpec(k, 1073741824), View.MeasureSpec.makeMeasureSpec(i, 1073741824));
    ...
    if (LocaleController.isRTL)
    {
      ...
      this.page2 = new SizeNotifierFrameLayout(paramContext)
      {
        ...
        protected void onMeasure(int paramAnonymousInt1, int paramAnonymousInt2)
        {
          ...
          ThemePreviewActivity.this.listView2.measure(View.MeasureSpec.makeMeasureSpec(j, 1073741824), View.MeasureSpec.makeMeasureSpec(paramAnonymousInt1, 1073741824));
        }
      };
    ...
    for (int i = 1;; i = 2)
    {
      ...
      final ViewPager localViewPager = new ViewPager(paramContext);
      ...
      localViewPager.setAdapter(new PagerAdapter()
      {
        ...
        {
          return paramAnonymousObject == paramAnonymousView;
        }
      ...
      this.dotsContainer = new View(paramContext)
      {
        ...
        {
          int k = localViewPager.getCurrentItem();
          int i = 0;
          if (i < 2)
          {
            ...
            for (int j = -6710887;; j = -3355444)
            {
              ...
              paramAnonymousCanvas.drawCircle(AndroidUtilities.dp(i * 15 + 3), AndroidUtilities.dp(4.0F), AndroidUtilities.dp(3.0F), this.paint);
              i += 1;
              break;
            }
          }
      ...
      ((TextView)localObject2).setText(LocaleController.getString("Cancel", 2131493127).toUpperCase());
      ...
      paramContext.setText(LocaleController.getString("ApplyTheme", 2131492984).toUpperCase());
    ...
    extends RecyclerListView.SelectionAdapter
  {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder paramViewHolder, int paramInt)
    {
      ...
      if ((localObject instanceof ChatMessageCell))
      {
        ...
        {
          localMessageObject2 = (MessageObject)this.messages.get(paramInt - 1);
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/ThemePreviewActivity.class
