  ...
  implements NotificationCenter.NotificationCenterDelegate
{
  ...
  private void sendSelectedPhotos(HashMap<Object, Object> paramHashMap, ArrayList<Object> paramArrayList)
  {
    ...
    {
      Object localObject1 = paramHashMap.get(paramArrayList.get(j));
  ...
  public View createView(Context paramContext)
  {
    ...
    this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick()
    {
      public void onItemClick(int paramAnonymousInt)
      {
        ...
        while ((paramAnonymousInt != 1) || (PhotoAlbumPickerActivity.this.delegate == null)) {
          return;
        }
    ...
    this.actionBar.createMenu().addItem(1, 2131165353);
    this.fragmentView = new FrameLayout(paramContext);
    FrameLayout localFrameLayout = (FrameLayout)this.fragmentView;
    localFrameLayout.setBackgroundColor(-16777216);
    this.actionBar.setTitle(LocaleController.getString("Gallery", 2131493623));
  ...
  public void didReceivedNotification(int paramInt1, int paramInt2, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt1 == NotificationCenter.recentImagesDidLoaded)
      {
        paramInt1 = ((Integer)paramVarArgs[0]).intValue();
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/PhotoAlbumPickerActivity.class
