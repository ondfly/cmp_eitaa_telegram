    ...
    if (paramAlbumEntry != null)
    {
      ...
      if ((paramAlbumEntry.coverPhoto != null) && (paramAlbumEntry.coverPhoto.path != null))
      {
        ...
        if (paramAlbumEntry.coverPhoto.isVideo) {
          localAlbumView.imageView.setImage("vthumb://" + paramAlbumEntry.coverPhoto.imageId + ":" + paramAlbumEntry.coverPhoto.path, null, getContext().getResources().getDrawable(2131165542));
        }
      }
      for (;;)
      {
        ...
        return;
        localAlbumView.imageView.setImage("thumb://" + paramAlbumEntry.coverPhoto.imageId + ":" + paramAlbumEntry.coverPhoto.path, null, getContext().getResources().getDrawable(2131165542));
        continue;
        localAlbumView.imageView.setImageResource(2131165542);
      }
    }
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/Cells/PhotoPickerAlbumsCell.class
