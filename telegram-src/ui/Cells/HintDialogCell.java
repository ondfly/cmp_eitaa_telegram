  ...
  extends FrameLayout
{
  ...
  public void update()
  {
    ...
    Object localObject = MessagesController.getInstance(this.currentAccount).getChat(Integer.valueOf(-i));
    this.avatarDrawable.setInfo((TLRPC.Chat)localObject);
  }
}


/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/Cells/HintDialogCell.class
