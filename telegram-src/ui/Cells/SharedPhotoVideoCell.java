  ...
  extends FrameLayout
{
  ...
  public void setItem(int paramInt1, int paramInt2, MessageObject paramMessageObject)
  {
    ...
    if (paramMessageObject != null)
    {
      ...
      else
      {
        for (;;)
        {
          ...
          else
          {
            ...
            localPhotoVideoView.imageView.setImage(null, null, null, ApplicationLoader.applicationContext.getResources().getDrawable(2131165584), null, paramMessageObject, "b", null, 0);
            return;
            bool = false;
            break;
          }
        ...
        label250:
        localPhotoVideoView.imageView.setImageResource(2131165584);
        return;
      }
      if (((paramMessageObject.messageOwner.media instanceof TLRPC.TL_messageMediaPhoto)) && (paramMessageObject.messageOwner.media.photo != null) && (!paramMessageObject.photoThumbs.isEmpty()))
      {
        ...
        localPhotoVideoView.imageView.setImage(null, null, null, ApplicationLoader.applicationContext.getResources().getDrawable(2131165584), null, paramMessageObject.location, "b", null, 0);
        return;
      }
      localPhotoVideoView.videoInfoContainer.setVisibility(4);
      localPhotoVideoView.imageView.setImageResource(2131165584);
    ...
    extends FrameLayout
  {
    ...
    public PhotoVideoView(Context paramContext)
    {
      ...
      SharedPhotoVideoCell.this.setImageResource(2131165425);
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/Cells/SharedPhotoVideoCell.class
