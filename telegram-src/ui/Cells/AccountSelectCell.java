  ...
  extends FrameLayout
{
  ...
  public AccountSelectCell(Context paramContext)
  {
    ...
    this.checkImageView.setImageResource(2131165187);
  ...
  {
    super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(paramInt1), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(56.0F), 1073741824));
  }
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/Cells/AccountSelectCell.class
