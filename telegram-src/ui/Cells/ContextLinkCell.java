  ...
  implements DownloadController.FileDownloadProgressListener
{
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        this.titleLayout = new StaticLayout(TextUtils.ellipsize(Emoji.replaceEmoji(this.inlineResult.title.replace('\n', ' '), Theme.chat_contextResult_titleTextPaint.getFontMetricsInt(), AndroidUtilities.dp(15.0F), false), Theme.chat_contextResult_titleTextPaint, Math.min(j, i), TextUtils.TruncateAt.END), Theme.chat_contextResult_titleTextPaint, i + AndroidUtilities.dp(4.0F), Layout.Alignment.ALIGN_NORMAL, 1.0F, 0.0F, false);
        ...
        catch (Exception localException2)
        {
          try
          {
            for (;;)
            {
              ...
              localObject7 = localImageReceiver;
              if (this.inlineResult != null)
              {
                ...
                if ((this.inlineResult.content instanceof TLRPC.TL_webDocument))
                {
                  ...
                  if (this.inlineResult.type != null)
                  {
                    ...
                    {
                      localObject1 = (TLRPC.TL_webDocument)this.inlineResult.content;
                      this.documentAttachType = 2;
                    }
                  }
                }
                ...
                if (localObject1 == null)
                {
                  ...
                  if ((this.inlineResult.thumb instanceof TLRPC.TL_webDocument)) {
                    localObject4 = (TLRPC.TL_webDocument)this.inlineResult.thumb;
                  }
                }
              ...
              if (this.documentAttach != null)
              {
                ...
                if (i < this.documentAttach.attributes.size())
                {
                  ...
                  if ((!(localObject1 instanceof TLRPC.TL_documentAttributeImageSize)) && (!(localObject1 instanceof TLRPC.TL_documentAttributeVideo))) {
                    break label1552;
                  }
                  k = ((TLRPC.DocumentAttribute)localObject1).w;
                  m = ((TLRPC.DocumentAttribute)localObject1).h;
                }
              }
              if (k != 0)
              {
              ...
              else
              {
                ...
                j = this.currentPhotoObject.w;
                i = this.currentPhotoObject.h;
              }
              if (j != 0)
              {
                k = i;
              ...
              if ((this.documentAttach != null) || (this.currentPhotoObject != null) || (localObject6 != null) || (localObject7 != null))
              {
                ...
                localObject1 = String.format(Locale.US, "%d_%d_b", new Object[] { Integer.valueOf((int)(i / AndroidUtilities.density)), Integer.valueOf(80) });
                localObject4 = localObject1;
                ...
                localObject6 = this.documentAttach;
                if (this.currentPhotoObject == null) {
                  break label1677;
                }
                localObject2 = this.currentPhotoObject.location;
                ((ImageReceiver)localObject4).setImage((TLObject)localObject6, null, (TLRPC.FileLocation)localObject2, (String)localObject1, this.documentAttach.size, (String)localObject5, 0);
          ...
          catch (Exception localException3)
          {
                ...
                if (this.documentAttachType != 5)
                {
                  ...
                  if (this.documentAttachType != 3)
                  {
                    ...
                    if (this.inlineResult != null)
                    {
                      ...
                      if (this.inlineResult.photo != null)
                      {
                        this.currentPhotoObject = FileLoader.getClosestPhotoSizeWithSize((ArrayList)localObject1, AndroidUtilities.getPhotoSize(), true);
                        localObject1 = FileLoader.getClosestPhotoSizeWithSize((ArrayList)localObject1, 80);
                        localObject5 = localObject8;
                        localObject3 = localObject1;
                        if (localObject1 == this.currentPhotoObject)
                        {
                          localObject3 = null;
                          localObject5 = localObject8;
                          continue;
                          ...
                          if (this.inlineResult.type.equals("photo")) {
                            if ((this.inlineResult.thumb instanceof TLRPC.TL_webDocument))
                            {
                              localObject1 = (TLRPC.TL_webDocument)this.inlineResult.thumb;
                            }
                            else
                            {
                              localObject1 = (TLRPC.TL_webDocument)this.inlineResult.content;
                              ...
                              if (this.inlineResult != null)
                              {
                                localObject1 = MessageObject.getInlineResultWidthAndHeight(this.inlineResult);
                                j = localObject1[0];
                                i = localObject1[1];
                                continue;
                                label1600:
                                localObject1 = String.format(Locale.US, "%d_%d", new Object[] { Integer.valueOf((int)(i / AndroidUtilities.density)), Integer.valueOf(80) });
                                localObject4 = (String)localObject1 + "_b";
                                continue;
                                label1663:
                                localObject1 = "52_52";
                                continue;
            ...
            {
              ((ImageReceiver)localObject4).setImage((TLObject)localObject6, (String)localObject7, null, null, (TLRPC.FileLocation)localObject3, (String)localObject1, -1, (String)localObject5, 1);
              break;
            }
            label1733:
            if (this.currentPhotoObject != null)
            {
              ...
              localObject7 = this.currentPhotoObject.location;
              if (localObject3 != null) {}
              for (localObject3 = ((TLRPC.PhotoSize)localObject3).location;; localObject3 = null)
              {
                ((ImageReceiver)localObject6).setImage((TLObject)localObject7, (String)localObject1, (TLRPC.FileLocation)localObject3, (String)localObject4, this.currentPhotoObject.size, (String)localObject5, 0);
                break;
              }
            }
            localImageReceiver = this.linkImageView;
            ...
            for (localObject3 = ((TLRPC.PhotoSize)localObject3).location;; localObject3 = null)
            {
              localImageReceiver.setImage((TLObject)localObject6, (String)localObject7, (String)localObject1, null, (TLRPC.FileLocation)localObject3, (String)localObject4, -1, (String)localObject5, 1);
              break;
            }
            label1846:
            i = 0;
  ...
  public void updateButtonState(boolean paramBoolean)
  {
    ...
    while (TextUtils.isEmpty((CharSequence)localObject2))
    {
      ...
      if ((this.inlineResult.content instanceof TLRPC.TL_webDocument))
      {
        localObject2 = new StringBuilder().append(Utilities.MD5(this.inlineResult.content.url)).append(".");
        str = this.inlineResult.content.url;
        if (this.documentAttachType == 5) {}
        for (localObject1 = "mp3";; localObject1 = "ogg")
        {
          localObject2 = ImageLoader.getHttpUrlExtension(str, (String)localObject1);
          localObject1 = new File(FileLoader.getDirectory(4), (String)localObject2);
          break;
        }
        localObject1 = localObject3;
        localObject2 = str;
        if (this.mediaWebpage) {
          if (this.inlineResult != null)
          {
            ...
            else if ((this.inlineResult.photo instanceof TLRPC.TL_photo))
            {
              ...
              localObject1 = FileLoader.getPathToAttach(this.currentPhotoObject);
            }
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/Cells/ContextLinkCell.class
