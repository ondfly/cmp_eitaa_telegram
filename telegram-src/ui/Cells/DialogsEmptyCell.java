  ...
  extends LinearLayout
{
  ...
  public DialogsEmptyCell(Context paramContext)
  {
    ...
    this.emptyTextView1.setText(LocaleController.getString("NoChats", 2131493885));
    ...
    String str = LocaleController.getString("NoChatsHelp", 2131493886);
    paramContext = str;
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    for (paramInt2 = AndroidUtilities.statusBarHeight;; paramInt2 = 0)
    {
      ...
      super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(paramInt1), 1073741824), View.MeasureSpec.makeMeasureSpec(i, 1073741824));
      return;
    }
  }
}
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/Cells/DialogsEmptyCell.class
