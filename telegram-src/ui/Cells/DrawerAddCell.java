  ...
  extends FrameLayout
{
  ...
  protected void onAttachedToWindow()
  {
    ...
    this.textView.setTextColor(Theme.getColor("chats_menuItemText"));
    this.textView.setText(LocaleController.getString("AddAccount", 2131492921));
    Drawable localDrawable = getResources().getDrawable(2131165186);
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/Cells/DrawerAddCell.class
