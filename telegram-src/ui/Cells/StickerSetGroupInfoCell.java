  ...
  extends LinearLayout
{
  ...
  public StickerSetGroupInfoCell(Context paramContext)
  {
    ...
    localTextView.setText(LocaleController.getString("GroupStickersInfo", 2131493637));
    ...
    this.addButton.setText(LocaleController.getString("ChooseStickerSet", 2131493248).toUpperCase());
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/Cells/StickerSetGroupInfoCell.class
