  ...
  extends FrameLayout
{
  ...
  public void setSticker(TLRPC.Document paramDocument, int paramInt)
  {
    ...
    if (paramInt == -1)
    {
      setBackgroundResource(2131165658);
    ...
    for (;;)
    {
      ...
      if (paramInt == 0)
      {
        setBackgroundResource(2131165657);
        setPadding(0, 0, 0, 0);
      }
      else if (paramInt == 1)
      {
        setBackgroundResource(2131165659);
        setPadding(0, 0, AndroidUtilities.dp(7.0F), 0);
      }
      else if (paramInt == 2)
      {
        setBackgroundResource(2131165655);
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/Cells/StickerCell.class
