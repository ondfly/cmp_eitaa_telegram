  ...
  extends FrameLayout
{
  ...
  public void setStickerSet(TLRPC.StickerSetCovered paramStickerSetCovered, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      localSpannableStringBuilder.setSpan(new ForegroundColorSpan(Theme.getColor("windowBackgroundWhiteBlueText4")), paramInt1, paramInt1 + paramInt2, 33);
      ...
      if (paramBoolean)
      {
        ...
        this.addButton.setText(LocaleController.getString("StickersRemove", 2131494427).toUpperCase());
        label172:
  ...
  public void setUrl(CharSequence paramCharSequence, int paramInt)
  {
    ...
    try
    {
      ...
      localSpannableStringBuilder.setSpan(new ColorSpanUnderline(Theme.getColor("chat_emojiPanelTrendingDescription")), paramInt, paramCharSequence.length(), 33);
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/Cells/FeaturedStickerSetInfoCell.class
