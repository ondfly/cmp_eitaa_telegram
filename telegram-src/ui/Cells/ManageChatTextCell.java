  ...
  extends FrameLayout
{
  ...
  {
    paramInt4 -= paramInt2;
    int i = (paramInt4 - this.valueTextView.getTextHeight()) / 2;
    if (LocaleController.isRTL)
    {
      paramInt2 = AndroidUtilities.dp(24.0F);
      this.valueTextView.layout(paramInt2, i, this.valueTextView.getMeasuredWidth() + paramInt2, this.valueTextView.getMeasuredHeight() + i);
      paramInt4 = (paramInt4 - this.textView.getTextHeight()) / 2;
      if (LocaleController.isRTL) {
        break label167;
      }
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    this.valueTextView.measure(View.MeasureSpec.makeMeasureSpec(paramInt2 - AndroidUtilities.dp(24.0F), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0F), 1073741824));
    this.textView.measure(View.MeasureSpec.makeMeasureSpec(paramInt2 - AndroidUtilities.dp(95.0F), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0F), 1073741824));
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/Cells/ManageChatTextCell.class
