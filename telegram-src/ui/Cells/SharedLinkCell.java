  ...
  extends FrameLayout
{
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    try
    {
      paramInt2 = (int)Math.ceil(this.titleTextPaint.measureText((String)localObject8));
    ...
    catch (Exception localException2)
    {
      try
      {
        this.descriptionLayout = ChatMessageCell.generateStaticLayout((CharSequence)localObject7, this.descriptionTextPaint, i, i, 0, 3);
      ...
      catch (Exception localException2)
      {
        try
        {
          for (;;)
          {
            this.descriptionLayout2 = ChatMessageCell.generateStaticLayout((CharSequence)localObject6, this.descriptionTextPaint, i, i, 0, 3);
        ...
        catch (Exception localException3)
        {
          ...
          if (LocaleController.isRTL)
          {
            ...
            if (j != 0)
            {
              ...
              localObject4 = FileLoader.getClosestPhotoSizeWithSize(this.message.photoThumbs, 80);
              ...
              FileLoader.getAttachFileName((TLObject)localObject6);
          ...
          {
            ((ImageReceiver)localObject5).setImage((TLObject)localObject6, (String)localObject4, (TLRPC.FileLocation)localObject2, String.format(Locale.US, "%d_%d_b", new Object[] { Integer.valueOf(i), Integer.valueOf(i) }), 0, null, 0);
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/Cells/SharedLinkCell.class
