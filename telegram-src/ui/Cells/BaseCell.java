  ...
  extends ViewGroup
{
  ...
  public static void setDrawableBounds(Drawable paramDrawable, float paramFloat1, float paramFloat2)
  {
  ...
  public static void setDrawableBounds(Drawable paramDrawable, int paramInt1, int paramInt2)
  {
    setDrawableBounds(paramDrawable, paramInt1, paramInt2, paramDrawable.getIntrinsicWidth(), paramDrawable.getIntrinsicHeight());
  }
  
  public static void setDrawableBounds(Drawable paramDrawable, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/Cells/BaseCell.class
