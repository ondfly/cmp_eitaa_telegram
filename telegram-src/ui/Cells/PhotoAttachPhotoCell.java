  ...
  extends FrameLayout
{
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    if (this.isVertical)
    {
      paramInt2 = View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(80.0F), 1073741824);
      if (this.isLast) {}
      for (;;)
      {
        super.onMeasure(paramInt2, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(paramInt1 + 80), 1073741824));
        return;
        paramInt1 = 6;
      }
    }
  ...
  public void setPhotoEntry(MediaController.PhotoEntry paramPhotoEntry, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (this.photoEntry.isVideo)
    {
      ...
      this.imageView.setImage(this.photoEntry.thumbPath, null, getResources().getDrawable(2131165542));
      label142:
    ...
    for (float f1 = f2;; f1 = 1.0F)
    {
      ...
      if (this.photoEntry.path != null)
      {
        if (this.photoEntry.isVideo)
        {
          this.imageView.setImage("vthumb://" + this.photoEntry.imageId + ":" + this.photoEntry.path, null, getResources().getDrawable(2131165542));
          break label142;
        }
        this.imageView.setOrientation(this.photoEntry.orientation, true);
        this.imageView.setImage("thumb://" + this.photoEntry.imageId + ":" + this.photoEntry.path, null, getResources().getDrawable(2131165542));
        break label142;
      }
      this.imageView.setImageResource(2131165542);
      break label142;
      i = 0;
      break label162;
      f1 = 1.0F;
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/Cells/PhotoAttachPhotoCell.class
