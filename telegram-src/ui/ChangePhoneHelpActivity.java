  ...
  extends BaseFragment
{
  ...
  public View createView(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      this.imageView.setImageResource(2131165576);
      ...
      try
      {
        this.textView1.setText(AndroidUtilities.replaceTags(LocaleController.getString("PhoneNumberHelp", 2131494156)));
        ...
        this.textView2.setText(LocaleController.getString("PhoneNumberChange", 2131494154));
        ...
        this.textView2.setOnClickListener(new View.OnClickListener()
        {
          public void onClick(View paramAnonymousView)
          {
            ...
            paramAnonymousView.setMessage(LocaleController.getString("PhoneNumberAlert", 2131494153));
        ...
        localObject1 = LocaleController.getString("NumberUnknown", 2131494027);
      }
      catch (Exception localException)
      {
        for (;;)
        {
          ...
          this.textView1.setText(LocaleController.getString("PhoneNumberHelp", 2131494156));
        }
      }
    }
  }
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/ChangePhoneHelpActivity.class
