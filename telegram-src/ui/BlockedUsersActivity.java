  ...
  implements NotificationCenter.NotificationCenterDelegate, ContactsActivity.ContactsActivityDelegate
{
  ...
  public View createView(Context paramContext)
  {
    ...
    this.actionBar.setTitle(LocaleController.getString("BlockedUsers", 2131493081));
    ...
    this.actionBar.createMenu().addItem(1, 2131165608);
    this.fragmentView = new FrameLayout(paramContext);
    FrameLayout localFrameLayout = (FrameLayout)this.fragmentView;
    this.emptyView = new EmptyTextProgressView(paramContext);
    this.emptyView.setText(LocaleController.getString("NoBlocked", 2131493880));
    ...
    if (LocaleController.isRTL)
    {
      ...
      this.listView.setOnItemLongClickListener(new RecyclerListView.OnItemLongClickListener()
      {
        public boolean onItemClick(View paramAnonymousView, int paramAnonymousInt)
        {
          ...
          paramAnonymousView = new AlertDialog.Builder(BlockedUsersActivity.this.getParentActivity());
          String str = LocaleController.getString("Unblock", 2131494506);
          ...
          BlockedUsersActivity.this.showDialog(paramAnonymousView.create());
          return true;
        }
      });
  ...
  public void didReceivedNotification(int paramInt1, int paramInt2, Object... paramVarArgs)
  {
    ...
    do
    {
      ...
      {
        return;
      } while (paramInt1 != NotificationCenter.blockedUsersDidLoaded);
      this.emptyView.showTextView();
  ...
  public ThemeDescription[] getThemeDescriptions()
  {
    ThemeDescription.ThemeDescriptionDelegate local4 = new ThemeDescription.ThemeDescriptionDelegate()
    {
      public void didSetColor()
      {
        ...
        {
          int j = BlockedUsersActivity.this.listView.getChildCount();
          int i = 0;
          while (i < j)
          {
            View localView = BlockedUsersActivity.this.listView.getChildAt(i);
            if ((localView instanceof UserCell)) {
    ...
    extends RecyclerListView.SelectionAdapter
  {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder paramViewHolder, int paramInt)
    {
      ...
      if (paramViewHolder.getItemViewType() == 0)
      {
        ...
        if (localUser != null)
        {
          ...
          str = LocaleController.getString("Bot", 2131493086).substring(0, 1).toUpperCase() + LocaleController.getString("Bot", 2131493086).substring(1);
        }
      }
      for (;;)
      {
        ...
        if ((localUser.phone != null) && (localUser.phone.length() != 0)) {
          ...
          str = LocaleController.getString("NumberUnknown", 2131494027);
        }
      }
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
    {
      ...
      default: 
        ...
        ((TextInfoCell)paramViewGroup).setText(LocaleController.getString("UnblockText", 2131494507));
      }
      for (;;)
      {
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/BlockedUsersActivity.class
