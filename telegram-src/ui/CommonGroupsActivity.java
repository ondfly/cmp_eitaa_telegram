  ...
  extends BaseFragment
{
  ...
  public View createView(Context paramContext)
  {
    ...
    this.actionBar.setTitle(LocaleController.getString("GroupsInCommonTitle", 2131493646));
    ...
    this.emptyView.setText(LocaleController.getString("NoGroupsInCommon", 2131493888));
    ...
    if (LocaleController.isRTL)
    {
      ...
      this.listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener()
      {
        public void onItemClick(View paramAnonymousView, int paramAnonymousInt)
        {
          ...
          } while (!MessagesController.getInstance(CommonGroupsActivity.this.currentAccount).checkCanOpenChat(localBundle, CommonGroupsActivity.this));
  ...
  public ThemeDescription[] getThemeDescriptions()
  {
    ThemeDescription.ThemeDescriptionDelegate local5 = new ThemeDescription.ThemeDescriptionDelegate()
    {
      public void didSetColor()
      {
        ...
        {
          int j = CommonGroupsActivity.this.listView.getChildCount();
          int i = 0;
          while (i < j)
          {
            View localView = CommonGroupsActivity.this.listView.getChildAt(i);
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/CommonGroupsActivity.class
