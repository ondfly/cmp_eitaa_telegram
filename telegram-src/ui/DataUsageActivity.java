  ...
  extends BaseFragment
{
  ...
  public View createView(Context paramContext)
  {
    ...
    if (this.currentType == 0) {
      this.actionBar.setTitle(LocaleController.getString("MobileUsage", 2131493848));
    }
    for (;;)
    {
      ...
      this.listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener()
      {
        public void onItemClick(View paramAnonymousView, int paramAnonymousInt)
        {
          ...
          while (paramAnonymousInt != DataUsageActivity.this.resetRow) {
            return;
          }
          ...
          paramAnonymousView.setMessage(LocaleController.getString("ResetStatisticsAlert", 2131494266));
          paramAnonymousView.setPositiveButton(LocaleController.getString("Reset", 2131494250), new DialogInterface.OnClickListener()
          {
      ...
      if (this.currentType == 1) {
        this.actionBar.setTitle(LocaleController.getString("WiFiUsage", 2131494640));
      } else if (this.currentType == 2) {
        this.actionBar.setTitle(LocaleController.getString("RoamingUsage", 2131494282));
      }
    }
  }
    ...
    extends RecyclerListView.SelectionAdapter
  {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder paramViewHolder, int paramInt)
    {
        ...
        do
        {
          ...
          do
          {
            ...
            if (paramInt == DataUsageActivity.this.resetRow)
            {
              ...
              localTextSettingsCell.setText(LocaleController.getString("ResetStatistics", 2131494265), false);
            ...
            {
              localTextSettingsCell.setTextAndValue(LocaleController.getString("OutgoingCalls", 2131494049), String.format("%d", new Object[] { Integer.valueOf(StatsController.getInstance(DataUsageActivity.this.currentAccount).getSentItemsCount(DataUsageActivity.this.currentType, i)) }), true);
              return;
            ...
            {
              localTextSettingsCell.setTextAndValue(LocaleController.getString("IncomingCalls", 2131493672), String.format("%d", new Object[] { Integer.valueOf(StatsController.getInstance(DataUsageActivity.this.currentAccount).getRecivedItemsCount(DataUsageActivity.this.currentType, i)) }), true);
              return;
            }
            if (paramInt == DataUsageActivity.this.callsTotalTimeRow)
            {
              ...
              {
                localTextSettingsCell.setTextAndValue(LocaleController.getString("CallsTotalTime", 2131493126), paramViewHolder, false);
                return;
              }
            }
            ...
            {
              localTextSettingsCell.setTextAndValue(LocaleController.getString("CountSent", 2131493306), String.format("%d", new Object[] { Integer.valueOf(StatsController.getInstance(DataUsageActivity.this.currentAccount).getSentItemsCount(DataUsageActivity.this.currentType, i)) }), true);
              return;
            }
            ...
            {
              localTextSettingsCell.setTextAndValue(LocaleController.getString("CountReceived", 2131493305), String.format("%d", new Object[] { Integer.valueOf(StatsController.getInstance(DataUsageActivity.this.currentAccount).getRecivedItemsCount(DataUsageActivity.this.currentType, i)) }), true);
              return;
            }
            ...
            {
              localTextSettingsCell.setTextAndValue(LocaleController.getString("BytesSent", 2131493101), AndroidUtilities.formatFileSize(StatsController.getInstance(DataUsageActivity.this.currentAccount).getSentBytesCount(DataUsageActivity.this.currentType, i)), true);
              return;
            }
          ...
          paramViewHolder = LocaleController.getString("BytesReceived", 2131493100);
          ...
          {
            paramViewHolder.setText(LocaleController.getString("TotalDataUsage", 2131494498));
            return;
          }
          if (paramInt == DataUsageActivity.this.callsSectionRow)
          {
            paramViewHolder.setText(LocaleController.getString("CallsDataUsage", 2131493125));
            return;
          }
          if (paramInt == DataUsageActivity.this.filesSectionRow)
          {
            paramViewHolder.setText(LocaleController.getString("FilesDataUsage", 2131493538));
            return;
          }
          if (paramInt == DataUsageActivity.this.audiosSectionRow)
          {
            paramViewHolder.setText(LocaleController.getString("LocalAudioCache", 2131493763));
            return;
          }
          if (paramInt == DataUsageActivity.this.videosSectionRow)
          {
            paramViewHolder.setText(LocaleController.getString("LocalVideoCache", 2131493772));
            return;
          }
          if (paramInt == DataUsageActivity.this.photosSectionRow)
          {
            paramViewHolder.setText(LocaleController.getString("LocalPhotoCache", 2131493771));
            return;
          }
        } while (paramInt != DataUsageActivity.this.messagesSectionRow);
        paramViewHolder.setText(LocaleController.getString("MessagesDataUsage", 2131493827));
        return;
      }
      ...
      paramViewHolder.setText(LocaleController.formatString("NetworkUsageSince", 2131493860, new Object[] { LocaleController.getInstance().formatterStats.format(StatsController.getInstance(DataUsageActivity.this.currentAccount).getResetStatsDate(DataUsageActivity.this.currentType)) }));
    }
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/DataUsageActivity.class
