  ...
  extends Drawable
{
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    for (int i = 65356;; i = 180)
    {
      ...
      f1 = AndroidUtilities.dp(5.0F) * (1.0F - Math.abs(this.currentRotation)) - AndroidUtilities.dp(0.5F) * Math.abs(this.currentRotation);
      float f2 = AndroidUtilities.dp(9.0F) - AndroidUtilities.dp(2.5F) * Math.abs(this.currentRotation);
      ...
      paramCanvas.drawLine(f4, -f3, f2, -f1, this.paint);
      paramCanvas.drawLine(f4, f3, f2, f1, this.paint);
      paramCanvas.restore();
      return;
      if (this.currentRotation < this.finalRotation)
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/ActionBar/MenuDrawable.class
