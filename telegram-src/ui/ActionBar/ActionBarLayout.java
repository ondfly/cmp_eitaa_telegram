  ...
  extends FrameLayout
{
  ...
  public ActionBarLayout(Context paramContext)
  {
    ...
    {
      layerShadowDrawable = getResources().getDrawable(2131165454);
      headerShadowDrawable = getResources().getDrawable(2131165342).mutate();
  ...
  private void checkNeedRebuild()
  {
    ...
    while (!this.animateThemeAfterAnimation) {
      return;
    }
  ...
  public void animateThemedValues(Theme.ThemeInfo paramThemeInfo)
  {
    ...
    for (;;)
    {
      ...
      if (localObject != null)
      {
        ...
        int i = 0;
        while (i < this.themeAnimatorDescriptions.length)
        {
  ...
  public void setThemeAnimationValue(float paramFloat)
  {
    ...
    if (this.themeAnimatorDescriptions != null)
    {
      ...
      while (i < this.themeAnimatorDescriptions.length)
      {
        int i2 = Color.red(this.animateEndColors[i]);
        int m = Color.green(this.animateEndColors[i]);
        int j = Color.blue(this.animateEndColors[i]);
        int i1 = Color.alpha(this.animateEndColors[i]);
        int i3 = Color.red(this.animateStartColors[i]);
        int n = Color.green(this.animateStartColors[i]);
        int k = Color.blue(this.animateStartColors[i]);
        int i4 = Color.alpha(this.animateStartColors[i]);
        i1 = Math.min(255, (int)(i4 + (i1 - i4) * paramFloat));
        i2 = Math.min(255, (int)(i3 + (i2 - i3) * paramFloat));
        m = Math.min(255, (int)(n + (m - n) * paramFloat));
        j = Math.min(255, (int)(k + (j - k) * paramFloat));
        this.themeAnimatorDescriptions[i].setColor(Color.argb(i1, i2, m, j), false, false);
        i += 1;
      }
  ...
  public void setTitleOverlayText(String paramString1, String paramString2, Runnable paramRunnable)
  {
    ...
    int i = 0;
    while (i < this.fragmentsStack.size())
    {
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/ActionBar/ActionBarLayout.class
