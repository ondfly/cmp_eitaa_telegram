  ...
  implements NotificationCenter.NotificationCenterDelegate
{
  ...
  public View createView(Context paramContext)
  {
    ...
    this.actionBar.setTitle(LocaleController.getString("ConvertGroup", 2131493296));
    ...
    extends RecyclerListView.SelectionAdapter
  {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder paramViewHolder, int paramInt)
    {
      ...
      do
      {
        ...
        paramViewHolder.setText(LocaleController.getString("ConvertGroup", 2131493296), false);
        return;
        paramViewHolder = (TextInfoPrivacyCell)paramViewHolder.itemView;
        if (paramInt == ConvertGroupActivity.this.convertInfoRow)
        {
          paramViewHolder.setText(AndroidUtilities.replaceTags(LocaleController.getString("ConvertGroupInfo2", 2131493300)));
      ...
      paramViewHolder.setText(AndroidUtilities.replaceTags(LocaleController.getString("ConvertGroupInfo3", 2131493301)));
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/ConvertGroupActivity.class
