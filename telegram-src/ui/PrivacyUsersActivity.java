  ...
  implements NotificationCenter.NotificationCenterDelegate
{
    ...
    for (;;)
    {
      ...
      this.listView.setOnItemLongClickListener(new RecyclerListView.OnItemLongClickListener()
      {
        public boolean onItemClick(View paramAnonymousView, int paramAnonymousInt)
        {
          ...
          String str = LocaleController.getString("Delete", 2131493356);
  ...
  public ThemeDescription[] getThemeDescriptions()
  {
    ThemeDescription.ThemeDescriptionDelegate local4 = new ThemeDescription.ThemeDescriptionDelegate()
    {
      public void didSetColor()
      {
        ...
        {
          int j = PrivacyUsersActivity.this.listView.getChildCount();
          int i = 0;
          while (i < j)
          {
            View localView = PrivacyUsersActivity.this.listView.getChildAt(i);
            if ((localView instanceof UserCell)) {
    ...
    extends RecyclerListView.SelectionAdapter
  {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder paramViewHolder, int paramInt)
    {
      ...
      label100:
      for (paramViewHolder = PhoneFormat.getInstance().format("+" + localUser.phone);; paramViewHolder = LocaleController.getString("NumberUnknown", 2131494027))
      {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
    {
      ...
      default: 
        ...
        ((TextInfoCell)paramViewGroup).setText(LocaleController.getString("RemoveFromListText", 2131494230));
      }
      for (;;)
      {
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/PrivacyUsersActivity.class
