  ...
  extends StatusDrawable
{
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    if (this.isChat) {}
    for (float f1 = 8.0F;; f1 = 9.0F)
    {
      paramCanvas.drawCircle(f2, AndroidUtilities.dp(f1), AndroidUtilities.dp(4.0F), Theme.chat_statusPaint);
      if (this.started) {
        update();
      }
      return;
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/Components/RoundStatusDrawable.class
