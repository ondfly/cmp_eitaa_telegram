  ...
  extends FrameLayout
{
  ...
  public PhotoFilterView(Context paramContext, Bitmap paramBitmap, int paramInt, MediaController.SavedFilterState paramSavedFilterState)
  {
    ...
    if (paramSavedFilterState != null)
    {
      ...
      this.blurItem.setImageResource(2131165679);
      ...
      this.curveItem.setImageResource(2131165681);
      ...
      str = LocaleController.getString("CurvesAll", 2131493319);
    ...
    for (float f = 0.0F;; f = 30.0F)
    {
      ...
      paramSavedFilterState.setOnClickListener(new View.OnClickListener()
      {
        public void onClick(View paramAnonymousView)
        {
          ...
          PhotoFilterView.this.curvesToolValue.activeType = j;
          int i = 0;
          if (i < 4)
          {
            paramAnonymousView = PhotoFilterView.this.curveRadioButton[i];
            if (i == j) {}
      ...
      if (paramInt == 1)
      {
        str = LocaleController.getString("CurvesRed", 2131493322);
        localTextView.setText(str.substring(0, 1).toUpperCase() + str.substring(1).toLowerCase());
      ...
      if (paramInt == 2)
      {
        str = LocaleController.getString("CurvesGreen", 2131493321);
        localTextView.setText(str.substring(0, 1).toUpperCase() + str.substring(1).toLowerCase());
      ...
      str = LocaleController.getString("CurvesBlue", 2131493320);
      localTextView.setText(str.substring(0, 1).toUpperCase() + str.substring(1).toLowerCase());
    ...
    this.blurOffButton.setText(LocaleController.getString("BlurOff", 2131493083));
    ...
    this.blurRadialButton.setText(LocaleController.getString("BlurRadial", 2131493084));
    ...
    this.blurLinearButton.setText(LocaleController.getString("BlurLinear", 2131493082));
  ...
  private void updateSelectedBlurType()
  {
    if (this.blurType == 0)
    {
      localDrawable = this.blurOffButton.getContext().getResources().getDrawable(2131165235).mutate();
      ...
      this.blurRadialButton.setCompoundDrawablesWithIntrinsicBounds(0, 2131165236, 0, 0);
      this.blurRadialButton.setTextColor(-1);
      this.blurLinearButton.setCompoundDrawablesWithIntrinsicBounds(0, 2131165234, 0, 0);
    ...
    do
    {
      ...
      if (this.blurType == 1)
      {
        this.blurOffButton.setCompoundDrawablesWithIntrinsicBounds(0, 2131165235, 0, 0);
        this.blurOffButton.setTextColor(-1);
        localDrawable = this.blurOffButton.getContext().getResources().getDrawable(2131165236).mutate();
        localDrawable.setColorFilter(new PorterDuffColorFilter(-11420173, PorterDuff.Mode.MULTIPLY));
    ...
    this.blurRadialButton.setCompoundDrawablesWithIntrinsicBounds(0, 2131165236, 0, 0);
    this.blurRadialButton.setTextColor(-1);
    Drawable localDrawable = this.blurOffButton.getContext().getResources().getDrawable(2131165234).mutate();
    localDrawable.setColorFilter(new PorterDuffColorFilter(-11420173, PorterDuff.Mode.MULTIPLY));
    ...
    extends DispatchQueue
  {
    ...
    private boolean initGL()
    {
      ...
      Object tmp642_641 = localObject1;
      tmp642_641[0] = -1.0F;
      Object tmp648_642 = tmp642_641;
      tmp648_642[1] = 1.0F;
      Object tmp652_648 = tmp648_642;
      tmp652_648[2] = 1.0F;
      Object tmp656_652 = tmp652_648;
      tmp656_652[3] = 1.0F;
      Object tmp660_656 = tmp656_652;
      tmp660_656[4] = -1.0F;
      Object tmp666_660 = tmp660_656;
      tmp666_660[5] = -1.0F;
      Object tmp672_666 = tmp666_660;
      tmp672_666[6] = 1.0F;
      Object tmp677_672 = tmp672_666;
      tmp677_672[7] = -1.0F;
      tmp677_672;
      ...
      localObject1 = new float[8];
      Object tmp736_735 = localObject1;
      tmp736_735[0] = -1.0F;
      Object tmp742_736 = tmp736_735;
      tmp742_736[1] = -1.0F;
      Object tmp748_742 = tmp742_736;
      tmp748_742[2] = 1.0F;
      Object tmp752_748 = tmp748_742;
      tmp752_748[3] = -1.0F;
      Object tmp758_752 = tmp752_748;
      tmp758_752[4] = -1.0F;
      Object tmp764_758 = tmp758_752;
      tmp764_758[5] = 1.0F;
      Object tmp768_764 = tmp764_758;
      tmp768_764[6] = 1.0F;
      Object tmp773_768 = tmp768_764;
      tmp773_768[7] = 1.0F;
      tmp773_768;
      localObject2 = ByteBuffer.allocateDirect(localObject1.length * 4);
      ((ByteBuffer)localObject2).order(ByteOrder.nativeOrder());
      ...
      localObject1 = new float[8];
      Object tmp830_829 = localObject1;
      tmp830_829[0] = 0.0F;
      Object tmp834_830 = tmp830_829;
      tmp834_830[1] = 0.0F;
      Object tmp838_834 = tmp834_830;
      tmp838_834[2] = 1.0F;
      Object tmp842_838 = tmp838_834;
      tmp842_838[3] = 0.0F;
      Object tmp846_842 = tmp842_838;
      tmp846_842[4] = 0.0F;
      Object tmp850_846 = tmp846_842;
      tmp850_846[5] = 1.0F;
      Object tmp854_850 = tmp850_846;
      tmp854_850[6] = 1.0F;
      Object tmp859_854 = tmp854_850;
      tmp859_854[7] = 1.0F;
      tmp859_854;
      localObject2 = ByteBuffer.allocateDirect(localObject1.length * 4);
      ((ByteBuffer)localObject2).order(ByteOrder.nativeOrder());
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder paramViewHolder, int paramInt)
    {
      ...
      do
      {
        do
        {
          ...
          {
            paramViewHolder.setIconAndTextAndValue(LocaleController.getString("Enhance", 2131493444), PhotoFilterView.this.enhanceValue, 0, 100);
            return;
          }
          if (paramInt == PhotoFilterView.this.highlightsTool)
          {
            paramViewHolder.setIconAndTextAndValue(LocaleController.getString("Highlights", 2131493649), PhotoFilterView.this.highlightsValue, -100, 100);
            return;
          }
          if (paramInt == PhotoFilterView.this.contrastTool)
          {
            paramViewHolder.setIconAndTextAndValue(LocaleController.getString("Contrast", 2131493295), PhotoFilterView.this.contrastValue, -100, 100);
            return;
          }
          if (paramInt == PhotoFilterView.this.exposureTool)
          {
            paramViewHolder.setIconAndTextAndValue(LocaleController.getString("Exposure", 2131493531), PhotoFilterView.this.exposureValue, -100, 100);
            return;
          }
          if (paramInt == PhotoFilterView.this.warmthTool)
          {
            paramViewHolder.setIconAndTextAndValue(LocaleController.getString("Warmth", 2131494622), PhotoFilterView.this.warmthValue, -100, 100);
            return;
          }
          if (paramInt == PhotoFilterView.this.saturationTool)
          {
            paramViewHolder.setIconAndTextAndValue(LocaleController.getString("Saturation", 2131494285), PhotoFilterView.this.saturationValue, -100, 100);
            return;
          }
          if (paramInt == PhotoFilterView.this.vignetteTool)
          {
            paramViewHolder.setIconAndTextAndValue(LocaleController.getString("Vignette", 2131494581), PhotoFilterView.this.vignetteValue, 0, 100);
            return;
          }
          if (paramInt == PhotoFilterView.this.shadowsTool)
          {
            paramViewHolder.setIconAndTextAndValue(LocaleController.getString("Shadows", 2131494380), PhotoFilterView.this.shadowsValue, -100, 100);
            return;
          }
          if (paramInt == PhotoFilterView.this.grainTool)
          {
            paramViewHolder.setIconAndTextAndValue(LocaleController.getString("Grain", 2131493631), PhotoFilterView.this.grainValue, 0, 100);
            return;
          }
          if (paramInt == PhotoFilterView.this.sharpenTool)
          {
            paramViewHolder.setIconAndTextAndValue(LocaleController.getString("Sharpen", 2131494400), PhotoFilterView.this.sharpenValue, 0, 100);
            return;
          }
        } while (paramInt != PhotoFilterView.this.fadeTool);
        paramViewHolder.setIconAndTextAndValue(LocaleController.getString("Fade", 2131493533), PhotoFilterView.this.fadeValue, 0, 100);
        return;
        paramViewHolder = (PhotoEditRadioCell)paramViewHolder.itemView;
        paramViewHolder.setTag(Integer.valueOf(paramInt));
        if (paramInt == PhotoFilterView.this.tintShadowsTool)
        {
          paramViewHolder.setIconAndTextAndValue(LocaleController.getString("TintShadows", 2131494495), 0, PhotoFilterView.this.tintShadowsColor);
          return;
        }
      } while (paramInt != PhotoFilterView.this.tintHighlightsTool);
      paramViewHolder.setIconAndTextAndValue(LocaleController.getString("TintHighlights", 2131494494), 0, PhotoFilterView.this.tintHighlightsColor);
    }
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/Components/PhotoFilterView.class
