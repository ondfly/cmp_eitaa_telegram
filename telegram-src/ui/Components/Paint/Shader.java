...
public class Shader
{
  ...
  private CompilationResult compileShader(int paramInt, String paramString)
  {
    ...
    if ((paramString[0] == 0) && (BuildVars.LOGS_ENABLED)) {
  ...
  private int linkProgram(int paramInt)
  {
    ...
    if ((arrayOfInt[0] == 0) && (BuildVars.LOGS_ENABLED)) {
      FileLog.e(GLES20.glGetProgramInfoLog(paramInt));
    }
    return arrayOfInt[0];
  }
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/Components/Paint/Shader.class
