  ...
  extends EntityView
{
  ...
  public StickerView(Context paramContext, Point paramPoint, float paramFloat1, float paramFloat2, Size paramSize, TLRPC.Document paramDocument)
  {
    ...
    for (;;)
    {
      ...
      this.centerImage.setImage(paramDocument, null, paramDocument.thumb.location, null, "webp", 1);
      updatePosition();
      return;
      label186:
      i += 1;
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/Components/Paint/Views/StickerView.class
