  ...
  extends EntityView
{
    ...
    extends EntityView.SelectionView
  {
    ...
    protected int pointInsideHandle(float paramFloat1, float paramFloat2)
    {
      ...
      if ((paramFloat1 > f2 + f3 - f1) && (paramFloat2 > f5 - f1) && (paramFloat1 < f2 + f3 + f1) && (paramFloat2 < f5 + f1)) {
        return 2;
      }
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/Components/Paint/Views/TextPaintView.class
