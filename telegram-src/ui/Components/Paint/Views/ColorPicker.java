  ...
  extends FrameLayout
{
  ...
  public ColorPicker(Context paramContext)
  {
    ...
    this.shadowDrawable = getResources().getDrawable(2131165453);
    ...
    this.settingsButton.setImageResource(2131165582);
    ...
    this.undoButton.setImageResource(2131165588);
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      do
      {
        ...
        f2 = this.rectF.left;
        f3 = paramMotionEvent.getY() - this.rectF.top;
      } while ((!this.interacting) && (f3 < -AndroidUtilities.dp(10.0F)));
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/Components/Paint/Views/ColorPicker.class
