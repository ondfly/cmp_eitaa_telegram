  ...
  extends BottomSheet
{
  ...
  public JoinGroupAlert(Context paramContext, TLRPC.ChatInvite paramChatInvite, String paramString, BaseFragment paramBaseFragment)
  {
    ...
    for (int j = 0;; j = 10)
    {
      ...
      paramChatInvite.setBackgroundResource(2131165343);
      ...
      paramContext.cancelButton.setText(LocaleController.getString("Cancel", 2131493127).toUpperCase());
      ...
      paramContext.doneButtonTextView.setText(LocaleController.getString("JoinGroup", 2131493710));
              ...
              AndroidUtilities.runOnUIThread(new Runnable()
              {
                public void run()
                {
                  ...
                  do
                  {
                    ...
                    MessagesController.getInstance(JoinGroupAlert.this.currentAccount).putUsers(((TLRPC.Updates)localObject2).users, false);
                    MessagesController.getInstance(JoinGroupAlert.this.currentAccount).putChats(((TLRPC.Updates)localObject2).chats, false);
                    localObject2 = new Bundle();
                    ((Bundle)localObject2).putInt("chat_id", ((TLRPC.Chat)localObject1).id);
                  } while (!MessagesController.getInstance(JoinGroupAlert.this.currentAccount).checkCanOpenChat((Bundle)localObject2, JoinGroupAlert.this.fragment));
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/Components/JoinGroupAlert.class
