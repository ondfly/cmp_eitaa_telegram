  ...
  extends Drawable
{
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    while (i < 3)
    {
      paramCanvas.drawRect(AndroidUtilities.dp(2.0F) + j, AndroidUtilities.dp(this.progress1 * 7.0F + 2.0F) + k, AndroidUtilities.dp(4.0F) + j, AndroidUtilities.dp(10.0F) + k, this.paint);
      paramCanvas.drawRect(AndroidUtilities.dp(5.0F) + j, AndroidUtilities.dp(this.progress2 * 7.0F + 2.0F) + k, AndroidUtilities.dp(7.0F) + j, AndroidUtilities.dp(10.0F) + k, this.paint);
      paramCanvas.drawRect(AndroidUtilities.dp(8.0F) + j, AndroidUtilities.dp(this.progress3 * 7.0F + 2.0F) + k, AndroidUtilities.dp(10.0F) + j, AndroidUtilities.dp(10.0F) + k, this.paint);
      i += 1;
    }
    if (this.started) {
      update();
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/Components/RoundVideoPlayingDrawable.class
