...
public class Scroller
{
  ...
  public boolean computeScrollOffset()
  {
    ...
    do
    {
      do
      {
        ...
        bool1 = bool2;
      } while (this.mCurrX != this.mFinalX);
      bool1 = bool2;
    } while (this.mCurrY != this.mFinalY);
    this.mFinished = true;
    return true;
    this.mCurrX = this.mFinalX;
    this.mCurrY = this.mFinalY;
  ...
  public void fling(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8)
  {
    ...
    this.mVelocity = f2;
    double d = Math.log(START_TENSION * f2 / 800.0F);
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/Components/Scroller.class
