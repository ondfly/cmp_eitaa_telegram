  ...
  extends View
{
  ...
  public GroupCreateSpan(Context paramContext, TLRPC.User paramUser, ContactsController.Contact paramContact)
  {
    ...
    this.deleteDrawable = getResources().getDrawable(2131165307);
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/Components/GroupCreateSpan.class
