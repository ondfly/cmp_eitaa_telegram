  ...
  extends FrameLayout
{
  ...
  public PasscodeView(Context paramContext)
  {
    ...
    ((ImageView)localObject).setImageResource(2131165573);
    ...
    if (AndroidUtilities.density < 1.0F)
    {
      ...
      this.checkImage.setImageResource(2131165571);
      this.checkImage.setScaleType(ImageView.ScaleType.CENTER);
      this.checkImage.setBackgroundResource(2131165227);
    ...
    this.eraseView.setImageResource(2131165572);
    ...
    {
      localObject = new FrameLayout(paramContext);
      ((FrameLayout)localObject).setBackgroundResource(2131165227);
  ...
  private void checkFingerprint()
  {
    ...
    if ((Build.VERSION.SDK_INT >= 23) && (localActivity != null) && (SharedConfig.useFingerprint) && (!ApplicationLoader.mainInterfacePaused)) {}
    try
    {
    ...
    catch (Exception localException1)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          ((TextView)localObject2).setText(LocaleController.getString("FingerprintInfo", 2131493540));
          ...
          this.fingerprintImageView.setImageResource(2131165379);
          ...
          this.fingerprintStatusTextView.setText(LocaleController.getString("FingerprintHelp", 2131493539));
          ...
          try
          {
            ...
            localFingerprintManagerCompat.authenticate(null, 0, this.cancellationSignal, new FingerprintManagerCompat.AuthenticationCallback()
            {
              ...
              {
                PasscodeView.this.showFingerprintError(LocaleController.getString("FingerprintNotRecognized", 2131493541));
              }
              ...
              public void onAuthenticationSucceeded(FingerprintManagerCompat.AuthenticationResult paramAnonymousAuthenticationResult)
              {
                ...
                catch (Exception paramAnonymousAuthenticationResult)
                {
                  for (;;)
                  {
                    FileLog.e(paramAnonymousAuthenticationResult);
                  }
                }
              }
            }, null);
  ...
  {
    this.fingerprintImageView.setImageResource(2131165378);
  ...
  public void onShow()
  {
    ...
    if (Theme.isCustomTheme())
    {
      ...
      this.passcodeTextView.setText(LocaleController.getString("EnterYourPasscode", 2131493452));
      if (SharedConfig.passcodeType != 0) {
        break label290;
      }
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/Components/PasscodeView.class
