  ...
  extends CompoundButton
{
  ...
  {
    super(paramContext);
    this.mThumbDrawable = paramContext.getResources().getDrawable(2131165667);
    if (this.mThumbDrawable != null) {
      this.mThumbDrawable.setCallback(this);
    }
    this.mTrackDrawable = paramContext.getResources().getDrawable(2131165670);
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/Components/Switch.class
