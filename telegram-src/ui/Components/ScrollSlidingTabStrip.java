  ...
  extends HorizontalScrollView
{
  ...
  public TextView addIconTabWithCounter(Drawable paramDrawable)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      paramDrawable.setBackgroundResource(2131165653);
  ...
  protected void onScrollChanged(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    {
      Object localObject2 = this.tabsContainer.getChildAt(paramInt1);
      ...
      for (;;)
      {
        ...
        if ((localObject1 instanceof TLRPC.Document))
        {
          localObject2 = (BackupImageView)((FrameLayout)localObject2).getChildAt(0);
          if ((paramInt1 < paramInt2) || (paramInt1 >= paramInt2 + paramInt3))
          {
            ((BackupImageView)localObject2).setImageDrawable(null);
          }
          else
          {
            localObject1 = (TLRPC.Document)localObject1;
            if (((TLRPC.Document)localObject1).thumb != null) {
              ((BackupImageView)localObject2).setImage(((TLRPC.Document)localObject1).thumb.location, null, "webp", null);
            }
          }
        }
      }
  ...
  {
    int j = AndroidUtilities.dp(52.0F);
    int i = getScrollX() / j;
    j = Math.min(this.tabsContainer.getChildCount(), (int)Math.ceil(getMeasuredWidth() / j) + i + 1);
    if (i < j)
    {
      View localView = this.tabsContainer.getChildAt(i);
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/Components/ScrollSlidingTabStrip.class
