  ...
  extends BaseFragment
{
  ...
  public View createView(Context paramContext)
  {
    ...
    this.imageView.setImageResource(2131165267);
    ...
    this.whatIsChannelText.setText(LocaleController.getString("ChannelAlertTitle", 2131493153));
    ...
    this.descriptionText.setText(LocaleController.getString("ChannelAlertText", 2131493152));
    ...
    this.createChannelText.setText(LocaleController.getString("ChannelAlertCreate", 2131493151));
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/ChannelIntroActivity.class
