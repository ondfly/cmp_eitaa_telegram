  ...
  implements NotificationCenter.NotificationCenterDelegate
{
  ...
  public View createView(Context paramContext)
  {
    ...
    {
      this.actionBar.setTitle(LocaleController.getString("ArchivedStickers", 2131492991));
      ...
      this.emptyView.setText(LocaleController.getString("ArchivedStickersEmpty", 2131492994));
      label128:
    ...
    for (;;)
    {
      ...
      this.actionBar.setTitle(LocaleController.getString("ArchivedMasks", 2131492986));
      break;
      label292:
      this.emptyView.setText(LocaleController.getString("ArchivedMasksEmpty", 2131492989));
      break label128;
      label311:
    ...
    extends RecyclerListView.SelectionAdapter
  {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder paramViewHolder, int paramInt)
    {
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        paramViewHolder.setChecked(DataQuery.getInstance(ArchivedStickersActivity.this.currentAccount).isStickerPackInstalled(localStickerSetCovered.set.id));
        return;
      }
    }
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/ArchivedStickersActivity.class
