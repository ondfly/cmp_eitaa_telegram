  ...
  implements ActionBarLayout.ActionBarLayoutDelegate
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    if (AndroidUtilities.isTablet())
    {
      ...
      BitmapDrawable localBitmapDrawable = (BitmapDrawable)getResources().getDrawable(2131165266);
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/ui/ManageSpaceActivity.class
