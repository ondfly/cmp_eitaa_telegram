...
public class VoIPController
{
  ...
  {
    File localFile2 = VoIPHelper.getLogsDir();
    Object localObject = localFile2.listFiles();
    ...
    while (localArrayList.size() > 20)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localFile1.getName().endsWith(".log")) && (localFile1.lastModified() < ((File)localObject).lastModified())) {
    ...
    return new File(localFile2, paramLong + ".log").getAbsolutePath();
  }
  ...
  public void setConfig(double paramDouble1, double paramDouble2, int paramInt, long paramLong)
  {
    ...
    try
    {
      bool3 = AcousticEchoCanceler.isAvailable();
      bool1 = bool3;
    ...
    l = this.nativeInst;
    if ((!bool1) || (!VoIPServerConfig.getBoolean("use_system_aec", true)))
    {
      bool1 = true;
      if ((bool2) && (VoIPServerConfig.getBoolean("use_system_ns", true))) {
        break label131;
      }
    }
    label131:
    ...
    {
      nativeSetConfig(l, paramDouble1, paramDouble2, paramInt, bool1, bool2, true, getLogFilePath(paramLong), null);
      return;
      bool1 = false;
      break;
    }
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/messenger/voip/VoIPController.class
