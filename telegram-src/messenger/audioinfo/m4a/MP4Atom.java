  ...
  extends MP4Box<RangeInputStream>
{
  ...
  {
    if (getChild() != null) {}
    for (long l = getChild().getRemaining(); l < getRemaining(); l = 0L) {
      return true;
    }
    return false;
  }
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/messenger/audioinfo/m4a/MP4Atom.class
