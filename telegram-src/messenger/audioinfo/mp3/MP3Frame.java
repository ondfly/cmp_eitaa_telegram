...
public class MP3Frame
{
  ...
  public static class Header
  {
    ...
    static
    {
      int[] arrayOfInt1 = { -1, -1, -1, -1 };
      FREQUENCIES = new int[][] { { 11025, -1, 22050, 44100 }, { 12000, -1, 24000, 48000 }, { 8000, -1, 16000, 32000 }, arrayOfInt1 };
      arrayOfInt1 = new int[] { 0, 0, 0, 0, 0 };
      int[] arrayOfInt2 = { 32000, 32000, 32000, 32000, 8000 };
      int[] arrayOfInt3 = { 64000, 48000, 40000, 48000, 16000 };
      int[] arrayOfInt4 = { 128000, 64000, 56000, 64000, 32000 };
      int[] arrayOfInt5 = { 224000, 112000, 96000, 112000, 56000 };
      int[] arrayOfInt6 = { 256000, 128000, 112000, 128000, 64000 };
      int[] arrayOfInt7 = { 352000, 224000, 192000, 176000, 112000 };
      ...
      BITRATES = new int[][] { arrayOfInt1, arrayOfInt2, arrayOfInt3, { 96000, 56000, 48000, 56000, 24000 }, arrayOfInt4, { 160000, 80000, 64000, 80000, 40000 }, { 192000, 96000, 80000, 96000, 48000 }, arrayOfInt5, arrayOfInt6, { 288000, 160000, 128000, 144000, 80000 }, { 320000, 192000, 160000, 160000, 96000 }, arrayOfInt7, arrayOfInt8, arrayOfInt9, arrayOfInt10, arrayOfInt11 };
      BITRATES_COLUMN = new int[][] { { -1, 4, 4, 3 }, { -1, -1, -1, -1 }, { -1, 4, 4, 3 }, { -1, 2, 1, 0 } };
      arrayOfInt1 = new int[] { -1, -1, -1, -1 };
      SIZE_COEFFICIENTS = new int[][] { { -1, 72, 144, 12 }, arrayOfInt1, { -1, 72, 144, 12 }, { -1, 144, 144, 12 } };
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/messenger/audioinfo/mp3/MP3Frame.class
