  ...
  implements AudioProcessor
{
  ...
  public void queueInput(ByteBuffer paramByteBuffer)
  {
    ...
    int j = (k - i) / (this.channelCount * 2);
    j = this.outputChannels.length * j * 2;
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/messenger/exoplayer2/audio/ChannelMappingAudioProcessor.class
