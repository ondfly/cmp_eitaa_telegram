  ...
  implements AudioSink
{
    ...
    throws AudioSink.ConfigurationException
  {
    ...
    for (int i3 = 1;; i3 = 0)
    {
      this.canApplyPlaybackParameters = i3;
      j = paramInt2;
      k = paramInt3;
      n = i;
      if (!bool) {
      ...
      for (;;)
      {
        ...
        try
        {
          i3 = i4.configure(paramInt1, paramInt2, paramInt3);
          paramInt5 |= i3;
          if (i4.isActive())
          {
    ...
    {
    default: 
      throw new AudioSink.ConfigurationException("Unsupported channel count: " + j);
    case 1: 
      label284:
      paramInt1 = 4;
      paramInt2 = paramInt1;
    ...
    for (;;)
    {
      ...
      if ((m != 0) || (!isInitialized()) || (this.outputEncoding != k) || (this.sampleRate != n) || (this.channelConfig != paramInt1)) {
        break label586;
      }
      return;
      paramInt1 = 12;
    ...
    this.outputEncoding = k;
    if (this.isInputPcm) {
      this.outputPcmFrameSize = Util.getPcmFrameSize(this.outputEncoding, j);
    }
    if (paramInt4 != 0)
    {
    ...
    for (long l = framesToDurationUs(this.bufferSize / this.outputPcmFrameSize);; l = -9223372036854775807L)
    {
      ...
      if (this.isInputPcm)
      {
        paramInt1 = AudioTrack.getMinBufferSize(n, paramInt1, this.outputEncoding);
        if (paramInt1 != -2) {}
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/messenger/exoplayer2/audio/DefaultAudioSink.class
