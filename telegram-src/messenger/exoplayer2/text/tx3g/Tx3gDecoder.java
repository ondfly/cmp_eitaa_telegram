  ...
  private void decodeInitializationData(List<byte[]> paramList)
  {
    if ((paramList != null) && (paramList.size() == 1) && ((((byte[])paramList.get(0)).length == 48) || (((byte[])paramList.get(0)).length == 53)))
    {
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        this.defaultVerticalPlacement = (((arrayOfByte[10] & 0xFF) << 8 | arrayOfByte[11] & 0xFF) / this.calculatedVideoTrackHeight);
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/messenger/exoplayer2/text/tx3g/Tx3gDecoder.class
