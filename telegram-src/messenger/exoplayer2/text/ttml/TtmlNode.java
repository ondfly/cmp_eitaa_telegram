...
final class TtmlNode
{
  ...
  public List<Cue> getCues(long paramLong, Map<String, TtmlStyle> paramMap, Map<String, TtmlRegion> paramMap1)
  {
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      paramMap.add(new Cue(cleanUpText((SpannableStringBuilder)localEntry.getValue()), null, localTtmlRegion.line, localTtmlRegion.lineType, localTtmlRegion.lineAnchor, localTtmlRegion.position, Integer.MIN_VALUE, localTtmlRegion.width));
    }
    return paramMap;
  }
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/messenger/exoplayer2/text/ttml/TtmlNode.class
