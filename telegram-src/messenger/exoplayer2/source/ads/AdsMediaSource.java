  ...
  extends CompositeMediaSource<MediaSource.MediaPeriodId>
{
  ...
  public MediaPeriod createPeriod(MediaSource.MediaPeriodId paramMediaPeriodId, Allocator paramAllocator)
  {
    if ((this.adPlaybackState.adGroupCount > 0) && (paramMediaPeriodId.isAd()))
    {
      ...
      {
        Object localObject = this.adPlaybackState.adGroups[paramMediaPeriodId.adGroupIndex].uris[paramMediaPeriodId.adIndexInAdGroup];
      ...
      paramMediaPeriodId = this.adGroupMediaSources[i][j];
      paramAllocator = new DeferredMediaPeriod(paramMediaPeriodId, new MediaSource.MediaPeriodId(0), paramAllocator);
      paramMediaPeriodId = (List)this.deferredMediaPeriodByAdMediaSource.get(paramMediaPeriodId);
      if (paramMediaPeriodId == null)
      {
        paramAllocator.createPeriod();
        return paramAllocator;
      }
      paramMediaPeriodId.add(paramAllocator);
      return paramAllocator;
    }
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/messenger/exoplayer2/source/ads/AdsMediaSource.class
