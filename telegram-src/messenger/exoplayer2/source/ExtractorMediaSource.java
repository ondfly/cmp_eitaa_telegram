  ...
  implements ExtractorMediaPeriod.Listener, MediaSource
{
  ...
  private ExtractorMediaSource(Uri paramUri, DataSource.Factory paramFactory, ExtractorsFactory paramExtractorsFactory, int paramInt1, Handler paramHandler, MediaSourceEventListener paramMediaSourceEventListener, String paramString, int paramInt2)
  {
    this.uri = paramUri;
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/messenger/exoplayer2/source/ExtractorMediaSource.class
