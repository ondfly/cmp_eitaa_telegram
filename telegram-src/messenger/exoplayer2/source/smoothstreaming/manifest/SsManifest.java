  ...
  public static class StreamElement
  {
    ...
    public Uri buildRequestUri(int paramInt1, int paramInt2)
    {
      ...
      for (boolean bool1 = bool2;; bool1 = false)
      {
        ...
        str1 = this.chunkTemplate.replace("{bitrate}", str1).replace("{Bitrate}", str1).replace("{start time}", str2).replace("{start_time}", str2);
        return UriUtil.resolveToUri(this.baseUri, str1);
        bool1 = false;
        break;
        bool1 = false;
        break label25;
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/messenger/exoplayer2/source/smoothstreaming/manifest/SsManifest.class
