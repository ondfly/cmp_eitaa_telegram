  ...
  implements Parcelable
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while ((this.colorSpace == ((ColorInfo)paramObject).colorSpace) && (this.colorRange == ((ColorInfo)paramObject).colorRange) && (this.colorTransfer == ((ColorInfo)paramObject).colorTransfer) && (Arrays.equals(this.hdrStaticInfo, ((ColorInfo)paramObject).hdrStaticInfo)));
    return false;
  }
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/messenger/exoplayer2/video/ColorInfo.class
