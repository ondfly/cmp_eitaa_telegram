  ...
  implements Extractor
{
    ...
    throws IOException, InterruptedException
  {
    ...
    int j = this.tsPacketBuffer.getPosition();
    int i = j;
    ...
    implements SectionPayloadReader
  {
    ...
    private TsPayloadReader.EsInfo readEsInfo(ParsableByteArray paramParsableByteArray, int paramInt)
    {
      ...
      return new TsPayloadReader.EsInfo(paramInt, (String)localObject1, (List)localObject3, Arrays.copyOfRange(paramParsableByteArray.data, j, k));
    }
      ...
      do
      {
        ...
        if ((TsExtractor.this.mode == 1) || (TsExtractor.this.mode == 2) || (TsExtractor.this.remainingPmts == 1))
        {
          ...
          if ((TsExtractor.this.mode == 2) && (TsExtractor.this.id3Reader == null))
          {
            ...
            TsExtractor.this.id3Reader.init(localTimestampAdjuster, TsExtractor.this.output, new TsPayloadReader.TrackIdGenerator(i1, 21, 8192));
          }
        ...
        while (j > 0)
        {
          ...
          for (localObject = TsExtractor.this.id3Reader;; localObject = TsExtractor.this.payloadReaderFactory.createPayloadReader(i, (TsPayloadReader.EsInfo)localObject))
          {
            if (TsExtractor.this.mode == 2)
            {
              j = n;
        ...
        while (i < j)
        {
          ...
          if (paramParsableByteArray != null)
          {
            if (paramParsableByteArray != TsExtractor.this.id3Reader) {
              paramParsableByteArray.init(localTimestampAdjuster, TsExtractor.this.output, new TsPayloadReader.TrackIdGenerator(i1, k, 8192));
            }
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/messenger/exoplayer2/extractor/ts/TsExtractor.class
