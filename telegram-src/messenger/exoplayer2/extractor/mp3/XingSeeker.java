  ...
  implements Mp3Extractor.Seeker
{
  ...
  public SeekMap.SeekPoints getSeekPoints(long paramLong)
  {
    ...
    {
      long l = Util.constrainValue(Math.round(d1 / 256.0D * this.dataSize), this.xingFrameSize, this.dataSize - 1L);
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/messenger/exoplayer2/extractor/mp3/XingSeeker.class
