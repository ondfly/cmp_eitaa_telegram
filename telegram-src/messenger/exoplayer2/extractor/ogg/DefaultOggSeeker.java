  ...
  implements OggSeeker
{
    ...
    throws IOException, InterruptedException
  {
    ...
    if ((l1 < 0L) || (l1 > 72000L))
    {
      ...
      for (paramLong = 2L;; paramLong = 1L) {
        return Math.min(Math.max(paramExtractorInput.getPosition() - l2 * paramLong + (this.end - this.start) * l1 / (this.endGranule - this.startGranule), this.start), this.end - 1L);
      }
    }
    paramExtractorInput.skipFully(i);
    ...
    implements SeekMap
  {
    ...
    public SeekMap.SeekPoints getSeekPoints(long paramLong)
    {
      ...
      long l = DefaultOggSeeker.this.streamReader.convertTimeToGranule(paramLong);
      return new SeekMap.SeekPoints(new SeekPoint(paramLong, DefaultOggSeeker.this.getEstimatedPosition(DefaultOggSeeker.this.startPosition, l, 30000L)));
    }
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/messenger/exoplayer2/extractor/ogg/DefaultOggSeeker.class
