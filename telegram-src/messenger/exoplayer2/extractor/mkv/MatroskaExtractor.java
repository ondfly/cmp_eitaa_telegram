  ...
  implements Extractor
{
    ...
    throws IOException, InterruptedException
  {
    ...
    Object localObject1 = (Track)this.tracks.get(this.blockTrackNumber);
  ...
  private static final class Track
  {
      ...
      throws ParserException
    {
      ...
      if (this.flagDefault)
      {
        ...
        k = 1;
        localObject1 = Format.createAudioSampleFormat(Integer.toString(paramInt), (String)localObject1, null, -1, i, this.channelCount, this.sampleRate, j, (List)localObject2, this.drmInitData, m, this.language);
        paramInt = k;
      }
      for (;;)
      {
        ...
        {
          i = 3;
          localObject1 = Format.createTextSampleFormat(Integer.toString(paramInt), (String)localObject1, m, this.language, this.drmInitData);
          paramInt = i;
        }
        else if ("text/x-ssa".equals(localObject1))
        {
          ...
          ((List)localObject2).add(this.codecPrivate);
          localObject1 = Format.createTextSampleFormat(Integer.toString(paramInt), (String)localObject1, null, -1, m, this.language, -1, this.drmInitData, Long.MAX_VALUE, (List)localObject2);
          paramInt = i;
        }
        else
        {
          ...
          i = 3;
          localObject1 = Format.createImageSampleFormat(Integer.toString(paramInt), (String)localObject1, null, -1, m, (List)localObject2, this.language, this.drmInitData);
          paramInt = i;
        }
      }
      label2335:
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/messenger/exoplayer2/extractor/mkv/MatroskaExtractor.class
