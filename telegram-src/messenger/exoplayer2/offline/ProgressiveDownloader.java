  ...
  implements Downloader
{
  ...
  public float getDownloadPercentage()
  {
    ...
    return (float)this.cachingCounters.totalCachedBytes() * 100.0F / (float)l;
  }
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/messenger/exoplayer2/offline/ProgressiveDownloader.class
