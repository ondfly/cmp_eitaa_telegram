    ...
    for (paramOnKeyStatusChangeListener = null;; paramOnKeyStatusChangeListener = new MediaDrm.OnKeyStatusChangeListener()
        {
          public void onKeyStatusChange(MediaDrm paramAnonymousMediaDrm, byte[] paramAnonymousArrayOfByte, List<MediaDrm.KeyStatus> paramAnonymousList, boolean paramAnonymousBoolean)
          {
            ...
            {
              MediaDrm.KeyStatus localKeyStatus = (MediaDrm.KeyStatus)paramAnonymousList.next();
              paramAnonymousMediaDrm.add(new ExoMediaDrm.DefaultKeyStatus(localKeyStatus.getStatusCode(), localKeyStatus.getKeyId()));
            }
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/messenger/exoplayer2/drm/FrameworkMediaDrm.class
