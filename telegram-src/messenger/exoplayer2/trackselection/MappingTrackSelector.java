  ...
  public static final class MappedTrackInfo
  {
    ...
    public int getRendererSupport(int paramInt)
    {
      ...
      while (paramInt < arrayOfInt.length)
      {
        ...
        {
          switch (arrayOfInt[paramInt][j] & 0x7)
          {
          }
          for (int k = 1;; k = 2)
          {
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/messenger/exoplayer2/trackselection/MappingTrackSelector.class
