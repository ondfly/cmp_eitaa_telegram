  ...
  extends SpliceCommand
{
  ...
  public static final class Event
  {
    ...
    private static Event parseFromSection(ParsableByteArray paramParsableByteArray)
    {
      ...
      {
        l2 = 1000L * ((1L & l2) << 32 | paramParsableByteArray.readUnsignedInt()) / 90L;
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/messenger/exoplayer2/metadata/scte35/SpliceScheduleCommand.class
