  ...
  implements DataSource
{
    ...
    throws RawResourceDataSource.RawResourceDataSourceException
  {
    ...
    //   77: dup
    //   78: aload_1
    //   79: invokespecial 100	org/telegram/messenger/exoplayer2/upstream/RawResourceDataSource$RawResourceDataSourceException:<init>	(Ljava/io/IOException;)V
    //   82: athrow
    //   83: astore_1
    //   84: aload_0
    //   85: aconst_null
    //   86: putfield 86	org/telegram/messenger/exoplayer2/upstream/RawResourceDataSource:assetFileDescriptor	Landroid/content/res/AssetFileDescriptor;
    //   89: aload_0
    //   90: getfield 91	org/telegram/messenger/exoplayer2/upstream/RawResourceDataSource:opened	Z
    //   93: ifeq +25 -> 118
    //   96: aload_0
    //   97: iconst_0
    //   98: putfield 91	org/telegram/messenger/exoplayer2/upstream/RawResourceDataSource:opened	Z
    //   101: aload_0
    //   102: getfield 47	org/telegram/messenger/exoplayer2/upstream/RawResourceDataSource:listener	Lorg/telegram/messenger/exoplayer2/upstream/TransferListener;
    //   105: ifnull +13 -> 118
    //   108: aload_0
    //   109: getfield 47	org/telegram/messenger/exoplayer2/upstream/RawResourceDataSource:listener	Lorg/telegram/messenger/exoplayer2/upstream/TransferListener;
    //   112: aload_0
    //   113: invokeinterface 97 2 0
    //   118: aload_1
    //   119: athrow
    //   120: astore_1
    //   121: new 8	org/telegram/messenger/exoplayer2/upstream/RawResourceDataSource$RawResourceDataSourceException
    //   124: dup
    //   125: aload_1
    //   126: invokespecial 100	org/telegram/messenger/exoplayer2/upstream/RawResourceDataSource$RawResourceDataSourceException:<init>	(Ljava/io/IOException;)V
    //   129: athrow
    //   130: astore_1
    //   131: aload_0
    //   132: aconst_null
    //   133: putfield 80	org/telegram/messenger/exoplayer2/upstream/RawResourceDataSource:inputStream	Ljava/io/InputStream;
    //   136: aload_0
    //   137: getfield 86	org/telegram/messenger/exoplayer2/upstream/RawResourceDataSource:assetFileDescriptor	Landroid/content/res/AssetFileDescriptor;
    //   140: ifnull +10 -> 150
    //   143: aload_0
    //   144: getfield 86	org/telegram/messenger/exoplayer2/upstream/RawResourceDataSource:assetFileDescriptor	Landroid/content/res/AssetFileDescriptor;
    //   147: invokevirtual 89	android/content/res/AssetFileDescriptor:close	()V
    //   150: aload_0
    //   151: aconst_null
    //   152: putfield 86	org/telegram/messenger/exoplayer2/upstream/RawResourceDataSource:assetFileDescriptor	Landroid/content/res/AssetFileDescriptor;
    //   155: aload_0
    //   156: getfield 91	org/telegram/messenger/exoplayer2/upstream/RawResourceDataSource:opened	Z
    //   159: ifeq +25 -> 184
    //   162: aload_0
    //   163: iconst_0
    //   164: putfield 91	org/telegram/messenger/exoplayer2/upstream/RawResourceDataSource:opened	Z
    //   167: aload_0
    //   168: getfield 47	org/telegram/messenger/exoplayer2/upstream/RawResourceDataSource:listener	Lorg/telegram/messenger/exoplayer2/upstream/TransferListener;
    //   171: ifnull +13 -> 184
    //   174: aload_0
    //   175: getfield 47	org/telegram/messenger/exoplayer2/upstream/RawResourceDataSource:listener	Lorg/telegram/messenger/exoplayer2/upstream/TransferListener;
    //   178: aload_0
    //   179: invokeinterface 97 2 0
    //   184: aload_1
    //   185: athrow
    //   186: astore_1
    //   187: new 8	org/telegram/messenger/exoplayer2/upstream/RawResourceDataSource$RawResourceDataSourceException
    //   190: dup
    //   191: aload_1
    //   192: invokespecial 100	org/telegram/messenger/exoplayer2/upstream/RawResourceDataSource$RawResourceDataSourceException:<init>	(Ljava/io/IOException;)V
    //   195: athrow
    //   196: astore_1
    //   197: aload_0
    //   198: aconst_null
    //   199: putfield 86	org/telegram/messenger/exoplayer2/upstream/RawResourceDataSource:assetFileDescriptor	Landroid/content/res/AssetFileDescriptor;
    //   202: aload_0
    //   203: getfield 91	org/telegram/messenger/exoplayer2/upstream/RawResourceDataSource:opened	Z
    //   206: ifeq +25 -> 231
    //   209: aload_0
    //   210: iconst_0
    //   211: putfield 91	org/telegram/messenger/exoplayer2/upstream/RawResourceDataSource:opened	Z
    //   214: aload_0
    //   215: getfield 47	org/telegram/messenger/exoplayer2/upstream/RawResourceDataSource:listener	Lorg/telegram/messenger/exoplayer2/upstream/TransferListener;
    //   218: ifnull +13 -> 231
    //   221: aload_0
    //   222: getfield 47	org/telegram/messenger/exoplayer2/upstream/RawResourceDataSource:listener	Lorg/telegram/messenger/exoplayer2/upstream/TransferListener;
    //   225: aload_0
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/messenger/exoplayer2/upstream/RawResourceDataSource.class
