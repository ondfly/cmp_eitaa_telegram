  ...
  extends ChooserTargetService
{
  ...
  public List<ChooserTarget> onGetChooserTargets(final ComponentName paramComponentName, final IntentFilter paramIntentFilter)
  {
    ...
    while (!MessagesController.getGlobalMainSettings().getBoolean("direct_share", true)) {
        ...
        for (;;)
        {
          try
          {
            ...
            if (!((ArrayList)localObject3).isEmpty()) {
              MessagesStorage.getInstance(i).getChatsInternal(TextUtils.join(",", (Iterable)localObject3), localArrayList2);
            }
          ...
          if (localObject3 != null)
          {
            ...
            if (localObject1 == null) {
              localObject4 = Icon.createWithResource(ApplicationLoader.applicationContext, 2131165481);
            }
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/messenger/TgChooserTargetService.class
