...
public class UserObject
{
  public static String getFirstName(TLRPC.User paramUser)
  {
    ...
    return LocaleController.getString("HiddenName", 2131493648);
  }
  ...
  public static String getUserName(TLRPC.User paramUser)
  {
    Object localObject;
    if ((paramUser == null) || (isDeleted(paramUser))) {
      localObject = LocaleController.getString("HiddenName", 2131493648);
    }
    do
    {
      String str;
  ...
  {
    return (paramUser != null) && (((paramUser instanceof TLRPC.TL_userContact_old2)) || (paramUser.contact) || (paramUser.mutual_contact));
  }
  ...
  {
    return (paramUser != null) && (((paramUser instanceof TLRPC.TL_userSelf_old3)) || (paramUser.self));
  }
}


/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/messenger/UserObject.class
