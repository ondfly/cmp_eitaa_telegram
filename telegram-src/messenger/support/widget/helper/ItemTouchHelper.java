    ...
    public void onLongPress(MotionEvent paramMotionEvent)
    {
      ...
      do
      {
        do
        {
          ...
          {
            return;
            localObject = ItemTouchHelper.this.findChildView(paramMotionEvent);
          } while (localObject == null);
          localObject = ItemTouchHelper.this.mRecyclerView.getChildViewHolder((View)localObject);
        } while ((localObject == null) || (!ItemTouchHelper.this.mCallback.hasDragFlag(ItemTouchHelper.this.mRecyclerView, (RecyclerView.ViewHolder)localObject)) || (paramMotionEvent.getPointerId(0) != ItemTouchHelper.this.mActivePointerId));
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/messenger/support/widget/helper/ItemTouchHelper.class
