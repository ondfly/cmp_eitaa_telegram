    ...
    implements JobIntentService.CompatJobEngine
  {
    ...
    public JobIntentService.GenericWorkItem dequeueWork()
    {
      ...
      synchronized (this.mLock)
      {
        ...
        ((JobWorkItem)localObject1).getIntent().setExtrasClassLoader(this.mService.getClassLoader());
        return new WrapperWorkItem((JobWorkItem)localObject1);
      }
    }
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/messenger/support/JobIntentService.class
