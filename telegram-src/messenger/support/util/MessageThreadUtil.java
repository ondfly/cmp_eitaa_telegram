  ...
  implements ThreadUtil<T>
{
  ...
  static class MessageQueue
  {
    ...
    MessageThreadUtil.SyncQueueItem next()
    {
      ...
      //   1: monitorenter
      //   2: aload_0
      //   3: getfield 18	org/telegram/messenger/support/util/MessageThreadUtil$MessageQueue:mRoot	Lorg/telegram/messenger/support/util/MessageThreadUtil$SyncQueueItem;
      //   6: astore_1
      //   7: aload_1
      //   8: ifnonnull +9 -> 17
      //   11: aconst_null
      ...
      //   16: areturn
      //   17: aload_0
      //   18: getfield 18	org/telegram/messenger/support/util/MessageThreadUtil$MessageQueue:mRoot	Lorg/telegram/messenger/support/util/MessageThreadUtil$SyncQueueItem;
      //   21: astore_1
      //   22: aload_0
      //   23: aload_0
      //   24: getfield 18	org/telegram/messenger/support/util/MessageThreadUtil$MessageQueue:mRoot	Lorg/telegram/messenger/support/util/MessageThreadUtil$SyncQueueItem;
      //   27: invokestatic 24	org/telegram/messenger/support/util/MessageThreadUtil$SyncQueueItem:access$000	(Lorg/telegram/messenger/support/util/MessageThreadUtil$SyncQueueItem;)Lorg/telegram/messenger/support/util/MessageThreadUtil$SyncQueueItem;
      //   30: putfield 18	org/telegram/messenger/support/util/MessageThreadUtil$MessageQueue:mRoot	Lorg/telegram/messenger/support/util/MessageThreadUtil$SyncQueueItem;
      //   33: goto -20 -> 13
      //   36: astore_1
      //   37: aload_0
      //   38: monitorexit
    ...
    void sendMessage(MessageThreadUtil.SyncQueueItem paramSyncQueueItem)
    {
      ...
      //   9: aload_0
      //   10: aload_1
      //   11: putfield 18	org/telegram/messenger/support/util/MessageThreadUtil$MessageQueue:mRoot	Lorg/telegram/messenger/support/util/MessageThreadUtil$SyncQueueItem;
      //   14: aload_0
      //   15: monitorexit
      //   16: return
      //   17: aload_0
      ...
      //   21: astore_2
      //   22: aload_2
      //   23: invokestatic 24	org/telegram/messenger/support/util/MessageThreadUtil$SyncQueueItem:access$000	(Lorg/telegram/messenger/support/util/MessageThreadUtil$SyncQueueItem;)Lorg/telegram/messenger/support/util/MessageThreadUtil$SyncQueueItem;
      //   26: ifnull +11 -> 37
      //   29: aload_2
      //   30: invokestatic 24	org/telegram/messenger/support/util/MessageThreadUtil$SyncQueueItem:access$000	(Lorg/telegram/messenger/support/util/MessageThreadUtil$SyncQueueItem;)Lorg/telegram/messenger/support/util/MessageThreadUtil$SyncQueueItem;
      //   33: astore_2
      //   34: goto -12 -> 22
      //   37: aload_2
      //   38: aload_1
      //   39: invokestatic 37	org/telegram/messenger/support/util/MessageThreadUtil$SyncQueueItem:access$002	(Lorg/telegram/messenger/support/util/MessageThreadUtil$SyncQueueItem;Lorg/telegram/messenger/support/util/MessageThreadUtil$SyncQueueItem;)Lorg/telegram/messenger/support/util/MessageThreadUtil$SyncQueueItem;
      //   42: pop
      //   43: goto -29 -> 14
      //   46: astore_1
      //   47: aload_0
...
/* Location:              /test_eitaa/dex2jar/telegram-dex2jar.jar!/org/telegram/messenger/support/util/MessageThreadUtil.class
