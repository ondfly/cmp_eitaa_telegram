...
import ir.eitaa.tgnet.SerializedJson;
...
import ir.eitaa.ui.Components.NumberPicker.Formatter;
...
public class AndroidUtilities
{
  ...
  public static AlertDialog.Builder buildTTLAlert(final Context paramContext, TLRPC.EncryptedChat paramEncryptedChat)
  {
    ...
    localBuilder.setTitle(LocaleController.getString("MessageLifetime", 2131165875));
      ...
      paramContext.setFormatter(new NumberPicker.Formatter()
      {
        public String format(int paramAnonymousInt)
        {
          if (paramAnonymousInt == 0) {
            return LocaleController.getString("ShortMessageLifetimeForever", 2131166292);
          }
  ...
  public static void checkDisplaySize(Context paramContext, Configuration paramConfiguration)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        FileLog.e("TSMS", "display size = " + displaySize.x + " " + displaySize.y + " " + displayMetrics.xdpi + "x" + displayMetrics.ydpi);
        return;
        bool = false;
      }
      return;
    ...
    throws IOException
  {
    // Byte code:
    //   0: aload_1
    //   1: invokevirtual 505	java/io/File:exists	()Z
    //   4: ifne +8 -> 12
    //   7: aload_1
    //   8: invokevirtual 508	java/io/File:createNewFile	()Z
    //   11: pop
    //   12: aconst_null
    //   13: astore 4
    //   15: aconst_null
    ...
    //   23: aconst_null
    //   24: astore 6
    //   26: new 510	java/io/FileInputStream
    //   29: dup
    //   30: aload_0
    //   31: invokespecial 513	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   34: astore_0
    //   35: new 515	java/io/FileOutputStream
    //   38: dup
    //   39: aload_1
    //   40: invokespecial 516	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   43: astore_1
    //   44: aload_1
    //   45: invokevirtual 520	java/io/FileOutputStream:getChannel	()Ljava/nio/channels/FileChannel;
    //   48: aload_0
    //   49: invokevirtual 521	java/io/FileInputStream:getChannel	()Ljava/nio/channels/FileChannel;
    //   52: lconst_0
    //   53: aload_0
    //   54: invokevirtual 521	java/io/FileInputStream:getChannel	()Ljava/nio/channels/FileChannel;
    //   57: invokevirtual 527	java/nio/channels/FileChannel:size	()J
    //   60: invokevirtual 531	java/nio/channels/FileChannel:transferFrom	(Ljava/nio/channels/ReadableByteChannel;JJ)J
    //   63: pop2
    //   64: aload_0
    //   65: ifnull +7 -> 72
    //   68: aload_0
    //   69: invokevirtual 534	java/io/FileInputStream:close	()V
    //   72: aload_1
    //   73: ifnull +7 -> 80
    //   76: aload_1
    //   77: invokevirtual 535	java/io/FileOutputStream:close	()V
    //   80: iconst_1
    //   81: istore_2
    //   82: iload_2
    //   83: ireturn
    ...
    //   97: ldc -105
    //   99: aload 5
    //   101: invokestatic 157	ir/eitaa/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   104: iconst_0
    //   105: istore_2
    //   106: aload_0
    //   107: ifnull +7 -> 114
    //   110: aload_0
    //   111: invokevirtual 534	java/io/FileInputStream:close	()V
    //   114: aload_1
    //   115: ifnull -33 -> 82
    //   118: aload_1
    //   119: invokevirtual 535	java/io/FileOutputStream:close	()V
    //   122: iconst_0
    //   123: ireturn
    //   124: astore_0
    //   125: aload 4
    //   127: ifnull +8 -> 135
    //   130: aload 4
    //   132: invokevirtual 534	java/io/FileInputStream:close	()V
    //   135: aload_3
    //   136: ifnull +7 -> 143
    //   139: aload_3
    //   140: invokevirtual 535	java/io/FileOutputStream:close	()V
    //   143: aload_0
    //   144: athrow
    //   145: astore_1
    //   146: aload_0
  ...
  {
    // Byte code:
    //   0: new 162	android/content/Intent
    //   3: dup
    //   4: getstatic 145	ir/eitaa/messenger/ApplicationLoader:applicationContext	Landroid/content/Context;
    //   7: ldc_w 561
    //   10: invokespecial 564	android/content/Intent:<init>	(Landroid/content/Context;Ljava/lang/Class;)V
    //   13: astore 12
    //   15: lload_0
    //   16: l2i
    //   17: istore 4
    ...
    //   39: ldc_w 566
    //   42: iload 5
    //   44: invokevirtual 570	android/content/Intent:putExtra	(Ljava/lang/String;I)Landroid/content/Intent;
    //   47: pop
    //   48: invokestatic 576	ir/eitaa/messenger/MessagesController:getInstance	()Lir/eitaa/messenger/MessagesController;
    //   51: iload 5
    //   53: invokestatic 582	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   56: invokevirtual 586	ir/eitaa/messenger/MessagesController:getEncryptedChat	(Ljava/lang/Integer;)Lir/eitaa/tgnet/TLRPC$EncryptedChat;
    //   59: astore 7
    //   61: aload 7
    //   63: ifnonnull +9 -> 72
    //   66: aconst_null
    ...
    //   69: aload 7
    //   71: areturn
    //   72: invokestatic 576	ir/eitaa/messenger/MessagesController:getInstance	()Lir/eitaa/messenger/MessagesController;
    //   75: aload 7
    //   77: getfield 589	ir/eitaa/tgnet/TLRPC$EncryptedChat:user_id	I
    //   80: invokestatic 582	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   83: invokevirtual 593	ir/eitaa/messenger/MessagesController:getUser	(Ljava/lang/Integer;)Lir/eitaa/tgnet/TLRPC$User;
    //   86: astore 8
    //   88: aload 8
    //   90: ifnonnull +78 -> 168
    //   93: aload 10
    ...
    //   107: ldc_w 595
    //   110: iload 4
    //   112: invokevirtual 570	android/content/Intent:putExtra	(Ljava/lang/String;I)Landroid/content/Intent;
    //   115: pop
    //   116: invokestatic 576	ir/eitaa/messenger/MessagesController:getInstance	()Lir/eitaa/messenger/MessagesController;
    //   119: iload 4
    //   121: invokestatic 582	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   124: invokevirtual 593	ir/eitaa/messenger/MessagesController:getUser	(Ljava/lang/Integer;)Lir/eitaa/tgnet/TLRPC$User;
    //   127: astore 8
    //   129: goto -41 -> 88
    //   132: iload 4
    //   134: ifge +32 -> 166
    //   137: invokestatic 576	ir/eitaa/messenger/MessagesController:getInstance	()Lir/eitaa/messenger/MessagesController;
    //   140: iload 4
    //   142: ineg
    //   143: invokestatic 582	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   146: invokevirtual 599	ir/eitaa/messenger/MessagesController:getChat	(Ljava/lang/Integer;)Lir/eitaa/tgnet/TLRPC$Chat;
    //   149: astore 10
    //   151: aload 12
    //   153: ldc_w 601
    //   156: iload 4
    //   158: ineg
    //   159: invokevirtual 570	android/content/Intent:putExtra	(Ljava/lang/String;I)Landroid/content/Intent;
    //   162: pop
    //   163: goto -75 -> 88
    //   166: aconst_null
    //   167: areturn
    ...
    //   173: ifnull +517 -> 690
    //   176: aload 8
    //   178: getfield 607	ir/eitaa/tgnet/TLRPC$User:first_name	Ljava/lang/String;
    //   181: aload 8
    //   183: getfield 610	ir/eitaa/tgnet/TLRPC$User:last_name	Ljava/lang/String;
    //   186: invokestatic 616	ir/eitaa/messenger/ContactsController:formatName	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   189: astore 11
    //   191: aload 11
    //   193: astore 7
    //   195: aload 8
    //   197: getfield 620	ir/eitaa/tgnet/TLRPC$User:photo	Lir/eitaa/tgnet/TLRPC$UserProfilePhoto;
    //   200: ifnull +17 -> 217
    //   203: aload 8
    //   205: getfield 620	ir/eitaa/tgnet/TLRPC$User:photo	Lir/eitaa/tgnet/TLRPC$UserProfilePhoto;
    //   208: getfield 626	ir/eitaa/tgnet/TLRPC$UserProfilePhoto:photo_small	Lir/eitaa/tgnet/TLRPC$FileLocation;
    //   211: astore 9
    //   213: aload 11
    //   215: astore 7
    //   217: aload 12
    //   219: new 110	java/lang/StringBuilder
    //   222: dup
    //   223: invokespecial 111	java/lang/StringBuilder:<init>	()V
    //   226: ldc_w 628
    //   229: invokevirtual 117	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   232: lload_0
    //   233: invokevirtual 631	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   236: invokevirtual 126	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   239: invokevirtual 635	android/content/Intent:setAction	(Ljava/lang/String;)Landroid/content/Intent;
    //   242: pop
    //   243: aload 12
    //   245: ldc_w 636
    //   248: invokevirtual 640	android/content/Intent:addFlags	(I)Landroid/content/Intent;
    //   251: pop
    //   252: new 162	android/content/Intent
    //   255: dup
    //   256: invokespecial 641	android/content/Intent:<init>	()V
    //   259: astore 11
    //   261: aload 11
    //   263: ldc_w 643
    //   266: aload 12
    //   268: invokevirtual 646	android/content/Intent:putExtra	(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;
    //   271: pop
    //   272: aload 11
    //   274: ldc_w 648
    //   277: aload 7
    //   279: invokevirtual 651	android/content/Intent:putExtra	(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    //   282: pop
    //   283: aload 11
    //   285: ldc_w 653
    //   288: iconst_0
    //   289: invokevirtual 656	android/content/Intent:putExtra	(Ljava/lang/String;Z)Landroid/content/Intent;
    //   292: pop
    //   293: aload 11
    //   295: astore 7
    //   297: iload_2
    ...
    //   316: aload 9
    //   318: iconst_1
    //   319: invokestatic 662	ir/eitaa/messenger/FileLoader:getPathToAttach	(Lir/eitaa/tgnet/TLObject;Z)Ljava/io/File;
    //   322: invokevirtual 663	java/io/File:toString	()Ljava/lang/String;
    //   325: invokestatic 669	android/graphics/BitmapFactory:decodeFile	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   328: astore 9
    //   330: aload 9
    //   332: astore 7
    //   334: aload 9
    ...
    //   341: astore 7
    //   343: ldc_w 670
    //   346: invokestatic 674	ir/eitaa/messenger/AndroidUtilities:dp	(F)I
    //   349: istore 6
    //   351: aload 9
    //   353: astore 7
    //   355: iload 6
    //   357: iload 6
    //   359: getstatic 680	android/graphics/Bitmap$Config:ARGB_8888	Landroid/graphics/Bitmap$Config;
    //   362: invokestatic 684	android/graphics/Bitmap:createBitmap	(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    //   365: astore 12
    //   367: aload 9
    //   369: astore 7
    //   371: aload 12
    //   373: iconst_0
    //   374: invokevirtual 687	android/graphics/Bitmap:eraseColor	(I)V
    //   377: aload 9
    //   379: astore 7
    //   381: new 689	android/graphics/Canvas
    //   384: dup
    //   385: aload 12
    //   387: invokespecial 692	android/graphics/Canvas:<init>	(Landroid/graphics/Bitmap;)V
    //   390: astore 13
    //   392: aload 9
    //   394: astore 7
    //   396: new 694	android/graphics/BitmapShader
    //   399: dup
    //   400: aload 9
    //   402: getstatic 700	android/graphics/Shader$TileMode:CLAMP	Landroid/graphics/Shader$TileMode;
    //   405: getstatic 700	android/graphics/Shader$TileMode:CLAMP	Landroid/graphics/Shader$TileMode;
    //   408: invokespecial 703	android/graphics/BitmapShader:<init>	(Landroid/graphics/Bitmap;Landroid/graphics/Shader$TileMode;Landroid/graphics/Shader$TileMode;)V
    //   411: astore 14
    //   413: aload 9
    //   415: astore 7
    //   417: getstatic 705	ir/eitaa/messenger/AndroidUtilities:roundPaint	Landroid/graphics/Paint;
    //   420: ifnonnull +32 -> 452
    //   423: aload 9
    //   425: astore 7
    //   427: new 707	android/graphics/Paint
    //   430: dup
    //   431: iconst_1
    //   432: invokespecial 709	android/graphics/Paint:<init>	(I)V
    //   435: putstatic 705	ir/eitaa/messenger/AndroidUtilities:roundPaint	Landroid/graphics/Paint;
    //   438: aload 9
    //   440: astore 7
    //   442: new 711	android/graphics/RectF
    //   445: dup
    //   446: invokespecial 712	android/graphics/RectF:<init>	()V
    //   449: putstatic 714	ir/eitaa/messenger/AndroidUtilities:bitmapRect	Landroid/graphics/RectF;
    //   452: aload 9
    //   454: astore 7
    //   456: iload 6
    //   458: i2f
    //   459: aload 9
    //   461: invokevirtual 717	android/graphics/Bitmap:getWidth	()I
    //   464: i2f
    //   465: fdiv
    //   466: fstore_3
    //   467: aload 9
    //   469: astore 7
    //   471: aload 13
    //   473: invokevirtual 720	android/graphics/Canvas:save	()I
    //   476: pop
    //   477: aload 9
    //   479: astore 7
    //   481: aload 13
    //   483: fload_3
    //   484: fload_3
    //   485: invokevirtual 724	android/graphics/Canvas:scale	(FF)V
    //   488: aload 9
    //   490: astore 7
    //   492: getstatic 705	ir/eitaa/messenger/AndroidUtilities:roundPaint	Landroid/graphics/Paint;
    //   495: aload 14
    //   497: invokevirtual 728	android/graphics/Paint:setShader	(Landroid/graphics/Shader;)Landroid/graphics/Shader;
    //   500: pop
    //   501: aload 9
    //   503: astore 7
    //   505: getstatic 714	ir/eitaa/messenger/AndroidUtilities:bitmapRect	Landroid/graphics/RectF;
    //   508: fconst_0
    //   509: fconst_0
    //   510: aload 9
    //   512: invokevirtual 717	android/graphics/Bitmap:getWidth	()I
    //   515: i2f
    //   516: aload 9
    //   518: invokevirtual 731	android/graphics/Bitmap:getHeight	()I
    //   521: i2f
    //   522: invokevirtual 735	android/graphics/RectF:set	(FFFF)V
    //   525: aload 9
    //   527: astore 7
    //   529: aload 13
    //   531: getstatic 714	ir/eitaa/messenger/AndroidUtilities:bitmapRect	Landroid/graphics/RectF;
    //   534: aload 9
    //   536: invokevirtual 717	android/graphics/Bitmap:getWidth	()I
    //   539: i2f
    //   540: aload 9
    //   542: invokevirtual 731	android/graphics/Bitmap:getHeight	()I
    //   545: i2f
    //   546: getstatic 705	ir/eitaa/messenger/AndroidUtilities:roundPaint	Landroid/graphics/Paint;
    //   549: invokevirtual 739	android/graphics/Canvas:drawRoundRect	(Landroid/graphics/RectF;FFLandroid/graphics/Paint;)V
    //   552: aload 9
    //   554: astore 7
    //   556: aload 13
    //   558: invokevirtual 742	android/graphics/Canvas:restore	()V
    //   561: aload 9
    //   563: astore 7
    //   565: getstatic 145	ir/eitaa/messenger/ApplicationLoader:applicationContext	Landroid/content/Context;
    //   568: invokevirtual 356	android/content/Context:getResources	()Landroid/content/res/Resources;
    //   571: ldc_w 743
    //   574: invokevirtual 747	android/content/res/Resources:getDrawable	(I)Landroid/graphics/drawable/Drawable;
    //   577: astore 14
    //   579: aload 9
    //   581: astore 7
    //   583: ldc_w 748
    //   586: invokestatic 674	ir/eitaa/messenger/AndroidUtilities:dp	(F)I
    //   589: istore 4
    //   591: aload 9
    //   593: astore 7
    //   595: iload 6
    ...
    //   599: isub
    //   600: fconst_2
    //   601: invokestatic 674	ir/eitaa/messenger/AndroidUtilities:dp	(F)I
    //   604: isub
    //   605: istore 5
    //   607: aload 9
    //   609: astore 7
    ...
    //   615: isub
    //   616: fconst_2
    //   617: invokestatic 674	ir/eitaa/messenger/AndroidUtilities:dp	(F)I
    //   620: isub
    //   621: istore 6
    //   623: aload 9
    //   625: astore 7
    ...
    //   640: iload 4
    //   642: iadd
    //   643: invokevirtual 752	android/graphics/drawable/Drawable:setBounds	(IIII)V
    //   646: aload 9
    //   648: astore 7
    //   650: aload 14
    //   652: aload 13
    //   654: invokevirtual 756	android/graphics/drawable/Drawable:draw	(Landroid/graphics/Canvas;)V
    //   657: aload 9
    //   659: astore 7
    //   661: aload 13
    //   663: aconst_null
    //   664: invokevirtual 759	android/graphics/Canvas:setBitmap	(Landroid/graphics/Bitmap;)V
    //   667: aload 12
    //   669: astore 7
    //   671: aload 7
    //   673: ifnull +65 -> 738
    ...
    //   678: ldc_w 761
    //   681: aload 7
    //   683: invokevirtual 646	android/content/Intent:putExtra	(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;
    //   686: pop
    //   687: aload 11
    //   689: areturn
    //   690: aload 10
    //   692: getfield 766	ir/eitaa/tgnet/TLRPC$Chat:title	Ljava/lang/String;
    //   695: astore 11
    //   697: aload 11
    //   699: astore 7
    //   701: aload 10
    //   703: getfield 769	ir/eitaa/tgnet/TLRPC$Chat:photo	Lir/eitaa/tgnet/TLRPC$ChatPhoto;
    //   706: ifnull -489 -> 217
    //   709: aload 10
    //   711: getfield 769	ir/eitaa/tgnet/TLRPC$Chat:photo	Lir/eitaa/tgnet/TLRPC$ChatPhoto;
    //   714: getfield 772	ir/eitaa/tgnet/TLRPC$ChatPhoto:photo_small	Lir/eitaa/tgnet/TLRPC$FileLocation;
    //   717: astore 9
    //   719: aload 11
    //   721: astore 7
    //   723: goto -506 -> 217
    ...
    //   728: ldc -105
    //   730: aload 9
    //   732: invokestatic 157	ir/eitaa/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   735: goto -64 -> 671
    //   738: aload 8
    //   740: ifnull +53 -> 793
    //   743: aload 8
    //   745: getfield 775	ir/eitaa/tgnet/TLRPC$User:bot	Z
    //   748: ifeq +24 -> 772
    //   751: aload 11
    //   753: ldc_w 777
    //   756: getstatic 145	ir/eitaa/messenger/ApplicationLoader:applicationContext	Landroid/content/Context;
    //   759: ldc_w 778
    //   762: invokestatic 784	android/content/Intent$ShortcutIconResource:fromContext	(Landroid/content/Context;I)Landroid/content/Intent$ShortcutIconResource;
    //   765: invokevirtual 646	android/content/Intent:putExtra	(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;
    //   768: pop
    //   769: aload 11
    //   771: areturn
    //   772: aload 11
    //   774: ldc_w 777
    //   777: getstatic 145	ir/eitaa/messenger/ApplicationLoader:applicationContext	Landroid/content/Context;
    //   780: ldc_w 785
    //   783: invokestatic 784	android/content/Intent$ShortcutIconResource:fromContext	(Landroid/content/Context;I)Landroid/content/Intent$ShortcutIconResource;
    //   786: invokevirtual 646	android/content/Intent:putExtra	(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;
    //   789: pop
    //   790: aload 11
    //   792: areturn
    //   793: aload 11
    ...
    //   799: ifnull -730 -> 69
    //   802: aload 10
    //   804: invokestatic 791	ir/eitaa/messenger/ChatObject:isChannel	(Lir/eitaa/tgnet/TLRPC$Chat;)Z
    //   807: ifeq +32 -> 839
    //   810: aload 10
    //   812: getfield 794	ir/eitaa/tgnet/TLRPC$Chat:megagroup	Z
    //   815: ifne +24 -> 839
    //   818: aload 11
    //   820: ldc_w 777
    //   823: getstatic 145	ir/eitaa/messenger/ApplicationLoader:applicationContext	Landroid/content/Context;
    //   826: ldc_w 795
    //   829: invokestatic 784	android/content/Intent$ShortcutIconResource:fromContext	(Landroid/content/Context;I)Landroid/content/Intent$ShortcutIconResource;
    //   832: invokevirtual 646	android/content/Intent:putExtra	(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;
    //   835: pop
    //   836: aload 11
    //   838: areturn
    //   839: aload 11
    //   841: ldc_w 777
    //   844: getstatic 145	ir/eitaa/messenger/ApplicationLoader:applicationContext	Landroid/content/Context;
    //   847: ldc_w 796
    //   850: invokestatic 784	android/content/Intent$ShortcutIconResource:fromContext	(Landroid/content/Context;I)Landroid/content/Intent$ShortcutIconResource;
    //   853: invokevirtual 646	android/content/Intent:putExtra	(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;
    //   856: pop
    //   857: aload 11
    //   859: areturn
    //   860: astore 7
    ...
    //   27	717	8	localUser	ir.eitaa.tgnet.TLRPC.User
    //   169	549	9	localObject2	Object
    //   726	5	9	localThrowable	Throwable
    //   30	781	10	localChat	ir.eitaa.tgnet.TLRPC.Chat
  ...
  public static byte[] decodeQuotedPrintable(byte[] paramArrayOfByte)
  {
    ...
    if (i < paramArrayOfByte.length)
    {
      ...
      for (;;)
      {
        ...
        {
          FileLog.e("TSMS", paramArrayOfByte);
          return null;
        }
  ...
  private static File getAlbumDir()
  {
    ...
    do
    {
      do
      {
        ...
        localFile = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES), "Eitaa");
        localObject = localFile;
      } while (localFile.mkdirs());
      localObject = localFile;
    } while (localFile.exists());
    FileLog.d("TSMS", "failed to create directory");
    return null;
    FileLog.d("TSMS", "External storage is not mounted READ/WRITE.");
    return null;
  }
    ...
    throws Exception
  {
    ...
    if ((localObject3 != null) && (((File)localObject3).exists()))
    {
      ...
      localObject2 = FileProvider.getUriForFile(paramActivity, "ir.eitaa.messenger.provider", (File)localObject3);
      if (localObject1 == null) {
        break label245;
      }
    }
    ...
    localIntent.setDataAndType(FileProvider.getUriForFile(paramActivity, "ir.eitaa.messenger.provider", (File)localObject3), "text/plain");
    for (;;)
    {
      paramActivity.startActivityForResult(localIntent, 500);
      return;
  ...
  public static void sendJson(String paramString1, String paramString2)
  {
    if (TextUtils.isEmpty(paramString1)) {
      return;
    }
    JSONObject localJSONObject = new JSONObject();
    HelperHttp localHelperHttp = new HelperHttp();
    localHelperHttp.URI(ConnectionsManager.getInstance().getHostName() + "/eitaa/log.php");
    try
    {
      localJSONObject.put("Request", paramString1);
      if (paramString2 != null) {
        localJSONObject.put("Response", paramString2);
      }
      localHelperHttp.send(localJSONObject);
      return;
    }
    catch (JSONException paramString1)
    {
      paramString1.printStackTrace();
      Log.i("TSMS", "JSONException: " + paramString1.getMessage());
    }
  }
  ...
  public static void setListViewEdgeEffectColor(AbsListView paramAbsListView, int paramInt)
  {
    ...
    {
      FileLog.e("TSMS", paramAbsListView);
    }
  }
  ...
  public static void setProgressBarAnimationDuration(ProgressBar paramProgressBar, int paramInt)
  {
    ...
    {
      FileLog.e("TSMS", paramProgressBar);
    }
  }
  ...
  public static String toJakson(Object paramObject)
  {
    Object localObject = new ObjectMapper().writer();
    try
    {
      localObject = ((ObjectWriter)localObject).writeValueAsString(paramObject);
      return (String)localObject;
    }
    catch (JsonProcessingException localJsonProcessingException)
    {
      localJsonProcessingException.printStackTrace();
      return "JsonProcessingException: " + paramObject + " e: " + localJsonProcessingException.getMessage();
    }
  }
  
  public static String toJson(TLObject paramTLObject)
  {
    SerializedJson localSerializedJson = new SerializedJson();
    paramTLObject.serializeToJson(localSerializedJson);
    return localSerializedJson.toJSONObject().toString();
  }
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/messenger/AndroidUtilities.class
