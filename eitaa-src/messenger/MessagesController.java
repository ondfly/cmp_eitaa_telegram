...
import ir.eitaa.tgnet.TLRPC.EncryptedMessage;
...
import ir.eitaa.tgnet.TLRPC.NotifyPeer;
...
import ir.eitaa.tgnet.TLRPC.TL_auth_logOut;
...
import ir.eitaa.tgnet.TLRPC.TL_channels_editAbout;
...
import ir.eitaa.tgnet.TLRPC.TL_channels_getFullChannel;
...
import ir.eitaa.tgnet.TLRPC.TL_channels_kickFromChannel;
import ir.eitaa.tgnet.TLRPC.TL_channels_leaveChannel;
import ir.eitaa.tgnet.TLRPC.TL_channels_readHistory;
import ir.eitaa.tgnet.TLRPC.TL_channels_toggleInvites;
import ir.eitaa.tgnet.TLRPC.TL_channels_toggleSignatures;
import ir.eitaa.tgnet.TLRPC.TL_channels_updatePinnedMessage;
...
import ir.eitaa.tgnet.TLRPC.TL_chatInviteEmpty;
...
import ir.eitaa.tgnet.TLRPC.TL_contactBlocked;
import ir.eitaa.tgnet.TLRPC.TL_contactLinkContact;
...
import ir.eitaa.tgnet.TLRPC.TL_disabledFeature;
import ir.eitaa.tgnet.TLRPC.TL_draftMessage;
import ir.eitaa.tgnet.TLRPC.TL_encryptedChat;
import ir.eitaa.tgnet.TLRPC.TL_error;
import ir.eitaa.tgnet.TLRPC.TL_help_appChangelog;
...
import ir.eitaa.tgnet.TLRPC.TL_inputChatPhotoEmpty;
...
import ir.eitaa.tgnet.TLRPC.TL_messages_deleteHistory;
...
import ir.eitaa.tgnet.TLRPC.TL_messages_getFullChat;
...
import ir.eitaa.tgnet.TLRPC.TL_messages_hideReportSpam;
...
import ir.eitaa.tgnet.TLRPC.TL_messages_receivedQueue;
...
import ir.eitaa.tgnet.TLRPC.TL_messages_toggleChatAdmins;
import ir.eitaa.tgnet.TLRPC.TL_notifyPeer;
...
import ir.eitaa.tgnet.TLRPC.TL_peerNotifySettingsEmpty;
...
import ir.eitaa.tgnet.TLRPC.TL_privacyKeyChatInvite;
import ir.eitaa.tgnet.TLRPC.TL_privacyKeyStatusTimestamp;
import ir.eitaa.tgnet.TLRPC.TL_replyKeyboardHide;
...
import ir.eitaa.tgnet.TLRPC.TL_updateChannelPinnedMessage;
import ir.eitaa.tgnet.TLRPC.TL_updateChannelTooLong;
import ir.eitaa.tgnet.TLRPC.TL_updateChatAdmins;
import ir.eitaa.tgnet.TLRPC.TL_updateChatParticipantAdd;
import ir.eitaa.tgnet.TLRPC.TL_updateChatParticipantAdmin;
import ir.eitaa.tgnet.TLRPC.TL_updateChatParticipantDelete;
import ir.eitaa.tgnet.TLRPC.TL_updateChatParticipants;
import ir.eitaa.tgnet.TLRPC.TL_updateChatUserTyping;
import ir.eitaa.tgnet.TLRPC.TL_updateContactLink;
import ir.eitaa.tgnet.TLRPC.TL_updateContactRegistered;
import ir.eitaa.tgnet.TLRPC.TL_updateDcOptions;
import ir.eitaa.tgnet.TLRPC.TL_updateDeleteChannelMessages;
import ir.eitaa.tgnet.TLRPC.TL_updateDeleteMessages;
import ir.eitaa.tgnet.TLRPC.TL_updateDraftMessage;
import ir.eitaa.tgnet.TLRPC.TL_updateEditChannelMessage;
import ir.eitaa.tgnet.TLRPC.TL_updateEditMessage;
import ir.eitaa.tgnet.TLRPC.TL_updateEncryptedChatTyping;
import ir.eitaa.tgnet.TLRPC.TL_updateEncryptedMessagesRead;
import ir.eitaa.tgnet.TLRPC.TL_updateEncryption;
import ir.eitaa.tgnet.TLRPC.TL_updateMessageID;
import ir.eitaa.tgnet.TLRPC.TL_updateNewAuthorization;
import ir.eitaa.tgnet.TLRPC.TL_updateNewChannelMessage;
import ir.eitaa.tgnet.TLRPC.TL_updateNewEncryptedMessage;
import ir.eitaa.tgnet.TLRPC.TL_updateNewGeoChatMessage;
import ir.eitaa.tgnet.TLRPC.TL_updateNewMessage;
import ir.eitaa.tgnet.TLRPC.TL_updateNewStickerSet;
import ir.eitaa.tgnet.TLRPC.TL_updateNotifySettings;
import ir.eitaa.tgnet.TLRPC.TL_updatePrivacy;
import ir.eitaa.tgnet.TLRPC.TL_updateReadChannelInbox;
import ir.eitaa.tgnet.TLRPC.TL_updateReadChannelOutbox;
import ir.eitaa.tgnet.TLRPC.TL_updateReadFeaturedStickers;
...
import ir.eitaa.tgnet.TLRPC.TL_updateRecentStickers;
import ir.eitaa.tgnet.TLRPC.TL_updateSavedGifs;
import ir.eitaa.tgnet.TLRPC.TL_updateServiceNotification;
import ir.eitaa.tgnet.TLRPC.TL_updateShort;
import ir.eitaa.tgnet.TLRPC.TL_updateShortChatMessage;
import ir.eitaa.tgnet.TLRPC.TL_updateShortMessage;
import ir.eitaa.tgnet.TLRPC.TL_updateStickerSets;
import ir.eitaa.tgnet.TLRPC.TL_updateStickerSetsOrder;
import ir.eitaa.tgnet.TLRPC.TL_updateUserBlocked;
import ir.eitaa.tgnet.TLRPC.TL_updateUserName;
import ir.eitaa.tgnet.TLRPC.TL_updateUserPhone;
import ir.eitaa.tgnet.TLRPC.TL_updateUserPhoto;
import ir.eitaa.tgnet.TLRPC.TL_updateUserStatus;
...
import ir.eitaa.tgnet.TLRPC.TL_updatesTooLong;
import ir.eitaa.tgnet.TLRPC.TL_updates_channelDifference;
import ir.eitaa.tgnet.TLRPC.TL_updates_channelDifferenceEmpty;
import ir.eitaa.tgnet.TLRPC.TL_updates_channelDifferenceTooLong;
import ir.eitaa.tgnet.TLRPC.TL_updates_difference;
import ir.eitaa.tgnet.TLRPC.TL_updates_differenceEmpty;
import ir.eitaa.tgnet.TLRPC.TL_updates_differenceSlice;
import ir.eitaa.tgnet.TLRPC.TL_updates_getChannelDifference;
import ir.eitaa.tgnet.TLRPC.TL_updates_getDifference;
import ir.eitaa.tgnet.TLRPC.TL_updates_getState;
import ir.eitaa.tgnet.TLRPC.TL_updates_state;
import ir.eitaa.tgnet.TLRPC.TL_userForeign_old2;
import ir.eitaa.tgnet.TLRPC.TL_userFull;
  ...
  implements NotificationCenter.NotificationCenterDelegate
{
  ...
  public int downloadChunkSize_KB = 32;
  ...
  public int schedule_period_background_delay_ms = 60000;
  public int schedule_period_background_ms = 60000;
  public int schedule_period_forground_ms = 5000;
  ...
  public int uploadChunkSize_KB = 128;
  ...
  public MessagesController()
  {
    ...
    this.schedule_period_forground_ms = ((SharedPreferences)localObject).getInt("schedule_period_forground_ms", 5000);
    this.schedule_period_background_ms = ((SharedPreferences)localObject).getInt("schedule_period_background_ms", 60000);
    this.schedule_period_background_delay_ms = ((SharedPreferences)localObject).getInt("schedule_period_background_delay_ms", 60000);
    this.uploadChunkSize_KB = ((SharedPreferences)localObject).getInt("uploadChunkSize_KB", 128);
    this.downloadChunkSize_KB = ((SharedPreferences)localObject).getInt("downloadChunkSize_KB", 32);
  ...
  public static boolean isFeatureEnabled(String paramString, BaseFragment paramBaseFragment)
  {
    ...
    if (paramBaseFragment.getParentActivity() != null)
    {
      ...
      paramString.setPositiveButton(LocaleController.getString("OK", 2131166047), null);
                ...
                for (;;)
                {
                  ...
                  catch (Exception localException)
                  {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable()
                    {
                      public void run()
                      {
                        MessagesController.access$4102(MessagesController.this, false);
                      }
                    });
                    return;
                  }
  ...
  public static void openByUserName(String paramString, final BaseFragment paramBaseFragment, final int paramInt)
  {
    ...
    ((ProgressDialog)localObject).setMessage(LocaleController.getString("Loading", 2131165837));
        ...
        AndroidUtilities.runOnUIThread(new Runnable()
        {
          public void run()
          {
            do
            {
              try
              {
                MessagesController.107.this.val$progressDialog.dismiss();
                MessagesController.107.this.val$fragment.setVisibleDialog(null);
                if (paramAnonymousTL_error == null)
                {
                  ...
                  {
                    MessagesController.openChatOrProfileWith(null, (TLRPC.Chat)localTL_contacts_resolvedPeer.chats.get(0), MessagesController.107.this.val$fragment, 1, false);
                    return;
                  }
                }
              }
              catch (Exception localException1)
              {
                ...
                MessagesController.openChatOrProfileWith((TLRPC.User)localException1.users.get(0), null, MessagesController.107.this.val$fragment, MessagesController.107.this.val$type, false);
                return;
              }
            } while ((MessagesController.107.this.val$fragment == null) || (MessagesController.107.this.val$fragment.getParentActivity() == null));
            try
            {
              Toast.makeText(MessagesController.107.this.val$fragment.getParentActivity(), LocaleController.getString("NoUsernameFound", 2131165961), 0).show();
              return;
            }
    ...
    ((ProgressDialog)localObject).setButton(-2, LocaleController.getString("Cancel", 2131165386), new DialogInterface.OnClickListener()
    {
      public void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt)
      {
        ...
        catch (Exception paramAnonymousDialogInterface)
        {
          for (;;)
          {
            FileLog.e("TSMS", paramAnonymousDialogInterface);
          }
        }
      }
    });
  ...
  private void processChannelsUpdatesQueue(int paramInt1, int paramInt2)
  {
    ...
    if (((ArrayList)localObject).size() > 0)
    {
      ...
      for (paramInt2 = j - 1;; paramInt2 = j - 1)
      {
        ...
        if (paramInt2 == 1)
        {
          ...
          {
            FileLog.e("TSMS", "HOLE IN CHANNEL " + paramInt1 + " UPDATES QUEUE - will wait more time");
            if (i == 0) {
              break;
            }
          ...
          FileLog.e("TSMS", "HOLE IN CHANNEL " + paramInt1 + " UPDATES QUEUE - getChannelDifference ");
    ...
    this.updatesQueueChannels.remove(Integer.valueOf(paramInt1));
    this.updatesStartWaitTimeChannels.remove(Integer.valueOf(paramInt1));
    FileLog.e("TSMS", "UPDATES CHANNEL " + paramInt1 + " QUEUE PROCEED - OK");
  }
  ...
  private void processUpdatesQueue(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      if (j == 1)
      {
        ...
        {
          FileLog.e("TSMS", "HOLE IN UPDATES QUEUE - will wait more time");
          if (paramInt2 != 0) {
            setUpdatesStartTime(paramInt1, System.currentTimeMillis());
          }
          return;
        }
        FileLog.e("TSMS", "HOLE IN UPDATES QUEUE - getDifference");
    ...
    label319:
    localArrayList.clear();
    FileLog.e("TSMS", "UPDATES QUEUE PROCEED - OK");
    label333:
    setUpdatesStartTime(paramInt1, 0L);
  }
  ...
  private void updatePrintingStrings()
  {
    ...
    while (localIterator1.hasNext())
    {
      ...
      if ((i > 0) || (i == 0) || (localArrayList.size() == 1))
      {
        ...
        {
          if (i < 0) {
            localHashMap1.put(Long.valueOf(l), LocaleController.formatString("IsRecordingAudio", 2131165771, new Object[] { getUserNameForTyping((TLRPC.User)localObject2) }));
          }
          for (;;)
          {
            localHashMap2.put(Long.valueOf(l), Integer.valueOf(1));
            break;
            localHashMap1.put(Long.valueOf(l), LocaleController.getString("RecordingAudio", 2131166152));
          }
        }
        if ((((PrintingUser)localObject1).action instanceof TLRPC.TL_sendMessageUploadAudioAction))
        {
          if (i < 0) {
            localHashMap1.put(Long.valueOf(l), LocaleController.formatString("IsSendingAudio", 2131165772, new Object[] { getUserNameForTyping((TLRPC.User)localObject2) }));
          }
          for (;;)
          {
            localHashMap2.put(Long.valueOf(l), Integer.valueOf(2));
            break;
            localHashMap1.put(Long.valueOf(l), LocaleController.getString("SendingAudio", 2131166249));
          }
        }
        ...
        {
          if (i < 0) {
            localHashMap1.put(Long.valueOf(l), LocaleController.formatString("IsSendingVideo", 2131165775, new Object[] { getUserNameForTyping((TLRPC.User)localObject2) }));
          }
          for (;;)
          {
            localHashMap2.put(Long.valueOf(l), Integer.valueOf(2));
            break;
            localHashMap1.put(Long.valueOf(l), LocaleController.getString("SendingVideoStatus", 2131166254));
          }
        }
        if ((((PrintingUser)localObject1).action instanceof TLRPC.TL_sendMessageUploadDocumentAction))
        {
          if (i < 0) {
            localHashMap1.put(Long.valueOf(l), LocaleController.formatString("IsSendingFile", 2131165773, new Object[] { getUserNameForTyping((TLRPC.User)localObject2) }));
          }
          for (;;)
          {
            localHashMap2.put(Long.valueOf(l), Integer.valueOf(2));
            break;
            localHashMap1.put(Long.valueOf(l), LocaleController.getString("SendingFile", 2131166250));
          }
        }
        if ((((PrintingUser)localObject1).action instanceof TLRPC.TL_sendMessageUploadPhotoAction))
        {
          if (i < 0) {
            localHashMap1.put(Long.valueOf(l), LocaleController.formatString("IsSendingPhoto", 2131165774, new Object[] { getUserNameForTyping((TLRPC.User)localObject2) }));
          }
          for (;;)
          {
            localHashMap2.put(Long.valueOf(l), Integer.valueOf(2));
            break;
            localHashMap1.put(Long.valueOf(l), LocaleController.getString("SendingPhoto", 2131166252));
          }
        }
        if (!(((PrintingUser)localObject1).action instanceof TLRPC.TL_sendMessageGamePlayAction))
        {
          if (i < 0) {
            localHashMap1.put(Long.valueOf(l), String.format("%s %s", new Object[] { getUserNameForTyping((TLRPC.User)localObject2), LocaleController.getString("IsTyping", 2131165776) }));
          }
          for (;;)
          {
            localHashMap2.put(Long.valueOf(l), Integer.valueOf(0));
            break;
            localHashMap1.put(Long.valueOf(l), LocaleController.getString("Typing", 2131166351));
          }
        }
      }
      else
      {
        ...
        {
          if (j == 1) {
            localHashMap1.put(Long.valueOf(l), String.format("%s %s", new Object[] { localObject2, LocaleController.getString("IsTyping", 2131165776) }));
          }
          for (;;)
          {
            localHashMap2.put(Long.valueOf(l), Integer.valueOf(0));
  ...
  public void addSupportUser()
  {
    ...
    localTL_userForeign_old2.first_name = "Eitaa";
          ...
          public void run(TLObject paramAnonymousTLObject, final TLRPC.TL_error paramAnonymousTL_error)
          {
            if ((bool2) && ((localInputUser instanceof TLRPC.TL_inputUserSelf))) {
              AndroidUtilities.runOnUIThread(new Runnable()
              {
                public void run()
                {
                  MessagesController.this.joiningToChannels.remove(Integer.valueOf(MessagesController.75.this.val$chat_id));
                }
              });
            }
            if (paramAnonymousTL_error != null)
            {
              AndroidUtilities.runOnUIThread(new Runnable()
              {
                ...
                {
                  boolean bool = true;
                  if (MessagesController.75.this.val$fragment != null)
                  {
                    str = paramAnonymousTL_error.text;
                    localBaseFragment = MessagesController.75.this.val$fragment;
                    if ((MessagesController.75.this.val$isChannel) && (!MessagesController.75.this.val$isMegagroup)) {
              ...
              else
              {
                ...
                if (bool2)
                {
                  ...
                  AndroidUtilities.runOnUIThread(new Runnable()
                  {
                    public void run()
                    {
                      MessagesController.this.loadFullChat(MessagesController.75.this.val$chat_id, 0, true);
                    }
                  }, 1000L);
                }
                if ((!bool2) || (!(localInputUser instanceof TLRPC.TL_inputUserSelf))) {
      ...
      public void run(TLObject paramAnonymousTLObject, final TLRPC.TL_error paramAnonymousTL_error)
      {
        if (paramAnonymousTL_error != null)
        {
          AndroidUtilities.runOnUIThread(new Runnable()
          {
            public void run()
            {
              if (MessagesController.67.this.val$fragment != null) {
                AlertsCreator.showAddUserAlert(paramAnonymousTL_error.text, MessagesController.67.this.val$fragment, true);
              }
              while (!paramAnonymousTL_error.text.equals("PEER_FLOOD")) {
                return;
              }
      ...
      public void run()
      {
        ...
        ConnectionsManager.getInstance().sendRequest(localTL_channels_getParticipant, new RequestDelegate()
        {
          public void run(final TLObject paramAnonymous2TLObject, TLRPC.TL_error paramAnonymous2TL_error)
          {
            ...
            paramAnonymous2TL_error.to_id.channel_id = MessagesController.94.this.val$chat_id;
            paramAnonymous2TL_error.dialog_id = (-MessagesController.94.this.val$chat_id);
            ...
            MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable()
            {
              public void run()
              {
                AndroidUtilities.runOnUIThread(new Runnable()
                {
                  public void run()
                  {
                    NotificationsController.getInstance().processNewMessages(MessagesController.94.1.2.this.val$pushMessages, true);
                  }
                });
              }
            });
            ...
            AndroidUtilities.runOnUIThread(new Runnable()
            {
              public void run()
              {
                MessagesController.this.updateInterfaceWithMessages(-MessagesController.94.this.val$chat_id, localArrayList1);
                NotificationCenter.getInstance().postNotificationName(NotificationCenter.dialogsNeedReload, new Object[0]);
              }
            });
          }
          ...
          public void run(TLObject paramAnonymousTLObject, TLRPC.TL_error paramAnonymousTL_error)
          {
            ...
            for (;;)
            {
              ...
              AndroidUtilities.runOnUIThread(new Runnable()
              {
                public void run()
                {
                  MessagesController.this.checkingLastMessagesDialogs.remove(Integer.valueOf(MessagesController.55.this.val$lower_id));
                }
              });
              return;
              label272:
              AndroidUtilities.runOnUIThread(new Runnable()
              {
                public void run()
                {
                  TLRPC.TL_dialog localTL_dialog = (TLRPC.TL_dialog)MessagesController.this.dialogs_dict.get(Long.valueOf(MessagesController.55.this.val$dialog.id));
                  if ((localTL_dialog != null) && (localTL_dialog.top_message == 0)) {
                    MessagesController.this.deleteDialog(MessagesController.55.this.val$dialog.id, 3);
                  }
                }
              });
            }
  ...
  public void convertToMegaGroup(final Context paramContext, final int paramInt)
  {
    ...
    localProgressDialog.setMessage(LocaleController.getString("Loading", 2131165837));
      ...
      public void run(TLObject paramAnonymousTLObject, TLRPC.TL_error paramAnonymousTL_error)
      {
        if (paramAnonymousTL_error == null)
        {
          AndroidUtilities.runOnUIThread(new Runnable()
          {
            public void run()
            {
              if (!((Activity)MessagesController.65.this.val$context).isFinishing()) {}
              try
              {
                MessagesController.65.this.val$progressDialog.dismiss();
                return;
              }
              catch (Exception localException)
              {
        ...
        AndroidUtilities.runOnUIThread(new Runnable()
        {
          public void run()
          {
            ...
            {
              MessagesController.65.this.val$progressDialog.dismiss();
              AlertDialog.Builder localBuilder = new AlertDialog.Builder(MessagesController.65.this.val$context);
              localBuilder.setTitle(LocaleController.getString("AppName", 2131165299));
              localBuilder.setMessage(LocaleController.getString("ErrorOccurred", 2131165629));
              localBuilder.setPositiveButton(LocaleController.getString("OK", 2131166047), null);
            ...
            AndroidUtilities.runOnUIThread(new Runnable()
            {
              public void run()
              {
                if (paramAnonymousTL_error.text.startsWith("FLOOD_WAIT")) {
                  AlertsCreator.showFloodWaitAlert(paramAnonymousTL_error.text, MessagesController.63.this.val$fragment);
                }
                for (;;)
                {
                  NotificationCenter.getInstance().postNotificationName(NotificationCenter.chatDidFailCreate, new Object[0]);
                  return;
                  AlertsCreator.showAddUserAlert(paramAnonymousTL_error.text, MessagesController.63.this.val$fragment, false);
                }
              }
            });
            return;
          ...
          public void run(final TLObject paramAnonymousTLObject, final TLRPC.TL_error paramAnonymousTL_error)
          {
            if (paramAnonymousTL_error != null)
            {
              AndroidUtilities.runOnUIThread(new Runnable()
              {
                ...
                {
                  if (paramAnonymousTL_error.text.startsWith("FLOOD_WAIT")) {
                    AlertsCreator.showFloodWaitAlert(paramAnonymousTL_error.text, MessagesController.64.this.val$fragment);
                  }
                  NotificationCenter.getInstance().postNotificationName(NotificationCenter.chatDidFailCreate, new Object[0]);
                }
              });
            ...
            public void run(TLObject paramAnonymousTLObject, TLRPC.TL_error paramAnonymousTL_error)
            {
              if (paramUser.id == UserConfig.getClientUserId()) {
                AndroidUtilities.runOnUIThread(new Runnable()
                {
                  public void run()
                  {
                    MessagesController.this.deleteDialog(-MessagesController.76.this.val$chat_id, 0);
                  }
                });
              }
              if (paramAnonymousTL_error != null) {}
              ...
              AndroidUtilities.runOnUIThread(new Runnable()
              {
                public void run()
                {
                  MessagesController.this.loadFullChat(MessagesController.76.this.val$chat_id, 0, true);
                }
              }, 1000L);
            }
          }, 64);
    ...
    MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable()
    {
      public void run()
      {
        AndroidUtilities.runOnUIThread(new Runnable()
        {
          public void run()
          {
            NotificationsController.getInstance().processNewMessages(MessagesController.92.this.val$pushMessages, true);
          }
        });
      }
    });
  ...
  protected void getChannelDifference(final int paramInt1, final int paramInt2, final long paramLong)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        FileLog.e("TSMS", "start getChannelDifference with pts = " + localObject2 + " channelId = " + paramInt1);
          ...
          public void run(final TLObject paramAnonymousTLObject, final TLRPC.TL_error paramAnonymousTL_error)
          {
                ...
                public void run()
                {
                  if (!paramAnonymousTL_error.isEmpty())
                  {
                    ...
                    while (localIterator.hasNext())
                    {
                      ...
                      long[] arrayOfLong = MessagesStorage.getInstance().updateMessageStateAndId(localTL_updateMessageID.random_id, null, localTL_updateMessageID.id, 0, false, MessagesController.90.this.val$channelId);
                      if (arrayOfLong != null) {
                  ...
                  Utilities.stageQueue.postRunnable(new Runnable()
                  {
                    public void run()
                    {
                      ...
                      label299:
                      boolean bool;
                      if (((MessagesController.90.2.this.val$res instanceof TLRPC.TL_updates_channelDifference)) || ((MessagesController.90.2.this.val$res instanceof TLRPC.TL_updates_channelDifferenceEmpty)))
                      {
                        if (!MessagesController.90.2.this.val$res.new_messages.isEmpty())
                        {
                          final HashMap localHashMap = new HashMap();
                          ImageLoader.saveMessagesThumbs(MessagesController.90.2.this.val$res.new_messages);
                          final ArrayList localArrayList = new ArrayList();
                          l1 = -MessagesController.90.this.val$channelId;
                          ...
                          i = 0;
                          if (i < MessagesController.90.2.this.val$res.new_messages.size())
                          {
                            localObject4 = (TLRPC.Message)MessagesController.90.2.this.val$res.new_messages.get(i);
                            if ((MessagesController.90.2.this.val$channelFinal == null) || (!MessagesController.90.2.this.val$channelFinal.left)) {
                            ...
                            for (bool = true;; bool = false)
                            {
                              ...
                              if ((MessagesController.90.2.this.val$channelFinal != null) && (MessagesController.90.2.this.val$channelFinal.megagroup)) {
                                ((TLRPC.Message)localObject4).flags |= 0x80000000;
                              }
                              MessageObject localMessageObject = new MessageObject((TLRPC.Message)localObject4, MessagesController.90.2.this.val$usersDict, MessagesController.this.createdDialogIds.contains(Long.valueOf(l1)));
                              if ((!localMessageObject.isOut()) && (localMessageObject.isUnread())) {
                                localArrayList.add(localMessageObject);
                              }
                              long l2 = -MessagesController.90.this.val$channelId;
                            ...
                            public void run()
                            {
                              if (!localArrayList.isEmpty()) {
                                AndroidUtilities.runOnUIThread(new Runnable()
                                {
                                  public void run()
                                  {
                                    NotificationsController.getInstance().processNewMessages(MessagesController.90.2.2.2.this.val$pushMessages, true);
                                  }
                                });
                              }
                              MessagesStorage.getInstance().putMessages(MessagesController.90.2.this.val$res.new_messages, true, false, false, MediaController.getInstance().getAutodownloadMask());
                            }
                          });
                        }
                        if (!MessagesController.90.2.this.val$res.other_updates.isEmpty()) {
                          MessagesController.this.processUpdateArray(MessagesController.90.2.this.val$res.other_updates, MessagesController.90.2.this.val$res.users, MessagesController.90.2.this.val$res.chats, true);
                        }
                        MessagesController.this.processChannelsUpdatesQueue(MessagesController.90.this.val$channelId, 1);
                        MessagesStorage.getInstance().saveChannelPts(MessagesController.90.this.val$channelId, MessagesController.90.2.this.val$res.pts);
                      }
                      for (;;)
                      {
                        MessagesController.this.gettingDifferenceChannels.remove(Integer.valueOf(MessagesController.90.this.val$channelId));
                        MessagesController.this.channelsPts.put(Integer.valueOf(MessagesController.90.this.val$channelId), Integer.valueOf(MessagesController.90.2.this.val$res.pts));
                        if ((MessagesController.90.2.this.val$res.flags & 0x2) != 0) {
                          MessagesController.this.shortPollChannels.put(MessagesController.90.this.val$channelId, (int)(System.currentTimeMillis() / 1000L) + MessagesController.90.2.this.val$res.timeout);
                        }
                        if (!MessagesController.90.2.this.val$res.isFinal) {
                          MessagesController.this.getChannelDifference(MessagesController.90.this.val$channelId);
                        }
                        FileLog.e("TSMS", "received channel difference with pts = " + MessagesController.90.2.this.val$res.pts + " channelId = " + MessagesController.90.this.val$channelId);
                        FileLog.e("TSMS", "new_messages = " + MessagesController.90.2.this.val$res.new_messages.size() + " messages = " + MessagesController.90.2.this.val$res.messages.size() + " users = " + MessagesController.90.2.this.val$res.users.size() + " chats = " + MessagesController.90.2.this.val$res.chats.size() + " other updates = " + MessagesController.90.2.this.val$res.other_updates.size());
                        if (MessagesController.90.this.val$newTaskId != 0L) {
                          MessagesStorage.getInstance().removePendingTask(MessagesController.90.this.val$newTaskId);
                        }
                        return;
                        if ((MessagesController.90.2.this.val$res instanceof TLRPC.TL_updates_channelDifferenceTooLong))
                        {
                          l1 = -MessagesController.90.this.val$channelId;
                          localObject2 = (Integer)MessagesController.this.dialogs_read_inbox_max.get(Long.valueOf(l1));
                          localObject1 = localObject2;
                          ...
                          i = 0;
                          if (i < MessagesController.90.2.this.val$res.messages.size())
                          {
                            localObject4 = (TLRPC.Message)MessagesController.90.2.this.val$res.messages.get(i);
                            ((TLRPC.Message)localObject4).dialog_id = (-MessagesController.90.this.val$channelId);
                            if ((!(((TLRPC.Message)localObject4).action instanceof TLRPC.TL_messageActionChannelCreate)) && ((MessagesController.90.2.this.val$channelFinal == null) || (!MessagesController.90.2.this.val$channelFinal.left))) {
                              if (((TLRPC.Message)localObject4).out)
                              {
                                localObject3 = localObject2;
                                label1310:
                          ...
                          MessagesStorage.getInstance().overwriteChannel(MessagesController.90.this.val$channelId, (TLRPC.TL_updates_channelDifferenceTooLong)MessagesController.90.2.this.val$res, MessagesController.90.this.val$newDialogType);
                        }
                      }
                    }
                  });
            ...
            do
            {
              ...
              AndroidUtilities.runOnUIThread(new Runnable()
              {
                public void run()
                {
                  MessagesController.this.checkChannelError(paramAnonymousTL_error.text, MessagesController.90.this.val$channelId);
                }
              });
  ...
  public void getDifference(int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    FileLog.e("TSMS", "start getDifference with date = " + MessagesStorage.lastDateValue + " pts = " + MessagesStorage.lastPtsValue + " seq = " + MessagesStorage.lastSeqValue);
          ...
          MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable()
          {
            public void run()
            {
              ...
              Utilities.stageQueue.postRunnable(new Runnable()
              {
                ...
                {
                  int i;
                  if ((!MessagesController.91.2.this.val$res.new_messages.isEmpty()) || (!MessagesController.91.2.this.val$res.new_encrypted_messages.isEmpty()))
                  {
                    final HashMap localHashMap = new HashMap();
                    i = 0;
                    Object localObject1;
                    Object localObject2;
                    while (i < MessagesController.91.2.this.val$res.new_encrypted_messages.size())
                    {
                      localObject1 = (TLRPC.EncryptedMessage)MessagesController.91.2.this.val$res.new_encrypted_messages.get(i);
                      ...
                      if ((localObject1 != null) && (!((ArrayList)localObject1).isEmpty()))
                      {
                        ...
                        while (j < ((ArrayList)localObject1).size())
                        {
                          ...
                          MessagesController.91.2.this.val$res.new_messages.add(localObject2);
                          j += 1;
                        }
                      }
                      i += 1;
                    }
                    ImageLoader.saveMessagesThumbs(MessagesController.91.2.this.val$res.new_messages);
                    final ArrayList localArrayList = new ArrayList();
                    int j = UserConfig.getClientUserId();
                    i = 0;
                    if (i < MessagesController.91.2.this.val$res.new_messages.size())
                    {
                      TLRPC.Message localMessage = (TLRPC.Message)MessagesController.91.2.this.val$res.new_messages.get(i);
                      ...
                      for (localMessage.dialog_id = (-localMessage.to_id.chat_id);; localMessage.dialog_id = localMessage.to_id.user_id)
                      {
                        if ((int)localMessage.dialog_id != 0)
                        {
                          ...
                          {
                            localObject1 = (TLRPC.User)MessagesController.91.2.this.val$usersDict.get(Integer.valueOf(localMessage.action.user_id));
                        ...
                        localObject3 = new MessageObject(localMessage, MessagesController.91.2.this.val$usersDict, MessagesController.91.2.this.val$chatsDict, MessagesController.this.createdDialogIds.contains(Long.valueOf(localMessage.dialog_id)));
                    ...
                    MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable()
                    {
                      public void run()
                      {
                        if (!localArrayList.isEmpty()) {
                          AndroidUtilities.runOnUIThread(new Runnable()
                          {
                            public void run()
                            {
                              ...
                              ArrayList localArrayList = MessagesController.91.2.2.2.this.val$pushMessages;
                              if (!(MessagesController.91.2.this.val$res instanceof TLRPC.TL_updates_differenceSlice)) {}
                              for (boolean bool = true;; bool = false)
                              {
                        ...
                        MessagesStorage.getInstance().putMessages(MessagesController.91.2.this.val$res.new_messages, true, false, false, MediaController.getInstance().getAutodownloadMask());
                      }
                    });
                    SecretChatHelper.getInstance().processPendingEncMessages();
                  }
                  if (!MessagesController.91.2.this.val$res.other_updates.isEmpty()) {
                    MessagesController.this.processUpdateArray(MessagesController.91.2.this.val$res.other_updates, MessagesController.91.2.this.val$res.users, MessagesController.91.2.this.val$res.chats, true);
                  }
                  if ((MessagesController.91.2.this.val$res instanceof TLRPC.TL_updates_difference))
                  {
                    MessagesController.this.gettingDifference = false;
                    MessagesStorage.lastSeqValue = MessagesController.91.2.this.val$res.state.seq;
                    MessagesStorage.lastDateValue = MessagesController.91.2.this.val$res.state.date;
                    MessagesStorage.lastPtsValue = MessagesController.91.2.this.val$res.state.pts;
                    MessagesStorage.lastQtsValue = MessagesController.91.2.this.val$res.state.qts;
                    ConnectionsManager.getInstance().setIsUpdating(false);
                    i = 0;
                    while (i < 3)
                    {
                  ...
                  if ((MessagesController.91.2.this.val$res instanceof TLRPC.TL_updates_differenceSlice))
                  {
                    MessagesStorage.lastDateValue = MessagesController.91.2.this.val$res.intermediate_state.date;
                    MessagesStorage.lastPtsValue = MessagesController.91.2.this.val$res.intermediate_state.pts;
                    MessagesStorage.lastQtsValue = MessagesController.91.2.this.val$res.intermediate_state.qts;
                  }
                  for (;;)
                  {
                    MessagesStorage.getInstance().saveDiffParams(MessagesStorage.lastSeqValue, MessagesStorage.lastPtsValue, MessagesStorage.lastDateValue, MessagesStorage.lastQtsValue);
                    FileLog.e("TSMS", "received difference with date = " + MessagesStorage.lastDateValue + " pts = " + MessagesStorage.lastPtsValue + " seq = " + MessagesStorage.lastSeqValue + " messages = " + MessagesController.91.2.this.val$res.new_messages.size() + " users = " + MessagesController.91.2.this.val$res.users.size() + " chats = " + MessagesController.91.2.this.val$res.chats.size() + " other updates = " + MessagesController.91.2.this.val$res.other_updates.size());
                    return;
                    if ((MessagesController.91.2.this.val$res instanceof TLRPC.TL_updates_differenceEmpty))
                    {
                      MessagesController.this.gettingDifference = false;
                      MessagesStorage.lastSeqValue = MessagesController.91.2.this.val$res.seq;
                      MessagesStorage.lastDateValue = MessagesController.91.2.this.val$res.date;
                      ConnectionsManager.getInstance().setIsUpdating(false);
                      i = 0;
                      while (i < 3)
                      {
  ...
  public void loadDialogs(int paramInt1, final int paramInt2, boolean paramBoolean)
  {
    ...
    NotificationCenter.getInstance().postNotificationName(NotificationCenter.dialogsNeedReload, new Object[0]);
    FileLog.e("TSMS", "load cacheOffset = " + paramInt1 + " count = " + paramInt2 + " cache = " + paramBoolean);
    if (paramBoolean)
    {
  ...
  {
    FileLog.e("TSMS", "load messages in chat " + paramLong + " count " + paramInt1 + " max_id " + paramInt2 + " cache " + paramBoolean1 + " mindate = " + paramInt3 + " guid " + paramInt4 + " load_type " + paramInt5 + " last_message_id " + paramInt6 + " index " + paramInt7 + " firstUnread " + paramInt8 + " underad count " + paramInt9 + " last_date " + paramInt10 + " queryFromServer " + paramBoolean3);
    int i = (int)paramLong;
          ...
          MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable()
          {
            public void run()
            {
              AndroidUtilities.runOnUIThread(new Runnable()
              {
                public void run()
                {
                  Object localObject = (TLRPC.TL_dialog)MessagesController.this.dialogs_dict.get(Long.valueOf(MessagesController.59.this.val$dialog_id));
                  if (localObject != null)
                  {
                  ...
                  if (!MessagesController.59.this.val$popup)
                  {
                    NotificationsController.getInstance().processReadMessages(null, MessagesController.59.this.val$dialog_id, 0, MessagesController.59.this.val$max_positive_id, false);
                    localObject = new HashMap();
                    ((HashMap)localObject).put(Long.valueOf(MessagesController.59.this.val$dialog_id), Integer.valueOf(0));
                    NotificationsController.getInstance().processDialogsUpdateRead((HashMap)localObject);
                    return;
                  }
                  NotificationsController.getInstance().processReadMessages(null, MessagesController.59.this.val$dialog_id, 0, MessagesController.59.this.val$max_positive_id, true);
                  localObject = new HashMap();
                  ((HashMap)localObject).put(Long.valueOf(MessagesController.59.this.val$dialog_id), Integer.valueOf(-1));
                  NotificationsController.getInstance().processDialogsUpdateRead((HashMap)localObject);
                }
              });
            }
      ...
      MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable()
      {
        public void run()
        {
          AndroidUtilities.runOnUIThread(new Runnable()
          {
            public void run()
            {
              NotificationsController.getInstance().processReadMessages(null, MessagesController.62.this.val$dialog_id, MessagesController.62.this.val$max_date, 0, MessagesController.62.this.val$popup);
      ...
      public void run()
      {
        ...
        AndroidUtilities.runOnUIThread(new Runnable()
        {
          public void run()
          {
            ...
            MessagesController.this.putChats(MessagesController.56.this.val$dialogsRes.chats, true);
  ...
  public void processLoadedDialogs(final TLRPC.messages_Dialogs parammessages_Dialogs, final ArrayList<TLRPC.EncryptedChat> paramArrayList, final int paramInt1, final int paramInt2, final int paramInt3, final boolean paramBoolean1, final boolean paramBoolean2)
  {
    Utilities.stageQueue.postRunnable(new Runnable()
    {
      public void run()
      {
        FileLog.e("TSMS", "loaded loadType " + paramInt3 + " count " + parammessages_Dialogs.dialogs.size());
        if ((paramInt3 == 1) && (parammessages_Dialogs.dialogs.size() == 0))
        {
          AndroidUtilities.runOnUIThread(new Runnable()
          {
            public void run()
            {
              MessagesController.this.putUsers(MessagesController.53.this.val$dialogsRes.users, true);
              MessagesController.this.loadingDialogs = false;
              if (MessagesController.53.this.val$resetEnd) {
                MessagesController.this.dialogsEndReached = false;
              }
              NotificationCenter.getInstance().postNotificationName(NotificationCenter.dialogsNeedReload, new Object[0]);
              MessagesController.this.loadDialogs(0, MessagesController.53.this.val$count, false);
            }
          });
          return;
        }
        ...
        AndroidUtilities.runOnUIThread(new Runnable()
        {
          public void run()
          {
            if (MessagesController.53.this.val$loadType != 1)
            {
              MessagesController.this.applyDialogsNotificationsSettings(MessagesController.53.this.val$dialogsRes.dialogs);
              if (!UserConfig.draftsLoaded) {
                DraftQuery.loadDrafts();
              }
            }
            Object localObject1 = MessagesController.this;
            Object localObject2 = MessagesController.53.this.val$dialogsRes.users;
            if (MessagesController.53.this.val$loadType == 1)
            {
              bool = true;
              ((MessagesController)localObject1).putUsers((ArrayList)localObject2, bool);
              localObject1 = MessagesController.this;
              localObject2 = MessagesController.53.this.val$dialogsRes.chats;
              if (MessagesController.53.this.val$loadType != 1) {
                break label226;
              }
            }
            ...
            for (boolean bool = true;; bool = false)
            {
              ...
              if (MessagesController.53.this.val$encChats == null) {
                break label232;
              }
              i = 0;
              while (i < MessagesController.53.this.val$encChats.size())
              {
                localObject1 = (TLRPC.EncryptedChat)MessagesController.53.this.val$encChats.get(i);
            ...
            label232:
            if (!MessagesController.53.this.val$migrate) {
              MessagesController.this.loadingDialogs = false;
            }
            int j = 0;
            if ((MessagesController.53.this.val$migrate) && (!MessagesController.this.dialogs.isEmpty()))
            {
            ...
            for (;;)
            {
              ...
              if ((!MessagesController.53.this.val$migrate) || (i == 0) || (((TLRPC.TL_dialog)localObject4).last_message_date >= i))
              {
                Object localObject5 = (TLRPC.TL_dialog)MessagesController.this.dialogs_dict.get(localObject2);
                if ((MessagesController.53.this.val$loadType != 1) && ((((TLRPC.TL_dialog)localObject4).draft instanceof TLRPC.TL_draftMessage))) {
            ...
            if (MessagesController.53.this.val$migrate)
            {
              ...
              if ((MessagesController.53.this.val$loadType != 2) && (!MessagesController.53.this.val$migrate))
              {
                localObject1 = MessagesController.this;
                if (((MessagesController.53.this.val$dialogsRes.dialogs.size() != 0) && (MessagesController.53.this.val$dialogsRes.dialogs.size() == MessagesController.53.this.val$count)) || (MessagesController.53.this.val$loadType != 0)) {
                  break label1432;
                }
                bool = true;
                label1303:
              ...
              UserConfig.migrateOffsetId = MessagesController.53.this.val$offset;
              UserConfig.saveConfig(false);
              MessagesController.access$4102(MessagesController.this, false);
            ...
            for (;;)
            {
              ...
              if ((j == 0) && (MessagesController.53.this.val$loadType == 1)) {
                MessagesController.this.loadDialogs(0, MessagesController.53.this.val$count, false);
              }
            }
          }
    ...
    Utilities.stageQueue.postRunnable(new Runnable()
    {
      public void run()
      {
          ...
          else
          {
            ...
            AndroidUtilities.runOnUIThread(new Runnable()
            {
              public void run()
              {
                ...
                long l = MessagesController.50.this.val$dialog_id;
                int j = MessagesController.50.this.val$count;
                if ((MessagesController.50.this.val$load_type == 2) && (MessagesController.50.this.val$queryFromServer)) {}
                for (int i = MessagesController.50.this.val$first_unread;; i = MessagesController.50.this.val$max_id)
                {
                  localMessagesController.loadMessages(l, j, i, false, 0, MessagesController.50.this.val$classGuid, MessagesController.50.this.val$load_type, MessagesController.50.this.val$last_message_id, MessagesController.50.this.val$isChannel, MessagesController.50.this.val$loadIndex, MessagesController.50.this.val$first_unread, MessagesController.50.this.val$unread_count, MessagesController.50.this.val$last_date, MessagesController.50.this.val$queryFromServer);
                  return;
                }
              }
            });
        ...
        AndroidUtilities.runOnUIThread(new Runnable()
        {
          public void run()
          {
            MessagesController.this.putUsers(MessagesController.50.this.val$messagesRes.users, MessagesController.50.this.val$isCache);
            MessagesController.this.putChats(MessagesController.50.this.val$messagesRes.chats, MessagesController.50.this.val$isCache);
            int i = Integer.MAX_VALUE;
            int j = i;
            if (MessagesController.50.this.val$queryFromServer)
            {
              j = i;
              if (MessagesController.50.this.val$load_type == 2)
              {
                int k = 0;
                for (;;)
                {
                  j = i;
                  if (k >= MessagesController.50.this.val$messagesRes.messages.size()) {
                    break;
                  }
                  TLRPC.Message localMessage = (TLRPC.Message)MessagesController.50.this.val$messagesRes.messages.get(k);
                  j = i;
                  if (!localMessage.out)
                  {
                    j = i;
                    if (localMessage.id > MessagesController.50.this.val$first_unread)
                    {
                      j = i;
            ...
            if (j == Integer.MAX_VALUE) {
              i = MessagesController.50.this.val$first_unread;
            }
            NotificationCenter.getInstance().postNotificationName(NotificationCenter.messagesDidLoaded, new Object[] { Long.valueOf(MessagesController.50.this.val$dialog_id), Integer.valueOf(MessagesController.50.this.val$count), localObject3, Boolean.valueOf(MessagesController.50.this.val$isCache), Integer.valueOf(i), Integer.valueOf(MessagesController.50.this.val$last_message_id), Integer.valueOf(MessagesController.50.this.val$unread_count), Integer.valueOf(MessagesController.50.this.val$last_date), Integer.valueOf(MessagesController.50.this.val$load_type), Boolean.valueOf(MessagesController.50.this.val$isEnd), Integer.valueOf(MessagesController.50.this.val$classGuid), Integer.valueOf(MessagesController.50.this.val$loadIndex) });
            if (!localObject4.isEmpty()) {
              MessagesController.this.reloadMessages(localObject4, MessagesController.50.this.val$dialog_id);
            }
            if (!localHashMap3.isEmpty()) {
              MessagesController.this.reloadWebPages(MessagesController.50.this.val$dialog_id, localHashMap3);
            }
          }
        });
      }
  ...
  {
    FileLog.e("TSMS", "processNewChannelDifferenceParams pts = " + paramInt1 + " pts_count = " + paramInt2 + " channeldId = " + paramInt3);
    ...
    do
    {
      ...
      {
        FileLog.e("TSMS", "APPLY CHANNEL PTS");
    ...
    {
      FileLog.e("TSMS", "ADD CHANNEL UPDATE TO QUEUE pts = " + paramInt1 + " pts_count = " + paramInt2);
      if (localObject3 == null) {
  ...
  {
    FileLog.e("TSMS", "processNewDifferenceParams seq = " + paramInt1 + " pts = " + paramInt2 + " date = " + paramInt3 + " pts_count = " + paramInt4);
    if (paramInt2 != -1)
    {
      if (MessagesStorage.lastPtsValue + paramInt4 != paramInt2) {
        break label158;
      }
      FileLog.e("TSMS", "APPLY PTS");
    ...
    do
    {
      for (;;)
      {
        ...
        if (MessagesStorage.lastPtsValue != paramInt2) {
          ...
          {
            FileLog.e("TSMS", "ADD UPDATE TO QUEUE pts = " + paramInt2 + " pts_count = " + paramInt4);
    ...
    {
      FileLog.e("TSMS", "ADD UPDATE TO QUEUE seq = " + paramInt1);
  ...
  public boolean processUpdateArray(ArrayList<TLRPC.Update> paramArrayList, final ArrayList<TLRPC.User> paramArrayList1, final ArrayList<TLRPC.Chat> paramArrayList2, final boolean paramBoolean)
  {
    ...
    if (i1 < paramArrayList.size())
    {
      ...
      FileLog.d("TSMS", "process update " + localObject4);
      int m;
      label670:
      label726:
      int i2;
      ...
      if (((localObject4 instanceof TLRPC.TL_updateNewMessage)) || ((localObject4 instanceof TLRPC.TL_updateNewChannelMessage)))
      {
        ...
        for (;;)
        {
          ...
          FileLog.d("TSMS", "not found chat " + m);
          return false;
          paramArrayList1 = ((TLRPC.TL_updateNewChannelMessage)localObject4).message;
          if (BuildVars.DEBUG_VERSION) {
            FileLog.d("TSMS", localObject4 + " channelId = " + paramArrayList1.to_id.channel_id);
          }
        ...
        for (;;)
        {
          ...
          if (i > 0)
          {
            ...
            if (localObject4 == null)
            {
              FileLog.d("TSMS", "not found user " + i);
              return false;
              if (k == 2)
              {
          ...
          else
          {
            ...
            if (!(localObject4 instanceof TLRPC.TL_updateNewGeoChatMessage)) {
              ...
              else
              {
                    ...
                    MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable()
                    {
                      public void run()
                      {
                        AndroidUtilities.runOnUIThread(new Runnable()
                        {
                          public void run()
                          {
                            if (MessagesController.103.this.val$finalUpdate.blocked) {
                              if (!MessagesController.this.blockedUsers.contains(Integer.valueOf(MessagesController.103.this.val$finalUpdate.user_id))) {
                                MessagesController.this.blockedUsers.add(Integer.valueOf(MessagesController.103.this.val$finalUpdate.user_id));
                              }
                            }
                            for (;;)
                            {
                              NotificationCenter.getInstance().postNotificationName(NotificationCenter.blockedUsersDidLoaded, new Object[0]);
                              return;
                              MessagesController.this.blockedUsers.remove(Integer.valueOf(MessagesController.103.this.val$finalUpdate.user_id));
                            }
                          }
                        });
                      }
                ...
                {
                  if (BuildVars.DEBUG_VERSION) {
                    FileLog.d("TSMS", localObject4 + " channelId = " + ((TLRPC.Update)localObject4).channel_id);
                  }
      ...
      MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable()
      {
        public void run()
        {
          AndroidUtilities.runOnUIThread(new Runnable()
          {
            public void run()
            {
              NotificationsController.getInstance().processNewMessages(MessagesController.104.this.val$pushMessages, true);
            }
          });
        }
      });
      ...
      public void run()
      {
        AndroidUtilities.runOnUIThread(new Runnable()
        {
          public void run()
          {
            ...
            int k;
            Object localObject1;
            if ((MessagesController.106.this.val$markAsReadMessagesInbox.size() != 0) || (MessagesController.106.this.val$markAsReadMessagesOutbox.size() != 0))
            {
              NotificationCenter.getInstance().postNotificationName(NotificationCenter.messagesRead, new Object[] { MessagesController.106.this.val$markAsReadMessagesInbox, MessagesController.106.this.val$markAsReadMessagesOutbox });
              NotificationsController.getInstance().processReadMessages(MessagesController.106.this.val$markAsReadMessagesInbox, 0L, 0, 0, false);
              k = 0;
              i = j;
              j = k;
              int m;
              while (j < MessagesController.106.this.val$markAsReadMessagesInbox.size())
              {
                k = MessagesController.106.this.val$markAsReadMessagesInbox.keyAt(j);
                m = (int)((Long)MessagesController.106.this.val$markAsReadMessagesInbox.get(k)).longValue();
              ...
              {
                i = j;
                if (k >= MessagesController.106.this.val$markAsReadMessagesOutbox.size()) {
                  break;
                }
                i = MessagesController.106.this.val$markAsReadMessagesOutbox.keyAt(k);
                m = (int)((Long)MessagesController.106.this.val$markAsReadMessagesOutbox.get(i)).longValue();
            ...
            j = i;
            Object localObject2;
            if (!MessagesController.106.this.val$markAsReadEncrypted.isEmpty())
            {
              localObject1 = MessagesController.106.this.val$markAsReadEncrypted.entrySet().iterator();
              for (;;)
              {
                j = i;
                if (!((Iterator)localObject1).hasNext()) {
            ...
            if (!MessagesController.106.this.val$markAsReadMessages.isEmpty()) {
              NotificationCenter.getInstance().postNotificationName(NotificationCenter.messagesReadContent, new Object[] { MessagesController.106.this.val$markAsReadMessages });
            }
            if (MessagesController.106.this.val$deletedMessages.size() != 0)
            {
              i = 0;
              if (i < MessagesController.106.this.val$deletedMessages.size())
              {
                k = MessagesController.106.this.val$deletedMessages.keyAt(i);
                localObject1 = (ArrayList)MessagesController.106.this.val$deletedMessages.get(k);
                if (localObject1 == null) {}
                label860:
                for (;;)
                {
              ...
              NotificationsController.getInstance().removeDeletedMessagesFromNotifications(MessagesController.106.this.val$deletedMessages);
            }
            if (j != 0) {
              NotificationCenter.getInstance().postNotificationName(NotificationCenter.updateInterfaces, new Object[] { Integer.valueOf(j) });
            }
  ...
  public void processUpdates(final TLRPC.Updates paramUpdates, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (((paramUpdates instanceof TLRPC.TL_updateShortChatMessage)) || ((paramUpdates instanceof TLRPC.TL_updateShortMessage)))
      {
              ...
              MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable()
              {
                public void run()
                {
                  AndroidUtilities.runOnUIThread(new Runnable()
                  {
                    public void run()
                    {
                      NotificationsController.getInstance().processNewMessages(MessagesController.97.this.val$objArr, true);
                    }
                  });
                }
              });
        ...
        FileLog.e("TSMS", "need get diff short message, pts: " + MessagesStorage.lastPtsValue + " " + paramUpdates.pts + " count = " + paramUpdates.pts_count);
        if ((this.gettingDifference) || (this.updatesStartWaitTimePts == 0L) || (Math.abs(System.currentTimeMillis() - this.updatesStartWaitTimePts) <= 1500L))
        {
          if (this.updatesStartWaitTimePts == 0L) {
            this.updatesStartWaitTimePts = System.currentTimeMillis();
          }
          FileLog.e("TSMS", "add to queue");
      ...
      if (((paramUpdates instanceof TLRPC.TL_updatesCombined)) || ((paramUpdates instanceof TLRPC.TL_updates)))
      {
        ...
        for (;;)
        {
          ...
          if (i < paramUpdates.updates.size())
          {
            ...
            if ((localObject2 instanceof TLRPC.TL_updateNewChannelMessage))
            {
              ...
              {
                FileLog.e("TSMS", "need get diff because of min channel " + j);
                j = 1;
              }
            }
          }
        ...
        if (MessagesStorage.lastPtsValue + ((TLRPC.TL_updates)localObject3).pts_count == ((TLRPC.TL_updates)localObject3).pts) {
          ...
          {
            FileLog.e("TSMS", "need get diff inner TL_updates, seq: " + MessagesStorage.lastSeqValue + " " + paramUpdates.seq);
            i = 1;
            n = k;
            localObject2 = localObject1;
          }
        ...
        for (;;)
        {
          ...
          {
            FileLog.e("TSMS", localObject4 + " need get diff, pts: " + MessagesStorage.lastPtsValue + " " + ((TLRPC.TL_updates)localObject3).pts + " count = " + ((TLRPC.TL_updates)localObject3).pts_count);
            ...
            else
            {
              ...
              if (getUpdateType((TLRPC.Update)localObject4) == 1)
              {
                ...
                else
                {
                  ...
                  if (MessagesStorage.lastPtsValue != ((TLRPC.TL_updates)localObject3).pts)
                  {
                    FileLog.e("TSMS", localObject4 + " need get diff, qts: " + MessagesStorage.lastQtsValue + " " + ((TLRPC.TL_updates)localObject3).pts);
              ...
              else
              {
                ...
                if (i == 0)
                {
                  if (((Integer)localObject3).intValue() + ((TLRPC.TL_updates)localObject5).pts_count == ((TLRPC.TL_updates)localObject5).pts)
                  {
                    ...
                    {
                      FileLog.e("TSMS", "need get channel diff inner TL_updates, channel_id = " + i3);
                      if (localObject1 == null)
                      {
                        localObject2 = new ArrayList();
                        i = j;
                  ...
                  else
                  {
                    ...
                    {
                      FileLog.e("TSMS", localObject4 + " need get channel diff, pts: " + localObject3 + " " + ((TLRPC.TL_updates)localObject5).pts + " count = " + ((TLRPC.TL_updates)localObject5).pts_count + " channelId = " + i3);
                ...
                {
                  FileLog.e("TSMS", "need load unknown channel = " + i3);
                  localObject2 = localObject1;
                  i = j;
                  n = k;
                }
        ...
        label3995:
        if ((paramUpdates instanceof TLRPC.TL_updatesCombined)) {
          FileLog.e("TSMS", "need get diff TL_updatesCombined, seq: " + MessagesStorage.lastSeqValue + " " + paramUpdates.seq_start);
        }
        for (;;)
        {
          if ((!this.gettingDifference) && (this.updatesStartWaitTimeSeq != 0L) && (Math.abs(System.currentTimeMillis() - this.updatesStartWaitTimeSeq) > 1500L)) {
          ...
          FileLog.e("TSMS", "add TL_updates/Combined to queue");
          ...
          n = i1;
          break;
          FileLog.e("TSMS", "need get diff TL_updates, seq: " + MessagesStorage.lastSeqValue + " " + paramUpdates.seq);
        }
        label4173:
        i = 1;
        localObject2 = localObject1;
      ...
      {
        FileLog.e("TSMS", "need get diff TL_updatesTooLong");
        i = 1;
        localObject2 = localObject6;
        m = i2;
        n = i1;
  ...
  public void registerForPush(final String paramString)
  {
    ...
    ConnectionsManager.getInstance().sendRequest(localTL_account_registerDevice, new RequestDelegate()
    {
      public void run(TLObject paramAnonymousTLObject, TLRPC.TL_error paramAnonymousTL_error)
      {
        ...
        {
          FileLog.e("TSMS", "registered for push");
      ...
      ConnectionsManager.getInstance().sendRequest(paramHashMap, new RequestDelegate()
      {
        public void run(final TLObject paramAnonymousTLObject, TLRPC.TL_error paramAnonymousTL_error)
        {
          AndroidUtilities.runOnUIThread(new Runnable()
          {
            public void run()
            {
              ArrayList localArrayList = (ArrayList)MessagesController.this.reloadingWebpages.remove(MessagesController.49.this.val$url);
              ...
              MessagesStorage.getInstance().putMessages(localTL_messages_messages, MessagesController.49.this.val$dialog_id, -2, 0, false);
              NotificationCenter.getInstance().postNotificationName(NotificationCenter.replaceMessagesObjects, new Object[] { Long.valueOf(MessagesController.49.this.val$dialog_id), localArrayList });
            }
          });
        }
      });
      ...
      public void run(TLObject paramAnonymousTLObject, TLRPC.TL_error paramAnonymousTL_error)
      {
        if ((paramAnonymousTLObject instanceof TLRPC.TL_boolTrue)) {
          AndroidUtilities.runOnUIThread(new Runnable()
          {
            public void run()
            {
              MessagesController.70.this.val$info.about = MessagesController.70.this.val$about;
              MessagesStorage.getInstance().updateChatInfo(MessagesController.70.this.val$info, false);
              NotificationCenter.getInstance().postNotificationName(NotificationCenter.chatInfoDidLoaded, new Object[] { MessagesController.70.this.val$info, Integer.valueOf(0), Boolean.valueOf(false), null });
            }
          });
        }
      }
      ...
      public void run(TLObject paramAnonymousTLObject, TLRPC.TL_error paramAnonymousTL_error)
      {
        if ((paramAnonymousTLObject instanceof TLRPC.TL_boolTrue)) {
          AndroidUtilities.runOnUIThread(new Runnable()
          {
            public void run()
            {
              TLRPC.Chat localChat = MessagesController.this.getChat(Integer.valueOf(MessagesController.71.this.val$chat_id));
              if (MessagesController.71.this.val$userName.length() != 0) {}
              for (localChat.flags |= 0x40;; localChat.flags &= 0xFFFFFFBF)
              {
                localChat.username = MessagesController.71.this.val$userName;
                ArrayList localArrayList = new ArrayList();
  ...
  public void updateConfig(final TLRPC.TL_config paramTL_config)
  {
    AndroidUtilities.runOnUIThread(new Runnable()
    {
      public void run()
      {
        ...
        MessagesController.this.schedule_period_forground_ms = paramTL_config.schedule_period_forground_ms;
        MessagesController.this.schedule_period_background_ms = paramTL_config.schedule_period_background_ms;
        MessagesController.this.schedule_period_background_delay_ms = paramTL_config.schedule_period_background_delay_ms;
        MessagesController.this.uploadChunkSize_KB = paramTL_config.uploadChunkSize_KB;
        MessagesController.this.downloadChunkSize_KB = paramTL_config.downloadChunkSize_KB;
        ...
        localEditor.putInt("schedule_period_forground_ms", MessagesController.this.schedule_period_forground_ms);
        localEditor.putInt("schedule_period_background_ms", MessagesController.this.schedule_period_background_ms);
        localEditor.putInt("schedule_period_background_delay_ms", MessagesController.this.schedule_period_background_delay_ms);
        localEditor.putInt("uploadChunkSize_KB", MessagesController.this.uploadChunkSize_KB);
        localEditor.putInt("downloadChunkSize_KB", MessagesController.this.downloadChunkSize_KB);
        try
        {
    ...
    if (UserConfig.isClientActivated())
    {
      if (!this.updatesQueueChannels.isEmpty())
      {
        ...
        while (i < ((ArrayList)localObject1).size())
        {
          ...
          {
            FileLog.e("TSMS", "QUEUE CHANNEL " + j + " UPDATES WAIT TIMEOUT - CHECK QUEUE");
      ...
      while (i < 3)
      {
        ...
        {
          FileLog.e("TSMS", i + " QUEUE UPDATES WAIT TIMEOUT - CHECK QUEUE");
          processUpdatesQueue(i, 0);
        }
        i += 1;
      }
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/messenger/MessagesController.class
