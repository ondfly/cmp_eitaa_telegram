...
public class LocaleController
{
  ...
  public LocaleController()
  {
    ...
    this.languagesDict.put(((LocaleInfo)localObject1).shortName, localObject1);
    localObject1 = new LocaleInfo();
    ((LocaleInfo)localObject1).name = "فارسی";
  ...
  public static String formatDate(long paramLong)
  {
    try
    {
      ...
      if ((k + 1 == i) && (j == m)) {
        return getString("Yesterday", 2131166417);
      }
      if (j == m) {
  ...
  public static String formatDateAudio(long paramLong)
  {
    try
    {
      ...
      int m = ((Calendar)localObject).get(1);
      if ((k == i) && (j == m)) {
        return String.format("%s %s", new Object[] { getString("TodayAt", 2131166346), getInstance().formatterDay.format(new Date(1000L * paramLong)) });
      }
      if ((k + 1 == i) && (j == m)) {
        return String.format("%s %s", new Object[] { getString("YesterdayAt", 2131166418), getInstance().formatterDay.format(new Date(1000L * paramLong)) });
      }
      if (j == m) {
        return formatString("formatDateAtTime", 2131166438, new Object[] { getInstance().formatterMonth.format(new Date(1000L * paramLong)), getInstance().formatterDay.format(new Date(1000L * paramLong)) });
      }
      localObject = formatString("formatDateAtTime", 2131166438, new Object[] { getInstance().formatterYear.format(new Date(1000L * paramLong)), getInstance().formatterDay.format(new Date(1000L * paramLong)) });
      return (String)localObject;
    }
    catch (Exception localException)
    {
  ...
  public static String formatDateOnline(long paramLong)
  {
    try
    {
      ...
      int m = ((Calendar)localObject).get(1);
      if ((k == i) && (j == m)) {
        return String.format("%s %s %s", new Object[] { getString("LastSeen", 2131165792), getString("TodayAt", 2131166346), getInstance().formatterDay.format(new Date(1000L * paramLong)) });
      }
      if ((k + 1 == i) && (j == m)) {
        return String.format("%s %s %s", new Object[] { getString("LastSeen", 2131165792), getString("YesterdayAt", 2131166418), getInstance().formatterDay.format(new Date(1000L * paramLong)) });
      }
      if (j == m)
      {
        localObject = formatString("formatDateAtTime", 2131166438, new Object[] { getInstance().formatterMonth.format(new Date(1000L * paramLong)), getInstance().formatterDay.format(new Date(1000L * paramLong)) });
        return String.format("%s %s", new Object[] { getString("LastSeenDate", 2131165797), localObject });
      }
      localObject = formatString("formatDateAtTime", 2131166438, new Object[] { getInstance().formatterYear.format(new Date(1000L * paramLong)), getInstance().formatterDay.format(new Date(1000L * paramLong)) });
      localObject = String.format("%s %s", new Object[] { getString("LastSeenDate", 2131165797), localObject });
      return (String)localObject;
    }
    catch (Exception localException)
    {
  ...
  public static String formatUserStatus(TLRPC.User paramUser)
  {
    ...
    {
      return getString("Online", 2131166049);
      label90:
    ...
    if (paramUser.status.expires == -1) {
      return getString("Invisible", 2131165762);
    }
    if (paramUser.status.expires == -100) {
      return getString("Lately", 2131165817);
    }
    if (paramUser.status.expires == -101) {
      return getString("WithinAWeek", 2131166408);
    }
    if (paramUser.status.expires == -102) {
      return getString("WithinAMonth", 2131166407);
    }
  ...
  {
    return getString("LanguageName", 2131165789);
  }
  ...
  private HashMap<String, String> getLocaleFileStrings(File paramFile)
  {
    ...
    //   18: aload 5
    //   20: astore_3
    //   21: invokestatic 829	android/util/Xml:newPullParser	()Lorg/xmlpull/v1/XmlPullParser;
    //   24: astore 10
    //   26: aload 5
    //   28: astore_3
    //   29: new 831	java/io/FileInputStream
    //   32: dup
    //   33: aload_1
    //   34: invokespecial 834	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   37: astore 8
    //   39: aload 10
    //   41: aload 8
    //   43: ldc_w 836
    //   46: invokeinterface 842 3 0
    //   51: aload 10
    //   53: invokeinterface 845 1 0
    //   58: istore_2
    //   59: aconst_null
    //   60: astore 6
    //   62: aconst_null
    ...
    //   96: astore_1
    //   97: aload 10
    //   99: invokeinterface 851 1 0
    //   104: ifle +19 -> 123
    //   107: aload 10
    //   109: iconst_0
    //   110: invokeinterface 854 2 0
    //   115: astore_3
    //   116: aload 7
    //   118: astore_1
    //   119: aload 6
    ...
    //   148: aload 4
    //   150: ldc_w 699
    //   153: invokevirtual 857	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   156: ifeq +82 -> 238
    //   159: aload_3
    //   160: astore 5
    //   162: aload 4
    ...
    //   195: astore 7
    //   197: aload_1
    //   198: invokevirtual 583	java/lang/String:length	()I
    //   201: ifeq +37 -> 238
    //   204: aload_3
    //   205: astore 5
    //   207: aload 4
    ...
    //   212: astore 7
    //   214: aload_3
    //   215: invokevirtual 583	java/lang/String:length	()I
    //   218: ifeq +20 -> 238
    //   221: aload 9
    //   223: aload_3
    //   224: aload_1
    ...
    //   290: ifnull -167 -> 123
    //   293: aload 7
    //   295: invokevirtual 865	java/lang/String:trim	()Ljava/lang/String;
    //   298: ldc_w 867
    //   301: ldc_w 869
    //   304: invokevirtual 873	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   307: ldc_w 875
    //   310: ldc_w 718
    //   313: invokevirtual 873	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   316: astore_1
    //   317: aload 5
    //   319: astore_3
    //   320: aload 6
    ...
    //   354: ifnull +8 -> 362
    //   357: aload 8
    //   359: invokevirtual 878	java/io/FileInputStream:close	()V
    //   362: aload 9
    //   364: areturn
    //   365: astore_1
    //   366: ldc_w 571
    //   369: aload_1
    //   370: invokestatic 577	ir/eitaa/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   373: goto -11 -> 362
    //   376: astore_3
    //   377: aload 4
    //   379: astore_1
    ...
    //   385: ldc_w 571
    //   388: aload 4
    //   390: invokestatic 577	ir/eitaa/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   393: aload_1
    //   394: ifnull +7 -> 401
    //   397: aload_1
    //   398: invokevirtual 878	java/io/FileInputStream:close	()V
    ...
    //   410: ldc_w 571
    //   413: aload_1
    //   414: invokestatic 577	ir/eitaa/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   417: goto -16 -> 401
    //   420: astore_1
    //   421: aload_3
    //   422: ifnull +7 -> 429
    //   425: aload_3
    //   426: invokevirtual 878	java/io/FileInputStream:close	()V
    //   429: aload_1
    //   430: athrow
    //   431: astore_3
    //   432: ldc_w 571
    //   435: aload_3
    //   436: invokestatic 577	ir/eitaa/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   439: goto -10 -> 429
    //   442: astore_1
    //   443: aload 8
    //   445: astore_3
  ...
  public void applyLanguage(LocaleInfo paramLocaleInfo, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramLocaleInfo)
      {
        ...
        Object localObject2;
        Locale localLocale;
        FileLog.e("TSMS", paramLocaleInfo);
        this.changingConfiguration = false;
        continue;
      }
      recreateFormatters();
  ...
  public void recreateFormatters()
  {
    ...
    if ((((String)localObject3).toLowerCase().equals("ar")) || (((String)localObject3).toLowerCase().equals("fa")))
    {
      ...
      nameDisplayOrder = i;
      this.formatterMonth = createFormatter((Locale)localObject1, getStringInternal("formatterMonth", 2131166441), "dd MMM");
      this.formatterYear = createFormatter((Locale)localObject1, getStringInternal("formatterYear", 2131166444), "dd.MM.yy");
      this.formatterYearMax = createFormatter((Locale)localObject1, getStringInternal("formatterYearMax", 2131166445), "dd.MM.yyyy");
      this.chatDate = createFormatter((Locale)localObject1, getStringInternal("chatDate", 2131166436), "d MMMM");
      this.chatFullDate = createFormatter((Locale)localObject1, getStringInternal("chatFullDate", 2131166437), "d MMMM yyyy");
      this.formatterWeek = createFormatter((Locale)localObject1, getStringInternal("formatterWeek", 2131166443), "EEE");
      this.formatterMonthYear = createFormatter((Locale)localObject1, getStringInternal("formatterMonthYear", 2131166442), "MMMM yyyy");
      localObject2 = localObject1;
      ...
      localObject1 = getStringInternal("formatterDay24H", 2131166440);
      label298:
      if (!is24HourFormat) {
        break label350;
      }
    ...
    for (localObject3 = "HH:mm";; localObject3 = "h:mm a")
    {
      ...
      break label281;
      localObject1 = getStringInternal("formatterDay12H", 2131166439);
      break label298;
    }
  }
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/messenger/LocaleController.class
