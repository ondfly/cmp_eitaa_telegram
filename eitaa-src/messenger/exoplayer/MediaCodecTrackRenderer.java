...
import ir.eitaa.messenger.exoplayer.drm.DrmSessionManager;
import ir.eitaa.messenger.exoplayer.drm.FrameworkMediaCrypto;
import ir.eitaa.messenger.exoplayer.util.Assertions;
import ir.eitaa.messenger.exoplayer.util.NalUnitUtil;
import ir.eitaa.messenger.exoplayer.util.TraceUtil;
  ...
  extends SampleSourceTrackRenderer
{
    ...
    throws ExoPlaybackException
  {
    ...
    //   0: aload_0
    //   1: aconst_null
    //   2: putfield 361	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:format	Lir/eitaa/messenger/exoplayer/MediaFormat;
    //   5: aload_0
    //   6: aconst_null
    //   7: putfield 619	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:drmInitData	Lir/eitaa/messenger/exoplayer/drm/DrmInitData;
    //   10: aload_0
    //   11: invokevirtual 507	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:releaseCodec	()V
    //   14: aload_0
    //   15: getfield 540	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:openedDrmSession	Z
    //   18: ifeq +17 -> 35
    //   21: aload_0
    //   22: getfield 139	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:drmSessionManager	Lir/eitaa/messenger/exoplayer/drm/DrmSessionManager;
    //   25: invokeinterface 716 1 0
    //   30: aload_0
    //   31: iconst_0
    //   32: putfield 540	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:openedDrmSession	Z
    //   35: aload_0
    //   36: invokespecial 718	ir/eitaa/messenger/exoplayer/SampleSourceTrackRenderer:onDisabled	()V
    //   39: return
    //   40: astore_1
    //   41: aload_0
    //   42: invokespecial 718	ir/eitaa/messenger/exoplayer/SampleSourceTrackRenderer:onDisabled	()V
    //   45: aload_1
    //   46: athrow
    //   47: astore_1
    //   48: aload_0
    //   49: getfield 540	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:openedDrmSession	Z
    //   52: ifeq +17 -> 69
    //   55: aload_0
    //   56: getfield 139	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:drmSessionManager	Lir/eitaa/messenger/exoplayer/drm/DrmSessionManager;
    //   59: invokeinterface 716 1 0
    //   64: aload_0
    //   65: iconst_0
    //   66: putfield 540	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:openedDrmSession	Z
    //   69: aload_0
    //   70: invokespecial 718	ir/eitaa/messenger/exoplayer/SampleSourceTrackRenderer:onDisabled	()V
    //   73: aload_1
    //   74: athrow
    //   75: astore_1
    //   76: aload_0
    //   77: invokespecial 718	ir/eitaa/messenger/exoplayer/SampleSourceTrackRenderer:onDisabled	()V
    //   80: aload_1
    //   81: athrow
  ...
  protected void releaseCodec()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 265	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:codec	Landroid/media/MediaCodec;
    //   4: ifnull +148 -> 152
    //   7: aload_0
    //   8: ldc2_w 578
    //   11: putfield 482	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:codecHotswapTimeMs	J
    //   14: aload_0
    //   15: iconst_m1
    //   16: putfield 329	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:inputIndex	I
    //   19: aload_0
    //   20: iconst_m1
    //   21: putfield 263	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:outputIndex	I
    //   24: aload_0
    //   25: iconst_0
    //   26: putfield 359	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:waitingForKeys	Z
    //   29: aload_0
    //   30: getfield 173	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:decodeOnlyPresentationTimestamps	Ljava/util/List;
    //   33: invokeinterface 582 1 0
    //   38: aload_0
    //   39: aconst_null
    //   40: putfield 334	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:inputBuffers	[Ljava/nio/ByteBuffer;
    //   43: aload_0
    //   44: aconst_null
    //   45: putfield 284	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:outputBuffers	[Ljava/nio/ByteBuffer;
    //   48: aload_0
    //   49: iconst_0
    //   50: putfield 588	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:codecReconfigured	Z
    //   53: aload_0
    //   54: iconst_0
    //   55: putfield 357	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:codecReceivedBuffers	Z
    //   58: aload_0
    //   59: iconst_0
    //   60: putfield 658	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:codecIsAdaptive	Z
    //   63: aload_0
    //   64: iconst_0
    //   65: putfield 400	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:codecNeedsDiscardToSpsWorkaround	Z
    //   68: aload_0
    //   69: iconst_0
    //   70: putfield 584	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:codecNeedsFlushWorkaround	Z
    //   73: aload_0
    //   74: iconst_0
    //   75: putfield 518	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:codecNeedsAdaptationWorkaround	Z
    //   78: aload_0
    //   79: iconst_0
    //   80: putfield 289	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:codecNeedsEosPropagationWorkaround	Z
    //   83: aload_0
    //   84: iconst_0
    //   85: putfield 586	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:codecNeedsEosFlushWorkaround	Z
    //   88: aload_0
    //   89: iconst_0
    //   90: putfield 528	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:codecNeedsMonoChannelCountWorkaround	Z
    //   93: aload_0
    //   94: iconst_0
    //   95: putfield 349	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:codecNeedsAdaptationWorkaroundBuffer	Z
    //   98: aload_0
    //   99: iconst_0
    //   100: putfield 296	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:shouldSkipAdaptationWorkaroundOutputBuffer	Z
    //   103: aload_0
    //   104: iconst_0
    //   105: putfield 343	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:codecReceivedEos	Z
    //   108: aload_0
    //   109: iconst_0
    //   110: putfield 180	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:codecReconfigurationState	I
    //   113: aload_0
    //   114: iconst_0
    //   115: putfield 182	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:codecReinitializationState	I
    //   118: aload_0
    //   119: getfield 156	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:codecCounters	Lir/eitaa/messenger/exoplayer/CodecCounters;
    //   122: astore_1
    //   123: aload_1
    //   124: aload_1
    //   125: getfield 734	ir/eitaa/messenger/exoplayer/CodecCounters:codecReleaseCount	I
    //   128: iconst_1
    //   129: iadd
    //   130: putfield 734	ir/eitaa/messenger/exoplayer/CodecCounters:codecReleaseCount	I
    //   133: aload_0
    //   134: getfield 265	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:codec	Landroid/media/MediaCodec;
    //   137: invokevirtual 737	android/media/MediaCodec:stop	()V
    //   140: aload_0
    //   141: getfield 265	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:codec	Landroid/media/MediaCodec;
    //   144: invokevirtual 740	android/media/MediaCodec:release	()V
    //   147: aload_0
    //   148: aconst_null
    //   149: putfield 265	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:codec	Landroid/media/MediaCodec;
    //   152: return
    //   153: astore_1
    //   154: aload_0
    //   155: aconst_null
    //   156: putfield 265	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:codec	Landroid/media/MediaCodec;
    //   159: aload_1
    //   160: athrow
    //   161: astore_1
    //   162: aload_0
    //   163: getfield 265	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:codec	Landroid/media/MediaCodec;
    //   166: invokevirtual 740	android/media/MediaCodec:release	()V
    //   169: aload_0
    //   170: aconst_null
    //   171: putfield 265	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:codec	Landroid/media/MediaCodec;
    //   174: aload_1
    //   175: athrow
    //   176: astore_1
    //   177: aload_0
    //   178: aconst_null
    //   179: putfield 265	ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer:codec	Landroid/media/MediaCodec;
    //   182: aload_1
    //   183: athrow
    // Local variable table:
    //   start	length	slot	name	signature
    ...
    extends Exception
  {
    ...
    private static String buildCustomDiagnosticInfo(int paramInt)
    {
      ...
      for (String str = "neg_";; str = "") {
        return "ir.eitaa.messenger.exoplayer.MediaCodecTrackRenderer_" + str + Math.abs(paramInt);
      }
    }
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/messenger/exoplayer/MediaCodecTrackRenderer.class
