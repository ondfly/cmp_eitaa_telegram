...
import ir.eitaa.messenger.exoplayer.SampleSourceTrackRenderer;
  ...
  implements Handler.Callback
{
  ...
  static
  {
    try
    {
      DEFAULT_PARSER_CLASSES.add(Class.forName("ir.eitaa.messenger.exoplayer.text.webvtt.WebvttParser").asSubclass(SubtitleParser.class));
      try
      {
        DEFAULT_PARSER_CLASSES.add(Class.forName("ir.eitaa.messenger.exoplayer.text.ttml.TtmlParser").asSubclass(SubtitleParser.class));
        try
        {
          DEFAULT_PARSER_CLASSES.add(Class.forName("ir.eitaa.messenger.exoplayer.text.webvtt.Mp4WebvttParser").asSubclass(SubtitleParser.class));
          try
          {
            DEFAULT_PARSER_CLASSES.add(Class.forName("ir.eitaa.messenger.exoplayer.text.subrip.SubripParser").asSubclass(SubtitleParser.class));
            try
            {
              DEFAULT_PARSER_CLASSES.add(Class.forName("ir.eitaa.messenger.exoplayer.text.tx3g.Tx3gParser").asSubclass(SubtitleParser.class));
              return;
            }
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/messenger/exoplayer/text/TextTrackRenderer.class
