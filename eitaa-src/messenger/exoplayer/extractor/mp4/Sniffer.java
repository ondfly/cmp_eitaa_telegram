    ...
    throws IOException, InterruptedException
  {
    ...
    for (;;)
    {
      ...
      if (i1 == Atom.TYPE_ftyp)
      {
        ...
        if (localParsableByteArray.capacity() < k) {
          localParsableByteArray.reset(new byte[k], k);
        }
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/messenger/exoplayer/extractor/mp4/Sniffer.class
