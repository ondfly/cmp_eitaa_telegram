...
final class FixedSampleSizeRechunker
{
  ...
  public static Results rechunk(int paramInt, long[] paramArrayOfLong, int[] paramArrayOfInt, long paramLong)
  {
    ...
    return new Results(arrayOfLong1, arrayOfInt1, m, arrayOfLong2, arrayOfInt2);
  }
  ...
  public static final class Results
  {
    ...
    public Results(long[] paramArrayOfLong1, int[] paramArrayOfInt1, int paramInt, long[] paramArrayOfLong2, int[] paramArrayOfInt2)
    {
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/messenger/exoplayer/extractor/mp4/FixedSampleSizeRechunker.class
