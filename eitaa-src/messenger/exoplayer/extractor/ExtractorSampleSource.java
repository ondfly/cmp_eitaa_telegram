...
import ir.eitaa.messenger.exoplayer.MediaFormatHolder;
import ir.eitaa.messenger.exoplayer.ParserException;
import ir.eitaa.messenger.exoplayer.SampleHolder;
import ir.eitaa.messenger.exoplayer.SampleSource;
import ir.eitaa.messenger.exoplayer.SampleSource.SampleSourceReader;
...
import ir.eitaa.messenger.exoplayer.upstream.Loader;
import ir.eitaa.messenger.exoplayer.upstream.Loader.Callback;
import ir.eitaa.messenger.exoplayer.upstream.Loader.Loadable;
  ...
  implements SampleSource, SampleSource.SampleSourceReader, ExtractorOutput, Loader.Callback
{
  ...
  static
  {
    try
    {
      DEFAULT_EXTRACTOR_CLASSES.add(Class.forName("ir.eitaa.messenger.exoplayer.extractor.webm.WebmExtractor").asSubclass(Extractor.class));
      try
      {
        DEFAULT_EXTRACTOR_CLASSES.add(Class.forName("ir.eitaa.messenger.exoplayer.extractor.mp4.FragmentedMp4Extractor").asSubclass(Extractor.class));
        try
        {
          DEFAULT_EXTRACTOR_CLASSES.add(Class.forName("ir.eitaa.messenger.exoplayer.extractor.mp4.Mp4Extractor").asSubclass(Extractor.class));
          try
          {
            DEFAULT_EXTRACTOR_CLASSES.add(Class.forName("ir.eitaa.messenger.exoplayer.extractor.mp3.Mp3Extractor").asSubclass(Extractor.class));
            try
            {
              DEFAULT_EXTRACTOR_CLASSES.add(Class.forName("ir.eitaa.messenger.exoplayer.extractor.ts.AdtsExtractor").asSubclass(Extractor.class));
              try
              {
                DEFAULT_EXTRACTOR_CLASSES.add(Class.forName("ir.eitaa.messenger.exoplayer.extractor.ts.TsExtractor").asSubclass(Extractor.class));
                try
                {
                  DEFAULT_EXTRACTOR_CLASSES.add(Class.forName("ir.eitaa.messenger.exoplayer.extractor.flv.FlvExtractor").asSubclass(Extractor.class));
                  try
                  {
                    DEFAULT_EXTRACTOR_CLASSES.add(Class.forName("ir.eitaa.messenger.exoplayer.extractor.ogg.OggExtractor").asSubclass(Extractor.class));
                    try
                    {
                      DEFAULT_EXTRACTOR_CLASSES.add(Class.forName("ir.eitaa.messenger.exoplayer.extractor.ts.PsExtractor").asSubclass(Extractor.class));
                      try
                      {
                        DEFAULT_EXTRACTOR_CLASSES.add(Class.forName("ir.eitaa.messenger.exoplayer.extractor.wav.WavExtractor").asSubclass(Extractor.class));
                        try
                        {
                          DEFAULT_EXTRACTOR_CLASSES.add(Class.forName("ir.eitaa.messenger.exoplayer.ext.flac.FlacExtractor").asSubclass(Extractor.class));
                          return;
                        }
    ...
    implements Loader.Loadable
  {
      ...
      throws IOException, java.lang.InterruptedException
    {
      ...
      //   3: ifne +262 -> 265
      //   6: aload_0
      //   7: getfield 68	ir/eitaa/messenger/exoplayer/extractor/ExtractorSampleSource$ExtractingLoadable:loadCanceled	Z
      //   10: ifne +255 -> 265
      //   13: aload_0
      //   14: getfield 58	ir/eitaa/messenger/exoplayer/extractor/ExtractorSampleSource$ExtractingLoadable:positionHolder	Lir/eitaa/messenger/exoplayer/extractor/PositionHolder;
      //   17: getfield 62	ir/eitaa/messenger/exoplayer/extractor/PositionHolder:position	J
      //   20: lstore 8
      //   22: aload_0
      //   23: getfield 43	ir/eitaa/messenger/exoplayer/extractor/ExtractorSampleSource$ExtractingLoadable:dataSource	Lir/eitaa/messenger/exoplayer/upstream/DataSource;
      //   26: new 77	ir/eitaa/messenger/exoplayer/upstream/DataSpec
      //   29: dup
      //   30: aload_0
      //   31: getfield 39	ir/eitaa/messenger/exoplayer/extractor/ExtractorSampleSource$ExtractingLoadable:uri	Landroid/net/Uri;
      //   34: lload 8
      //   36: ldc2_w 78
      //   39: aconst_null
      //   40: invokespecial 82	ir/eitaa/messenger/exoplayer/upstream/DataSpec:<init>	(Landroid/net/Uri;JJLjava/lang/String;)V
      ...
      //   67: ladd
      //   68: lstore 4
      //   70: new 88	ir/eitaa/messenger/exoplayer/extractor/DefaultExtractorInput
      //   73: dup
      //   74: aload_0
      //   75: getfield 43	ir/eitaa/messenger/exoplayer/extractor/ExtractorSampleSource$ExtractingLoadable:dataSource	Lir/eitaa/messenger/exoplayer/upstream/DataSource;
      //   78: lload 8
      //   80: lload 4
      //   82: invokespecial 91	ir/eitaa/messenger/exoplayer/extractor/DefaultExtractorInput:<init>	(Lir/eitaa/messenger/exoplayer/upstream/DataSource;JJ)V
      //   85: astore 10
      //   87: iload_1
      //   88: istore_3
      //   89: aload_0
      //   90: getfield 47	ir/eitaa/messenger/exoplayer/extractor/ExtractorSampleSource$ExtractingLoadable:extractorHolder	Lir/eitaa/messenger/exoplayer/extractor/ExtractorSampleSource$ExtractorHolder;
      //   93: aload 10
      //   95: invokevirtual 95	ir/eitaa/messenger/exoplayer/extractor/ExtractorSampleSource$ExtractorHolder:selectExtractor	(Lir/eitaa/messenger/exoplayer/extractor/ExtractorInput;)Lir/eitaa/messenger/exoplayer/extractor/Extractor;
      //   98: astore 11
      //   100: iload_1
      //   101: istore_2
      //   102: iload_1
      //   103: istore_3
      //   104: aload_0
      //   105: getfield 64	ir/eitaa/messenger/exoplayer/extractor/ExtractorSampleSource$ExtractingLoadable:pendingExtractorSeek	Z
      //   108: ifeq +21 -> 129
      //   111: iload_1
      //   112: istore_3
      //   113: aload 11
      ...
      //   122: aload_0
      //   123: iconst_0
      //   124: putfield 64	ir/eitaa/messenger/exoplayer/extractor/ExtractorSampleSource$ExtractingLoadable:pendingExtractorSeek	Z
      //   127: iload_1
      //   128: istore_2
      //   129: iload_2
      //   130: ifne +46 -> 176
      ...
      //   134: istore_3
      //   135: aload_0
      //   136: getfield 68	ir/eitaa/messenger/exoplayer/extractor/ExtractorSampleSource$ExtractingLoadable:loadCanceled	Z
      //   139: ifne +37 -> 176
      //   142: iload_2
      //   143: istore_3
      //   144: aload_0
      //   145: getfield 51	ir/eitaa/messenger/exoplayer/extractor/ExtractorSampleSource$ExtractingLoadable:allocator	Lir/eitaa/messenger/exoplayer/upstream/Allocator;
      //   148: aload_0
      //   149: getfield 53	ir/eitaa/messenger/exoplayer/extractor/ExtractorSampleSource$ExtractingLoadable:requestedBufferSize	I
      ...
      //   161: aload 10
      //   163: aload_0
      //   164: getfield 58	ir/eitaa/messenger/exoplayer/extractor/ExtractorSampleSource$ExtractingLoadable:positionHolder	Lir/eitaa/messenger/exoplayer/extractor/PositionHolder;
      ...
      //   182: istore_1
      //   183: aload_0
      //   184: getfield 43	ir/eitaa/messenger/exoplayer/extractor/ExtractorSampleSource$ExtractingLoadable:dataSource	Lir/eitaa/messenger/exoplayer/upstream/DataSource;
      ...
      //   199: ifnull -16 -> 183
      //   202: aload_0
      //   203: getfield 58	ir/eitaa/messenger/exoplayer/extractor/ExtractorSampleSource$ExtractingLoadable:positionHolder	Lir/eitaa/messenger/exoplayer/extractor/PositionHolder;
      //   206: aload 10
      //   208: invokeinterface 117 1 0
      //   213: putfield 62	ir/eitaa/messenger/exoplayer/extractor/PositionHolder:position	J
      //   216: iload_2
      //   217: istore_1
      //   218: goto -35 -> 183
      //   221: astore 11
      ...
      //   231: aload_0
      //   232: getfield 43	ir/eitaa/messenger/exoplayer/extractor/ExtractorSampleSource$ExtractingLoadable:dataSource	Lir/eitaa/messenger/exoplayer/upstream/DataSource;
      ...
      //   245: ifnull -14 -> 231
      //   248: aload_0
      //   249: getfield 58	ir/eitaa/messenger/exoplayer/extractor/ExtractorSampleSource$ExtractingLoadable:positionHolder	Lir/eitaa/messenger/exoplayer/extractor/PositionHolder;
      //   252: aload 10
      //   254: invokeinterface 117 1 0
      //   259: putfield 62	ir/eitaa/messenger/exoplayer/extractor/PositionHolder:position	J
      //   262: goto -31 -> 231
      //   265: return
      //   266: astore 11
      //   268: iload_3
  ...
  private static final class ExtractorHolder
  {
      ...
      throws ExtractorSampleSource.UnrecognizedInputFormatException, IOException, java.lang.InterruptedException
    {
      // Byte code:
      //   0: aload_0
      //   1: getfield 26	ir/eitaa/messenger/exoplayer/extractor/ExtractorSampleSource$ExtractorHolder:extractor	Lir/eitaa/messenger/exoplayer/extractor/Extractor;
      //   4: ifnull +8 -> 12
      //   7: aload_0
      //   8: getfield 26	ir/eitaa/messenger/exoplayer/extractor/ExtractorSampleSource$ExtractorHolder:extractor	Lir/eitaa/messenger/exoplayer/extractor/Extractor;
      //   11: areturn
      //   12: aload_0
      //   13: getfield 20	ir/eitaa/messenger/exoplayer/extractor/ExtractorSampleSource$ExtractorHolder:extractors	[Lir/eitaa/messenger/exoplayer/extractor/Extractor;
      //   16: astore 4
      //   18: aload 4
      //   20: arraylength
      //   21: istore_3
      ...
      //   46: aload_0
      //   47: aload 5
      //   49: putfield 26	ir/eitaa/messenger/exoplayer/extractor/ExtractorSampleSource$ExtractorHolder:extractor	Lir/eitaa/messenger/exoplayer/extractor/Extractor;
      //   52: aload_1
      //   53: invokeinterface 49 1 0
      //   58: aload_0
      //   59: getfield 26	ir/eitaa/messenger/exoplayer/extractor/ExtractorSampleSource$ExtractorHolder:extractor	Lir/eitaa/messenger/exoplayer/extractor/Extractor;
      //   62: ifnonnull +50 -> 112
      //   65: new 34	ir/eitaa/messenger/exoplayer/extractor/ExtractorSampleSource$UnrecognizedInputFormatException
      //   68: dup
      //   69: aload_0
      //   70: getfield 20	ir/eitaa/messenger/exoplayer/extractor/ExtractorSampleSource$ExtractorHolder:extractors	[Lir/eitaa/messenger/exoplayer/extractor/Extractor;
      //   73: invokespecial 52	ir/eitaa/messenger/exoplayer/extractor/ExtractorSampleSource$UnrecognizedInputFormatException:<init>	([Lir/eitaa/messenger/exoplayer/extractor/Extractor;)V
      //   76: athrow
      //   77: aload_1
      ...
      //   111: athrow
      //   112: aload_0
      //   113: getfield 26	ir/eitaa/messenger/exoplayer/extractor/ExtractorSampleSource$ExtractorHolder:extractor	Lir/eitaa/messenger/exoplayer/extractor/Extractor;
      //   116: aload_0
      //   117: getfield 22	ir/eitaa/messenger/exoplayer/extractor/ExtractorSampleSource$ExtractorHolder:extractorOutput	Lir/eitaa/messenger/exoplayer/extractor/ExtractorOutput;
      //   120: invokeinterface 56 2 0
      //   125: aload_0
      //   126: getfield 26	ir/eitaa/messenger/exoplayer/extractor/ExtractorSampleSource$ExtractorHolder:extractor	Lir/eitaa/messenger/exoplayer/extractor/Extractor;
      //   129: areturn
      // Local variable table:
      //   start	length	slot	name	signature
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/messenger/exoplayer/extractor/ExtractorSampleSource.class
