...
public final class VideoFrameReleaseTimeHelper
{
  ...
  private VideoFrameReleaseTimeHelper(float paramFloat, boolean paramBoolean)
  {
    this.useDefaultDisplayVsync = paramBoolean;
    if (paramBoolean)
    {
      this.vsyncSampler = VSyncSampler.getInstance();
      this.vsyncDurationNs = ((1.0E9D / paramFloat));
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/messenger/exoplayer/VideoFrameReleaseTimeHelper.class
