...
public class Emoji
{
  ...
  static
  {
    ...
    cols = new int[][] { { 12, 12, 12, 12 }, { 6, 6, 6, 6 }, localObject, { 9, 9, 9, 9 }, { 8, 8, 8, 7 } };
    int j = 2;
    int i;
    float f;
    label232:
  ...
  public static EmojiDrawable getEmojiDrawable(CharSequence paramCharSequence)
  {
    ...
    {
      FileLog.e("TSMS", "No drawable for emoji " + paramCharSequence);
      return null;
    }
  ...
  private static void loadEmoji(int paramInt1, final int paramInt2)
  {
    ...
    {
      FileLog.e("TSMS", "Error loading emoji", localThrowable1);
    }
  }
  ...
  public static CharSequence replaceEmoji(CharSequence paramCharSequence, Paint.FontMetricsInt paramFontMetricsInt, int paramInt, boolean paramBoolean, int[] paramArrayOfInt)
  {
    ...
    int i7;
    int j;
    for (Spannable localSpannable = (Spannable)paramCharSequence;; localSpannable = Spannable.Factory.getInstance().newSpannable(paramCharSequence.toString()))
    {
      l2 = 0L;
      i3 = 0;
      i2 = -1;
      ...
      {
        int i;
        FileLog.e("TSMS", paramFontMetricsInt);
        return paramCharSequence;
      }
    ...
    for (;;)
    {
      ...
      if (localObject != null)
      {
        localSpannable.setSpan(new EmojiSpan((EmojiDrawable)localObject, 0, paramInt, paramFontMetricsInt), n, n + i4, 33);
        i1 = i3 + 1;
      }
      m = 0;
      i4 = -1;
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/messenger/Emoji.class
