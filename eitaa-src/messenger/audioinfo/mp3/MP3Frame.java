...
public class MP3Frame
{
  ...
  public static class Header
  {
    ...
    private static final int[][] SIDE_INFO_SIZES = { { 17, -1, 17, 32 }, { 17, -1, 17, 32 }, { 17, -1, 17, 32 }, { 9, -1, 9, 17 } };
    ...
    static
    {
      int[] arrayOfInt1 = { 12000, -1, 24000, 48000 };
      int[] arrayOfInt2 = { 8000, -1, 16000, 32000 };
      int[] arrayOfInt3 = { -1, -1, -1, -1 };
      FREQUENCIES = new int[][] { { 11025, -1, 22050, 44100 }, arrayOfInt1, arrayOfInt2, arrayOfInt3 };
      arrayOfInt1 = new int[] { 0, 0, 0, 0, 0 };
      arrayOfInt2 = new int[] { 32000, 32000, 32000, 32000, 8000 };
      arrayOfInt3 = new int[] { 128000, 64000, 56000, 64000, 32000 };
      int[] arrayOfInt4 = { 160000, 80000, 64000, 80000, 40000 };
      int[] arrayOfInt5 = { 256000, 128000, 112000, 128000, 64000 };
      int[] arrayOfInt6 = { 288000, 160000, 128000, 144000, 80000 };
      int[] arrayOfInt7 = { 320000, 192000, 160000, 160000, 96000 };
      int[] arrayOfInt8 = { 384000, 256000, 224000, 192000, 128000 };
      int[] arrayOfInt9 = { 416000, 320000, 256000, 224000, 144000 };
      int[] arrayOfInt10 = { 448000, 384000, 320000, 256000, 160000 };
      int[] arrayOfInt11 = { -1, -1, -1, -1, -1 };
      BITRATES = new int[][] { arrayOfInt1, arrayOfInt2, { 64000, 48000, 40000, 48000, 16000 }, { 96000, 56000, 48000, 56000, 24000 }, arrayOfInt3, arrayOfInt4, { 192000, 96000, 80000, 96000, 48000 }, { 224000, 112000, 96000, 112000, 56000 }, arrayOfInt5, arrayOfInt6, arrayOfInt7, { 352000, 224000, 192000, 176000, 112000 }, arrayOfInt8, arrayOfInt9, arrayOfInt10, arrayOfInt11 };
      BITRATES_COLUMN = new int[][] { { -1, 4, 4, 3 }, { -1, -1, -1, -1 }, { -1, 4, 4, 3 }, { -1, 2, 1, 0 } };
      arrayOfInt1 = new int[] { -1, -1, -1, -1 };
      arrayOfInt2 = new int[] { -1, 72, 144, 12 };
      arrayOfInt3 = new int[] { -1, 144, 144, 12 };
      SIZE_COEFFICIENTS = new int[][] { { -1, 72, 144, 12 }, arrayOfInt1, arrayOfInt2, arrayOfInt3 };
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/messenger/audioinfo/mp3/MP3Frame.class
