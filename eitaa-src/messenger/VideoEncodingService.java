  ...
  implements NotificationCenter.NotificationCenterDelegate
{
  ...
  public void onDestroy()
  {
    ...
    FileLog.e("TSMS", "destroy video service");
  }
  ...
  public int onStartCommand(Intent paramIntent, int paramInt1, int paramInt2)
  {
    ...
    FileLog.e("TSMS", "start video service");
    if (this.builder == null)
    {
      ...
      this.builder.setTicker(LocaleController.getString("SendingGif", 2131166251));
      this.builder.setContentText(LocaleController.getString("SendingGif", 2131166251));
    }
    for (;;)
    {
      ...
      return 2;
      label200:
      this.builder.setTicker(LocaleController.getString("SendingVideo", 2131166253));
      this.builder.setContentText(LocaleController.getString("SendingVideo", 2131166253));
    }
  }
}


/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/messenger/VideoEncodingService.class
