  ...
  extends Application
{
  ...
  public static TelephonyManager getDeviceInfo()
  {
  ...
  public static void loadWallpaper()
  {
    ...
    Utilities.searchQueue.postRunnable(new Runnable()
    {
      ...
      {
        // Byte code:
        //   0: invokestatic 24	ir/eitaa/messenger/ApplicationLoader:access$000	()Ljava/lang/Object;
        //   3: astore 4
        //   5: aload 4
        //   7: monitorenter
        //   8: iconst_0
        ...
        //   10: iload_2
        //   11: istore_1
        //   12: getstatic 28	ir/eitaa/messenger/ApplicationLoader:applicationContext	Landroid/content/Context;
        //   15: ldc 30
        //   17: iconst_0
        ...
        //   62: invokestatic 53	ir/eitaa/messenger/ApplicationLoader:access$102	(I)I
        //   65: pop
        //   66: iload_2
        //   67: istore_1
        //   68: aload 5
        ...
        //   78: invokestatic 58	ir/eitaa/messenger/ApplicationLoader:access$202	(I)I
        //   81: pop
        //   82: iload_2
        //   83: istore_1
        //   84: iload_2
        ...
        //   94: iload_2
        //   95: istore_1
        //   96: getstatic 28	ir/eitaa/messenger/ApplicationLoader:applicationContext	Landroid/content/Context;
        ...
        //   107: invokestatic 73	ir/eitaa/messenger/ApplicationLoader:access$302	(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
        //   110: pop
        //   111: iload_2
        //   112: istore_1
        //   113: iconst_0
        //   114: invokestatic 77	ir/eitaa/messenger/ApplicationLoader:access$402	(Z)Z
        //   117: pop
        //   118: iload_2
        //   119: istore_1
        //   120: invokestatic 81	ir/eitaa/messenger/ApplicationLoader:access$300	()Landroid/graphics/drawable/Drawable;
        ...
        //   143: invokestatic 73	ir/eitaa/messenger/ApplicationLoader:access$302	(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
        //   146: pop
        //   147: invokestatic 91	ir/eitaa/messenger/ApplicationLoader:access$100	()I
        //   150: ifne +6 -> 156
        //   153: invokestatic 94	ir/eitaa/messenger/ApplicationLoader:access$500	()V
        //   156: new 13	ir/eitaa/messenger/ApplicationLoader$1$1
        //   159: dup
        //   160: aload_0
        //   161: invokespecial 97	ir/eitaa/messenger/ApplicationLoader$1$1:<init>	(Lir/eitaa/messenger/ApplicationLoader$1;)V
        //   164: invokestatic 103	ir/eitaa/messenger/AndroidUtilities:runOnUIThread	(Ljava/lang/Runnable;)V
        //   167: aload 4
        //   169: monitorexit
        //   170: return
        //   171: iload_2
        ...
        //   176: dup
        //   177: invokestatic 109	ir/eitaa/messenger/ApplicationLoader:getFilesDirFixed	()Ljava/io/File;
        //   180: ldc 111
        ...
        //   207: invokestatic 73	ir/eitaa/messenger/ApplicationLoader:access$302	(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
        //   210: pop
        //   211: iload_2
        //   212: istore_1
        //   213: iconst_1
        //   214: invokestatic 77	ir/eitaa/messenger/ApplicationLoader:access$402	(Z)Z
        //   217: pop
        //   218: iload_2
        //   219: istore_1
        //   220: goto -100 -> 120
        //   223: iload_2
        //   224: istore_1
        //   225: getstatic 28	ir/eitaa/messenger/ApplicationLoader:applicationContext	Landroid/content/Context;
        ...
        //   236: invokestatic 73	ir/eitaa/messenger/ApplicationLoader:access$302	(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
        //   239: pop
        //   240: iload_2
        //   241: istore_1
        //   242: iconst_0
        //   243: invokestatic 77	ir/eitaa/messenger/ApplicationLoader:access$402	(Z)Z
        //   246: pop
        //   247: iload_2
        //   248: istore_1
        //   249: goto -129 -> 120
    ...
    catch (Exception localException3)
    {
      ...
      catch (Exception localException3)
      {
        try
        {
          ...
          FileLog.e("TSMS", "screen state = " + isScreenOn);
        ...
        catch (Exception localException3)
        {
          try
          {
            for (;;)
            {
              ...
              localObject1 = (ApplicationLoader)applicationContext;
              FileLog.e("TSMS", "app initied");
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/messenger/ApplicationLoader.class
