...
public class CameraSession
{
  ...
  protected void configurePhotoCamera()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 40	ir/eitaa/messenger/camera/CameraSession:cameraInfo	Lir/eitaa/messenger/camera/CameraInfo;
    //   4: getfield 191	ir/eitaa/messenger/camera/CameraInfo:camera	Landroid/hardware/Camera;
    //   7: astore 5
    //   9: aload 5
    //   11: ifnull +180 -> 191
    ...
    //   34: astore_3
    //   35: aload_0
    //   36: getfield 40	ir/eitaa/messenger/camera/CameraSession:cameraInfo	Lir/eitaa/messenger/camera/CameraInfo;
    //   39: invokevirtual 201	ir/eitaa/messenger/camera/CameraInfo:getCameraId	()I
    //   42: aload 6
    //   44: invokestatic 205	android/hardware/Camera:getCameraInfo	(ILandroid/hardware/Camera$CameraInfo;)V
    //   47: aload_0
    //   48: aload 6
    //   50: iconst_1
    //   51: invokespecial 207	ir/eitaa/messenger/camera/CameraSession:getDisplayOrientation	(Landroid/hardware/Camera$CameraInfo;Z)I
    //   54: istore_2
    //   55: ldc -47
    ...
    //   89: aload_3
    //   90: aload_0
    //   91: getfield 34	ir/eitaa/messenger/camera/CameraSession:previewSize	Lir/eitaa/messenger/camera/Size;
    //   94: invokevirtual 220	ir/eitaa/messenger/camera/Size:getWidth	()I
    //   97: aload_0
    //   98: getfield 34	ir/eitaa/messenger/camera/CameraSession:previewSize	Lir/eitaa/messenger/camera/Size;
    //   101: invokevirtual 223	ir/eitaa/messenger/camera/Size:getHeight	()I
    //   104: invokevirtual 229	android/hardware/Camera$Parameters:setPreviewSize	(II)V
    //   107: aload_3
    //   108: aload_0
    //   109: getfield 36	ir/eitaa/messenger/camera/CameraSession:pictureSize	Lir/eitaa/messenger/camera/Size;
    //   112: invokevirtual 220	ir/eitaa/messenger/camera/Size:getWidth	()I
    //   115: aload_0
    //   116: getfield 36	ir/eitaa/messenger/camera/CameraSession:pictureSize	Lir/eitaa/messenger/camera/Size;
    //   119: invokevirtual 223	ir/eitaa/messenger/camera/Size:getHeight	()I
    //   122: invokevirtual 232	android/hardware/Camera$Parameters:setPictureSize	(II)V
    //   125: aload_3
    //   126: aload_0
    //   127: getfield 38	ir/eitaa/messenger/camera/CameraSession:pictureFormat	I
    ...
    //   177: aload_3
    //   178: aload_0
    //   179: getfield 30	ir/eitaa/messenger/camera/CameraSession:currentFlashMode	Ljava/lang/String;
    ...
    //   194: ldc_w 259
    //   197: aload 4
    //   199: invokestatic 265	ir/eitaa/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   202: goto -167 -> 35
    //   205: astore_3
    //   206: ldc_w 259
    //   209: aload_3
    //   210: invokestatic 265	ir/eitaa/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   213: return
    //   214: iconst_0
    //   215: istore_1
    //   216: iload_2
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/messenger/camera/CameraSession.class
