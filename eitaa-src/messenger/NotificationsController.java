...
public class NotificationsController
{
  ...
  private String getStringForMessage(MessageObject paramMessageObject, boolean paramBoolean)
  {
    ...
    do
    {
        ...
        do
        {
          do
          {
            ...
            do
            {
              do
              {
                do
                {
                  ...
                  if (((int)l1 == 0) || (AndroidUtilities.needShowPasscode(false)) || (UserConfig.isWaitingForPasscodeEnter)) {
                    return LocaleController.getString("YouHaveNewMessage", 2131166420);
                  }
                  if ((j != 0) || (i == 0)) {
                    break label1319;
                  }
                  ...
                  if ((paramMessageObject.messageOwner.action instanceof TLRPC.TL_messageActionUserJoined)) {
                    return LocaleController.formatString("NotificationContactJoined", 2131165993, new Object[] { str });
                  }
                  if ((paramMessageObject.messageOwner.action instanceof TLRPC.TL_messageActionUserUpdatedPhoto)) {
                    return LocaleController.formatString("NotificationContactNewPhoto", 2131165994, new Object[] { str });
                  }
                  if ((paramMessageObject.messageOwner.action instanceof TLRPC.TL_messageActionLoginUnknownLocation))
                  {
                    str = LocaleController.formatString("formatDateAtTime", 2131166438, new Object[] { LocaleController.getInstance().formatterYear.format(paramMessageObject.messageOwner.date * 1000L), LocaleController.getInstance().formatterDay.format(paramMessageObject.messageOwner.date * 1000L) });
                    return LocaleController.formatString("NotificationUnrecognizedDevice", 2131166032, new Object[] { UserConfig.getCurrentUser().first_name, str, paramMessageObject.messageOwner.action.title, paramMessageObject.messageOwner.action.address });
                  }
                ...
                if (paramMessageObject.isMediaEmpty())
                {
                  if (!paramBoolean)
                  {
                    if ((paramMessageObject.messageOwner.message != null) && (paramMessageObject.messageOwner.message.length() != 0)) {
                      return LocaleController.formatString("NotificationMessageText", 2131166029, new Object[] { str, paramMessageObject.messageOwner.message });
                    }
                    return LocaleController.formatString("NotificationMessageNoText", 2131166025, new Object[] { str });
                  }
                  return LocaleController.formatString("NotificationMessageNoText", 2131166025, new Object[] { str });
                }
                if ((paramMessageObject.messageOwner.media instanceof TLRPC.TL_messageMediaPhoto))
                {
                  if ((!paramBoolean) && (Build.VERSION.SDK_INT >= 19) && (!TextUtils.isEmpty(paramMessageObject.messageOwner.media.caption))) {
                    return LocaleController.formatString("NotificationMessageText", 2131166029, new Object[] { str, "🖼 " + paramMessageObject.messageOwner.media.caption });
                  }
                  return LocaleController.formatString("NotificationMessagePhoto", 2131166026, new Object[] { str });
                }
                if (paramMessageObject.isVideo())
                {
                  ...
                  return LocaleController.formatString("NotificationMessageVideo", 2131166030, new Object[] { str });
                }
                if (paramMessageObject.isGame()) {
                  return LocaleController.formatString("NotificationMessageGame", 2131166008, new Object[] { str, paramMessageObject.messageOwner.media.game.title });
                }
                if (paramMessageObject.isVoice()) {
                  return LocaleController.formatString("NotificationMessageAudio", 2131166005, new Object[] { str });
                }
                if (paramMessageObject.isMusic()) {
                  return LocaleController.formatString("NotificationMessageMusic", 2131166024, new Object[] { str });
                }
                if ((paramMessageObject.messageOwner.media instanceof TLRPC.TL_messageMediaContact)) {
                  return LocaleController.formatString("NotificationMessageContact", 2131166006, new Object[] { str });
                }
                if (((paramMessageObject.messageOwner.media instanceof TLRPC.TL_messageMediaGeo)) || ((paramMessageObject.messageOwner.media instanceof TLRPC.TL_messageMediaVenue))) {
                  return LocaleController.formatString("NotificationMessageMap", 2131166023, new Object[] { str });
                }
              ...
              if (paramMessageObject.isSticker())
              {
                ...
                if (paramMessageObject != null) {
                  return LocaleController.formatString("NotificationMessageStickerEmoji", 2131166028, new Object[] { str, paramMessageObject });
                }
                return LocaleController.formatString("NotificationMessageSticker", 2131166027, new Object[] { str });
              }
              if (paramMessageObject.isGif())
              {
                ...
                return LocaleController.formatString("NotificationMessageGif", 2131166009, new Object[] { str });
              }
              if ((!paramBoolean) && (Build.VERSION.SDK_INT >= 19) && (!TextUtils.isEmpty(paramMessageObject.messageOwner.media.caption))) {
                return LocaleController.formatString("NotificationMessageText", 2131166029, new Object[] { str, "📎 " + paramMessageObject.messageOwner.media.caption });
              }
              return LocaleController.formatString("NotificationMessageDocument", 2131166007, new Object[] { str });
              return LocaleController.formatString("NotificationMessageNoText", 2131166025, new Object[] { str });
            } while (j == 0);
            ...
            if ((paramMessageObject.messageOwner.action instanceof TLRPC.TL_messageActionChatAddUser))
            {
              ...
              if (j != 0)
              {
                ...
                if (j == UserConfig.getClientUserId()) {
                  return LocaleController.formatString("NotificationInvitedToGroup", 2131166003, new Object[] { str, ((TLRPC.Chat)localObject1).title });
                }
                ...
                if (i == paramMessageObject.id)
                {
                  if (((TLRPC.Chat)localObject1).megagroup) {
                    return LocaleController.formatString("NotificationGroupAddSelfMega", 2131165999, new Object[] { str, ((TLRPC.Chat)localObject1).title });
                  }
                  return LocaleController.formatString("NotificationGroupAddSelf", 2131165998, new Object[] { str, ((TLRPC.Chat)localObject1).title });
                }
                return LocaleController.formatString("NotificationGroupAddMember", 2131165997, new Object[] { str, ((TLRPC.Chat)localObject1).title, UserObject.getUserName(paramMessageObject) });
              }
              ...
              return LocaleController.formatString("NotificationGroupAddMember", 2131165997, new Object[] { str, ((TLRPC.Chat)localObject1).title, ((StringBuilder)localObject2).toString() });
            }
            if ((paramMessageObject.messageOwner.action instanceof TLRPC.TL_messageActionChatJoinedByLink)) {
              return LocaleController.formatString("NotificationInvitedToGroupByLink", 2131166004, new Object[] { str, ((TLRPC.Chat)localObject1).title });
            }
            if ((paramMessageObject.messageOwner.action instanceof TLRPC.TL_messageActionChatEditTitle)) {
              return LocaleController.formatString("NotificationEditedGroupName", 2131165995, new Object[] { str, paramMessageObject.messageOwner.action.title });
            }
            if (((paramMessageObject.messageOwner.action instanceof TLRPC.TL_messageActionChatEditPhoto)) || ((paramMessageObject.messageOwner.action instanceof TLRPC.TL_messageActionChatDeletePhoto)))
            {
              ...
              return LocaleController.formatString("NotificationEditedGroupPhoto", 2131165996, new Object[] { str, ((TLRPC.Chat)localObject1).title });
            }
            if ((paramMessageObject.messageOwner.action instanceof TLRPC.TL_messageActionChatDeleteUser))
            {
              if (paramMessageObject.messageOwner.action.user_id == UserConfig.getClientUserId()) {
                return LocaleController.formatString("NotificationGroupKickYou", 2131166001, new Object[] { str, ((TLRPC.Chat)localObject1).title });
              }
              if (paramMessageObject.messageOwner.action.user_id == i) {
                return LocaleController.formatString("NotificationGroupLeftMember", 2131166002, new Object[] { str, ((TLRPC.Chat)localObject1).title });
              }
              paramMessageObject = MessagesController.getInstance().getUser(Integer.valueOf(paramMessageObject.messageOwner.action.user_id));
              if (paramMessageObject == null) {
                return null;
              }
              return LocaleController.formatString("NotificationGroupKickMember", 2131166000, new Object[] { str, ((TLRPC.Chat)localObject1).title, UserObject.getUserName(paramMessageObject) });
            }
            ...
            if ((paramMessageObject.messageOwner.action instanceof TLRPC.TL_messageActionPinMessage))
            {
              if (paramMessageObject.replyMessageObject == null)
              {
                if ((!ChatObject.isChannel((TLRPC.Chat)localObject1)) || (((TLRPC.Chat)localObject1).megagroup)) {
                  return LocaleController.formatString("NotificationActionPinnedNoText", 2131165979, new Object[] { str, ((TLRPC.Chat)localObject1).title });
                }
                return LocaleController.formatString("NotificationActionPinnedNoTextChannel", 2131165980, new Object[] { str, ((TLRPC.Chat)localObject1).title });
              }
              localObject2 = paramMessageObject.replyMessageObject;
              if (((MessageObject)localObject2).isMusic())
              {
                if ((!ChatObject.isChannel((TLRPC.Chat)localObject1)) || (((TLRPC.Chat)localObject1).megagroup)) {
                  return LocaleController.formatString("NotificationActionPinnedMusic", 2131165977, new Object[] { str, ((TLRPC.Chat)localObject1).title });
                }
                return LocaleController.formatString("NotificationActionPinnedMusicChannel", 2131165978, new Object[] { ((TLRPC.Chat)localObject1).title });
              }
              if (((MessageObject)localObject2).isVideo())
              {
                if ((Build.VERSION.SDK_INT >= 19) && (!TextUtils.isEmpty(((MessageObject)localObject2).messageOwner.media.caption)))
                {
                  ...
                  if ((!ChatObject.isChannel((TLRPC.Chat)localObject1)) || (((TLRPC.Chat)localObject1).megagroup)) {
                    return LocaleController.formatString("NotificationActionPinnedText", 2131165987, new Object[] { str, paramMessageObject, ((TLRPC.Chat)localObject1).title });
                  }
                  return LocaleController.formatString("NotificationActionPinnedTextChannel", 2131165988, new Object[] { ((TLRPC.Chat)localObject1).title, paramMessageObject });
                }
                if ((!ChatObject.isChannel((TLRPC.Chat)localObject1)) || (((TLRPC.Chat)localObject1).megagroup)) {
                  return LocaleController.formatString("NotificationActionPinnedVideo", 2131165989, new Object[] { str, ((TLRPC.Chat)localObject1).title });
                }
                return LocaleController.formatString("NotificationActionPinnedVideoChannel", 2131165990, new Object[] { ((TLRPC.Chat)localObject1).title });
              }
              if (((MessageObject)localObject2).isGif())
              {
                ...
                if ((!ChatObject.isChannel((TLRPC.Chat)localObject1)) || (((TLRPC.Chat)localObject1).megagroup)) {
                  return LocaleController.formatString("NotificationActionPinnedGif", 2131165975, new Object[] { str, ((TLRPC.Chat)localObject1).title });
                }
                return LocaleController.formatString("NotificationActionPinnedGifChannel", 2131165976, new Object[] { ((TLRPC.Chat)localObject1).title });
              }
              if (((MessageObject)localObject2).isVoice())
              {
                if ((!ChatObject.isChannel((TLRPC.Chat)localObject1)) || (((TLRPC.Chat)localObject1).megagroup)) {
                  return LocaleController.formatString("NotificationActionPinnedVoice", 2131165991, new Object[] { str, ((TLRPC.Chat)localObject1).title });
                }
                return LocaleController.formatString("NotificationActionPinnedVoiceChannel", 2131165992, new Object[] { ((TLRPC.Chat)localObject1).title });
              }
              if (((MessageObject)localObject2).isSticker())
              {
                ...
                {
                  if ((!ChatObject.isChannel((TLRPC.Chat)localObject1)) || (((TLRPC.Chat)localObject1).megagroup)) {
                    return LocaleController.formatString("NotificationActionPinnedStickerEmoji", 2131165985, new Object[] { str, ((TLRPC.Chat)localObject1).title, paramMessageObject });
                  }
                  return LocaleController.formatString("NotificationActionPinnedStickerEmojiChannel", 2131165986, new Object[] { ((TLRPC.Chat)localObject1).title, paramMessageObject });
                }
                if ((!ChatObject.isChannel((TLRPC.Chat)localObject1)) || (((TLRPC.Chat)localObject1).megagroup)) {
                  return LocaleController.formatString("NotificationActionPinnedSticker", 2131165983, new Object[] { str, ((TLRPC.Chat)localObject1).title });
                }
                return LocaleController.formatString("NotificationActionPinnedStickerChannel", 2131165984, new Object[] { ((TLRPC.Chat)localObject1).title });
              }
              if ((((MessageObject)localObject2).messageOwner.media instanceof TLRPC.TL_messageMediaDocument))
              {
                ...
                if ((!ChatObject.isChannel((TLRPC.Chat)localObject1)) || (((TLRPC.Chat)localObject1).megagroup)) {
                  return LocaleController.formatString("NotificationActionPinnedFile", 2131165969, new Object[] { str, ((TLRPC.Chat)localObject1).title });
                }
                return LocaleController.formatString("NotificationActionPinnedFileChannel", 2131165970, new Object[] { ((TLRPC.Chat)localObject1).title });
              }
              if ((((MessageObject)localObject2).messageOwner.media instanceof TLRPC.TL_messageMediaGeo))
              {
                if ((!ChatObject.isChannel((TLRPC.Chat)localObject1)) || (((TLRPC.Chat)localObject1).megagroup)) {
                  return LocaleController.formatString("NotificationActionPinnedGeo", 2131165973, new Object[] { str, ((TLRPC.Chat)localObject1).title });
                }
                return LocaleController.formatString("NotificationActionPinnedGeoChannel", 2131165974, new Object[] { ((TLRPC.Chat)localObject1).title });
              }
              if ((((MessageObject)localObject2).messageOwner.media instanceof TLRPC.TL_messageMediaContact))
              {
                if ((!ChatObject.isChannel((TLRPC.Chat)localObject1)) || (((TLRPC.Chat)localObject1).megagroup)) {
                  return LocaleController.formatString("NotificationActionPinnedContact", 2131165967, new Object[] { str, ((TLRPC.Chat)localObject1).title });
                }
                return LocaleController.formatString("NotificationActionPinnedContactChannel", 2131165968, new Object[] { ((TLRPC.Chat)localObject1).title });
              }
              if ((((MessageObject)localObject2).messageOwner.media instanceof TLRPC.TL_messageMediaPhoto))
              {
                ...
                if ((!ChatObject.isChannel((TLRPC.Chat)localObject1)) || (((TLRPC.Chat)localObject1).megagroup)) {
                  return LocaleController.formatString("NotificationActionPinnedPhoto", 2131165981, new Object[] { str, ((TLRPC.Chat)localObject1).title });
                }
                return LocaleController.formatString("NotificationActionPinnedPhotoChannel", 2131165982, new Object[] { ((TLRPC.Chat)localObject1).title });
              }
              if ((((MessageObject)localObject2).messageOwner.media instanceof TLRPC.TL_messageMediaGame))
              {
                if ((!ChatObject.isChannel((TLRPC.Chat)localObject1)) || (((TLRPC.Chat)localObject1).megagroup)) {
                  return LocaleController.formatString("NotificationActionPinnedGame", 2131165971, new Object[] { str, ((TLRPC.Chat)localObject1).title });
                }
                return LocaleController.formatString("NotificationActionPinnedGameChannel", 2131165972, new Object[] { ((TLRPC.Chat)localObject1).title });
              }
              ...
              return LocaleController.formatString("NotificationActionPinnedNoTextChannel", 2131165980, new Object[] { ((TLRPC.Chat)localObject1).title });
            }
          } while (!(paramMessageObject.messageOwner.action instanceof TLRPC.TL_messageActionGameScore));
          return paramMessageObject.messageText.toString();
          if ((!ChatObject.isChannel((TLRPC.Chat)localObject1)) || (((TLRPC.Chat)localObject1).megagroup)) {
          ...
          if (paramMessageObject.isMediaEmpty())
          {
            if ((!paramBoolean) && (paramMessageObject.messageOwner.message != null) && (paramMessageObject.messageOwner.message.length() != 0)) {
              return LocaleController.formatString("NotificationMessageGroupText", 2131166021, new Object[] { str, ((TLRPC.Chat)localObject1).title, paramMessageObject.messageOwner.message });
            }
          ...
          {
            if ((!paramBoolean) && (Build.VERSION.SDK_INT >= 19) && (!TextUtils.isEmpty(paramMessageObject.messageOwner.media.caption))) {
              return LocaleController.formatString("NotificationMessageGroupText", 2131166021, new Object[] { str, ((TLRPC.Chat)localObject1).title, "🖼 " + paramMessageObject.messageOwner.media.caption });
            }
      ...
      if (paramMessageObject.isMediaEmpty())
      {
        ...
        return LocaleController.formatString("NotificationMessageGroupNoText", 2131166017, new Object[] { str, ((TLRPC.Chat)localObject1).title });
      }
      if ((paramMessageObject.messageOwner.media instanceof TLRPC.TL_messageMediaPhoto))
      {
        if ((!paramBoolean) && (Build.VERSION.SDK_INT >= 19) && (!TextUtils.isEmpty(paramMessageObject.messageOwner.media.caption))) {
        ...
        return LocaleController.formatString("NotificationMessageGroupPhoto", 2131166018, new Object[] { str, ((TLRPC.Chat)localObject1).title });
      }
      if (paramMessageObject.isVideo())
      {
        if ((!paramBoolean) && (Build.VERSION.SDK_INT >= 19) && (!TextUtils.isEmpty(paramMessageObject.messageOwner.media.caption))) {
        ...
        return LocaleController.formatString("NotificationMessageGroupVideo", 2131166022, new Object[] { str, ((TLRPC.Chat)localObject1).title });
      }
      if (paramMessageObject.isVoice()) {
        return LocaleController.formatString("NotificationMessageGroupAudio", 2131166010, new Object[] { str, ((TLRPC.Chat)localObject1).title });
      }
      if (paramMessageObject.isMusic()) {
        return LocaleController.formatString("NotificationMessageGroupMusic", 2131166016, new Object[] { str, ((TLRPC.Chat)localObject1).title });
      }
      if ((paramMessageObject.messageOwner.media instanceof TLRPC.TL_messageMediaContact)) {
        return LocaleController.formatString("NotificationMessageGroupContact", 2131166011, new Object[] { str, ((TLRPC.Chat)localObject1).title });
      }
      if ((paramMessageObject.messageOwner.media instanceof TLRPC.TL_messageMediaGame)) {
        return LocaleController.formatString("NotificationMessageGroupGame", 2131166013, new Object[] { str, ((TLRPC.Chat)localObject1).title, paramMessageObject.messageOwner.media.game.title });
      }
      if (((paramMessageObject.messageOwner.media instanceof TLRPC.TL_messageMediaGeo)) || ((paramMessageObject.messageOwner.media instanceof TLRPC.TL_messageMediaVenue))) {
        return LocaleController.formatString("NotificationMessageGroupMap", 2131166015, new Object[] { str, ((TLRPC.Chat)localObject1).title });
      }
    } while (!(paramMessageObject.messageOwner.media instanceof TLRPC.TL_messageMediaDocument));
    if (paramMessageObject.isSticker())
    {
      paramMessageObject = paramMessageObject.getStickerEmoji();
      if (paramMessageObject != null) {
        return LocaleController.formatString("NotificationMessageGroupStickerEmoji", 2131166020, new Object[] { str, ((TLRPC.Chat)localObject1).title, paramMessageObject });
      }
      return LocaleController.formatString("NotificationMessageGroupSticker", 2131166019, new Object[] { str, ((TLRPC.Chat)localObject1).title });
    }
    if (paramMessageObject.isGif())
    {
      if ((!paramBoolean) && (Build.VERSION.SDK_INT >= 19) && (!TextUtils.isEmpty(paramMessageObject.messageOwner.media.caption))) {
      ...
      return LocaleController.formatString("NotificationMessageGroupGif", 2131166014, new Object[] { str, ((TLRPC.Chat)localObject1).title });
    }
    if ((!paramBoolean) && (Build.VERSION.SDK_INT >= 19) && (!TextUtils.isEmpty(paramMessageObject.messageOwner.media.caption))) {
      return LocaleController.formatString("NotificationMessageGroupText", 2131166021, new Object[] { str, ((TLRPC.Chat)localObject1).title, "📎 " + paramMessageObject.messageOwner.media.caption });
    }
    return LocaleController.formatString("NotificationMessageGroupDocument", 2131166012, new Object[] { str, ((TLRPC.Chat)localObject1).title });
    label6493:
    if ((ChatObject.isChannel((TLRPC.Chat)localObject1)) && (!((TLRPC.Chat)localObject1).megagroup)) {
      return LocaleController.formatString("ChannelMessageNoText", 2131165455, new Object[] { str, ((TLRPC.Chat)localObject1).title });
    }
  ...
  private void scheduleNotificationDelay(boolean paramBoolean)
  {
    try
    {
      FileLog.e("TSMS", "delay notification start, onlineReason = " + paramBoolean);
      ...
      public void run()
      {
        ...
        for (;;)
        {
          ...
          try
          {
            ...
            localContentValues.put("tag", "ir.eitaa.messenger/ir.eitaa.ui.LaunchActivity");
    ...
    for (;;)
    {
      ...
      if (i < localArrayList1.size())
      {
        ...
        if ((AndroidUtilities.needShowPasscode(false)) || (UserConfig.isWaitingForPasscodeEnter))
        {
          ...
          ((Intent)localObject1).setAction("ir.eitaa.messenger.ACTION_MESSAGE_HEARD");
          ...
          if (!ChatObject.isChannel(localChat))
          {
            ...
            if (!AndroidUtilities.needShowPasscode(false))
            {
              ...
              if (!UserConfig.isWaitingForPasscodeEnter)
              {
                localObject1 = new Intent();
                ((Intent)localObject1).addFlags(32);
                ((Intent)localObject1).setAction("ir.eitaa.messenger.ACTION_MESSAGE_REPLY");
                ((Intent)localObject1).putExtra("dialog_id", l);
                ((Intent)localObject1).putExtra("max_id", j);
                localBuilder.setReplyAction(PendingIntent.getBroadcast(ApplicationLoader.applicationContext, localInteger.intValue(), (Intent)localObject1, 134217728), new RemoteInput.Builder("extra_voice_reply").setLabel(LocaleController.getString("Reply", 2131166159)).build());
                ...
                localObject5 = new RemoteInput.Builder("extra_voice_reply").setLabel(LocaleController.getString("Reply", 2131166159)).build();
                if (localChat == null) {
                  break label1075;
                }
              }
        ...
        label1061:
        label1075:
        for (localObject1 = LocaleController.formatString("ReplyToGroup", 2131166160, new Object[] { localObject3 });; localObject1 = LocaleController.formatString("ReplyToUser", 2131166161, new Object[] { localObject3 }))
        {
          localObject4 = new NotificationCompat.Action.Builder(2130837752, (CharSequence)localObject1, (PendingIntent)localObject4).addRemoteInput((RemoteInput)localObject5).build();
        ...
        for (;;)
        {
          ...
          localObject1 = new NotificationCompat.Builder(ApplicationLoader.applicationContext).setContentTitle((CharSequence)localObject3).setSmallIcon(2130837860).setGroup("messages").setContentText((CharSequence)localObject1).setAutoCancel(true).setNumber(localArrayList2.size()).setColor(ContextCompat.getColor(ApplicationLoader.applicationContext, 2131361802)).setGroupSummary(false).setWhen(((MessageObject)localArrayList2.get(0)).messageOwner.date * 1000L).setStyle(localMessagingStyle).setContentIntent((PendingIntent)localObject5).extend((NotificationCompat.Extender)localObject6).extend(new NotificationCompat.CarExtender().setUnreadConversation(localBuilder.build())).setCategory("msg");
          if (paramBuilder != null)
          {
  ...
  private void showOrUpdateNotification(boolean paramBoolean)
  {
                      ...
                      if (((TLRPC.User)localObject6).photo.photo_small.local_id != 0)
                      {
                        ...
                        if (this.pushDialogs.size() == 1)
                        {
                          ...
                          else
                          {
                            ...
                            continue;
                            localObject8 = LocaleController.formatString("NotificationMessagesPeopleDisplayOrder", 2131166031, new Object[] { LocaleController.formatPluralString("NewMessages", this.total_unread_count), LocaleController.formatPluralString("FromChats", this.pushDialogs.size()) });
                            continue;
    ...
    if ((int)l2 != 0) {
      ...
      else
      {
        ...
        localBuilder = new NotificationCompat.Builder(ApplicationLoader.applicationContext).setContentTitle((CharSequence)localObject5).setSmallIcon(2130837860).setAutoCancel(true).setNumber(this.total_unread_count).setContentIntent((PendingIntent)localObject4).setGroup("messages").setGroupSummary(true).setColor(ContextCompat.getColor(ApplicationLoader.applicationContext, 2131361802));
    ...
    for (;;)
    {
      ...
      if ((Build.VERSION.SDK_INT < 24) && (UserConfig.passcodeHash.length() == 0) && (hasMessagesToReply()))
      {
        ...
        localBuilder.addAction(2130837715, LocaleController.getString("Reply", 2131166159), PendingIntent.getBroadcast(ApplicationLoader.applicationContext, 2, (Intent)localObject1, 134217728));
      }
      label1744:
    ...
    for (;;)
    {
      ...
      break label1667;
      label2946:
      localBuilder.addAction(2130837714, LocaleController.getString("Reply", 2131166159), PendingIntent.getBroadcast(ApplicationLoader.applicationContext, 2, localThrowable, 134217728));
      break label1744;
      label2979:
      i = i1;
      if (i2 != 0) {
    ...
    for (final ArrayList localArrayList = null;; localArrayList = new ArrayList(this.popupMessages))
    {
      this.notificationsQueue.postRunnable(new Runnable()
      {
        public void run()
        {
          ...
          {
            NotificationsController.access$1002(NotificationsController.this, false);
            if (localSharedPreferences.getBoolean("badgeNumber", false)) {
  ...
  public void setLastOnlineFromOtherDevice(final int paramInt)
  {
    this.notificationsQueue.postRunnable(new Runnable()
    {
      public void run()
      {
        FileLog.e("TSMS", "set last online from other device = " + paramInt);
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/messenger/NotificationsController.class
