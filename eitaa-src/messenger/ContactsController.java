...
import ir.eitaa.tgnet.TLRPC.TL_account_getAccountTTL;
...
public class ContactsController
{
  ...
  private void applyContactsUpdates(ArrayList<Integer> paramArrayList1, ConcurrentHashMap<Integer, TLRPC.User> paramConcurrentHashMap, final ArrayList<TLRPC.TL_contact> paramArrayList, ArrayList<Integer> paramArrayList2)
  {
    ...
    FileLog.e("TSMS", "process update - contacts add = " + paramArrayList.size() + " delete = " + ((ArrayList)localObject1).size());
  ...
  private boolean checkContactsInternal()
  {
    ...
    //   15: istore_2
    //   16: aload_0
    //   17: invokespecial 597	ir/eitaa/messenger/ContactsController:hasContactsPermission	()Z
    //   20: ifne +5 -> 25
    //   23: iconst_0
    //   24: ireturn
    //   25: iload_1
    //   26: istore_2
    //   27: getstatic 248	ir/eitaa/messenger/ApplicationLoader:applicationContext	Landroid/content/Context;
    ...
    //   173: ldc_w 438
    //   176: aload 10
    //   178: invokestatic 631	ir/eitaa/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   181: iload_1
    //   182: istore_2
    //   183: aload 8
    //   185: ifnull +14 -> 199
    ...
    //   238: istore_3
    //   239: aload_0
    //   240: getfield 179	ir/eitaa/messenger/ContactsController:lastContactsVersions	Ljava/lang/String;
    ...
    //   265: istore_3
    //   266: aload_0
    //   267: getfield 179	ir/eitaa/messenger/ContactsController:lastContactsVersions	Ljava/lang/String;
    //   270: aload 11
    ...
    //   292: aload_0
    //   293: aload 11
    //   295: putfield 179	ir/eitaa/messenger/ContactsController:lastContactsVersions	Ljava/lang/String;
    //   298: iload_2
    //   299: istore_1
    //   300: iload_1
    //   301: istore_2
    ...
    //   323: ldc_w 438
    //   326: aload 8
    //   328: invokestatic 631	ir/eitaa/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   331: goto -132 -> 199
    //   334: astore 8
    //   336: aload 9
    //   338: ifnull +12 -> 350
  ...
  private HashMap<Integer, Contact> readContactsFromPhoneBook()
  {
    ...
    for (;;)
    {
      ...
      ((Contact)localObject3).phoneTypes.add(LocaleController.getString("PhoneHome", 2131166107));
      continue;
      label365:
      if (i == 2) {
        ((Contact)localObject3).phoneTypes.add(LocaleController.getString("PhoneMobile", 2131166109));
      } else if (i == 3) {
        ((Contact)localObject3).phoneTypes.add(LocaleController.getString("PhoneWork", 2131166114));
      } else if (i == 12) {
        ((Contact)localObject3).phoneTypes.add(LocaleController.getString("PhoneMain", 2131166108));
      } else {
        ((Contact)localObject3).phoneTypes.add(LocaleController.getString("PhoneOther", 2131166113));
      }
    }
            ...
            if ((localObject3 != null) && (((String)localObject3).length() != 0))
            {
              ...
              if (!localHashMap2.containsKey(localObject3))
              {
                ...
                if (!TextUtils.isEmpty((CharSequence)localObject5))
                {
                  ...
                  ((Contact)localObject6).phoneTypes.add(LocaleController.getString("PhoneMobile", 2131166109));
  ...
  public long addContactToPhoneBook(TLRPC.User arg1, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      localBuilder = ContentProviderOperation.newInsert(ContactsContract.Data.CONTENT_URI);
      localBuilder.withValueBackReference("raw_contact_id", 0);
      localBuilder.withValue("mimetype", "vnd.android.cursor.item/vnd.ir.eitaa.messenger.android.profile");
      localBuilder.withValue("data1", Integer.valueOf(???.id));
      localBuilder.withValue("data2", "Eitaa Profile");
  ...
  public void checkAppAccount()
  {
    ...
    try
    {
      Account[] arrayOfAccount1 = localAccountManager.getAccountsByType("ir.eitaa.account");
      int i;
    ...
    {
      FileLog.e("TSMS", localException2);
      arrayOfAccount2 = localAccountManager.getAccountsByType("ir.eitaa.messenger");
      j = 0;
      i = 0;
      ...
      try
      {
        this.currentAccount = new Account("" + UserConfig.getClientUserId(), "ir.eitaa.messenger");
  ...
  public void checkContacts()
  {
    Utilities.globalQueue.postRunnable(new Runnable()
    {
      public void run()
      {
        ...
        {
          FileLog.e("TSMS", "detected contacts change");
  ...
  public void deleteAllAppAccounts()
  {
    ...
    {
      AccountManager localAccountManager = AccountManager.get(ApplicationLoader.applicationContext);
      Account[] arrayOfAccount = localAccountManager.getAccountsByType("ir.eitaa.messenger");
      int i = 0;
  ...
  public String getInviteText()
  {
    ...
    return LocaleController.getString("InviteText", 2131165766);
  }
  ...
  public void loadContacts(boolean paramBoolean1, boolean paramBoolean2)
  {
    synchronized (loadContactsSync)
    {
      ...
      if (paramBoolean1)
      {
        FileLog.e("TSMS", "load contacts from cache");
        MessagesStorage.getInstance().getContacts();
        return;
      }
    }
    FileLog.e("TSMS", "load contacts from server");
        ...
        public void run(TLObject paramAnonymousTLObject, TLRPC.TL_error paramAnonymousTL_error)
        {
          if (paramAnonymousTL_error == null)
          {
            ...
            if ((paramAnonymousTLObject instanceof TLRPC.TL_contacts_contactsNotModified))
            {
              ...
              FileLog.e("TSMS", "load contacts don't change");
            }
          }
          else
          {
  ...
  protected void performSyncPhoneBook(final HashMap<Integer, Contact> paramHashMap, final boolean paramBoolean1, final boolean paramBoolean2, final boolean paramBoolean3, final boolean paramBoolean4)
  {
    ...
    Utilities.globalQueue.postRunnable(new Runnable()
    {
      public void run()
      {
        ...
        FileLog.e("TSMS", "start read contacts from phone");
        if (!paramBoolean3) {
        ...
        if (!paramHashMap.isEmpty())
        {
          ...
          if ((!paramBoolean2) && (paramHashMap.isEmpty()) && (localArrayList.isEmpty()) && (k == localHashMap1.size())) {
            FileLog.e("TSMS", "contacts not changed!");
          }
        }
        label1275:
        label1325:
        ...
        do
        {
          ...
          do
          {
            FileLog.e("TSMS", "done processing contacts");
            if (!paramBoolean1) {
              break label1604;
            }
            if (localArrayList.isEmpty()) {
            ...
            ContactsController.access$002(ContactsController.this, 0);
            j = (int)Math.ceil(localArrayList.size() / 100.0F);
            i = 0;
            while (i < j)
            {
              localObject2 = new ArrayList();
              ((ArrayList)localObject2).addAll(localArrayList.subList(i * 100, Math.min((i + 1) * 100, localArrayList.size())));
              ...
              ConnectionsManager.getInstance().sendRequest((TLObject)localObject3, new RequestDelegate()
              {
                public void run(TLObject paramAnonymous2TLObject, TLRPC.TL_error paramAnonymous2TL_error)
                {
                  ...
                  {
                    FileLog.e("TSMS", "contacts imported");
                  ...
                  for (;;)
                  {
                    ...
                    return;
                    FileLog.e("TSMS", "import contacts error " + paramAnonymous2TL_error.text);
                  }
                }
              }, 6);
              i += 1;
  ...
  public void processContactsUpdates(ArrayList<Integer> paramArrayList, ConcurrentHashMap<Integer, TLRPC.User> paramConcurrentHashMap)
  {
    ...
    if ((!this.contactsLoaded) || (!this.contactsBookLoaded))
    {
      ...
      FileLog.e("TSMS", "delay update - contacts add = " + localArrayList1.size() + " delete = " + localArrayList2.size());
      return;
    }
    ...
    AndroidUtilities.runOnUIThread(new Runnable()
    {
      public void run()
      {
        ...
        Utilities.stageQueue.postRunnable(new Runnable()
        {
          public void run()
          {
            FileLog.e("TSMS", "done loading contacts");
            ...
            while (((Iterator)localObject1).hasNext())
            {
              ...
              {
                ContactsController.this.loadContacts(false, true);
                FileLog.e("TSMS", "contacts are broken, load from server");
                return;
              }
            }
            Object localObject3;
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/messenger/ContactsController.class
