  ...
  public void postNotificationNameInternal(int paramInt, boolean paramBoolean, Object... paramVarArgs)
  {
    ...
    if ((!paramBoolean) && (this.animationInProgress))
    {
      ...
      if (BuildVars.DEBUG_VERSION) {
        FileLog.e("TSMS", "delay post notification " + paramInt + " with args count = " + paramVarArgs.length);
      }
    }
    int i;
    int j;
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/messenger/NotificationCenter.class
