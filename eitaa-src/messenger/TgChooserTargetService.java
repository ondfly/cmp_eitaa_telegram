  ...
  extends ChooserTargetService
{
  ...
  public List<ChooserTarget> onGetChooserTargets(final ComponentName paramComponentName, final IntentFilter paramIntentFilter)
  {
        ...
        for (;;)
        {
          ...
          if (localObject3 != null)
          {
            ...
            if (localObject1 == null) {
              localObject4 = Icon.createWithResource(ApplicationLoader.applicationContext, 2130837811);
            }
    ...
    {
      FileLog.e("TSMS", paramIntentFilter);
    }
    return paramComponentName;
  }
}
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/messenger/TgChooserTargetService.class
