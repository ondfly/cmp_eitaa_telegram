...
import ir.eitaa.tgnet.TLRPC.TL_inputEncryptedFileBigUploaded;
import ir.eitaa.tgnet.TLRPC.TL_inputEncryptedFileUploaded;
...
public class FileUploadOperation
{
  ...
  private int uploadChunkSize = 98304;
  ...
  private void startUploadRequest()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          FileLog.e("TSMS", localNoSuchAlgorithmException);
        }
      }
    ...
    if (this.isEncrypted)
    {
      ...
      if (this.isEncrypted)
      {
        ...
        localObject4 = ((SharedPreferences)localObject1).getString(this.fileKey + "_key", null);
        if ((localObject3 == null) || (localObject4 == null)) {
          break label1775;
        }
        this.key = Utilities.hexToBytes((String)localObject4);
      ...
      else
      {
        for (;;)
        {
          ...
          localObject4 = Arrays.copyOf(this.readBuffer, n);
          ...
          this.mdEnc.update((byte[])localObject4);
    ...
    for (;;)
    {
      ...
      else
      {
        for (;;)
        {
          ...
          localObject2 = new NativeByteBuffer(k + i);
          if ((k != this.uploadChunkSize) || ((this.estimatedSize == 0) && (this.totalPartsCount == this.currentPartNum + 1))) {
            this.isLastPart = true;
          }
          ((NativeByteBuffer)localObject2).writeBytes(this.readBuffer, 0, k);
          if (!this.isEncrypted) {
            break label1594;
          }
          j = 0;
        ...
        Utilities.aesIgeEncryption(((NativeByteBuffer)localObject2).buffer, this.key, this.ivChange, true, true, 0, k + i);
        label1594:
        ((NativeByteBuffer)localObject2).rewind();
        localObject3 = Arrays.copyOf(this.readBuffer, k);
        if (!this.isBigFile) {
          this.mdEnc.update((byte[])localObject3);
        }
        if (this.isBigFile)
        {
          ...
          if (this.estimatedSize != 0)
          {
            ...
            ((TLRPC.TL_upload_saveBigFilePart)localObject2).bytes = ((byte[])localObject3);
          }
        }
        for (;;)
        {
          ...
          ((TLRPC.TL_upload_saveFilePart)localObject2).bytes = ((byte[])localObject3);
        }
        Object localObject2 = "";
        break label269;
        label1770:
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/messenger/FileUploadOperation.class
