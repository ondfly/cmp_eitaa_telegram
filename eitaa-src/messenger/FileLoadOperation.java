...
import ir.eitaa.tgnet.TLRPC.TL_inputEncryptedFileLocation;
import ir.eitaa.tgnet.TLRPC.TL_inputFileLocation;
import ir.eitaa.tgnet.TLRPC.TL_upload_file;
...
public class FileLoadOperation
{
  ...
  private void cleanup()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 248	ir/eitaa/messenger/FileLoadOperation:fileOutputStream	Ljava/io/RandomAccessFile;
    //   4: astore_2
    //   5: aload_2
    //   6: ifnull +25 -> 31
    //   9: aload_0
    //   10: getfield 248	ir/eitaa/messenger/FileLoadOperation:fileOutputStream	Ljava/io/RandomAccessFile;
    ...
    //   19: aload_0
    //   20: getfield 248	ir/eitaa/messenger/FileLoadOperation:fileOutputStream	Ljava/io/RandomAccessFile;
    //   23: invokevirtual 260	java/io/RandomAccessFile:close	()V
    //   26: aload_0
    //   27: aconst_null
    //   28: putfield 248	ir/eitaa/messenger/FileLoadOperation:fileOutputStream	Ljava/io/RandomAccessFile;
    //   31: aload_0
    //   32: getfield 262	ir/eitaa/messenger/FileLoadOperation:fiv	Ljava/io/RandomAccessFile;
    //   35: ifnull +15 -> 50
    //   38: aload_0
    //   39: getfield 262	ir/eitaa/messenger/FileLoadOperation:fiv	Ljava/io/RandomAccessFile;
    //   42: invokevirtual 260	java/io/RandomAccessFile:close	()V
    //   45: aload_0
    //   46: aconst_null
    //   47: putfield 262	ir/eitaa/messenger/FileLoadOperation:fiv	Ljava/io/RandomAccessFile;
    //   50: aload_0
    //   51: getfield 264	ir/eitaa/messenger/FileLoadOperation:delayedRequestInfos	Ljava/util/ArrayList;
    //   54: ifnull +94 -> 148
    //   57: iconst_0
    //   58: istore_1
    //   59: iload_1
    //   60: aload_0
    //   61: getfield 264	ir/eitaa/messenger/FileLoadOperation:delayedRequestInfos	Ljava/util/ArrayList;
    //   64: invokevirtual 268	java/util/ArrayList:size	()I
    //   67: if_icmpge +74 -> 141
    //   70: aload_0
    //   71: getfield 264	ir/eitaa/messenger/FileLoadOperation:delayedRequestInfos	Ljava/util/ArrayList;
    //   74: iload_1
    //   75: invokevirtual 272	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   78: checkcast 19	ir/eitaa/messenger/FileLoadOperation$RequestInfo
    //   81: astore_2
    //   82: aload_2
    //   83: invokestatic 276	ir/eitaa/messenger/FileLoadOperation$RequestInfo:access$800	(Lir/eitaa/messenger/FileLoadOperation$RequestInfo;)Lir/eitaa/tgnet/TLRPC$TL_upload_file;
    //   86: ifnull +18 -> 104
    //   89: aload_2
    //   90: invokestatic 276	ir/eitaa/messenger/FileLoadOperation$RequestInfo:access$800	(Lir/eitaa/messenger/FileLoadOperation$RequestInfo;)Lir/eitaa/tgnet/TLRPC$TL_upload_file;
    //   93: iconst_0
    //   94: putfield 281	ir/eitaa/tgnet/TLRPC$TL_upload_file:disableFree	Z
    //   97: aload_2
    //   98: invokestatic 276	ir/eitaa/messenger/FileLoadOperation$RequestInfo:access$800	(Lir/eitaa/messenger/FileLoadOperation$RequestInfo;)Lir/eitaa/tgnet/TLRPC$TL_upload_file;
    //   101: invokevirtual 284	ir/eitaa/tgnet/TLRPC$TL_upload_file:freeResources	()V
    //   104: iload_1
    //   105: iconst_1
    //   106: iadd
    //   107: istore_1
    ...
    //   112: ldc -97
    //   114: aload_2
    //   115: invokestatic 165	ir/eitaa/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   118: goto -99 -> 19
    //   121: astore_2
    //   122: ldc -97
    //   124: aload_2
    //   125: invokestatic 165	ir/eitaa/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   128: goto -97 -> 31
    //   131: astore_2
    //   132: ldc -97
    //   134: aload_2
    //   135: invokestatic 165	ir/eitaa/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   138: goto -88 -> 50
    //   141: aload_0
    //   142: getfield 264	ir/eitaa/messenger/FileLoadOperation:delayedRequestInfos	Ljava/util/ArrayList;
    ...
    throws Exception
  {
    ...
    if ((this.cacheFileTemp != null) && (!this.cacheFileTemp.renameTo(this.cacheFileFinal)))
    {
      if (BuildVars.DEBUG_VERSION) {
        FileLog.e("TSMS", "unable to rename temp = " + this.cacheFileTemp + " to final = " + this.cacheFileFinal + " retry = " + this.renameRetryCount);
      }
    ...
    if (BuildVars.DEBUG_VERSION) {
      FileLog.e("TSMS", "finished downloading file to " + this.cacheFileFinal);
    }
  ...
  private void processRequestResult(RequestInfo paramRequestInfo, TLRPC.TL_error paramTL_error)
  {
    ...
    if (paramTL_error == null)
    {
      ...
      {
        onFail(false, 0);
        FileLog.e("TSMS", paramRequestInfo);
        return;
      }
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (this.location != null) {
          FileLog.e("TSMS", "" + this.location + " id = " + this.location.id + " local_id = " + this.location.local_id + " access_hash = " + this.location.access_hash + " volume_id = " + this.location.volume_id + " secret = " + this.location.secret);
        }
        onFail(false, 0);
        label696:
        return;
  ...
  public boolean start()
  {
    ...
    for (;;)
    {
      ...
      if (this.totalBytesCount >= 1048576)
      {
        ...
        if (BuildVars.DEBUG_VERSION) {
          FileLog.d("TSMS", "start loading file to temp = " + this.cacheFileTemp + " final = " + this.cacheFileFinal);
        }
        if (str1 != null) {
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/messenger/FileLoadOperation.class
