...
public class FileLog
{
  ...
  public static void debugLog(StackTraceElement[] paramArrayOfStackTraceElement, Boolean paramBoolean, String paramString)
  {
    if (!paramBoolean.booleanValue()) {
      return;
    }
    paramBoolean = paramArrayOfStackTraceElement[2].getClassName();
    paramBoolean = paramBoolean.substring(paramBoolean.lastIndexOf(".") + 1);
    String str = paramArrayOfStackTraceElement[2].getMethodName();
    int i = paramArrayOfStackTraceElement[2].getLineNumber();
    Log.i(paramBoolean + "." + str + "():" + i, paramString);
  }
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/messenger/FileLog.class
