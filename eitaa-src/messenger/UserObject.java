...
public class UserObject
{
  public static String getFirstName(TLRPC.User paramUser)
  {
    ...
    return LocaleController.getString("HiddenName", 2131165732);
  }
  ...
  public static String getUserName(TLRPC.User paramUser)
  {
    Object localObject;
    if ((paramUser == null) || (isDeleted(paramUser))) {
      localObject = LocaleController.getString("HiddenName", 2131165732);
    }
    do
    {
      String str;
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/messenger/UserObject.class
