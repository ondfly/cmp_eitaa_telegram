...
public class MessagesStorage
{
  ...
  private void markMessagesAsReadInternal(SparseArray<Long> paramSparseArray1, SparseArray<Long> paramSparseArray2, HashMap<Integer, Integer> paramHashMap)
  {
    ...
    for (int i = 0;; i = 0) {
      do
      {
        ...
        {
          FileLog.e("TSMS", paramSparseArray1);
        }
  ...
  private void putDialogsInternal(TLRPC.messages_Dialogs parammessages_Dialogs)
  {
    for (;;)
    {
      ...
      {
        FileLog.e("TSMS", parammessages_Dialogs);
        return;
      }
      continue;
      label811:
  ...
  private long[] updateMessageStateAndIdInternal(long paramLong, Integer paramInteger, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    catch (Exception localException6)
    {
      for (;;)
      {
        ...
        FileLog.e("TSMS", localException6);
        if (localObject3 != null) {
          ((SQLitePreparedStatement)localObject3).dispose();
        }
      }
  ...
  public int getChannelPtsSync(final int paramInt)
  {
    ...
    getInstance().getStorageQueue().postRunnable(new Runnable()
    {
      ...
      public void run()
      {
        ...
        //   3: astore_1
        //   4: aload_0
        //   5: getfield 23	ir/eitaa/messenger/MessagesStorage$80:this$0	Lir/eitaa/messenger/MessagesStorage;
        //   8: invokestatic 40	ir/eitaa/messenger/MessagesStorage:access$000	(Lir/eitaa/messenger/MessagesStorage;)Lir/eitaa/SQLite/SQLiteDatabase;
        ...
        //   23: aload_0
        //   24: getfield 25	ir/eitaa/messenger/MessagesStorage$80:val$channelId	I
        //   27: ineg
        ...
        //   38: invokevirtual 62	ir/eitaa/SQLite/SQLiteDatabase:queryFinalized	(Ljava/lang/String;[Ljava/lang/Object;)Lir/eitaa/SQLite/SQLiteCursor;
        //   41: astore_3
        //   42: aload_3
        //   43: astore_1
        //   44: aload_3
        //   45: astore_2
        //   46: aload_3
        //   47: invokevirtual 68	ir/eitaa/SQLite/SQLiteCursor:next	()Z
        //   50: ifeq +21 -> 71
        //   53: aload_3
        //   54: astore_1
        //   55: aload_3
        //   56: astore_2
        //   57: aload_0
        //   58: getfield 27	ir/eitaa/messenger/MessagesStorage$80:val$pts	[Ljava/lang/Integer;
        //   61: iconst_0
        //   62: aload_3
        //   63: iconst_0
        //   64: invokevirtual 71	ir/eitaa/SQLite/SQLiteCursor:intValue	(I)I
        //   67: invokestatic 77	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
        //   70: aastore
        //   71: aload_3
        //   72: ifnull +7 -> 79
        //   75: aload_3
        //   76: invokevirtual 80	ir/eitaa/SQLite/SQLiteCursor:dispose	()V
        //   79: aload_0
        //   80: getfield 29	ir/eitaa/messenger/MessagesStorage$80:val$semaphore	Ljava/util/concurrent/Semaphore;
        //   83: ifnull +10 -> 93
        //   86: aload_0
        //   87: getfield 29	ir/eitaa/messenger/MessagesStorage$80:val$semaphore	Ljava/util/concurrent/Semaphore;
        ...
        //   97: ldc 87
        //   99: aload_3
        //   100: invokestatic 93	ir/eitaa/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
        //   103: aload_1
        //   104: ifnull -25 -> 79
        //   107: aload_1
        //   108: invokevirtual 80	ir/eitaa/SQLite/SQLiteCursor:dispose	()V
        //   111: goto -32 -> 79
        //   114: astore_1
        //   115: aload_2
        //   116: ifnull +7 -> 123
        //   119: aload_2
        //   120: invokevirtual 80	ir/eitaa/SQLite/SQLiteCursor:dispose	()V
        //   123: aload_1
        //   124: athrow
        //   125: astore_1
        //   126: ldc 87
        //   128: aload_1
        //   129: invokestatic 93	ir/eitaa/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
        //   132: return
  ...
  public void getDialogs(final int paramInt1, final int paramInt2)
  {
    this.storageQueue.postRunnable(new Runnable()
    {
      ...
      {
        // Byte code:
        //   0: new 33	ir/eitaa/tgnet/TLRPC$messages_Dialogs
        //   3: dup
        //   4: invokespecial 34	ir/eitaa/tgnet/TLRPC$messages_Dialogs:<init>	()V
        //   7: astore 7
        ...
        //   25: astore 9
        //   27: aload 9
        //   29: invokestatic 43	ir/eitaa/messenger/UserConfig:getClientUserId	()I
        ...
        //   73: astore 12
        //   75: aload_0
        //   76: getfield 20	ir/eitaa/messenger/MessagesStorage$77:this$0	Lir/eitaa/messenger/MessagesStorage;
        //   79: invokestatic 60	ir/eitaa/messenger/MessagesStorage:access$000	(Lir/eitaa/messenger/MessagesStorage;)Lir/eitaa/SQLite/SQLiteDatabase;
        ...
        //   92: iconst_0
        //   93: aload_0
        //   94: getfield 22	ir/eitaa/messenger/MessagesStorage$77:val$offset	I
        //   97: invokestatic 49	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
        //   100: aastore
        //   101: dup
        //   102: iconst_1
        //   103: aload_0
        //   104: getfield 24	ir/eitaa/messenger/MessagesStorage$77:val$count	I
        ...
        //   118: invokevirtual 80	ir/eitaa/SQLite/SQLiteDatabase:queryFinalized	(Ljava/lang/String;[Ljava/lang/Object;)Lir/eitaa/SQLite/SQLiteCursor;
        //   121: astore 14
        //   123: aload 14
        //   125: invokevirtual 86	ir/eitaa/SQLite/SQLiteCursor:next	()Z
        //   128: ifeq +696 -> 824
        //   131: new 88	ir/eitaa/tgnet/TLRPC$TL_dialog
        //   134: dup
        //   135: invokespecial 89	ir/eitaa/tgnet/TLRPC$TL_dialog:<init>	()V
        //   138: astore 15
        //   140: aload 15
        //   142: aload 14
        //   144: iconst_0
        //   145: invokevirtual 93	ir/eitaa/SQLite/SQLiteCursor:longValue	(I)J
        //   148: putfield 97	ir/eitaa/tgnet/TLRPC$TL_dialog:id	J
        //   151: aload 15
        //   153: aload 14
        //   155: iconst_1
        //   156: invokevirtual 101	ir/eitaa/SQLite/SQLiteCursor:intValue	(I)I
        //   159: putfield 104	ir/eitaa/tgnet/TLRPC$TL_dialog:top_message	I
        //   162: aload 15
        //   164: aload 14
        //   166: iconst_2
        //   167: invokevirtual 101	ir/eitaa/SQLite/SQLiteCursor:intValue	(I)I
        //   170: putfield 107	ir/eitaa/tgnet/TLRPC$TL_dialog:unread_count	I
        //   173: aload 15
        //   175: aload 14
        //   177: iconst_3
        //   178: invokevirtual 101	ir/eitaa/SQLite/SQLiteCursor:intValue	(I)I
        //   181: putfield 110	ir/eitaa/tgnet/TLRPC$TL_dialog:last_message_date	I
        //   184: aload 15
        //   186: aload 14
        //   188: bipush 10
        //   190: invokevirtual 101	ir/eitaa/SQLite/SQLiteCursor:intValue	(I)I
        //   193: putfield 113	ir/eitaa/tgnet/TLRPC$TL_dialog:pts	I
        //   196: aload 15
        //   198: getfield 113	ir/eitaa/tgnet/TLRPC$TL_dialog:pts	I
        //   201: ifeq +910 -> 1111
        //   204: aload 15
        //   206: getfield 97	ir/eitaa/tgnet/TLRPC$TL_dialog:id	J
        //   209: l2i
        //   210: ifle +516 -> 726
        //   213: goto +898 -> 1111
        //   216: aload 15
        //   218: iload_1
        //   219: putfield 116	ir/eitaa/tgnet/TLRPC$TL_dialog:flags	I
        //   222: aload 15
        //   224: aload 14
        //   226: bipush 11
        //   228: invokevirtual 101	ir/eitaa/SQLite/SQLiteCursor:intValue	(I)I
        //   231: putfield 119	ir/eitaa/tgnet/TLRPC$TL_dialog:read_inbox_max_id	I
        //   234: aload 15
        //   236: aload 14
        //   238: bipush 12
        //   240: invokevirtual 101	ir/eitaa/SQLite/SQLiteCursor:intValue	(I)I
        //   243: putfield 122	ir/eitaa/tgnet/TLRPC$TL_dialog:read_outbox_max_id	I
        //   246: aload 14
        //   248: bipush 8
        //   250: invokevirtual 93	ir/eitaa/SQLite/SQLiteCursor:longValue	(I)J
        //   253: lstore_3
        //   254: lload_3
        //   255: l2i
        //   256: istore_1
        //   257: aload 15
        //   259: new 124	ir/eitaa/tgnet/TLRPC$TL_peerNotifySettings
        //   262: dup
        //   263: invokespecial 125	ir/eitaa/tgnet/TLRPC$TL_peerNotifySettings:<init>	()V
        //   266: putfield 129	ir/eitaa/tgnet/TLRPC$TL_dialog:notify_settings	Lir/eitaa/tgnet/TLRPC$PeerNotifySettings;
        //   269: iload_1
        //   270: iconst_1
        //   271: iand
        //   272: ifeq +37 -> 309
        //   275: aload 15
        //   277: getfield 129	ir/eitaa/tgnet/TLRPC$TL_dialog:notify_settings	Lir/eitaa/tgnet/TLRPC$PeerNotifySettings;
        //   280: lload_3
        //   281: bipush 32
        //   283: lshr
        //   284: l2i
        //   285: putfield 134	ir/eitaa/tgnet/TLRPC$PeerNotifySettings:mute_until	I
        //   288: aload 15
        //   290: getfield 129	ir/eitaa/tgnet/TLRPC$TL_dialog:notify_settings	Lir/eitaa/tgnet/TLRPC$PeerNotifySettings;
        //   293: getfield 134	ir/eitaa/tgnet/TLRPC$PeerNotifySettings:mute_until	I
        //   296: ifne +13 -> 309
        //   299: aload 15
        //   301: getfield 129	ir/eitaa/tgnet/TLRPC$TL_dialog:notify_settings	Lir/eitaa/tgnet/TLRPC$PeerNotifySettings;
        //   304: ldc -121
        //   306: putfield 134	ir/eitaa/tgnet/TLRPC$PeerNotifySettings:mute_until	I
        //   309: aload 7
        //   311: getfield 139	ir/eitaa/tgnet/TLRPC$messages_Dialogs:dialogs	Ljava/util/ArrayList;
        //   314: aload 15
        //   316: invokevirtual 53	java/util/ArrayList:add	(Ljava/lang/Object;)Z
        //   319: pop
        //   320: aload 14
        //   322: iconst_4
        //   323: invokevirtual 143	ir/eitaa/SQLite/SQLiteCursor:byteBufferValue	(I)Lir/eitaa/tgnet/NativeByteBuffer;
        //   326: astore 17
        //   328: aload 17
        //   330: ifnull +290 -> 620
        //   333: aload 17
        //   335: aload 17
        //   337: iconst_0
        //   338: invokevirtual 149	ir/eitaa/tgnet/NativeByteBuffer:readInt32	(Z)I
        //   341: iconst_0
        //   342: invokestatic 155	ir/eitaa/tgnet/TLRPC$Message:TLdeserialize	(Lir/eitaa/tgnet/AbstractSerializedData;IZ)Lir/eitaa/tgnet/TLRPC$Message;
        //   345: astore 16
        //   347: aload 17
        //   349: invokevirtual 158	ir/eitaa/tgnet/NativeByteBuffer:reuse	()V
        //   352: aload 16
        //   354: ifnull +266 -> 620
        //   357: aload 16
        //   359: aload 14
        //   361: iconst_5
        //   362: invokevirtual 101	ir/eitaa/SQLite/SQLiteCursor:intValue	(I)I
        //   365: invokestatic 164	ir/eitaa/messenger/MessageObject:setUnreadFlags	(Lir/eitaa/tgnet/TLRPC$Message;I)V
        //   368: aload 16
        //   370: aload 14
        //   372: bipush 6
        //   374: invokevirtual 101	ir/eitaa/SQLite/SQLiteCursor:intValue	(I)I
        //   377: putfield 166	ir/eitaa/tgnet/TLRPC$Message:id	I
        //   380: aload 14
        //   382: bipush 9
        //   384: invokevirtual 101	ir/eitaa/SQLite/SQLiteCursor:intValue	(I)I
        //   387: istore_1
        //   388: iload_1
        //   389: ifeq +9 -> 398
        //   392: aload 15
        //   394: iload_1
        //   395: putfield 110	ir/eitaa/tgnet/TLRPC$TL_dialog:last_message_date	I
        //   398: aload 16
        //   400: aload 14
        //   402: bipush 7
        //   404: invokevirtual 101	ir/eitaa/SQLite/SQLiteCursor:intValue	(I)I
        //   407: putfield 169	ir/eitaa/tgnet/TLRPC$Message:send_state	I
        //   410: aload 16
        //   412: aload 15
        //   414: getfield 97	ir/eitaa/tgnet/TLRPC$TL_dialog:id	J
        //   417: putfield 172	ir/eitaa/tgnet/TLRPC$Message:dialog_id	J
        //   420: aload 7
        //   422: getfield 175	ir/eitaa/tgnet/TLRPC$messages_Dialogs:messages	Ljava/util/ArrayList;
        //   425: aload 16
        ...
        //   433: aload 9
        //   435: aload 10
        //   437: invokestatic 179	ir/eitaa/messenger/MessagesStorage:addUsersAndChatsFromMessage	(Lir/eitaa/tgnet/TLRPC$Message;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
        //   440: aload 16
        //   442: getfield 182	ir/eitaa/tgnet/TLRPC$Message:reply_to_msg_id	I
        //   445: ifeq +175 -> 620
        //   448: aload 16
        //   450: getfield 186	ir/eitaa/tgnet/TLRPC$Message:action	Lir/eitaa/tgnet/TLRPC$MessageAction;
        //   453: instanceof 188
        //   456: ifne +14 -> 470
        //   459: aload 16
        //   461: getfield 186	ir/eitaa/tgnet/TLRPC$Message:action	Lir/eitaa/tgnet/TLRPC$MessageAction;
        //   464: instanceof 190
        //   467: ifeq +153 -> 620
        //   470: aload 14
        //   472: bipush 13
        //   474: invokevirtual 194	ir/eitaa/SQLite/SQLiteCursor:isNull	(I)Z
        //   477: ifne +59 -> 536
        //   480: aload 14
        //   482: bipush 13
        //   484: invokevirtual 143	ir/eitaa/SQLite/SQLiteCursor:byteBufferValue	(I)Lir/eitaa/tgnet/NativeByteBuffer;
        //   487: astore 17
        //   489: aload 17
        //   491: ifnull +45 -> 536
        //   494: aload 16
        ...
        //   498: aload 17
        //   500: iconst_0
        //   501: invokevirtual 149	ir/eitaa/tgnet/NativeByteBuffer:readInt32	(Z)I
        //   504: iconst_0
        //   505: invokestatic 155	ir/eitaa/tgnet/TLRPC$Message:TLdeserialize	(Lir/eitaa/tgnet/AbstractSerializedData;IZ)Lir/eitaa/tgnet/TLRPC$Message;
        //   508: putfield 198	ir/eitaa/tgnet/TLRPC$Message:replyMessage	Lir/eitaa/tgnet/TLRPC$Message;
        //   511: aload 17
        //   513: invokevirtual 158	ir/eitaa/tgnet/NativeByteBuffer:reuse	()V
        //   516: aload 16
        //   518: getfield 198	ir/eitaa/tgnet/TLRPC$Message:replyMessage	Lir/eitaa/tgnet/TLRPC$Message;
        //   521: ifnull +15 -> 536
        //   524: aload 16
        //   526: getfield 198	ir/eitaa/tgnet/TLRPC$Message:replyMessage	Lir/eitaa/tgnet/TLRPC$Message;
        //   529: aload 9
        //   531: aload 10
        //   533: invokestatic 179	ir/eitaa/messenger/MessagesStorage:addUsersAndChatsFromMessage	(Lir/eitaa/tgnet/TLRPC$Message;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
        //   536: aload 16
        //   538: getfield 198	ir/eitaa/tgnet/TLRPC$Message:replyMessage	Lir/eitaa/tgnet/TLRPC$Message;
        //   541: ifnonnull +79 -> 620
        //   544: aload 16
        //   546: getfield 182	ir/eitaa/tgnet/TLRPC$Message:reply_to_msg_id	I
        //   549: i2l
        //   550: lstore 5
        //   552: lload 5
        //   554: lstore_3
        //   555: aload 16
        //   557: getfield 202	ir/eitaa/tgnet/TLRPC$Message:to_id	Lir/eitaa/tgnet/TLRPC$Peer;
        //   560: getfield 207	ir/eitaa/tgnet/TLRPC$Peer:channel_id	I
        //   563: ifeq +19 -> 582
        //   566: lload 5
        //   568: aload 16
        //   570: getfield 202	ir/eitaa/tgnet/TLRPC$Message:to_id	Lir/eitaa/tgnet/TLRPC$Peer;
        //   573: getfield 207	ir/eitaa/tgnet/TLRPC$Peer:channel_id	I
        //   576: i2l
        //   577: bipush 32
        //   579: lshl
        //   580: lor
        ...
        //   604: aload 12
        //   606: aload 15
        //   608: getfield 97	ir/eitaa/tgnet/TLRPC$TL_dialog:id	J
        ...
        //   619: pop
        //   620: aload 15
        //   622: getfield 97	ir/eitaa/tgnet/TLRPC$TL_dialog:id	J
        //   625: l2i
        //   626: istore_1
        //   627: aload 15
        //   629: getfield 97	ir/eitaa/tgnet/TLRPC$TL_dialog:id	J
        //   632: bipush 32
        //   634: lshr
        //   635: l2i
        //   636: istore_2
        ...
        //   671: astore 9
        //   673: aload 7
        //   675: getfield 139	ir/eitaa/tgnet/TLRPC$messages_Dialogs:dialogs	Ljava/util/ArrayList;
        //   678: invokevirtual 222	java/util/ArrayList:clear	()V
        //   681: aload 7
        //   683: getfield 225	ir/eitaa/tgnet/TLRPC$messages_Dialogs:users	Ljava/util/ArrayList;
        //   686: invokevirtual 222	java/util/ArrayList:clear	()V
        //   689: aload 7
        //   691: getfield 228	ir/eitaa/tgnet/TLRPC$messages_Dialogs:chats	Ljava/util/ArrayList;
        //   694: invokevirtual 222	java/util/ArrayList:clear	()V
        //   697: aload 8
        //   699: invokevirtual 222	java/util/ArrayList:clear	()V
        //   702: ldc -26
        //   704: aload 9
        //   706: invokestatic 236	ir/eitaa/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
        //   709: invokestatic 242	ir/eitaa/messenger/MessagesController:getInstance	()Lir/eitaa/messenger/MessagesController;
        //   712: aload 7
        //   714: aload 8
        //   716: iconst_0
        //   717: bipush 100
        ...
        //   720: iconst_1
        //   721: iconst_0
        //   722: invokevirtual 246	ir/eitaa/messenger/MessagesController:processLoadedDialogs	(Lir/eitaa/tgnet/TLRPC$messages_Dialogs;Ljava/util/ArrayList;IIIZZ)V
        //   725: return
        //   726: iconst_1
        //   727: istore_1
        //   728: goto -512 -> 216
        ...
        //   733: ldc -26
        //   735: aload 16
        //   737: invokestatic 236	ir/eitaa/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
        //   740: goto -120 -> 620
        //   743: iload_1
        //   744: ifle +28 -> 772
        //   747: aload 9
        ...
        //   821: goto -698 -> 123
        //   824: aload 14
        //   826: invokevirtual 249	ir/eitaa/SQLite/SQLiteCursor:dispose	()V
        //   829: aload 13
        //   831: invokevirtual 252	java/util/ArrayList:isEmpty	()Z
        //   834: ifne +172 -> 1006
        //   837: aload_0
        //   838: getfield 20	ir/eitaa/messenger/MessagesStorage$77:this$0	Lir/eitaa/messenger/MessagesStorage;
        //   841: invokestatic 60	ir/eitaa/messenger/MessagesStorage:access$000	(Lir/eitaa/messenger/MessagesStorage;)Lir/eitaa/SQLite/SQLiteDatabase;
        ...
        //   871: invokevirtual 80	ir/eitaa/SQLite/SQLiteDatabase:queryFinalized	(Ljava/lang/String;[Ljava/lang/Object;)Lir/eitaa/SQLite/SQLiteCursor;
        //   874: astore 13
        //   876: aload 13
        //   878: invokevirtual 86	ir/eitaa/SQLite/SQLiteCursor:next	()Z
        //   881: ifeq +120 -> 1001
        //   884: aload 13
        //   886: iconst_0
        //   887: invokevirtual 143	ir/eitaa/SQLite/SQLiteCursor:byteBufferValue	(I)Lir/eitaa/tgnet/NativeByteBuffer;
        //   890: astore 15
        //   892: aload 15
        //   894: ifnull -18 -> 876
        //   897: aload 15
        //   899: aload 15
        //   901: iconst_0
        //   902: invokevirtual 149	ir/eitaa/tgnet/NativeByteBuffer:readInt32	(Z)I
        //   905: iconst_0
        //   906: invokestatic 155	ir/eitaa/tgnet/TLRPC$Message:TLdeserialize	(Lir/eitaa/tgnet/AbstractSerializedData;IZ)Lir/eitaa/tgnet/TLRPC$Message;
        //   909: astore 14
        //   911: aload 15
        //   913: invokevirtual 158	ir/eitaa/tgnet/NativeByteBuffer:reuse	()V
        //   916: aload 14
        //   918: aload 13
        //   920: iconst_1
        //   921: invokevirtual 101	ir/eitaa/SQLite/SQLiteCursor:intValue	(I)I
        //   924: putfield 166	ir/eitaa/tgnet/TLRPC$Message:id	I
        //   927: aload 14
        //   929: aload 13
        //   931: iconst_2
        //   932: invokevirtual 101	ir/eitaa/SQLite/SQLiteCursor:intValue	(I)I
        //   935: putfield 265	ir/eitaa/tgnet/TLRPC$Message:date	I
        //   938: aload 14
        //   940: aload 13
        //   942: iconst_3
        //   943: invokevirtual 93	ir/eitaa/SQLite/SQLiteCursor:longValue	(I)J
        //   946: putfield 172	ir/eitaa/tgnet/TLRPC$Message:dialog_id	J
        //   949: aload 14
        //   951: aload 9
        //   953: aload 10
        //   955: invokestatic 179	ir/eitaa/messenger/MessagesStorage:addUsersAndChatsFromMessage	(Lir/eitaa/tgnet/TLRPC$Message;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
        //   958: aload 12
        //   960: aload 14
        //   962: getfield 172	ir/eitaa/tgnet/TLRPC$Message:dialog_id	J
        ...
        //   971: checkcast 151	ir/eitaa/tgnet/TLRPC$Message
        //   974: astore 15
        //   976: aload 15
        //   978: ifnull -102 -> 876
        //   981: aload 15
        //   983: aload 14
        //   985: putfield 198	ir/eitaa/tgnet/TLRPC$Message:replyMessage	Lir/eitaa/tgnet/TLRPC$Message;
        //   988: aload 14
        //   990: aload 15
        //   992: getfield 172	ir/eitaa/tgnet/TLRPC$Message:dialog_id	J
        //   995: putfield 172	ir/eitaa/tgnet/TLRPC$Message:dialog_id	J
        //   998: goto -122 -> 876
        //   1001: aload 13
        //   1003: invokevirtual 249	ir/eitaa/SQLite/SQLiteCursor:dispose	()V
        //   1006: aload 11
        //   1008: invokevirtual 252	java/util/ArrayList:isEmpty	()Z
        //   1011: ifne +22 -> 1033
        //   1014: aload_0
        //   1015: getfield 20	ir/eitaa/messenger/MessagesStorage$77:this$0	Lir/eitaa/messenger/MessagesStorage;
        //   1018: ldc_w 256
        //   1021: aload 11
        //   1023: invokestatic 262	android/text/TextUtils:join	(Ljava/lang/CharSequence;Ljava/lang/Iterable;)Ljava/lang/String;
        //   1026: aload 8
        //   1028: aload 9
        //   1030: invokevirtual 273	ir/eitaa/messenger/MessagesStorage:getEncryptedChatsInternal	(Ljava/lang/String;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
        //   1033: aload 10
        //   1035: invokevirtual 252	java/util/ArrayList:isEmpty	()Z
        //   1038: ifne +23 -> 1061
        //   1041: aload_0
        //   1042: getfield 20	ir/eitaa/messenger/MessagesStorage$77:this$0	Lir/eitaa/messenger/MessagesStorage;
        //   1045: ldc_w 256
        //   1048: aload 10
        //   1050: invokestatic 262	android/text/TextUtils:join	(Ljava/lang/CharSequence;Ljava/lang/Iterable;)Ljava/lang/String;
        //   1053: aload 7
        //   1055: getfield 228	ir/eitaa/tgnet/TLRPC$messages_Dialogs:chats	Ljava/util/ArrayList;
        //   1058: invokevirtual 277	ir/eitaa/messenger/MessagesStorage:getChatsInternal	(Ljava/lang/String;Ljava/util/ArrayList;)V
        //   1061: aload 9
        //   1063: invokevirtual 252	java/util/ArrayList:isEmpty	()Z
        //   1066: ifne +23 -> 1089
        //   1069: aload_0
        //   1070: getfield 20	ir/eitaa/messenger/MessagesStorage$77:this$0	Lir/eitaa/messenger/MessagesStorage;
        //   1073: ldc_w 256
        //   1076: aload 9
        //   1078: invokestatic 262	android/text/TextUtils:join	(Ljava/lang/CharSequence;Ljava/lang/Iterable;)Ljava/lang/String;
        //   1081: aload 7
        //   1083: getfield 225	ir/eitaa/tgnet/TLRPC$messages_Dialogs:users	Ljava/util/ArrayList;
        //   1086: invokevirtual 280	ir/eitaa/messenger/MessagesStorage:getUsersInternal	(Ljava/lang/String;Ljava/util/ArrayList;)V
        //   1089: invokestatic 242	ir/eitaa/messenger/MessagesController:getInstance	()Lir/eitaa/messenger/MessagesController;
        //   1092: aload 7
        //   1094: aload 8
        //   1096: aload_0
        //   1097: getfield 22	ir/eitaa/messenger/MessagesStorage$77:val$offset	I
        //   1100: aload_0
        //   1101: getfield 24	ir/eitaa/messenger/MessagesStorage$77:val$count	I
        //   1104: iconst_1
        //   1105: iconst_0
        //   1106: iconst_0
        //   1107: invokevirtual 246	ir/eitaa/messenger/MessagesController:processLoadedDialogs	(Lir/eitaa/tgnet/TLRPC$messages_Dialogs;Ljava/util/ArrayList;IIIZZ)V
        //   1110: return
        //   1111: iconst_0
        //   1112: istore_1
        //   1113: goto -897 -> 216
    ...
    throws Exception
  {
    ...
    paramString = this.database.queryFinalized(String.format(Locale.US, "SELECT data, user, g, authkey, ttl, layer, seq_in, seq_out, use_count, exchange_id, key_date, fprint, fauthkey, khash, in_seq_no FROM enc_chats WHERE uid IN(%s)", new Object[] { paramString }), new Object[0]);
    while (paramString.next()) {
      try
      {
        NativeByteBuffer localNativeByteBuffer = paramString.byteBufferValue(0);
  ...
  public TLObject getSentFile(final String paramString, final int paramInt)
  {
    ...
    this.storageQueue.postRunnable(new Runnable()
    {
      ...
      public void run()
      {
        // Byte code:
        //   0: aload_0
        //   1: getfield 27	ir/eitaa/messenger/MessagesStorage$48:val$path	Ljava/lang/String;
        //   4: invokestatic 46	ir/eitaa/messenger/Utilities:MD5	(Ljava/lang/String;)Ljava/lang/String;
        //   7: astore_1
        //   8: aload_1
        //   9: ifnull +102 -> 111
        //   12: aload_0
        //   13: getfield 25	ir/eitaa/messenger/MessagesStorage$48:this$0	Lir/eitaa/messenger/MessagesStorage;
        //   16: invokestatic 50	ir/eitaa/messenger/MessagesStorage:access$000	(Lir/eitaa/messenger/MessagesStorage;)Lir/eitaa/SQLite/SQLiteDatabase;
        ...
        //   33: iconst_1
        //   34: aload_0
        //   35: getfield 29	ir/eitaa/messenger/MessagesStorage$48:val$type	I
        ...
        //   49: invokevirtual 76	ir/eitaa/SQLite/SQLiteDatabase:queryFinalized	(Ljava/lang/String;[Ljava/lang/Object;)Lir/eitaa/SQLite/SQLiteCursor;
        //   52: astore_1
        //   53: aload_1
        //   54: invokevirtual 82	ir/eitaa/SQLite/SQLiteCursor:next	()Z
        //   57: ifeq +50 -> 107
        //   60: aload_1
        //   61: iconst_0
        //   62: invokevirtual 86	ir/eitaa/SQLite/SQLiteCursor:byteBufferValue	(I)Lir/eitaa/tgnet/NativeByteBuffer;
        //   65: astore_2
        //   66: aload_2
        //   67: ifnull +40 -> 107
        //   70: aload_2
        //   71: aload_2
        //   72: iconst_0
        //   73: invokevirtual 92	ir/eitaa/tgnet/NativeByteBuffer:readInt32	(Z)I
        //   76: iconst_0
        //   77: invokestatic 98	ir/eitaa/tgnet/TLRPC$MessageMedia:TLdeserialize	(Lir/eitaa/tgnet/AbstractSerializedData;IZ)Lir/eitaa/tgnet/TLRPC$MessageMedia;
        //   80: astore_3
        //   81: aload_2
        //   82: invokevirtual 101	ir/eitaa/tgnet/NativeByteBuffer:reuse	()V
        //   85: aload_3
        //   86: instanceof 103
        //   89: ifeq +30 -> 119
        //   92: aload_0
        //   93: getfield 31	ir/eitaa/messenger/MessagesStorage$48:val$result	Ljava/util/ArrayList;
        //   96: aload_3
        //   97: checkcast 103	ir/eitaa/tgnet/TLRPC$TL_messageMediaDocument
        //   100: getfield 107	ir/eitaa/tgnet/TLRPC$TL_messageMediaDocument:document	Lir/eitaa/tgnet/TLRPC$Document;
        //   103: invokevirtual 113	java/util/ArrayList:add	(Ljava/lang/Object;)Z
        //   106: pop
        //   107: aload_1
        //   108: invokevirtual 116	ir/eitaa/SQLite/SQLiteCursor:dispose	()V
        //   111: aload_0
        //   112: getfield 33	ir/eitaa/messenger/MessagesStorage$48:val$semaphore	Ljava/util/concurrent/Semaphore;
        ...
        //   123: ifeq -16 -> 107
        //   126: aload_0
        //   127: getfield 31	ir/eitaa/messenger/MessagesStorage$48:val$result	Ljava/util/ArrayList;
        //   130: aload_3
        //   131: checkcast 123	ir/eitaa/tgnet/TLRPC$TL_messageMediaPhoto
        //   134: getfield 127	ir/eitaa/tgnet/TLRPC$TL_messageMediaPhoto:photo	Lir/eitaa/tgnet/TLRPC$Photo;
        ...
        //   145: ldc -127
        //   147: aload_1
        //   148: invokestatic 135	ir/eitaa/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
        //   151: aload_0
        //   152: getfield 33	ir/eitaa/messenger/MessagesStorage$48:val$semaphore	Ljava/util/concurrent/Semaphore;
        //   155: invokevirtual 121	java/util/concurrent/Semaphore:release	()V
        //   158: return
        //   159: astore_1
        //   160: aload_0
        //   161: getfield 33	ir/eitaa/messenger/MessagesStorage$48:val$semaphore	Ljava/util/concurrent/Semaphore;
      ...
      public void run()
      {
        ...
        for (;;)
        {
          try
          {
            ...
            localSQLitePreparedStatement1 = localSQLitePreparedStatement2;
            localObject1 = localNativeByteBuffer1;
            localSQLitePreparedStatement2 = MessagesStorage.this.database.executeFast("UPDATE enc_chats SET data = ?, g = ?, authkey = ?, ttl = ?, layer = ?, seq_in = ?, seq_out = ?, use_count = ?, exchange_id = ?, key_date = ?, fprint = ?, fauthkey = ?, khash = ?, in_seq_no = ? WHERE uid = ?");
            localSQLitePreparedStatement1 = localSQLitePreparedStatement2;
            localObject1 = localSQLitePreparedStatement2;
            ...
            if (paramEncryptedChat.a_or_b != null)
            {
              ...
              localSQLitePreparedStatement1 = localSQLitePreparedStatement2;
              localObject1 = localSQLitePreparedStatement2;
              localSQLitePreparedStatement2.bindInteger(15, paramEncryptedChat.id);
              localSQLitePreparedStatement1 = localSQLitePreparedStatement2;
              localObject1 = localSQLitePreparedStatement2;
              localSQLitePreparedStatement2.step();
              localSQLitePreparedStatement1 = localSQLitePreparedStatement2;
    ...
    this.storageQueue.postRunnable(new Runnable()
    {
      public void run()
      {
        ...
        try
        {
          ...
          localObject1 = localSQLitePreparedStatement;
          localObject3 = localSQLitePreparedStatement;
          localSQLitePreparedStatement.bindInteger(5, paramEncryptedChat.id);
          localObject1 = localSQLitePreparedStatement;
          localObject3 = localSQLitePreparedStatement;
          localSQLitePreparedStatement.step();
          if (localSQLitePreparedStatement != null) {
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/messenger/MessagesStorage.class
