...
public class PhoneFormat
{
  ...
  public void init(String paramString)
  {
    ...
    //   12: aload 7
    //   14: astore 5
    //   16: getstatic 266	ir/eitaa/messenger/ApplicationLoader:applicationContext	Landroid/content/Context;
    ...
    //   126: putfield 108	ir/eitaa/PhoneFormat/PhoneFormat:data	[B
    //   129: aload_0
    //   130: aload_0
    //   131: getfield 108	ir/eitaa/PhoneFormat/PhoneFormat:data	[B
    //   134: invokestatic 310	java/nio/ByteBuffer:wrap	([B)Ljava/nio/ByteBuffer;
    //   137: putfield 312	ir/eitaa/PhoneFormat/PhoneFormat:buffer	Ljava/nio/ByteBuffer;
    //   140: aload_0
    //   141: getfield 312	ir/eitaa/PhoneFormat/PhoneFormat:buffer	Ljava/nio/ByteBuffer;
    ...
    //   180: aload_0
    //   181: aload_1
    //   182: putfield 232	ir/eitaa/PhoneFormat/PhoneFormat:defaultCountry	Ljava/lang/String;
    //   185: aload_0
    //   186: new 92	java/util/HashMap
    //   189: dup
    //   190: sipush 255
    //   193: invokespecial 323	java/util/HashMap:<init>	(I)V
    //   196: putfield 104	ir/eitaa/PhoneFormat/PhoneFormat:callingCodeOffsets	Ljava/util/HashMap;
    //   199: aload_0
    //   200: new 92	java/util/HashMap
    //   203: dup
    //   204: sipush 255
    //   207: invokespecial 323	java/util/HashMap:<init>	(I)V
    //   210: putfield 117	ir/eitaa/PhoneFormat/PhoneFormat:callingCodeCountries	Ljava/util/HashMap;
    //   213: aload_0
    //   214: new 92	java/util/HashMap
    //   217: dup
    //   218: bipush 10
    //   220: invokespecial 323	java/util/HashMap:<init>	(I)V
    //   223: putfield 100	ir/eitaa/PhoneFormat/PhoneFormat:callingCodeData	Ljava/util/HashMap;
    //   226: aload_0
    //   227: new 92	java/util/HashMap
    //   230: dup
    //   231: sipush 255
    //   234: invokespecial 323	java/util/HashMap:<init>	(I)V
    //   237: putfield 87	ir/eitaa/PhoneFormat/PhoneFormat:countryCallingCode	Ljava/util/HashMap;
    //   240: aload_0
    //   241: invokevirtual 326	ir/eitaa/PhoneFormat/PhoneFormat:parseDataHeader	()V
    //   244: aload_0
    //   245: iconst_1
    //   246: putfield 34	ir/eitaa/PhoneFormat/PhoneFormat:initialzed	Z
    //   249: return
    //   250: astore 4
    //   252: ldc -2
    //   254: aload 4
    //   256: invokestatic 260	ir/eitaa/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   259: goto -98 -> 161
    //   262: astore_3
    //   263: ldc -2
    //   265: aload_3
    //   266: invokestatic 260	ir/eitaa/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   269: goto -100 -> 169
    //   272: astore_1
    //   273: ldc -2
    //   275: aload_1
    //   276: invokestatic 260	ir/eitaa/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   279: goto -168 -> 111
    //   282: astore_1
    //   283: ldc -2
    //   285: aload_1
    //   286: invokestatic 260	ir/eitaa/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   289: return
    //   290: astore_1
    //   291: aload 4
    //   293: astore_3
    ...
    //   316: ldc -2
    //   318: aload 4
    //   320: invokestatic 260	ir/eitaa/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   323: goto -19 -> 304
    //   326: astore_3
    //   327: ldc -2
    //   329: aload_3
    //   330: invokestatic 260	ir/eitaa/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   333: goto -21 -> 312
    //   336: aload_0
    ...
    //   346: putfield 232	ir/eitaa/PhoneFormat/PhoneFormat:defaultCountry	Ljava/lang/String;
    //   349: goto -164 -> 185
    //   352: astore_1
    //   353: aload 7
    //   355: astore 5
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/PhoneFormat/PhoneFormat.class
