      ...
      for (paramInt = 5;; paramInt = 3)
      {
        ...
        this.problemText.setOnClickListener(new View.OnClickListener()
        {
          public void onClick(View paramAnonymousView)
          {
            ...
            {
              CancelAccountDeletionActivity.this.needShowAlert(LocaleController.getString("NoMailInstalled", 2131165938));
            }
          }
        });
        return;
                ...
                do
                {
                  for (;;)
                  {
                    ...
                    if (CancelAccountDeletionActivity.LoginActivitySmsView.this.nextType == 2) {
                      CancelAccountDeletionActivity.LoginActivitySmsView.this.timeText.setText(LocaleController.formatString("SmsText", 2131166303, new Object[] { Integer.valueOf(i), Integer.valueOf(j) }));
                    }
                  }
                  if (CancelAccountDeletionActivity.LoginActivitySmsView.this.progressView != null) {
              ...
              for (;;)
              {
                ...
                if (paramAnonymousTL_error.text != null) {
                  if (paramAnonymousTL_error.text.contains("PHONE_CODE_EXPIRED")) {
                    ...
                    CancelAccountDeletionActivity.this.needShowAlert(LocaleController.getString("FloodWait", 2131165642));
                  } else if (paramAnonymousTL_error.code != 64536) {
                    CancelAccountDeletionActivity.this.needShowAlert(LocaleController.getString("ErrorOccurred", 2131165629) + "\n" + paramAnonymousTL_error.text);
                  }
                }
              }
            }
            ...
            AndroidUtilities.runOnUIThread(new Runnable()
            {
              public void run()
              {
                ...
                for (;;)
                {
                  ...
                  CancelAccountDeletionActivity.this.needShowAlert(LocaleController.getString("InvalidCode", 2131165757));
                  return;
                  if (CancelAccountDeletionActivity.LoginActivitySmsView.this.currentType == 3)
                  {
          ...
          public void run(final TLObject paramAnonymousTLObject, final TLRPC.TL_error paramAnonymousTL_error)
          {
            AndroidUtilities.runOnUIThread(new Runnable()
            {
              public void run()
              {
                ...
                if (paramAnonymousTL_error.text.startsWith("FLOOD_WAIT"))
                {
                  CancelAccountDeletionActivity.access$602(CancelAccountDeletionActivity.this, CancelAccountDeletionActivity.this.needShowAlert(LocaleController.getString("FloodWait", 2131165642)));
                  return;
                }
                CancelAccountDeletionActivity.access$602(CancelAccountDeletionActivity.this, CancelAccountDeletionActivity.this.needShowAlert(LocaleController.getString("ErrorOccurred", 2131165629)));
              }
            });
          }
        }, 2);
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/CancelAccountDeletionActivity.class
