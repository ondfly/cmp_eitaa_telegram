...
import ir.eitaa.tgnet.TLRPC.TL_account_getAuthorizations;
import ir.eitaa.tgnet.TLRPC.TL_account_resetAuthorization;
import ir.eitaa.tgnet.TLRPC.TL_auth_resetAuthorizations;
  ...
  implements NotificationCenter.NotificationCenterDelegate
{
  ...
  public View createView(Context paramContext)
  {
    ...
    this.actionBar.setTitle(LocaleController.getString("SessionsTitle", 2131166261));
    ...
    this.emptyLayout.setBackgroundResource(2130837695);
    ...
    ((ImageView)localObject2).setImageResource(2130837641);
    ...
    ((TextView)localObject2).setText(LocaleController.getString("NoOtherSessions", 2131165944));
    this.emptyLayout.addView((View)localObject2);
    ...
    ((TextView)localObject2).setText(LocaleController.getString("NoOtherSessionsInfo", 2131165945));
    this.emptyLayout.addView((View)localObject2);
    localObject3 = (LinearLayout.LayoutParams)((TextView)localObject2).getLayoutParams();
    ...
    paramContext.setOnItemClickListener(new AdapterView.OnItemClickListener()
    {
      public void onItemClick(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, final int paramAnonymousInt, long paramAnonymousLong)
      {
                  ...
                  AndroidUtilities.runOnUIThread(new Runnable()
                  {
                    public void run()
                    {
                      ...
                      if ((paramAnonymous3TL_error == null) && ((paramAnonymous3TLObject instanceof TLRPC.TL_boolTrue))) {
                        Toast.makeText(SessionsActivity.this.getParentActivity(), LocaleController.getString("TerminateAllSessions", 2131166331), 0).show();
                      }
                      for (;;)
                      {
                        SessionsActivity.this.finishFragment();
                        return;
                        Toast.makeText(SessionsActivity.this.getParentActivity(), LocaleController.getString("UnknownError", 2131166355), 0).show();
                      }
                    }
                  });
        ...
        paramAnonymousAdapterView = new AlertDialog.Builder(SessionsActivity.this.getParentActivity());
        paramAnonymousAdapterView.setMessage(LocaleController.getString("TerminateSessionQuestion", 2131166333));
        paramAnonymousAdapterView.setTitle(LocaleController.getString("AppName", 2131165299));
        paramAnonymousAdapterView.setPositiveButton(LocaleController.getString("OK", 2131166047), new DialogInterface.OnClickListener()
        {
    ...
    public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
    {
      ...
      if (i == 0)
      {
        ...
        if (paramInt == SessionsActivity.this.terminateAllSessionsRow)
        {
          ...
          paramView.setText(LocaleController.getString("TerminateAllSessions", 2131166331), false);
          paramViewGroup = (ViewGroup)localObject;
        }
      }
      for (;;)
      {
        ...
        if (i == 1)
        {
          ...
          else
          {
            ...
            {
              ((TextInfoPrivacyCell)localObject).setText(LocaleController.getString("TerminateSessionInfo", 2131166332));
        ...
        else if (i == 2)
        {
          ...
          else
          {
            ...
            {
              ((HeaderCell)localObject).setText(LocaleController.getString("OtherSessions", 2131166063));
              paramViewGroup = (ViewGroup)localObject;
            }
          }
        }
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/SessionsActivity.class
