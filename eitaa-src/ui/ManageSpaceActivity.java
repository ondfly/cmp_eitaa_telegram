  ...
  implements ActionBarLayout.ActionBarLayoutDelegate
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    if (AndroidUtilities.isTablet())
    {
      ...
      BitmapDrawable localBitmapDrawable = (BitmapDrawable)getResources().getDrawable(2130837591);
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/ManageSpaceActivity.class
