  ...
  extends FrameLayout
{
  ...
  public TextView addSubItem(int paramInt1, String paramString, int paramInt2)
  {
    ...
    localTextView.setBackgroundResource(2130837798);
  ...
  public ActionBarMenuItem setIsSearchField(boolean paramBoolean)
  {
    ...
    try
    {
      ...
      ((Field)localObject).set(this.searchField, Integer.valueOf(2130837969));
      ...
      this.clearButton.setImageResource(2130837722);
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/ActionBar/ActionBarMenuItem.class
