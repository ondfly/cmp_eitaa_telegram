    ...
    extends FrameLayout
  {
    ...
    public ActionBarPopupWindowLayout(Context paramContext)
    {
      ...
      if (backgroundDrawable == null) {
        backgroundDrawable = getResources().getDrawable(2130837945);
      }
    ...
    protected void onDraw(Canvas paramCanvas)
    {
      ...
      for (;;)
      {
        backgroundDrawable.draw(paramCanvas);
        return;
        label66:
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/ActionBar/ActionBarPopupWindow.class
