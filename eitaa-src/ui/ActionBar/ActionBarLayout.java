  ...
  extends FrameLayout
{
  ...
  public ActionBarLayout(Context paramContext)
  {
    ...
    {
      layerShadowDrawable = getResources().getDrawable(2130837789);
      headerShadowDrawable = getResources().getDrawable(2130837699);
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/ActionBar/ActionBarLayout.class
