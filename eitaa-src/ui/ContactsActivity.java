  ...
  implements NotificationCenter.NotificationCenterDelegate
{
          ...
          if (this.needForwardCount)
          {
            ...
            paramString.addTextChangedListener(new TextWatcher()
            {
              public void afterTextChanged(Editable paramAnonymousEditable)
              {
                ...
                {
                  FileLog.e("TSMS", paramAnonymousEditable);
                  return;
                }
  ...
  public View createView(Context paramContext)
  {
    ...
    if (this.destroyAfterSelect) {
      ...
      {
        this.actionBar.setTitle(LocaleController.getString("SelectContact", 2131166234));
        ...
        ((ActionBarMenu)localObject1).addItem(0, 2130837716).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener()
        {
          public void onSearchCollapse()
          {
            ...
            ContactsActivity.this.emptyTextView.setText(LocaleController.getString("NoContacts", 2131165935));
          }
          ...
          public void onTextChanged(EditText paramAnonymousEditText)
          {
            ...
            if (paramAnonymousEditText.length() != 0)
            {
              ...
              if (ContactsActivity.this.emptyTextView != null) {
                ContactsActivity.this.emptyTextView.setText(LocaleController.getString("NoResult", 2131165952));
              }
            }
    ...
    for (int i = 1;; i = 2)
    {
      ...
      this.listView.setOnItemClickListener(new AdapterView.OnItemClickListener()
      {
        public void onItemClick(final AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
        {
              ...
              do
              {
                do
                {
                  ...
                  do
                  {
                    do
                    {
                      do
                      {
                        ...
                        try
                        {
                          ...
                          ContactsActivity.this.getParentActivity().startActivityForResult(Intent.createChooser(paramAnonymousAdapterView, LocaleController.getString("InviteFriends", 2131165764)), 500);
                          return;
                        }
                    ...
                    return;
                  } while ((paramAnonymousInt != 1) || (!MessagesController.isFeatureEnabled("broadcast_create", ContactsActivity.this)));
          ...
          paramAnonymousView.setMessage(LocaleController.getString("InviteUser", 2131165770));
          ...
          paramAnonymousView.setPositiveButton(LocaleController.getString("OK", 2131166047), new DialogInterface.OnClickListener()
          {
            public void onClick(DialogInterface paramAnonymous2DialogInterface, int paramAnonymous2Int)
            {
              try
              {
                ...
                paramAnonymous2DialogInterface.putExtra("sms_body", LocaleController.getString("InviteText", 2131165766));
      ...
      this.actionBar.setTitle(LocaleController.getString("NewMessageTitle", 2131165921));
      break;
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/ContactsActivity.class
