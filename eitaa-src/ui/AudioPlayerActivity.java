  ...
  implements NotificationCenter.NotificationCenterDelegate, MediaController.FileDownloadProgressListener
{
  ...
  private void updateRepeatButton()
  {
    ...
    do
    {
      ...
      if (i == 1)
      {
        this.repeatButton.setImageResource(2130837928);
        return;
      }
    } while (i != 2);
  ...
  private void updateShuffleButton()
  {
    ...
    {
      this.shuffleButton.setImageResource(2130837930);
      return;
    }
  ...
  private void updateTitle(boolean paramBoolean)
  {
    ...
    {
      this.playButton.setImageResource(2130837940);
    ...
    for (localObject1 = String.format("%d:%02d", new Object[] { Integer.valueOf(j / 60), Integer.valueOf(j % 60) });; localObject1 = "-:--")
    {
      ...
      break label122;
      this.placeholder.setImageResource(2130837856);
  ...
  public View createView(Context paramContext)
  {
    ...
    this.actionBar.setBackButtonImage(2130837917);
    ...
    ((View)localObject).setBackgroundResource(2130837700);
    ...
    this.prevButton.setImageResource(2130837941);
    ...
    this.nextButton.setImageResource(2130837938);
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/AudioPlayerActivity.class
