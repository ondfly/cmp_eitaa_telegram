  ...
  implements NotificationCenter.NotificationCenterDelegate, ContactsActivity.ContactsActivityDelegate
{
  ...
  public View createView(Context paramContext)
  {
    ...
    this.emptyTextView.setText(LocaleController.getString("NoBlocked", 2131165931));
    ...
    if (LocaleController.isRTL)
    {
      ...
      this.listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener()
      {
        public boolean onItemLongClick(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
        {
          ...
          paramAnonymousView = LocaleController.getString("Unblock", 2131166352);
    ...
    extends BaseFragmentAdapter
  {
    ...
    public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
    {
      ...
      ((TextInfoCell)paramView).setText(LocaleController.getString("UnblockText", 2131166353));
      return paramView;
    }
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/BlockedUsersActivity.class
