...
import ir.eitaa.ui.Cells.PhotoPickerAlbumsCell.PhotoPickerAlbumsCellDelegate;
import ir.eitaa.ui.Cells.PhotoPickerSearchCell;
import ir.eitaa.ui.Cells.PhotoPickerSearchCell.PhotoPickerSearchCellDelegate;
  ...
  implements NotificationCenter.NotificationCenterDelegate
{
  ...
  public View createView(Context paramContext)
  {
    ...
    this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick()
    {
      public void onItemClick(int paramAnonymousInt)
      {
        ...
        do
        {
          ...
          PhotoAlbumPickerActivity.this.dropDown.setText(LocaleController.getString("PickerPhotos", 2131166123));
          PhotoAlbumPickerActivity.this.emptyView.setText(LocaleController.getString("NoPhotos", 2131165946));
        ...
        PhotoAlbumPickerActivity.this.dropDown.setText(LocaleController.getString("PickerVideo", 2131166124));
        PhotoAlbumPickerActivity.this.emptyView.setText(LocaleController.getString("NoVideo", 2131165962));
        PhotoAlbumPickerActivity.this.listAdapter.notifyDataSetChanged();
      }
    });
    Object localObject = this.actionBar.createMenu();
    ((ActionBarMenu)localObject).addItem(1, 2130837713);
    ...
    if (!this.singlePhoto)
    {
      ...
      this.dropDownContainer.addSubItem(2, LocaleController.getString("PickerPhotos", 2131166123), 0);
      this.dropDownContainer.addSubItem(3, LocaleController.getString("PickerVideo", 2131166124), 0);
      ...
      if (AndroidUtilities.isTablet())
      {
        ...
        this.dropDown.setText(LocaleController.getString("PickerPhotos", 2131166123));
    ...
    for (;;)
    {
      ...
      break;
      this.actionBar.setTitle(LocaleController.getString("Gallery", 2131165715));
      break label458;
      label1126:
      this.progressView.setVisibility(8);
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/PhotoAlbumPickerActivity.class
