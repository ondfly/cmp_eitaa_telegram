...
import ir.eitaa.ui.Components.ChipSpan;
import ir.eitaa.ui.Components.LayoutHelper;
import ir.eitaa.ui.Components.LetterSectionsListView;
  ...
  implements NotificationCenter.NotificationCenterDelegate, AvatarUpdater.AvatarUpdaterDelegate
{
  ...
  private boolean checkUserName(final String paramString)
  {
    ...
    for (;;)
    {
      ...
      this.checkTextView.setText(LocaleController.getString("LinkInvalid", 2131165829));
    ...
    while (i < paramString.length())
    {
      ...
      if ((i == 0) && (j >= 48) && (j <= 57))
      {
        this.checkTextView.setText(LocaleController.getString("LinkInvalidStartNumber", 2131165833));
        this.checkTextView.setTextColor(-3198928);
        return false;
      }
    ...
    {
      this.checkTextView.setText(LocaleController.getString("LinkInvalidShort", 2131165831));
      this.checkTextView.setTextColor(-3198928);
      return false;
    }
    if (paramString.length() > 32)
    {
      this.checkTextView.setText(LocaleController.getString("LinkInvalidLong", 2131165830));
      this.checkTextView.setTextColor(-3198928);
      return false;
    }
    this.checkTextView.setText(LocaleController.getString("LinkChecking", 2131165825));
            ...
            AndroidUtilities.runOnUIThread(new Runnable()
            {
              public void run()
              {
                ...
                if ((ChannelCreateActivity.this.lastCheckName != null) && (ChannelCreateActivity.this.lastCheckName.equals(ChannelCreateActivity.19.this.val$name)))
                {
                  ...
                  {
                    ChannelCreateActivity.this.checkTextView.setText(LocaleController.formatString("LinkAvailable", 2131165824, new Object[] { ChannelCreateActivity.19.this.val$name }));
                ...
                for (;;)
                {
                  ...
                  return;
                  ChannelCreateActivity.this.checkTextView.setText(LocaleController.getString("LinkInUse", 2131165827));
                }
              }
            });
          }
      ...
      public void run(final TLObject paramAnonymousTLObject, final TLRPC.TL_error paramAnonymousTL_error)
      {
        AndroidUtilities.runOnUIThread(new Runnable()
        {
          public void run()
          {
            ...
            for (String str = ChannelCreateActivity.this.invite.link;; str = LocaleController.getString("Loading", 2131165837))
            {
              ...
              AdminedChannelCell localAdminedChannelCell = new AdminedChannelCell(ChannelCreateActivity.this.getParentActivity(), new View.OnClickListener()
              {
                public void onClick(final View paramAnonymous3View)
                {
                  ...
                  if (paramAnonymous3View.megagroup) {
                    localBuilder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("RevokeLinkAlert", 2131166197, new Object[] { "eitaa.com/" + paramAnonymous3View.username, paramAnonymous3View.title })));
                  }
                  for (;;)
                  {
                    localBuilder.setNegativeButton(LocaleController.getString("Cancel", 2131165386), null);
                    localBuilder.setPositiveButton(LocaleController.getString("RevokeButton", 2131166195), new DialogInterface.OnClickListener()
                    {
                    ...
                    return;
                    localBuilder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("RevokeLinkAlertChannel", 2131166198, new Object[] { "eitaa.com/" + paramAnonymous3View.username, paramAnonymous3View.title })));
                  }
                }
              });
  ...
  private void showErrorAlert(String paramString)
  {
    ...
    for (;;)
    {
      ...
      i = 2;
      break;
      localBuilder.setMessage(LocaleController.getString("LinkInvalid", 2131165829));
      continue;
      localBuilder.setMessage(LocaleController.getString("LinkInUse", 2131165827));
      continue;
      localBuilder.setMessage(LocaleController.getString("FeatureUnavailable", 2131165634));
    }
  }
  ...
  private void updatePrivatePublic()
  {
    ...
    if ((!this.isPrivate) && (!this.canCreatePublic))
    {
      ...
      if (this.loadingAdminedChannels)
      {
        ...
        this.typeInfoCell.setBackgroundResource(2130837695);
      ...
      for (;;)
      {
        ...
        return;
        this.typeInfoCell.setBackgroundResource(2130837694);
    ...
    label581:
    label591:
    for (Object localObject1 = this.invite.link;; localObject1 = LocaleController.getString("Loading", 2131165837))
    {
  ...
  public View createView(Context paramContext)
  {
    ...
    this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick()
    {
      public void onItemClick(final int paramAnonymousInt)
      {
        ...
        if (ChannelCreateActivity.this.avatarUpdater.uploadingAvatar != null)
        {
          ...
          ChannelCreateActivity.this.progressDialog.setMessage(LocaleController.getString("Loading", 2131165837));
    ...
    if (this.currentStep != 2)
    {
      ...
      this.actionBar.setTitle(LocaleController.getString("NewChannel", 2131165919));
      ...
      this.nameTextView.setHint(LocaleController.getString("EnterChannelName", 2131165622));
    ...
    do
    {
      ...
      if (this.currentStep == 1)
      {
        ...
        this.radioButtonCell1.setBackgroundResource(2130837798);
        ...
        if (!this.isPrivate)
        {
          ...
          this.radioButtonCell2.setBackgroundResource(2130837798);
          ...
          ((EditText)localObject1).setText("eitaa.com/");
          ...
          this.privateContainer.setBackgroundResource(2130837798);
          ...
          this.privateContainer.setOnClickListener(new View.OnClickListener()
          {
            public void onClick(View paramAnonymousView)
            {
              ...
              try
              {
                ...
                Toast.makeText(ChannelCreateActivity.this.getParentActivity(), LocaleController.getString("LinkCopied", 2131165826), 0).show();
                return;
              }
        ...
        for (i = 5;; i = 3)
        {
          ...
          this.adminedInfoCell.setBackgroundResource(2130837695);
    ...
    if (LocaleController.isRTL)
    {
      ...
      this.nameTextView.addTextChangedListener(new TextWatcher()
      {
        public void afterTextChanged(Editable paramAnonymousEditable)
        {
          ...
          for (;;)
          {
            if (i != 0)
            {
              ...
              if (ChannelCreateActivity.this.emptyTextView != null) {
                ChannelCreateActivity.this.emptyTextView.setText(LocaleController.getString("NoResult", 2131165952));
              }
          ...
          ChannelCreateActivity.this.emptyTextView.setText(LocaleController.getString("NoContacts", 2131165935));
        }
      ...
      this.emptyTextView.setText(LocaleController.getString("NoContacts", 2131165935));
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/ChannelCreateActivity.class
