...
import ir.eitaa.ui.Adapters.BaseLocationAdapter.BaseLocationAdapterDelegate;
import ir.eitaa.ui.Adapters.LocationActivityAdapter;
import ir.eitaa.ui.Adapters.LocationActivitySearchAdapter;
  ...
  implements NotificationCenter.NotificationCenterDelegate
{
  ...
  private void onMapInit()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 153	ir/eitaa/ui/LocationActivity:googleMap	Lcom/google/android/gms/maps/GoogleMap;
    //   4: ifnonnull +4 -> 8
    //   7: return
    //   8: aload_0
    //   9: getfield 159	ir/eitaa/ui/LocationActivity:messageObject	Lir/eitaa/messenger/MessageObject;
    //   12: ifnull +160 -> 172
    //   15: new 384	com/google/android/gms/maps/model/LatLng
    //   18: dup
    //   19: aload_0
    //   20: getfield 266	ir/eitaa/ui/LocationActivity:userLocation	Landroid/location/Location;
    //   23: invokevirtual 390	android/location/Location:getLatitude	()D
    //   26: aload_0
    //   27: getfield 266	ir/eitaa/ui/LocationActivity:userLocation	Landroid/location/Location;
    ...
    //   36: astore_1
    //   37: aload_0
    //   38: getfield 153	ir/eitaa/ui/LocationActivity:googleMap	Lcom/google/android/gms/maps/GoogleMap;
    ...
    //   65: aload_1
    //   66: aload_0
    //   67: getfield 153	ir/eitaa/ui/LocationActivity:googleMap	Lcom/google/android/gms/maps/GoogleMap;
    ...
    //   80: astore_1
    //   81: aload_0
    //   82: getfield 153	ir/eitaa/ui/LocationActivity:googleMap	Lcom/google/android/gms/maps/GoogleMap;
    //   85: aload_1
    //   86: invokevirtual 433	com/google/android/gms/maps/GoogleMap:moveCamera	(Lcom/google/android/gms/maps/CameraUpdate;)V
    //   89: aload_0
    //   90: getfield 153	ir/eitaa/ui/LocationActivity:googleMap	Lcom/google/android/gms/maps/GoogleMap;
    //   93: iconst_1
    //   94: invokevirtual 436	com/google/android/gms/maps/GoogleMap:setMyLocationEnabled	(Z)V
    //   97: aload_0
    //   98: getfield 153	ir/eitaa/ui/LocationActivity:googleMap	Lcom/google/android/gms/maps/GoogleMap;
    ...
    //   108: aload_0
    //   109: getfield 153	ir/eitaa/ui/LocationActivity:googleMap	Lcom/google/android/gms/maps/GoogleMap;
    ...
    //   119: aload_0
    //   120: getfield 153	ir/eitaa/ui/LocationActivity:googleMap	Lcom/google/android/gms/maps/GoogleMap;
    ...
    //   130: aload_0
    //   131: getfield 153	ir/eitaa/ui/LocationActivity:googleMap	Lcom/google/android/gms/maps/GoogleMap;
    //   134: new 32	ir/eitaa/ui/LocationActivity$19
    //   137: dup
    //   138: aload_0
    //   139: invokespecial 452	ir/eitaa/ui/LocationActivity$19:<init>	(Lir/eitaa/ui/LocationActivity;)V
    ...
    //   145: aload_0
    //   146: invokespecial 458	ir/eitaa/ui/LocationActivity:getLastLocation	()Landroid/location/Location;
    //   149: astore_1
    //   150: aload_0
    //   151: aload_1
    //   152: putfield 190	ir/eitaa/ui/LocationActivity:myLocation	Landroid/location/Location;
    //   155: aload_0
    //   156: aload_1
    //   157: invokespecial 240	ir/eitaa/ui/LocationActivity:positionMarker	(Landroid/location/Location;)V
    //   160: return
    //   161: astore_2
    //   162: ldc_w 460
    //   165: aload_2
    //   166: invokestatic 466	ir/eitaa/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   169: goto -104 -> 65
    //   172: aload_0
    ...
    //   183: putfield 266	ir/eitaa/ui/LocationActivity:userLocation	Landroid/location/Location;
    //   186: aload_0
    //   187: getfield 266	ir/eitaa/ui/LocationActivity:userLocation	Landroid/location/Location;
    //   190: ldc2_w 472
    //   193: invokevirtual 477	android/location/Location:setLatitude	(D)V
    //   196: aload_0
    //   197: getfield 266	ir/eitaa/ui/LocationActivity:userLocation	Landroid/location/Location;
    //   200: ldc2_w 478
    ...
    //   210: ldc_w 460
    //   213: aload_1
    //   214: invokestatic 466	ir/eitaa/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   217: goto -120 -> 97
  ...
  private void positionMarker(Location paramLocation)
  {
    ...
    do
    {
      do
      {
        ...
        if (f < 1000.0F)
        {
          this.distanceTextView.setText(String.format("%d %s", new Object[] { Integer.valueOf((int)f), LocaleController.getString("MetersAway", 2131165883) }));
          return;
        }
        this.distanceTextView.setText(String.format("%.2f %s", new Object[] { Float.valueOf(f / 1000.0F), LocaleController.getString("KMetersAway", 2131165781) }));
        return;
  ...
  private void showPermissionAlert(boolean paramBoolean)
  {
    ...
    if (paramBoolean) {
      localBuilder.setMessage(LocaleController.getString("PermissionNoLocationPosition", 2131166103));
    }
    for (;;)
    {
      localBuilder.setNegativeButton(LocaleController.getString("PermissionOpenSettings", 2131166104), new DialogInterface.OnClickListener()
      {
        @TargetApi(9)
      ...
      return;
      localBuilder.setMessage(LocaleController.getString("PermissionNoLocation", 2131166102));
    }
  }
  ...
  public View createView(Context paramContext)
  {
    ...
    if (this.messageObject != null)
    {
      ...
      ((ActionBarMenu)localObject1).addItem(1, 2130837980);
      localObject1 = ((ActionBarMenu)localObject1).addItem(0, 2130837713);
      ((ActionBarMenuItem)localObject1).addSubItem(2, LocaleController.getString("Map", 2131165851), 0);
      ((ActionBarMenuItem)localObject1).addSubItem(3, LocaleController.getString("Satellite", 2131166200), 0);
      ((ActionBarMenuItem)localObject1).addSubItem(4, LocaleController.getString("Hybrid", 2131165747), 0);
      ...
      this.locationButton.setBackgroundResource(2130837691);
      this.locationButton.setImageResource(2130837853);
      ...
      ((FrameLayout)localObject2).setBackgroundResource(2130837807);
      ...
      paramContext.setBackgroundResource(2130837690);
      paramContext.setImageResource(2130837854);
    ...
    for (float f2 = 0.0F;; f2 = 14.0F)
    {
      ...
      break label196;
      this.actionBar.setTitle(LocaleController.getString("ShareLocation", 2131166279));
      ((ActionBarMenu)localObject1).addItem(0, 2130837716).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener()
      {
      ...
      }).getSearchField().setHint(LocaleController.getString("Search", 2131166209));
      break label206;
      i = 3;
      break label616;
      f1 = 12.0F;
    ...
    ((View)localObject2).setBackgroundResource(2130837700);
    ...
    this.markerImageView.setImageResource(2130837813);
    ...
    this.markerXImageView.setImageResource(2130837931);
    ...
    for (float f3 = 0.0F;; f3 = 14.0F)
    {
      ...
      ((TextView)localObject2).setText(LocaleController.getString("NoResult", 2131165952));
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/LocationActivity.class
