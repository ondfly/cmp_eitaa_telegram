...
import ir.eitaa.ui.Adapters.DialogsSearchAdapter.DialogsSearchAdapterDelegate;
  ...
  implements NotificationCenter.NotificationCenterDelegate
{
  ...
  private void updatePasscodeButton()
  {
    ...
    if ((UserConfig.passcodeHash.length() != 0) && (!this.searching))
    {
      ...
      {
        this.passcodeItem.setIcon(2130837809);
        return;
      }
      this.passcodeItem.setIcon(2130837810);
      return;
    }
  ...
  public View createView(final Context paramContext)
  {
    ...
    {
      this.passcodeItem = ((ActionBarMenu)localObject1).addItem(1, 2130837809);
      updatePasscodeButton();
    }
    if (BuildVars.DEBUG_VERSION) {
      ((ActionBarMenu)localObject1).addItem(1, 2130837731).setOnClickListener(new View.OnClickListener()
      {
    ...
    if (this.onlySelect)
    {
      ...
      this.actionBar.setTitle(LocaleController.getString("SelectChat", 2131166233));
        ...
        public boolean onItemClick(View paramAnonymousView, int paramAnonymousInt)
        {
          ...
          if (DialogObject.isChannel(paramAnonymousView))
          {
            ...
            if ((localObject2 != null) && (((TLRPC.Chat)localObject2).megagroup))
            {
              ...
              for (paramAnonymousView = LocaleController.getString("LeaveMegaMenu", 2131165821);; paramAnonymousView = LocaleController.getString("DeleteMegaMenu", 2131165575))
              {
                ...
                localBuilder.setItems(paramAnonymousView, new DialogInterface.OnClickListener()
                {
                  public void onClick(DialogInterface paramAnonymous2DialogInterface, int paramAnonymous2Int)
                  {
                    ...
                    if (paramAnonymous2Int == 0)
                    {
                      ...
                      for (;;)
                      {
                        paramAnonymous2DialogInterface.setPositiveButton(LocaleController.getString("OK", 2131166047), new DialogInterface.OnClickListener()
                        {
                    ...
                    if ((localObject2 != null) && (localObject2.megagroup)) {
                      if (!localObject2.creator) {
                        paramAnonymous2DialogInterface.setMessage(LocaleController.getString("MegaLeaveAlert", 2131165859));
                      }
                    }
                    for (;;)
                    {
                      ...
                      break;
                      paramAnonymous2DialogInterface.setMessage(LocaleController.getString("MegaDeleteAlert", 2131165857));
                      continue;
            ...
            localObject1[0] = LocaleController.getString("ClearHistoryCache", 2131165510);
            if ((localObject2 == null) || (!((TLRPC.Chat)localObject2).creator)) {}
            for (paramAnonymousView = LocaleController.getString("LeaveChannelMenu", 2131165819);; paramAnonymousView = LocaleController.getString("ChannelDeleteMenu", 2131165424))
            {
              localObject1[1] = paramAnonymousView;
              paramAnonymousView = (View)localObject1;
              break;
      ...
      this.searchEmptyView.setText(LocaleController.getString("NoResult", 2131165952));
      ...
      ((TextView)localObject1).setText(LocaleController.getString("NoChats", 2131165933));
      ...
      Object localObject2 = LocaleController.getString("NoChatsHelp", 2131165934);
      ...
      this.floatingButton.setBackgroundResource(2130837690);
      this.floatingButton.setImageResource(2130837688);
  ...
  public void onResume()
  {
    ...
    if ((this.checkPermission) && (!this.onlySelect) && (Build.VERSION.SDK_INT >= 23))
    {
      ...
      if (localObject != null)
      {
        ...
        if ((((Activity)localObject).checkSelfPermission("android.permission.READ_CONTACTS") != 0) || (((Activity)localObject).checkSelfPermission("android.permission.WRITE_EXTERNAL_STORAGE") != 0))
        {
          ...
          ((AlertDialog.Builder)localObject).setMessage(LocaleController.getString("PermissionContacts", 2131166099));
    ...
    if (((Activity)localObject).shouldShowRequestPermissionRationale("android.permission.WRITE_EXTERNAL_STORAGE"))
    {
      localObject = new AlertDialog.Builder((Context)localObject);
      ((AlertDialog.Builder)localObject).setTitle(LocaleController.getString("AppName", 2131165299));
      ((AlertDialog.Builder)localObject).setMessage(LocaleController.getString("PermissionStorage", 2131166105));
      ((AlertDialog.Builder)localObject).setPositiveButton(LocaleController.getString("OK", 2131166047), null);
      localObject = ((AlertDialog.Builder)localObject).create();
      this.permissionDialog = ((AlertDialog)localObject);
      showDialog((Dialog)localObject);
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/DialogsActivity.class
