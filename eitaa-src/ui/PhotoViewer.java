...
import ir.eitaa.messenger.exoplayer.AspectRatioFrameLayout;
import ir.eitaa.messenger.exoplayer.util.PlayerControl;
...
import ir.eitaa.ui.Components.PhotoCropView.PhotoCropViewDelegate;
...
import ir.eitaa.ui.Components.VideoPlayer.ExtractorRendererBuilder;
import ir.eitaa.ui.Components.VideoPlayer.Listener;
import java.io.File;
  ...
  implements NotificationCenter.NotificationCenterDelegate, GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener
{
  ...
  private void animateTo(float paramFloat1, float paramFloat2, float paramFloat3, boolean paramBoolean, int paramInt)
  {
    ...
    this.imageMoveAnimation.addListener(new AnimatorListenerAdapterProxy()
    {
      ...
      {
        PhotoViewer.access$6202(PhotoViewer.this, null);
  ...
  private void onActionClick(boolean paramBoolean)
  {
    ...
    if (Build.VERSION.SDK_INT >= 24)
    {
      ...
      ((Intent)localObject2).setDataAndType(FileProvider.getUriForFile(this.parentActivity, "ir.eitaa.messenger.provider", (File)localObject1), "video/mp4");
    }
    for (;;)
    {
  ...
  private void onSharePressed()
  {
    ...
    do
    {
      try
      {
        if (this.currentMessageObject != null)
        {
          ...
          this.parentActivity.startActivityForResult(Intent.createChooser(localIntent, LocaleController.getString("ShareFile", 2131166277)), 500);
          return;
        }
      }
      catch (Exception localException)
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      ((AlertDialog.Builder)localObject).setPositiveButton(LocaleController.getString("OK", 2131166047), null);
      ((AlertDialog.Builder)localObject).setMessage(LocaleController.getString("PleaseDownload", 2131166130));
  ...
  private void openCaptionEnter()
  {
    ...
    this.actionBar.setTitle(LocaleController.getString("PhotoCaption", 2131166115));
  }
  ...
  private void preparePlayer(File paramFile, boolean paramBoolean)
  {
    ...
    this.videoPlayButton.setImageResource(2130837778);
    if (this.videoPlayer == null)
    {
      ...
      this.videoPlayer.addListener(new VideoPlayer.Listener()
      {
        ...
        {
          FileLog.e("TSMS", paramAnonymousException);
        }
          ...
          for (;;)
          {
            try
            {
              ...
              if (!PhotoViewer.this.isPlaying)
              {
                ...
                PhotoViewer.this.videoPlayButton.setImageResource(2130837777);
            ...
            if (PhotoViewer.this.isPlaying)
            {
              ...
              PhotoViewer.this.videoPlayButton.setImageResource(2130837778);
    ...
    do
    {
      ...
      if (!this.imagesArr.isEmpty())
      {
        ...
        if ((this.currentMessageObject != null) && (this.currentMessageObject.getId() == ((MessageObject)localObject1).getId()))
        {
          ...
          localObject1 = LocaleController.formatString("formatDateAtTime", 2131166438, new Object[] { LocaleController.getInstance().formatterYear.format(new Date(l)), LocaleController.getInstance().formatterDay.format(new Date(l)) });
      ...
      for (paramBoolean = true;; paramBoolean = false)
      {
        ...
        if ((this.totalImagesCount + this.totalImagesCountMerge != 0) && (!this.needSearchImageInArr)) {
          if (this.opennedFromMedia) {
            if ((this.imagesArr.size() < this.totalImagesCount + this.totalImagesCountMerge) && (!this.loadingMoreImages) && (this.currentIndex > this.imagesArr.size() - 5))
            {
              ...
              this.actionBar.setTitle(LocaleController.formatString("Of", 2131166048, new Object[] { Integer.valueOf(this.currentIndex + 1), Integer.valueOf(this.totalImagesCount + this.totalImagesCountMerge) }));
            }
          }
        }
        for (;;)
        {
          ...
          for (l = this.currentDialogId;; l = this.mergeDialogId)
          {
            SharedMediaQuery.loadMedia(l, 0, 80, k, 0, true, this.classGuid);
            this.loadingMoreImages = true;
            this.actionBar.setTitle(LocaleController.formatString("Of", 2131166048, new Object[] { Integer.valueOf(this.totalImagesCount + this.totalImagesCountMerge - this.imagesArr.size() + this.currentIndex + 1), Integer.valueOf(this.totalImagesCount + this.totalImagesCountMerge) }));
            break;
        ...
        if (!this.imagesArrLocations.isEmpty())
        {
          ...
          this.actionBar.setTitle(LocaleController.formatString("Of", 2131166048, new Object[] { Integer.valueOf(this.currentIndex + 1), Integer.valueOf(this.imagesArrLocations.size()) }));
          this.menuItem.showSubItem(1);
          this.allowShare = true;
          localObject1 = this.shareButton;
          if ((this.videoPlayerControlFrameLayout == null) || (this.videoPlayerControlFrameLayout.getVisibility() != 0)) {}
        ...
        for (;;)
        {
          ...
          this.actionBar.setTitle(LocaleController.getString("AttachPhoto", 2131165343));
          continue;
          this.actionBar.setTitle(LocaleController.formatString("Of", 2131166048, new Object[] { Integer.valueOf(this.currentIndex + 1), Integer.valueOf(this.imagesArrLocals.size()) }));
        }
  ...
  private void setIndexToImage(ImageReceiver paramImageReceiver, int paramInt)
  {
    ...
    if (!this.imagesArrLocals.isEmpty())
    {
      ...
      if ((paramInt >= 0) && (paramInt < this.imagesArrLocals.size()))
      {
        Object localObject10 = this.imagesArrLocals.get(paramInt);
        ...
        int i = 0;
        localObject1 = null;
        if ((localObject10 instanceof MediaController.PhotoEntry))
        {
          localObject8 = (MediaController.PhotoEntry)localObject10;
          localObject3 = localObject7;
          paramInt = i;
          localObject4 = localObject6;
          if (!((MediaController.PhotoEntry)localObject8).isVideo)
          {
            if (((MediaController.PhotoEntry)localObject8).imagePath != null)
            {
              localObject2 = ((MediaController.PhotoEntry)localObject8).imagePath;
        ...
        for (localObject2 = ((TLRPC.Document)localObject3).thumb.location;; localObject2 = null)
        {
          ...
          return;
          paramImageReceiver.setOrientation(((MediaController.PhotoEntry)localObject8).orientation, false);
          localObject2 = ((MediaController.PhotoEntry)localObject8).path;
          break;
          if ((localObject10 instanceof TLRPC.BotInlineResult))
          {
            localObject8 = (TLRPC.BotInlineResult)localObject10;
            if ((((TLRPC.BotInlineResult)localObject8).type.equals("video")) || (MessageObject.isVideoDocument(((TLRPC.BotInlineResult)localObject8).document)))
            {
              if (((TLRPC.BotInlineResult)localObject8).document != null)
              {
                localObject4 = ((TLRPC.BotInlineResult)localObject8).document.thumb.location;
                localObject3 = localObject7;
                paramInt = i;
                break label224;
              }
              localObject2 = ((TLRPC.BotInlineResult)localObject8).thumb_url;
              localObject3 = localObject7;
              paramInt = i;
              localObject4 = localObject6;
              break label224;
            }
            if ((((TLRPC.BotInlineResult)localObject8).type.equals("gif")) && (((TLRPC.BotInlineResult)localObject8).document != null))
            {
              localObject3 = ((TLRPC.BotInlineResult)localObject8).document;
              paramInt = ((TLRPC.BotInlineResult)localObject8).document.size;
              localObject1 = "d";
              localObject4 = localObject6;
              break label224;
            }
            if (((TLRPC.BotInlineResult)localObject8).photo != null)
            {
              localObject1 = FileLoader.getClosestPhotoSizeWithSize(((TLRPC.BotInlineResult)localObject8).photo.sizes, AndroidUtilities.getPhotoSize());
            ...
            paramInt = i;
            localObject4 = localObject6;
            if (((TLRPC.BotInlineResult)localObject8).content_url == null) {
              break label224;
            }
            if (((TLRPC.BotInlineResult)localObject8).type.equals("gif")) {}
            for (localObject1 = "d";; localObject1 = String.format(Locale.US, "%d_%d", new Object[] { Integer.valueOf(k), Integer.valueOf(k) }))
            {
              localObject2 = ((TLRPC.BotInlineResult)localObject8).content_url;
              localObject3 = localObject7;
              paramInt = i;
              localObject4 = localObject6;
              break;
          ...
          paramInt = i;
          localObject4 = localObject6;
          if (!(localObject10 instanceof MediaController.SearchImage)) {
            break label224;
          }
          localObject1 = (MediaController.SearchImage)localObject10;
    ...
    if (localObject5 != null)
    {
      ...
      if ((localObject1 != null) && (((MessageObject)localObject1).isVideo()))
      {
        ...
        paramImageReceiver.setImageBitmap(this.parentActivity.getResources().getDrawable(2130837915));
        return;
      }
    ...
    do
    {
          ...
          for (;;)
          {
            ...
            this.imageMoveAnimation.addListener(new AnimatorListenerAdapterProxy()
            {
              public void onAnimationEnd(Animator paramAnonymousAnimator)
              {
                ...
                {
                  PhotoViewer.access$6202(PhotoViewer.this, null);
                  PhotoViewer.access$6002(PhotoViewer.this, paramInt);
                  PhotoViewer.access$7802(PhotoViewer.this, 1.0F);
                  PhotoViewer.access$7902(PhotoViewer.this, 0.0F);
                  PhotoViewer.access$8002(PhotoViewer.this, 0.0F);
                  PhotoViewer.access$2702(PhotoViewer.this, 1.0F);
      ...
      if (paramInt == 1)
      {
        if (this.photoCropView == null)
        {
          ...
          this.photoCropView.setDelegate(new PhotoCropView.PhotoCropViewDelegate()
          {
            ...
            public void needMoveImageTo(float paramAnonymousFloat1, float paramAnonymousFloat2, float paramAnonymousFloat3, boolean paramAnonymousBoolean)
            {
              ...
              PhotoViewer.access$2802(PhotoViewer.this, paramAnonymousFloat1);
              PhotoViewer.access$2902(PhotoViewer.this, paramAnonymousFloat2);
              PhotoViewer.access$2702(PhotoViewer.this, paramAnonymousFloat3);
              PhotoViewer.this.containerView.invalidate();
            }
          });
        }
        ...
        this.changeModeAnimation.addListener(new AnimatorListenerAdapterProxy()
        {
          public void onAnimationEnd(Animator paramAnonymousAnimator)
          {
            PhotoViewer.access$8402(PhotoViewer.this, null);
            ...
            if (paramAnonymousAnimator != null)
            {
              ...
              float f2 = PhotoViewer.this.getContainerViewWidth(1) / i;
              ...
              f2 = f3;
              label224:
              PhotoViewer.access$7802(PhotoViewer.this, f2 / f1);
              PhotoViewer.access$7902(PhotoViewer.this, 0.0F);
            ...
            {
              PhotoViewer.access$8002(paramAnonymousAnimator, i + j);
              PhotoViewer.access$8702(PhotoViewer.this, System.currentTimeMillis());
              PhotoViewer.access$8802(PhotoViewer.this, true);
              PhotoViewer.access$6202(PhotoViewer.this, new AnimatorSet());
              ...
              PhotoViewer.this.imageMoveAnimation.addListener(new AnimatorListenerAdapterProxy()
              {
                ...
                {
                  PhotoViewer.access$6202(PhotoViewer.this, null);
                  PhotoViewer.access$6002(PhotoViewer.this, PhotoViewer.31.this.val$mode);
                  PhotoViewer.access$7802(PhotoViewer.this, 1.0F);
                  PhotoViewer.access$7902(PhotoViewer.this, 0.0F);
                  PhotoViewer.access$8002(PhotoViewer.this, 0.0F);
                  PhotoViewer.access$2702(PhotoViewer.this, 1.0F);
            ...
            for (int i = AndroidUtilities.statusBarHeight / 2;; i = 0)
            {
              ...
              PhotoViewer.this.imageMoveAnimation.addListener(new AnimatorListenerAdapterProxy()
              {
                public void onAnimationEnd(Animator paramAnonymous2Animator)
                {
                  ...
                  PhotoViewer.access$6202(PhotoViewer.this, null);
                  PhotoViewer.access$6002(PhotoViewer.this, PhotoViewer.34.this.val$mode);
                  PhotoViewer.access$7802(PhotoViewer.this, 1.0F);
                  PhotoViewer.access$7902(PhotoViewer.this, 0.0F);
                  PhotoViewer.access$8002(PhotoViewer.this, 0.0F);
                  PhotoViewer.access$2702(PhotoViewer.this, 1.0F);
        ...
        public void onAnimationEnd(Animator paramAnonymousAnimator)
        {
          ...
          if (PhotoViewer.this.centerImage.getBitmap() != null)
          {
            ...
            if (f1 > f4)
            {
              ...
              i = AndroidUtilities.statusBarHeight;
              PhotoViewer.access$8002(paramAnonymousAnimator, (i + (j - k)) / 2);
              PhotoViewer.access$8702(PhotoViewer.this, System.currentTimeMillis());
              PhotoViewer.access$8802(PhotoViewer.this, true);
            }
          }
          ...
          {
            PhotoViewer.access$6202(PhotoViewer.this, new AnimatorSet());
            paramAnonymousAnimator = PhotoViewer.this.imageMoveAnimation;
          ...
          for (int i = AndroidUtilities.statusBarHeight;; i = 0)
          {
            paramAnonymousAnimator.playTogether(new Animator[] { localObjectAnimator1, localObjectAnimator2, localObjectAnimator3, ObjectAnimator.ofFloat(localActionBar, "translationY", new float[] { j - i, 0.0F }) });
            PhotoViewer.this.imageMoveAnimation.setDuration(200L);
            PhotoViewer.this.imageMoveAnimation.addListener(new AnimatorListenerAdapterProxy()
            {
              public void onAnimationEnd(Animator paramAnonymous2Animator)
              {
                ...
                PhotoViewer.access$6202(PhotoViewer.this, null);
                PhotoViewer.access$6002(PhotoViewer.this, PhotoViewer.37.this.val$mode);
                PhotoViewer.access$7802(PhotoViewer.this, 1.0F);
                PhotoViewer.access$7902(PhotoViewer.this, 0.0F);
                PhotoViewer.access$8002(PhotoViewer.this, 0.0F);
                PhotoViewer.access$2702(PhotoViewer.this, 1.0F);
          ...
          this.currentActionBarAnimation.addListener(new AnimatorListenerAdapterProxy()
          {
            public void onAnimationEnd(Animator paramAnonymousAnimator)
            {
              if ((PhotoViewer.this.currentActionBarAnimation != null) && (PhotoViewer.this.currentActionBarAnimation.equals(paramAnonymousAnimator)))
              {
                ...
                PhotoViewer.access$8902(PhotoViewer.this, null);
              }
            }
          });
        }
        ...
        else
        {
          ...
          this.animationEndRunnable = new Runnable()
          {
            public void run()
            {
              ...
              PhotoViewer.access$9202(PhotoViewer.this, 0);
              ...
              AndroidUtilities.runOnUIThread(new Runnable()
              {
                public void run()
                {
                  if (PhotoViewer.this.animationEndRunnable != null)
                  {
                    ...
                    PhotoViewer.access$9802(PhotoViewer.this, null);
                  }
                }
              });
            }
      ...
      for (;;)
      {
        try
        {
          ...
          if (Build.VERSION.SDK_INT >= 21)
          {
            ...
            this.actionBar.setTitle(LocaleController.formatString("Of", 2131166048, new Object[] { Integer.valueOf(1), Integer.valueOf(1) }));
            ...
            if (localPlaceProviderObject.radius != 0)
            {
              ...
              this.animationEndRunnable = new Runnable()
              {
                public void run()
                {
                  ...
                  do
                  {
                    ...
                    PhotoViewer.access$9202(PhotoViewer.this, 0);
                    PhotoViewer.access$9302(PhotoViewer.this, 0L);
              ...
              BackgroundDrawable.access$9902(this.backgroundDrawable, new Runnable()
              {
                public void run()
                {
                  PhotoViewer.access$4202(PhotoViewer.this, false);
                  localPlaceProviderObject.imageReceiver.setVisible(false, true);
                }
              });
              return true;
  ...
  public boolean openPhotoForSelect(ArrayList<Object> paramArrayList, int paramInt1, int paramInt2, PhotoViewerProvider paramPhotoViewerProvider, ChatActivity paramChatActivity)
  {
    ...
    label66:
    for (String str = LocaleController.getString("Set", 2131166262).toUpperCase();; str = LocaleController.getString("Send", 2131166236).toUpperCase())
    {
  ...
  public void setParentActivity(Activity paramActivity)
  {
    ...
    this.actvityContext = new ContextThemeWrapper(this.parentActivity, 2131296259);
    if (progressDrawables == null)
    {
      progressDrawables = new Drawable[4];
      progressDrawables[0] = this.parentActivity.getResources().getDrawable(2130837601);
      progressDrawables[1] = this.parentActivity.getResources().getDrawable(2130837590);
      progressDrawables[2] = this.parentActivity.getResources().getDrawable(2130837802);
      progressDrawables[3] = this.parentActivity.getResources().getDrawable(2130837934);
    }
    ...
    this.windowView = new FrameLayout(paramActivity)
    {
      ...
      protected void onDetachedFromWindow()
      {
        ...
        PhotoViewer.access$3302(PhotoViewer.this, false);
        PhotoViewer.access$2502(PhotoViewer.this, false);
      }
      ...
      protected void onLayout(boolean paramAnonymousBoolean, int paramAnonymousInt1, int paramAnonymousInt2, int paramAnonymousInt3, int paramAnonymousInt4)
      {
        ...
        PhotoViewer.access$2502(PhotoViewer.this, true);
        if (paramAnonymousBoolean)
        {
          if (!PhotoViewer.this.dontResetZoomOnFirstLayout)
          {
            PhotoViewer.access$2702(PhotoViewer.this, 1.0F);
            PhotoViewer.access$2802(PhotoViewer.this, 0.0F);
            PhotoViewer.access$2902(PhotoViewer.this, 0.0F);
            PhotoViewer.this.updateMinMax(PhotoViewer.this.scale);
          }
        ...
        if (PhotoViewer.this.dontResetZoomOnFirstLayout)
        {
          ...
          PhotoViewer.access$2602(PhotoViewer.this, false);
        }
      }
      ...
      protected void onMeasure(int paramAnonymousInt1, int paramAnonymousInt2)
      {
        ...
        for (;;)
        {
          ...
          PhotoViewer.this.containerView.measure(View.MeasureSpec.makeMeasureSpec(i, 1073741824), View.MeasureSpec.makeMeasureSpec(paramAnonymousInt2, 1073741824));
          return;
          paramAnonymousInt2 = paramAnonymousInt1;
          i = j;
          if (paramAnonymousInt1 > AndroidUtilities.displaySize.y)
    ...
    if (Build.VERSION.SDK_INT >= 21) {
      this.containerView.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener()
      {
        ...
        {
          PhotoViewer.access$2202(PhotoViewer.this, paramAnonymousWindowInsets);
    ...
    if (Build.VERSION.SDK_INT >= 21)
    {
          ...
          do
          {
            do
            {
              do
              {
                ...
                PhotoViewer.access$4202(PhotoViewer.this, true);
            ...
            {
              ((AlertDialog.Builder)localObject).setTitle(LocaleController.getString("AppName", 2131165299));
              ((AlertDialog.Builder)localObject).setPositiveButton(LocaleController.getString("OK", 2131166047), new DialogInterface.OnClickListener()
              {
                public void onClick(DialogInterface paramAnonymous2DialogInterface, int paramAnonymous2Int)
                {
                  ...
                  PhotoViewer.access$4502(PhotoViewer.this, -1);
            ...
            if (paramAnonymousInt == 12)
            {
              ...
              for (;;)
              {
                PhotoViewer.access$5202(localPhotoViewer, bool);
                if (PhotoViewer.this.videoPlayer != null) {
      ...
      this.masksItem = paramActivity.addItem(13, 2130837741);
      this.muteItem = paramActivity.addItem(12, 2130838030);
      this.menuItem = paramActivity.addItem(0, 2130837713);
      this.menuItem.addSubItem(11, LocaleController.getString("OpenInExternalApp", 2131166061), 0);
      this.menuItem.addSubItem(2, LocaleController.getString("ShowAllMedia", 2131166294), 0);
      this.menuItem.addSubItem(10, LocaleController.getString("ShareFile", 2131166277), 0);
      this.menuItem.addSubItem(1, LocaleController.getString("SaveToGallery", 2131166205), 0);
      this.menuItem.addSubItem(6, LocaleController.getString("Delete", 2131165560), 0);
      this.captionDoneItem = paramActivity.addItemWithWidth(9, 2130837725, AndroidUtilities.dp(56.0F));
      ...
      this.shareButton.setImageResource(2130837980);
      ...
      this.tuneItem.setImageResource(2130837892);
      ...
      this.paintItem.setImageResource(2130837884);
      ...
      this.cropItem.setImageResource(2130837881);
      ...
      paramActivity = new ImageReceiver.ImageReceiverDelegate()
      {
        ...
        {
          if ((paramAnonymousImageReceiver == PhotoViewer.this.centerImage) && (paramAnonymousBoolean1) && (PhotoViewer.this.placeProvider != null) && (PhotoViewer.this.placeProvider.scaleToFill()))
          {
            if (!PhotoViewer.this.wasLayout) {
              PhotoViewer.access$2602(PhotoViewer.this, true);
            }
          }
          else {
            return;
      ...
      int i = ((WindowManager)ApplicationLoader.applicationContext.getSystemService("window")).getDefaultDisplay().getRotation();
      this.checkImageView = new CheckBox(this.containerView.getContext(), 2130837979);
      ...
      localObject = new MentionsAdapter(this.actvityContext, true, 0L, new MentionsAdapter.MentionsAdapterDelegate()
      {
        public void needChangePanelVisibility(boolean paramAnonymousBoolean)
        {
          ...
          if (paramAnonymousBoolean)
          {
            ...
            if (PhotoViewer.this.mentionsAdapter.getItemCount() > 3)
            {
              ...
              if (PhotoViewer.this.mentionListAnimation != null)
              {
                ...
                PhotoViewer.access$6802(PhotoViewer.this, null);
              }
          ...
          do
          {
            ...
            {
              PhotoViewer.this.mentionListView.setVisibility(0);
              PhotoViewer.access$6802(PhotoViewer.this, new AnimatorSet());
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/PhotoViewer.class
