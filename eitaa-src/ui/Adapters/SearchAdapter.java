  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramInt == this.searchResult.size())
    {
      ...
      if (paramView == null)
      {
        ...
        ((GreySectionCell)localObject1).setText(LocaleController.getString("GlobalSearch", 2131165718));
      }
    }
    label97:
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/Adapters/SearchAdapter.class
