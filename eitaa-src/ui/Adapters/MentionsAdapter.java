...
import ir.eitaa.messenger.SendMessagesHelper.LocationProvider;
import ir.eitaa.messenger.SendMessagesHelper.LocationProvider.LocationProviderDelegate;
...
import ir.eitaa.ui.Cells.ContextLinkCell.ContextLinkCellDelegate;
                    ...
                    if (!((TLRPC.TL_contacts_resolvedPeer)localObject1).users.isEmpty())
                    {
                      ...
                      if ((((TLRPC.User)localObject2).bot) && (((TLRPC.User)localObject2).bot_inline_placeholder != null))
                      {
                        ...
                        if (MentionsAdapter.this.foundContextBot.bot_inline_geo)
                        {
                          ...
                          ((AlertDialog.Builder)localObject2).setTitle(LocaleController.getString("ShareYouLocationTitle", 2131166284));
                          ((AlertDialog.Builder)localObject2).setMessage(LocaleController.getString("ShareYouLocationInline", 2131166283));
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/Adapters/MentionsAdapter.class
