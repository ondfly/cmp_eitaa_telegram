  ...
  implements NotificationCenter.NotificationCenterDelegate
{
  ...
  private void processDone()
  {
    ...
    do
    {
            ...
            AndroidUtilities.runOnUIThread(new Runnable()
            {
              public void run()
              {
                ...
                if (paramAnonymousTL_error.text.startsWith("FLOOD_WAIT"))
                {
                  ...
                  {
                    TwoStepVerificationActivity.this.showAlertWithText(LocaleController.getString("AppName", 2131165299), LocaleController.formatString("FloodWaitTime", 2131165643, new Object[] { str }));
                    return;
                  }
                }
      ...
      if (this.passwordSetState == 0)
      {
        ...
        this.titleTextView.setText(LocaleController.getString("ReEnterYourPasscode", 2131166150));
      ...
      if (this.passwordSetState == 1)
      {
        if (!this.firstPassword.equals(this.passwordEditText.getText().toString())) {
          try
          {
            Toast.makeText(getParentActivity(), LocaleController.getString("PasswordDoNotMatch", 2131166092), 0).show();
      ...
      if (this.passwordSetState == 2)
      {
        ...
        if (this.hint.toLowerCase().equals(this.firstPassword.toLowerCase())) {
          try
          {
            Toast.makeText(getParentActivity(), LocaleController.getString("PasswordAsHintError", 2131166090), 0).show();
            onPasscodeError(false);
            return;
          }
        ...
        AndroidUtilities.runOnUIThread(new Runnable()
        {
          public void run()
          {
            ...
            if (paramAnonymousTL_error == null)
            {
              ...
              ((AlertDialog.Builder)localObject).setMessage(LocaleController.getString("PasswordReset", 2131166097));
            ...
            if (paramAnonymousTL_error.text.startsWith("FLOOD_WAIT"))
            {
              ...
              {
                TwoStepVerificationActivity.this.showAlertWithText(LocaleController.getString("AppName", 2131165299), LocaleController.formatString("FloodWaitTime", 2131165643, new Object[] { localObject }));
                return;
              }
            }
            TwoStepVerificationActivity.this.showAlertWithText(LocaleController.getString("AppName", 2131165299), paramAnonymousTL_error.text);
        ...
        public void run(final TLObject paramAnonymousTLObject, final TLRPC.TL_error paramAnonymousTL_error)
        {
          AndroidUtilities.runOnUIThread(new Runnable()
          {
            public void run()
            {
              ...
              do
              {
                do
                {
                  do
                  {
                    ...
                    ((AlertDialog.Builder)localObject).setMessage(LocaleController.getString("YourPasswordSuccessText", 2131166434));
                    ((AlertDialog.Builder)localObject).setTitle(LocaleController.getString("YourPasswordSuccess", 2131166433));
                    localObject = TwoStepVerificationActivity.this.showDialog(((AlertDialog.Builder)localObject).create());
                ...
                ((AlertDialog.Builder)localObject).setMessage(LocaleController.getString("YourEmailAlmostThereText", 2131166426));
                ((AlertDialog.Builder)localObject).setTitle(LocaleController.getString("YourEmailAlmostThere", 2131166425));
                localObject = TwoStepVerificationActivity.this.showDialog(((AlertDialog.Builder)localObject).create());
              } while (localObject == null);
              ((Dialog)localObject).setCanceledOnTouchOutside(false);
              ((Dialog)localObject).setCancelable(false);
              ...
              {
                TwoStepVerificationActivity.this.showAlertWithText(LocaleController.getString("AppName", 2131165299), LocaleController.getString("PasswordEmailInvalid", 2131166093));
                return;
              }
              if (paramAnonymousTL_error.text.startsWith("FLOOD_WAIT"))
              {
  ...
  private void setPasswordSetState(int paramInt)
  {
    ...
    if (this.passwordSetState == 0)
    {
      this.actionBar.setTitle(LocaleController.getString("YourPassword", 2131166432));
      if ((this.currentPassword instanceof TLRPC.TL_account_noPassword))
      {
        this.titleTextView.setText(LocaleController.getString("PleaseEnterFirstPassword", 2131166132));
    ...
    for (;;)
    {
      this.passwordEditText.setText("");
      return;
      this.titleTextView.setText(LocaleController.getString("PleaseEnterPassword", 2131166133));
      break;
      if (this.passwordSetState == 1)
      {
        this.actionBar.setTitle(LocaleController.getString("YourPassword", 2131166432));
        this.titleTextView.setText(LocaleController.getString("PleaseReEnterPassword", 2131166134));
        this.passwordEditText.setImeOptions(5);
        this.passwordEditText.setTransformationMethod(PasswordTransformationMethod.getInstance());
        this.bottomTextView.setVisibility(4);
        this.bottomButton.setVisibility(4);
      ...
      {
        this.actionBar.setTitle(LocaleController.getString("PasswordHint", 2131166094));
        this.titleTextView.setText(LocaleController.getString("PasswordHintText", 2131166095));
        this.passwordEditText.setImeOptions(5);
      ...
      else
      {
        if (this.passwordSetState == 3)
        {
          this.actionBar.setTitle(LocaleController.getString("RecoveryEmail", 2131166153));
          this.titleTextView.setText(LocaleController.getString("YourEmail", 2131166424));
        ...
        {
          this.actionBar.setTitle(LocaleController.getString("PasswordRecovery", 2131166096));
          this.titleTextView.setText(LocaleController.getString("PasswordCode", 2131166091));
          this.bottomTextView.setText(LocaleController.getString("RestoreEmailSentInfo", 2131166187));
          this.bottomButton.setText(LocaleController.formatString("RestoreEmailTrouble", 2131166188, new Object[] { this.currentPassword.email_unconfirmed_pattern }));
          this.passwordEditText.setImeOptions(6);
          this.passwordEditText.setTransformationMethod(null);
  ...
  private void updateRows()
  {
    ...
    this.bottomButton.setVisibility(0);
    this.bottomTextView.setVisibility(4);
    this.bottomButton.setText(LocaleController.getString("ForgotPassword", 2131165645));
  ...
  public View createView(Context paramContext)
  {
    ...
    this.doneItem = this.actionBar.createMenu().addItemWithWidth(1, 2130837725, AndroidUtilities.dp(56.0F));
    ...
    if (LocaleController.isRTL)
    {
      ...
      this.bottomTextView.setText(LocaleController.getString("YourEmailInfo", 2131166427));
      ...
      this.bottomButton.setText(LocaleController.getString("YourEmailSkip", 2131166428));
      ...
      this.bottomButton.setOnClickListener(new View.OnClickListener()
      {
        public void onClick(View paramAnonymousView)
        {
          if (TwoStepVerificationActivity.this.type == 0)
          {
            ...
            TwoStepVerificationActivity.this.showAlertWithText(LocaleController.getString("RestorePasswordNoEmailTitle", 2131166191), LocaleController.getString("RestorePasswordNoEmailText", 2131166190));
            return;
          }
          if (TwoStepVerificationActivity.this.passwordSetState == 4)
          {
            TwoStepVerificationActivity.this.showAlertWithText(LocaleController.getString("RestorePasswordNoEmailTitle", 2131166191), LocaleController.getString("RestoreEmailTroubleText", 2131166189));
            return;
          }
          paramAnonymousView = new AlertDialog.Builder(TwoStepVerificationActivity.this.getParentActivity());
          paramAnonymousView.setMessage(LocaleController.getString("YourEmailSkipWarningText", 2131166430));
          paramAnonymousView.setTitle(LocaleController.getString("YourEmailSkipWarning", 2131166429));
          paramAnonymousView.setPositiveButton(LocaleController.getString("YourEmailSkip", 2131166428), new DialogInterface.OnClickListener()
          {
      ...
      this.listView.setOnItemClickListener(new AdapterView.OnItemClickListener()
      {
        public void onItemClick(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
        {
          ...
          paramAnonymousAdapterView.setMessage(LocaleController.getString("TurnPasswordOffQuestion", 2131166348));
          paramAnonymousAdapterView.setTitle(LocaleController.getString("AppName", 2131165299));
          paramAnonymousAdapterView.setPositiveButton(LocaleController.getString("OK", 2131166047), new DialogInterface.OnClickListener()
          {
            public void onClick(DialogInterface paramAnonymous2DialogInterface, int paramAnonymous2Int)
            {
      ...
      updateRows();
      this.actionBar.setTitle(LocaleController.getString("TwoStepVerification", 2131166349));
      this.titleTextView.setText(LocaleController.getString("PleaseEnterCurrentPassword", 2131166131));
    }
    for (;;)
    {
      ...
      do
      {
        do
        {
          do
          {
            ...
            {
              paramView.setText(LocaleController.getString("SetAdditionalPassword", 2131166263), true);
              return paramViewGroup;
            }
            if (paramInt == TwoStepVerificationActivity.this.turnPasswordOffRow)
            {
              paramView.setText(LocaleController.getString("TurnPasswordOff", 2131166347), true);
              return paramViewGroup;
            }
            ...
            {
              paramView.setText(LocaleController.getString("SetRecoveryEmail", 2131166271), false);
              return paramViewGroup;
            }
            localObject = paramViewGroup;
        ...
        {
          ((TextInfoPrivacyCell)paramViewGroup).setText(LocaleController.getString("SetAdditionalPasswordInfo", 2131166264));
        ...
        if (paramInt == TwoStepVerificationActivity.this.passwordSetupDetailRow)
        {
          ...
          paramViewGroup.setBackgroundResource(2130837696);
          return paramViewGroup;
        }
        if (paramInt == TwoStepVerificationActivity.this.passwordEnabledDetailRow)
        {
          ((TextInfoPrivacyCell)paramViewGroup).setText(LocaleController.getString("EnabledPasswordText", 2131165606));
          paramViewGroup.setBackgroundResource(2130837695);
          return paramViewGroup;
        }
        localObject = paramViewGroup;
      } while (paramInt != TwoStepVerificationActivity.this.passwordEmailVerifyDetailRow);
      ((TextInfoPrivacyCell)paramViewGroup).setText(LocaleController.formatString("PendingEmailText", 2131166098, new Object[] { TwoStepVerificationActivity.this.currentPassword.email_unconfirmed_pattern }));
      paramViewGroup.setBackgroundResource(2130837695);
      return paramViewGroup;
    }
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/TwoStepVerificationActivity.class
