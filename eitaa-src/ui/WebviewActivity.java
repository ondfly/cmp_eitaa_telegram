  ...
  extends BaseFragment
{
  ...
  public WebviewActivity(String paramString1, String paramString2, String paramString3, String paramString4, MessageObject paramMessageObject)
  {
    ...
    paramString2 = new StringBuilder().append("https://eitaa.com/").append(this.currentBot);
      ...
      try
      {
        ...
        if (localObject2 != null)
        {
          ...
          if (i < 0)
          {
            ...
            paramString3 = new StringBuilder().append("https://eitaa.com/").append(paramString3);
  ...
  public View createView(Context paramContext)
  {
    ...
    this.progressItem = localActionBarMenu.addItemWithWidth(1, 2130837980, AndroidUtilities.dp(54.0F));
    ...
    localActionBarMenu.addItem(0, 2130837713).addSubItem(2, LocaleController.getString("OpenInExternalApp", 2131166061), 0);
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/WebviewActivity.class
