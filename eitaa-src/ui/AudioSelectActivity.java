...
import ir.eitaa.messenger.MediaController.AudioEntry;
...
import ir.eitaa.ui.Cells.AudioCell;
import ir.eitaa.ui.Cells.AudioCell.AudioCellDelegate;
  ...
  implements NotificationCenter.NotificationCenterDelegate
{
  ...
  public View createView(Context paramContext)
  {
    ...
    this.progressView.setText(LocaleController.getString("NoAudio", 2131165930));
    ...
    if (LocaleController.isRTL)
    {
      ...
      paramContext.setBackgroundResource(2130837700);
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/AudioSelectActivity.class
