  ...
  extends BaseFragment
{
  ...
  public View createView(Context paramContext)
  {
    ...
    this.actionBar.setTitle(LocaleController.getString("EncryptionKey", 2131165616));
    ...
    if (localObject2 != null)
    {
      ...
      ((SpannableStringBuilder)localObject3).append(AndroidUtilities.replaceTags(LocaleController.formatString("EncryptionKeyDescription", 2131165617, new Object[] { ((TLRPC.User)localObject1).first_name, ((TLRPC.User)localObject1).first_name })));
      int i = ((SpannableStringBuilder)localObject3).toString().indexOf("eitaa.com");
      if (i != -1) {
        ((SpannableStringBuilder)localObject3).setSpan(new URLSpanReplacement(LocaleController.getString("EncryptionKeyLink", 2131165618)), i, "eitaa.com".length() + i, 33);
      }
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/IdenticonActivity.class
