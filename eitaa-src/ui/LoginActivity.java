...
import ir.eitaa.tgnet.TLRPC.TL_auth_checkPassword;
...
import ir.eitaa.tgnet.TLRPC.TL_auth_signUp;
  ...
  extends BaseFragment
{
  ...
  private void needShowInvalidAlert(final String paramString, final boolean paramBoolean)
  {
    ...
    for (;;)
    {
      localBuilder.setNeutralButton(LocaleController.getString("BotHelp", 2131165367), new DialogInterface.OnClickListener()
      {
        public void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt)
        {
          try
          {
            ...
            localIntent.putExtra("android.intent.extra.EMAIL", new String[] { "support@eitaa.com" });
            if (paramBoolean)
            {
          ...
          {
            LoginActivity.this.needShowAlert(LocaleController.getString("AppName", 2131165299), LocaleController.getString("NoMailInstalled", 2131165938));
          }
        }
      });
      localBuilder.setPositiveButton(LocaleController.getString("OK", 2131166047), null);
      showDialog(localBuilder.create());
      return;
      localBuilder.setMessage(LocaleController.getString("InvalidPhoneNumber", 2131165761));
    }
  }
  ...
  private void needShowProgress()
  {
    ...
    this.progressDialog.setMessage(LocaleController.getString("Loading", 2131165837));
    ...
    extends SlideView
  {
    ...
    public LoginActivityPasswordView(Context paramContext)
    {
      ...
      if (LocaleController.isRTL)
      {
        ...
        this.confirmTextView.setText(LocaleController.getString("LoginPasswordText", 2131165849));
        ...
        this.codeField.setHint(LocaleController.getString("LoginPassword", 2131165848));
        ...
        ((TextView)localObject).setText(LocaleController.getString("ForgotPassword", 2131165645));
        ...
        ((TextView)localObject).setOnClickListener(new View.OnClickListener()
        {
          public void onClick(View paramAnonymousView)
          {
                  ...
                  AndroidUtilities.runOnUIThread(new Runnable()
                  {
                    public void run()
                    {
                      ...
                      if (paramAnonymous2TL_error == null)
                      {
                        ...
                        localBuilder.setMessage(LocaleController.formatString("RestoreEmailSent", 2131166186, new Object[] { ((TLRPC.TL_auth_passwordRecovery)localObject).email_pattern }));
                        localBuilder.setTitle(LocaleController.getString("AppName", 2131165299));
                      ...
                      if (paramAnonymous2TL_error.text.startsWith("FLOOD_WAIT"))
                      {
                        ...
                        {
                          LoginActivity.this.needShowAlert(LocaleController.getString("AppName", 2131165299), LocaleController.formatString("FloodWaitTime", 2131165643, new Object[] { localObject }));
                          return;
                        }
                      }
            ...
            LoginActivity.this.needShowAlert(LocaleController.getString("RestorePasswordNoEmailTitle", 2131166191), LocaleController.getString("RestorePasswordNoEmailText", 2131166190));
          }
        });
        ...
        this.resetAccountButton.setText(LocaleController.getString("ResetMyAccount", 2131166180));
        ...
        this.resetAccountButton.setOnClickListener(new View.OnClickListener()
        {
          public void onClick(View paramAnonymousView)
          {
            ...
            paramAnonymousView.setMessage(LocaleController.getString("ResetMyAccountWarningText", 2131166184));
            paramAnonymousView.setTitle(LocaleController.getString("ResetMyAccountWarning", 2131166182));
            paramAnonymousView.setPositiveButton(LocaleController.getString("ResetMyAccountWarningReset", 2131166183), new DialogInterface.OnClickListener()
            {
                  ...
                  public void run(TLObject paramAnonymous3TLObject, final TLRPC.TL_error paramAnonymous3TL_error)
                  {
                    AndroidUtilities.runOnUIThread(new Runnable()
                    {
                      public void run()
                      {
                        ...
                        {
                          LoginActivity.this.needShowAlert(LocaleController.getString("AppName", 2131165299), LocaleController.getString("ResetAccountCancelledAlert", 2131166176));
                          return;
                        }
        ...
        this.resetAccountText.setText(LocaleController.getString("ResetMyAccountText", 2131166181));
    ...
    {
      return LocaleController.getString("LoginPassword", 2131165848);
    }
        ...
        public void run(final TLObject paramAnonymousTLObject, final TLRPC.TL_error paramAnonymousTL_error)
        {
          AndroidUtilities.runOnUIThread(new Runnable()
          {
            public void run()
            {
              ...
              {
                localObject1 = (TLRPC.TL_auth_authorization)paramAnonymousTLObject;
                ConnectionsManager.getInstance().setUserId(((TLRPC.TL_auth_authorization)localObject1).user.id);
                Object localObject2 = UserConfig.imei;
                UserConfig.clearConfig();
                MessagesController.getInstance().cleanup();
                UserConfig.setCurrentUser(((TLRPC.TL_auth_authorization)localObject1).user);
                UserConfig.token = ((TLRPC.TL_auth_authorization)localObject1).token;
                UserConfig.imei = (String)localObject2;
                UserConfig.saveConfig(true);
                MessagesStorage.getInstance().cleanup(true);
                localObject2 = new ArrayList();
                ((ArrayList)localObject2).add(((TLRPC.TL_auth_authorization)localObject1).user);
                MessagesStorage.getInstance().putUsersAndChats((ArrayList)localObject2, null, true, true);
                MessagesController.getInstance().putUser(((TLRPC.TL_auth_authorization)localObject1).user, false);
              ...
              if (paramAnonymousTL_error.text.startsWith("FLOOD_WAIT"))
              {
                ...
                if (i < 60) {}
                for (localObject1 = LocaleController.formatPluralString("Seconds", i);; localObject1 = LocaleController.formatPluralString("Minutes", i / 60))
                {
                  LoginActivity.this.needShowAlert(LocaleController.getString("AppName", 2131165299), LocaleController.formatString("FloodWaitTime", 2131165643, new Object[] { localObject1 }));
                  return;
                }
              }
    ...
    extends SlideView
  {
    ...
    public LoginActivityRecoverView(Context paramContext)
    {
      ...
      if (LocaleController.isRTL)
      {
        ...
        ((TextView)localObject).setGravity(i);
        this.confirmTextView.setLineSpacing(AndroidUtilities.dp(2.0F), 1.0F);
        this.confirmTextView.setText(LocaleController.getString("RestoreEmailSentInfo", 2131166187));
        localObject = this.confirmTextView;
        if (!LocaleController.isRTL) {
          break label434;
        }
        ...
        AndroidUtilities.clearCursorDrawable(this.codeField);
        this.codeField.setHintTextColor(-6842473);
        this.codeField.setHint(LocaleController.getString("PasswordCode", 2131166091));
        this.codeField.setImeOptions(268435461);
        this.codeField.setTextSize(1, 18.0F);
        this.codeField.setMaxLines(1);
        this.codeField.setPadding(0, 0, 0, 0);
      ...
      for (int i = j;; i = 3)
      {
        ...
        this.cancelButton.setOnClickListener(new View.OnClickListener()
        {
          ...
          {
            paramAnonymousView = new AlertDialog.Builder(LoginActivity.this.getParentActivity());
            paramAnonymousView.setMessage(LocaleController.getString("RestoreEmailTroubleText", 2131166189));
            paramAnonymousView.setTitle(LocaleController.getString("RestorePasswordNoEmailTitle", 2131166191));
    ...
    public void setParams(Bundle paramBundle)
    {
      ...
      this.currentParams = paramBundle;
      this.email_unconfirmed_pattern = this.currentParams.getString("email_unconfirmed_pattern");
      this.cancelButton.setText(LocaleController.formatString("RestoreEmailTrouble", 2131166188, new Object[] { this.email_unconfirmed_pattern }));
      AndroidUtilities.showKeyboard(this.codeField);
      this.codeField.requestFocus();
    }
  }
    ...
    extends SlideView
  {
    ...
    public LoginActivityRegisterView(Context paramContext)
    {
      ...
      ((TextView)localObject).setText(LocaleController.getString("RegisterText", 2131166154));
      ...
      if (LocaleController.isRTL)
      {
        ...
        this.firstNameField.setHint(LocaleController.getString("FirstName", 2131165641));
        ...
        this.lastNameField.setHint(LocaleController.getString("LastName", 2131165791));
    ...
    public String getHeaderName()
    {
      return LocaleController.getString("YourName", 2131166431);
    }
          ...
          AndroidUtilities.runOnUIThread(new Runnable()
          {
            public void run()
            {
              ...
              if (paramAnonymousTL_error == null)
              {
                ...
                Object localObject = UserConfig.imei;
                UserConfig.clearConfig();
                MessagesController.getInstance().cleanup();
                UserConfig.setCurrentUser(localTL_auth_authorization.user);
                UserConfig.token = localTL_auth_authorization.token;
                UserConfig.imei = (String)localObject;
                UserConfig.saveConfig(true);
                MessagesStorage.getInstance().cleanup(true);
              ...
              {
                LoginActivity.this.needShowAlert(LocaleController.getString("AppName", 2131165299), LocaleController.getString("InvalidPhoneNumber", 2131165761));
                return;
              }
              if ((paramAnonymousTL_error.text.contains("PHONE_CODE_EMPTY")) || (paramAnonymousTL_error.text.contains("PHONE_CODE_INVALID")))
              {
                LoginActivity.this.needShowAlert(LocaleController.getString("AppName", 2131165299), LocaleController.getString("InvalidCode", 2131165757));
                return;
              }
              ...
              {
                LoginActivity.this.needShowAlert(LocaleController.getString("AppName", 2131165299), LocaleController.getString("InvalidFirstName", 2131165758));
                return;
              }
              if (paramAnonymousTL_error.text.contains("LASTNAME_INVALID"))
              {
                LoginActivity.this.needShowAlert(LocaleController.getString("AppName", 2131165299), LocaleController.getString("InvalidLastName", 2131165759));
                return;
              }
              LoginActivity.this.needShowAlert(LocaleController.getString("AppName", 2131165299), paramAnonymousTL_error.text);
            }
    ...
    extends SlideView
  {
    ...
    public LoginActivityResetWaitView(Context paramContext)
    {
      ...
      if (LocaleController.isRTL)
      {
        ...
        localTextView.setText(LocaleController.getString("ResetAccountStatus", 2131166178));
        ...
        this.resetAccountButton.setText(LocaleController.getString("ResetAccountButton", 2131166175));
        this.resetAccountButton.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
        this.resetAccountButton.setTextSize(1, 14.0F);
        this.resetAccountButton.setLineSpacing(AndroidUtilities.dp(2.0F), 1.0F);
        this.resetAccountButton.setPadding(0, AndroidUtilities.dp(14.0F), 0, 0);
    ...
    public String getHeaderName()
    {
      return LocaleController.getString("ResetAccount", 2131166174);
    }
    ...
    public void setParams(Bundle paramBundle)
    {
      ...
      this.confirmTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("ResetAccountInfo", 2131166177, new Object[] { PhoneFormat.getInstance().format("+" + this.requestPhone) })));
      updateTimeText();
    ...
    implements NotificationCenter.NotificationCenterDelegate
  {
    ...
    public LoginActivitySmsView(Context paramContext, int paramInt)
    {
      ...
      for (paramInt = 5;; paramInt = 3)
      {
        ...
        paramContext.setText(LocaleController.getString("WrongNumber", 2131166410));
        paramContext.setOnClickListener(new View.OnClickListener()
        {
          public void onClick(View paramAnonymousView)
          {
                ...
                do
                {
                  for (;;)
                  {
                    ...
                    if (LoginActivity.LoginActivitySmsView.this.nextType == 2) {
                      LoginActivity.LoginActivitySmsView.this.timeText.setText(LocaleController.formatString("SmsText", 2131166303, new Object[] { Integer.valueOf(i), Integer.valueOf(j) }));
                    }
                  }
                  if (LoginActivity.LoginActivitySmsView.this.progressView != null) {
            ...
            public void run()
            {
              ...
              for (;;)
              {
                ...
                if (paramAnonymousTL_error.text != null) {
                  ...
                  {
                    LoginActivity.this.needShowAlert(LocaleController.getString("AppName", 2131165299), LocaleController.getString("FloodWait", 2131165642));
                  }
                  else if (paramAnonymousTL_error.code != 64536)
                  {
                    LoginActivity.this.needShowAlert(LocaleController.getString("AppName", 2131165299), LocaleController.getString("ErrorOccurred", 2131165629) + "\n" + paramAnonymousTL_error.text);
                  }
                }
              }
            }
    ...
    public String getHeaderName()
    {
      return LocaleController.getString("YourCode", 2131166423);
    }
            ...
            AndroidUtilities.runOnUIThread(new Runnable()
            {
              public void run()
              {
                ...
                if (paramAnonymousTL_error.text.contains("PHONE_NUMBER_UNOCCUPIED"))
                {
                  ...
                  ((Bundle)localObject1).putString("phoneFormated", LoginActivity.LoginActivitySmsView.this.requestPhone);
                  ((Bundle)localObject1).putString("phoneHash", LoginActivity.LoginActivitySmsView.this.phoneHash);
                  ((Bundle)localObject1).putString("code", LoginActivity.LoginActivitySmsView.8.this.val$req.phone_code);
                  LoginActivity.this.setPage(5, true, (Bundle)localObject1, false);
                  LoginActivity.LoginActivitySmsView.this.destroyTimer();
                  LoginActivity.LoginActivitySmsView.this.destroyCodeTimer();
                  return;
                }
                ...
                {
                  localObject1 = new TLRPC.TL_account_getPassword();
                  ConnectionsManager.getInstance().sendRequest((TLObject)localObject1, new RequestDelegate()
                  {
    ...
    public void setParams(Bundle paramBundle)
    {
      ...
      {
        paramBundle = AndroidUtilities.replaceTags(LocaleController.getString("SentAppCode", 2131166255));
        label258:
      ...
      for (;;)
      {
        ...
        if (this.currentType == 2)
        {
          paramBundle = AndroidUtilities.replaceTags(LocaleController.formatString("SentSmsCode", 2131166258, new Object[] { str }));
          break label258;
        }
        if (this.currentType == 3)
        {
          paramBundle = AndroidUtilities.replaceTags(LocaleController.formatString("SentCallCode", 2131166256, new Object[] { str }));
          break label258;
        }
        if (this.currentType != 4) {
          break label258;
        }
        paramBundle = AndroidUtilities.replaceTags(LocaleController.formatString("SentCallOnly", 2131166257, new Object[] { str }));
        break label258;
        label475:
        AndroidUtilities.hideKeyboard(this.codeField);
      }
      ...
      if ((this.currentType == 3) && ((this.nextType == 4) || (this.nextType == 2)))
      {
        ...
        for (;;)
        {
          ...
          return;
          if (this.nextType == 2) {
            this.timeText.setText(LocaleController.formatString("SmsText", 2131166303, new Object[] { Integer.valueOf(1), Integer.valueOf(0) }));
          }
        }
      }
    ...
    implements AdapterView.OnItemSelectedListener
  {
    ...
    public PhoneView(Context paramContext)
    {
      ...
      if (LocaleController.isRTL)
      {
        ...
        this.codeField.addTextChangedListener(new TextWatcher()
        {
          public void afterTextChanged(Editable paramAnonymousEditable)
          {
            ...
            for (;;)
            {
              ...
              localObject1 = null;
              break label447;
              LoginActivity.PhoneView.this.countryButton.setText(LocaleController.getString("WrongCountry", 2131166409));
              LoginActivity.PhoneView.this.phoneField.setHintText(null);
        ...
        paramContext = new TextView(paramContext);
        paramContext.setText(LocaleController.getString("StartText", 2131166312));
      ...
      for (;;)
      {
        ...
        catch (Exception this$1)
        {
          for (;;)
          {
            FileLog.e("TSMS", LoginActivity.this);
            this$1 = paramContext;
          }
          this.codeField.requestFocus();
        }
    ...
    public String getHeaderName()
    {
      return LocaleController.getString("YourPhone", 2131166435);
    }
    ...
    public void onNextPressed()
    {
      ...
      {
        LoginActivity.this.needShowAlert(LocaleController.getString("AppName", 2131165299), LocaleController.getString("WrongCountry", 2131166409));
        return;
      }
      if (this.codeField.length() == 0)
      {
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/LoginActivity.class
