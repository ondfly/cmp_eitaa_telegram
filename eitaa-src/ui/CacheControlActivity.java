...
import ir.eitaa.messenger.ClearCacheService;
      ...
      public void onItemClick(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
      {
        ...
        do
        {
          ...
          if (paramAnonymousInt == CacheControlActivity.this.keepMediaRow)
          {
            ...
            localObject2 = LocaleController.getString("KeepMediaForever", 2131165783);
          ...
          if (paramAnonymousInt == CacheControlActivity.this.databaseRow)
          {
            ...
            paramAnonymousAdapterView.setMessage(LocaleController.getString("LocalDatabaseClear", 2131165841));
        ...
        if (paramAnonymousInt < 6)
        {
          ...
          if (paramAnonymousInt == 0)
          {
            ...
            paramAnonymousAdapterView = LocaleController.getString("LocalPhotoCache", 2131165845);
            label321:
          ...
          for (;;)
          {
            ...
            if (paramAnonymousInt == 1)
            {
              ...
              paramAnonymousAdapterView = LocaleController.getString("LocalVideoCache", 2131165846);
              break label321;
            }
            if (paramAnonymousInt == 2)
            {
              paramAnonymousLong = CacheControlActivity.this.documentsSize;
              paramAnonymousAdapterView = LocaleController.getString("LocalDocumentCache", 2131165843);
              break label321;
            }
            if (paramAnonymousInt == 3)
            {
              paramAnonymousLong = CacheControlActivity.this.musicSize;
              paramAnonymousAdapterView = LocaleController.getString("LocalMusicCache", 2131165844);
              break label321;
            }
            if (paramAnonymousInt == 4)
            {
              paramAnonymousLong = CacheControlActivity.this.audioSize;
              paramAnonymousAdapterView = LocaleController.getString("LocalAudioCache", 2131165838);
              break label321;
            }
            ...
            paramAnonymousAdapterView = LocaleController.getString("LocalCache", 2131165839);
            break label321;
            label541:
        ...
        paramAnonymousAdapterView.setBackgroundResource(2130837798);
    ...
    extends BaseFragmentAdapter
  {
    ...
    public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
    {
      ...
      if (i == 0)
      {
        ...
        {
          localTextSettingsCell.setTextAndValue(LocaleController.getString("LocalDatabase", 2131165840), AndroidUtilities.formatFileSize(CacheControlActivity.this.databaseSize), false);
      ...
      do
      {
        do
        {
          ...
          for (;;)
          {
            localTextSettingsCell.setTextAndValue(LocaleController.getString("KeepMedia", 2131165782), paramView, false);
            return paramViewGroup;
            if (paramInt == 1) {
              paramView = LocaleController.formatPluralString("Months", 1);
            } else {
              paramView = LocaleController.getString("KeepMediaForever", 2131165783);
            }
          }
        ...
        {
          ((TextInfoPrivacyCell)paramViewGroup).setText(LocaleController.getString("LocalDatabaseInfo", 2131165842));
        ...
        if (paramInt == CacheControlActivity.this.cacheInfoRow)
        {
          ...
          paramViewGroup.setBackgroundResource(2130837694);
          return paramViewGroup;
        }
        localObject = paramViewGroup;
      } while (paramInt != CacheControlActivity.this.keepMediaInfoRow);
      ((TextInfoPrivacyCell)paramViewGroup).setText(AndroidUtilities.replaceTags(LocaleController.getString("KeepMediaInfo", 2131165784)));
      paramViewGroup.setBackgroundResource(2130837694);
      return paramViewGroup;
    }
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/CacheControlActivity.class
