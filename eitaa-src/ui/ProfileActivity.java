...
import ir.eitaa.tgnet.TLRPC.TL_channelParticipantEditor;
import ir.eitaa.tgnet.TLRPC.TL_channelParticipantModerator;
...
import ir.eitaa.ui.Cells.AboutLinkCell.AboutLinkCellDelegate;
  ...
  implements NotificationCenter.NotificationCenterDelegate, DialogsActivity.DialogsActivityDelegate, PhotoViewer.PhotoViewerProvider
{
  ...
  private void createActionBarMenu()
  {
    ...
    if (this.user_id != 0) {
      if (UserConfig.getClientUserId() != this.user_id) {
        if (ContactsController.getInstance().contactsDict.get(this.user_id) == null)
        {
          ...
          localObject2 = localActionBarMenu.addItem(10, 2130837713);
          ...
          if ((((TLRPC.User)localObject1).phone != null) && (((TLRPC.User)localObject1).phone.length() != 0))
          {
            ...
            ((ActionBarMenuItem)localObject2).addSubItem(3, LocaleController.getString("ShareContact", 2131166276), 0);
            if (!this.userBlocked)
            {
    ...
    for (;;)
    {
      ...
      return;
      localObject1 = LocaleController.getString("Unblock", 2131166352);
      break;
      if (((TLRPC.User)localObject1).bot)
      {
        if (!this.userBlocked) {}
      ...
      if (!this.userBlocked) {}
      for (localObject1 = LocaleController.getString("BlockContact", 2131165359);; localObject1 = LocaleController.getString("Unblock", 2131166352))
      {
        ((ActionBarMenuItem)localObject2).addSubItem(2, (String)localObject1, 0);
        localObject1 = localObject2;
        break;
      ...
      localObject1 = localActionBarMenu.addItem(10, 2130837713);
      ((ActionBarMenuItem)localObject1).addSubItem(3, LocaleController.getString("ShareContact", 2131166276), 0);
      continue;
      if (this.chat_id != 0) {
        if (this.chat_id > 0)
        {
          ...
          if (this.writeButton != null)
          {
            ...
            this.writeButton.setImageResource(2130837687);
          ...
          for (;;)
          {
            ...
            ((ActionBarMenuItem)localObject1).addSubItem(7, LocaleController.getString("LeaveMegaMenu", 2131165821), 0);
            break;
            label765:
          ...
          if ((localChat.creator) && (this.chat_id > 0)) {
            ((ActionBarMenuItem)localObject1).addSubItem(11, LocaleController.getString("SetAdmins", 2131166265), 0);
          }
  ...
  private void needLayout()
  {
    ...
    do
    {
      ...
      f1 = -(float)(Math.floor(this.nameTextView[i].getMeasuredWidth() * 1.12F) - this.nameTextView[i].getMeasuredWidth()) + 35.0F * AndroidUtilities.density * f2;
      this.nameTextView[i].setTranslationX(f1);
      this.nameTextView[i].setTranslationY((float)Math.floor(f3) + AndroidUtilities.dp(1.3F) + AndroidUtilities.dp(7.0F) * f2);
      localObject = this.onlineTextView[i];
      if (!LocaleController.isRTL) {
        break label1167;
      }
      j = 5;
      ((TextView)localObject).setTranslationX(j * AndroidUtilities.density * f2);
      this.onlineTextView[i].setTranslationY((float)Math.floor(f3) + AndroidUtilities.dp(24.0F) + (float)Math.floor(11.0F * AndroidUtilities.density) * f2);
      this.nameTextView[i].setScaleX(1.0F + 0.12F * f2);
      this.nameTextView[i].setScaleY(1.0F + 0.12F * f2);
    } while ((i != 1) || (this.openAnimationInProgress));
    if (AndroidUtilities.isTablet())
    {
      j = AndroidUtilities.dp(490.0F);
      label901:
      j = (int)(j - AndroidUtilities.dp(126.0F + 40.0F * (1.0F - f2)) - this.nameTextView[i].getTranslationX());
      f1 = this.nameTextView[i].getPaint().measureText(this.nameTextView[i].getText().toString());
      float f4 = this.nameTextView[i].getScaleX();
      localObject = (FrameLayout.LayoutParams)this.nameTextView[i].getLayoutParams();
      if (j >= f1 * f4) {
        break label1185;
      }
      ((FrameLayout.LayoutParams)localObject).width = ((int)Math.ceil(j / this.nameTextView[i].getScaleX()));
      label1024:
      ...
      ((FrameLayout.LayoutParams)localObject).leftMargin = ((int)Math.ceil(this.onlineTextView[i].getTranslationX() + AndroidUtilities.dp(8.0F) + AndroidUtilities.dp(40.0F) * (1.0F - f2)));
    }
    for (;;)
    {
      ...
      break;
      label1112:
      f1 = 5.0F * AndroidUtilities.density * f2;
      break label724;
      label1125:
      localObject = this.nameTextView[i];
      if (LocaleController.isRTL) {}
      for (j = 5;; j = -21)
      {
        ((TextView)localObject).setTranslationX(j * AndroidUtilities.density * f2);
      ...
      break label1024;
      label1195:
      ((FrameLayout.LayoutParams)localObject).rightMargin = ((int)Math.ceil(this.onlineTextView[i].getTranslationX() + AndroidUtilities.dp(8.0F) + AndroidUtilities.dp(40.0F) * (1.0F - f2)));
    }
  }
  ...
  private void updateProfileData()
  {
    ...
    do
    {
      ...
      if (this.user_id != 0)
      {
        ...
        for (;;)
        {
          ...
          {
            localObject1 = LocaleController.getString("ServiceNotifications", 2131166259);
            break;
          }
          if (((TLRPC.User)localObject4).bot)
          {
          ...
          for (;;)
          {
            ...
            this.nameTextView[j].setCompoundDrawablesWithIntrinsicBounds(i, 0, k, 0);
            break;
          ...
          this.nameTextView[j].setCompoundDrawablesWithIntrinsicBounds(k, 0, i, 0);
        }
    ...
    if (localObject2 != null)
    {
      ...
      localObject1 = LocaleController.getString("Loading", 2131165837).toLowerCase();
      label722:
      i = 0;
      label724:
      if (i >= 2) {
    ...
    for (;;)
    {
      ...
      if (i != 0)
      {
        if (((TLRPC.Chat)localObject2).verified)
        {
          ...
          this.nameTextView[i].setCompoundDrawablesWithIntrinsicBounds(2130837597, 0, 0, 0);
        }
        for (;;)
        {
          ...
          break;
          label1193:
          this.nameTextView[i].setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130837597, 0);
        }
      }
      if (LocaleController.isRTL)
      {
        ...
        for (j = 2130837851;; j = 0)
        {
          ((TextView)localObject3).setCompoundDrawablesWithIntrinsicBounds(j, 0, 0, 0);
          break;
        }
      }
      localObject3 = this.nameTextView[i];
      ...
      for (j = 2130837851;; j = 0)
      {
        ((TextView)localObject3).setCompoundDrawablesWithIntrinsicBounds(0, 0, j, 0);
        break;
      }
      label1305:
  ...
  public View createView(Context paramContext)
  {
          ...
          do
          {
            do
            {
              ...
              if (paramAnonymousInt == 3)
              {
                ...
                ((Bundle)localObject1).putString("selectAlertString", LocaleController.getString("SendContactTo", 2131166238));
                ((Bundle)localObject1).putString("selectAlertStringGroup", LocaleController.getString("SendContactToGroup", 2131166239));
            ...
            ((AlertDialog.Builder)localObject3).setPositiveButton(LocaleController.getString("OK", 2131166047), new DialogInterface.OnClickListener()
            {
              public void onClick(DialogInterface paramAnonymous2DialogInterface, int paramAnonymous2Int)
              {
          ...
          if (paramAnonymousInt == 10) {
            for (;;)
            {
              try
              {
                ...
                {
                  ((Intent)localObject3).putExtra("android.intent.extra.TEXT", String.format("%s https://eitaa.com/%s", new Object[] { str, ((TLRPC.User)localObject1).username }));
              ...
              ((Intent)localObject3).putExtra("android.intent.extra.TEXT", String.format("https://eitaa.com/%s", new Object[] { localException1.username }));
            }
          }
          Object localObject2;
          ...
          if ((paramAnonymousInt > ProfileActivity.this.emptyRowChat2) && (paramAnonymousInt < ProfileActivity.this.membersEndRow))
          {
            ...
            for (;;)
            {
              ...
              for (;;)
              {
                ...
                localObject2 = LocaleController.getString("SetAsAdmin", 2131166270);
                String str = LocaleController.getString("KickFromGroup", 2131165786);
            ...
            label490:
            if (ProfileActivity.this.chat_id > 0) {}
            for (paramAnonymousView = LocaleController.getString("KickFromGroup", 2131165786);; paramAnonymousView = LocaleController.getString("KickFromBroadcast", 2131165785))
            {
              localObject2 = new DialogInterface.OnClickListener()
              {
                public void onClick(DialogInterface paramAnonymous2DialogInterface, int paramAnonymous2Int)
    ...
    this.nameTextView[i] = new TextView(paramContext);
    this.nameTextView[i].setTextColor(-1);
    this.nameTextView[i].setTextSize(18.0F);
    this.nameTextView[i].setSingleLine();
    this.nameTextView[i].setEllipsize(TextUtils.TruncateAt.END);
    ...
    if (LocaleController.isRTL)
    {
      j = 5;
      label640:
      ((TextView)localObject2).setGravity(j);
      this.nameTextView[i].setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
      this.nameTextView[i].setCompoundDrawablePadding(AndroidUtilities.dp(16.0F));
      ...
      f2 = 118.0F;
      ((FrameLayout)localObject1).addView((View)localObject2, LayoutHelper.createFrame(-2, -2.0F, j | 0x30, f1, 0.0F, f2, 0.0F));
      this.onlineTextView[i] = new TextView(paramContext);
      ...
      j = 5;
      label826:
      ((TextView)localObject2).setTextColor(AvatarDrawable.getProfileTextColorForId(j));
      this.onlineTextView[i].setTextSize(14.0F);
      localObject2 = this.onlineTextView[i];
      if (!LocaleController.isRTL) {
        break label1004;
      }
    ...
    try
    {
      ...
      if (this.user_id != 0)
      {
        ...
        f1 = 16.0F;
        ((FrameLayout)localObject1).addView(paramContext, LayoutHelper.createFrame(-2, -2.0F, i | 0x30, f1, 0.0F, 16.0F, 0.0F));
  ...
  protected AnimatorSet onCustomTransitionAnimation(boolean paramBoolean, final Runnable paramRunnable)
  {
    if ((this.playProfileAnimation) && (this.allowProfileAnimation))
    {
      ...
      if ((((ActionBarMenu)localObject).getItem(10) == null) && (this.animatingItem == null)) {
        this.animatingItem = ((ActionBarMenu)localObject).addItem(10, 2130837713);
      }
      int i;
      float f;
      label265:
      ...
      if (paramBoolean)
      {
        ...
        if (LocaleController.isRTL)
        {
          ((FrameLayout.LayoutParams)localObject).rightMargin = ((int)(80.0F * AndroidUtilities.density + AndroidUtilities.dp(8.0F)));
          ((FrameLayout.LayoutParams)localObject).leftMargin = ((int)(-21.0F * AndroidUtilities.density + AndroidUtilities.dp(8.0F)));
          ...
          f = this.nameTextView[1].getPaint().measureText(this.nameTextView[1].getText().toString());
          ...
          localTextView = this.onlineTextView[i];
          if (i != 0) {
            break label606;
          }
          f = 1.0F;
          ...
          localTextView = this.nameTextView[i];
          if (i != 0) {
            break label611;
          }
          f = 1.0F;
          ...
          f = 0.0F;
          label505:
          ((ArrayList)localObject).add(ObjectAnimator.ofFloat(localTextView, "alpha", new float[] { f }));
          localTextView = this.nameTextView[i];
          if (i != 0) {
            break label621;
          }
  ...
  public void setAnimationProgress(float paramFloat)
  {
    ...
    if ((this.user_id != 0) || ((ChatObject.isChannel(this.chat_id)) && (!this.currentChat.megagroup)))
    {
      ...
      i = Color.red(-1674199);
      j = Color.green(-1674199);
      k = Color.blue(-1674199);
    ...
    extends RecyclerView.Adapter
  {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder paramViewHolder, int paramInt)
    {
      ...
      while (paramViewHolder.itemView.getBackground() == null)
      {
        ...
        if (paramInt == ProfileActivity.this.phoneRow)
        {
          ...
          {
            ((TextDetailCell)localObject2).setTextAndValueAndIcon((String)localObject1, LocaleController.getString("PhoneMobile", 2131166109), 2130837880);
            i = j;
            break;
          }
        }
        if (paramInt == ProfileActivity.this.usernameRow)
        {
          ...
          {
            ((TextDetailCell)localObject2).setTextAndValue((String)localObject1, LocaleController.getString("Username", 2131166368));
            i = j;
            break;
          }
        }
        ...
        {
          ((TextDetailCell)localObject2).setTextAndValue((String)localObject1, "eitaa.com/" + ProfileActivity.this.currentChat.username);
          i = j;
          break;
        }
        ...
        if (paramInt == ProfileActivity.this.sharedMediaRow)
        {
          ...
          {
            localObject1 = LocaleController.getString("Loading", 2131165837);
            if ((ProfileActivity.this.user_id == 0) || (UserConfig.getClientUserId() != ProfileActivity.this.user_id)) {
              break label763;
            }
            ((TextCell)localObject2).setTextAndValueAndIcon(LocaleController.getString("SharedMedia", 2131166288), (String)localObject1, 2130837950);
            i = j;
            break;
          }
          ...
          ((TextCell)localObject2).setTextAndValue(LocaleController.getString("SharedMedia", 2131166288), (String)localObject1);
          i = j;
          break;
        }
        if (paramInt == ProfileActivity.this.settingsTimerRow)
        {
          ...
          for (localObject1 = LocaleController.getString("ShortMessageLifetimeForever", 2131166292);; localObject1 = AndroidUtilities.formatTTLString(((TLRPC.EncryptedChat)localObject1).ttl))
          {
            ((TextCell)localObject2).setTextAndValue(LocaleController.getString("MessageLifetime", 2131165875), (String)localObject1);
            i = j;
            break;
          }
        }
        ...
        {
          ((TextCell)localObject2).setTextAndIcon(LocaleController.getString("NotificationsAndSounds", 2131166034), 2130837950);
          i = j;
          break;
        }
        if (paramInt == ProfileActivity.this.startSecretChatRow)
        {
          ((TextCell)localObject2).setText(LocaleController.getString("StartEncryptedChat", 2131166310));
        ...
        if (paramInt == ProfileActivity.this.settingsKeyRow)
        {
          ...
          ((TextCell)localObject2).setTextAndValueDrawable(LocaleController.getString("EncryptionKey", 2131165616), (Drawable)localObject1);
          i = j;
          break;
        }
        if (paramInt == ProfileActivity.this.leaveChannelRow)
        {
          ...
          ((TextCell)localObject2).setText(LocaleController.getString("LeaveChannel", 2131165818));
          i = j;
          break;
        }
        if (paramInt == ProfileActivity.this.convertRow)
        {
          ((TextCell)localObject2).setText(LocaleController.getString("UpgradeGroup", 2131166364));
          ((TextCell)localObject2).setTextColor(-13129447);
          i = j;
          break;
        }
        ...
        {
          ((AboutLinkCell)localObject2).setTextAndIcon(MessagesController.getInstance().getUserAbout(ProfileActivity.this.user_id), 2130837566);
          i = j;
          break;
        }
        i = j;
        ...
        ((AboutLinkCell)localObject2).setTextAndIcon((String)localObject1, 2130837566);
        i = j;
        break;
        i = 0;
        break label164;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
    {
      ...
      for (;;)
      {
        ...
        localTextInfoPrivacyCell.setBackgroundResource(2130837694);
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/ProfileActivity.class
