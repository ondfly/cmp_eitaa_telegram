  ...
  implements NotificationCenter.NotificationCenterDelegate
{
  ...
  private boolean checkUserName(final String paramString)
  {
    ...
    while (i < paramString.length())
    {
      ...
      if ((i == 0) && (j >= 48) && (j <= 57))
      {
        ...
        {
          this.checkTextView.setText(LocaleController.getString("LinkInvalidStartNumberMega", 2131165834));
          this.checkTextView.setTextColor(-3198928);
          return false;
        }
    ...
    if ((paramString == null) || (paramString.length() < 5))
    {
      if (this.currentChat.megagroup)
      {
        this.checkTextView.setText(LocaleController.getString("LinkInvalidShortMega", 2131165832));
        this.checkTextView.setTextColor(-3198928);
        return false;
      }
            ...
            AndroidUtilities.runOnUIThread(new Runnable()
            {
              public void run()
              {
                ...
                if ((ChannelEditTypeActivity.this.lastCheckName != null) && (ChannelEditTypeActivity.this.lastCheckName.equals(ChannelEditTypeActivity.9.this.val$name)))
                {
                  ...
                  {
                    ChannelEditTypeActivity.this.checkTextView.setText(LocaleController.formatString("LinkAvailable", 2131165824, new Object[] { ChannelEditTypeActivity.9.this.val$name }));
                ...
                for (;;)
                {
                  ...
                  return;
                  ChannelEditTypeActivity.this.checkTextView.setText(LocaleController.getString("LinkInUse", 2131165827));
                }
              }
            });
          }
      ...
      public void run(final TLObject paramAnonymousTLObject, final TLRPC.TL_error paramAnonymousTL_error)
      {
        AndroidUtilities.runOnUIThread(new Runnable()
        {
          public void run()
          {
            ...
            for (String str = ChannelEditTypeActivity.this.invite.link;; str = LocaleController.getString("Loading", 2131165837))
            {
  ...
  private void updatePrivatePublic()
  {
    ...
    if (this.currentChat.megagroup)
    {
      ...
      if (this.isPrivate)
      {
        localObject1 = LocaleController.getString("MegaPrivateLinkHelp", 2131165862);
        label378:
    ...
    for (Object localObject1 = this.invite.link;; localObject1 = LocaleController.getString("Loading", 2131165837))
    {
      ...
      break;
      localObject1 = LocaleController.getString("MegaUsernameHelp", 2131165865);
      break label378;
  ...
  public View createView(Context paramContext)
  {
    ...
    this.actionBar.createMenu().addItemWithWidth(1, 2130837725, AndroidUtilities.dp(56.0F));
    ...
    if (this.currentChat.megagroup)
    {
      this.actionBar.setTitle(LocaleController.getString("GroupType", 2131165723));
      ...
      str1 = LocaleController.getString("MegaPublic", 2131165863);
      str2 = LocaleController.getString("MegaPublicInfo", 2131165864);
      if (this.isPrivate) {
        break label1110;
      }
      bool = true;
      ...
      this.radioButtonCell2.setTextAndValue(LocaleController.getString("MegaPrivate", 2131165860), LocaleController.getString("MegaPrivateInfo", 2131165861), this.isPrivate, false);
      label365:
      ...
      this.privateContainer.setOnClickListener(new View.OnClickListener()
      {
        public void onClick(View paramAnonymousView)
        {
          ...
          try
          {
            ...
            Toast.makeText(ChannelEditTypeActivity.this.getParentActivity(), LocaleController.getString("LinkCopied", 2131165826), 0).show();
            return;
          }
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/ChannelEditTypeActivity.class
