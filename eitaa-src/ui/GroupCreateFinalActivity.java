  ...
  implements NotificationCenter.NotificationCenterDelegate, AvatarUpdater.AvatarUpdaterDelegate
{
  ...
  public View createView(Context paramContext)
  {
    ...
    if (this.chatType == 1)
    {
      this.actionBar.setTitle(LocaleController.getString("NewBroadcastList", 2131165918));
      this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick()
      {
        public void onItemClick(final int paramAnonymousInt)
        {
          ...
          GroupCreateFinalActivity.this.progressDialog.setMessage(LocaleController.getString("Loading", 2131165837));
      ...
      localObject = LocaleController.getString("EnterGroupNamePlaceholder", 2131165624);
      label405:
    ...
    for (int i = AndroidUtilities.dp(96.0F);; i = AndroidUtilities.dp(16.0F))
    {
      ...
      this.actionBar.setTitle(LocaleController.getString("NewGroup", 2131165920));
      break;
      bool = false;
      break label194;
      i = AndroidUtilities.dp(16.0F);
      ...
      i = 3;
      break label320;
      localObject = LocaleController.getString("EnterListName", 2131165625);
      break label405;
      i = 3;
      break label457;
  ...
  public void didUploadedPhoto(final TLRPC.InputFile paramInputFile, final TLRPC.PhotoSize paramPhotoSize1, TLRPC.PhotoSize paramPhotoSize2)
  {
    AndroidUtilities.runOnUIThread(new Runnable()
    {
      public void run()
      {
        ...
        {
          FileLog.e("TSMS", "avatar did uploaded");
          MessagesController.getInstance().createChat(GroupCreateFinalActivity.this.nameTextView.getText().toString(), GroupCreateFinalActivity.this.selectedContacts, null, GroupCreateFinalActivity.this.chatType, GroupCreateFinalActivity.this);
        }
      }
    });
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/GroupCreateFinalActivity.class
