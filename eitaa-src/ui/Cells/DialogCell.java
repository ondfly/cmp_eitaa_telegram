  ...
  extends BaseCell
{
  ...
  public DialogCell(Context paramContext)
  {
    ...
    if (namePaint == null)
    {
      ...
      lockDrawable = getResources().getDrawable(2130837797);
      checkDrawable = getResources().getDrawable(2130837644);
      halfCheckDrawable = getResources().getDrawable(2130837645);
      clockDrawable = getResources().getDrawable(2130837835);
      errorDrawable = getResources().getDrawable(2130837646);
      countDrawable = getResources().getDrawable(2130837642);
      countDrawableGrey = getResources().getDrawable(2130837643);
      groupDrawable = getResources().getDrawable(2130837794);
      broadcastDrawable = getResources().getDrawable(2130837791);
      muteDrawable = getResources().getDrawable(2130837852);
      verifiedDrawable = getResources().getDrawable(2130837595);
      botDrawable = getResources().getDrawable(2130837574);
    }
    ...
    setBackgroundResource(2130837798);
  ...
  public void buildLayout()
  {
    ...
    for (;;)
    {
      ...
      if (((String)localObject2).length() == 0) {
        localObject6 = LocaleController.getString("HiddenName", 2131165732);
      }
      label541:
      label566:
      int n;
        ...
        try
        {
          for (;;)
          {
            ...
            if (this.message == null)
            {
              ...
              {
                localObject1 = LocaleController.getString("EncryptionProcessing", 2131165619);
                k = j;
              ...
              {
                localObject1 = LocaleController.getString("EncryptionRejected", 2131165620);
                k = j;
                localObject4 = localObject2;
                break label356;
              }
              ...
              if (this.encryptedChat.admin_id == UserConfig.getClientUserId())
              {
                if ((this.user != null) && (this.user.first_name != null))
                {
                  localObject1 = LocaleController.formatString("EncryptedChatStartedOutgoing", 2131165608, new Object[] { this.user.first_name });
                  k = j;
                  localObject4 = localObject2;
                  break label356;
                }
                localObject1 = LocaleController.formatString("EncryptedChatStartedOutgoing", 2131165608, new Object[] { "" });
                k = j;
                localObject4 = localObject2;
                break label356;
              }
              localObject1 = LocaleController.getString("EncryptedChatStartedIncoming", 2131165607);
              k = j;
              localObject4 = localObject2;
              break label356;
            }
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/Cells/DialogCell.class
