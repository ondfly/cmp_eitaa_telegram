  ...
  extends FrameLayout
{
  ...
  public PhotoAttachPhotoCell(Context paramContext)
  {
    ...
    this.checkBox = new CheckBox(paramContext, 2130837598);
  ...
  public void setPhotoEntry(MediaController.PhotoEntry paramPhotoEntry, boolean paramBoolean)
  {
    ...
    {
      this.imageView.setImage(this.photoEntry.thumbPath, null, getResources().getDrawable(2130837859));
    ...
    for (paramBoolean = true;; paramBoolean = false)
    {
      ...
      if (this.photoEntry.path != null)
      {
        ...
        this.imageView.setImage("thumb://" + this.photoEntry.imageId + ":" + this.photoEntry.path, null, getResources().getDrawable(2130837859));
        break;
      }
      this.imageView.setImageResource(2130837859);
      break;
    }
  }
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/Cells/PhotoAttachPhotoCell.class
