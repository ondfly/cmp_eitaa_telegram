  ...
  extends LinearLayout
{
  ...
  public PhotoPickerSearchCell(Context paramContext, boolean paramBoolean)
  {
    ...
    ((SearchButton)localObject).textView1.setText(LocaleController.getString("SearchImages", 2131166212));
    ((SearchButton)localObject).textView2.setText(LocaleController.getString("SearchImagesInfo", 2131166213));
    ((SearchButton)localObject).imageView.setImageResource(2130837978);
    ...
    paramContext.textView1.setText(LocaleController.getString("SearchGifs", 2131166210));
    paramContext.textView2.setText("GIPHY");
    paramContext.imageView.setImageResource(2130837973);
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/Cells/PhotoPickerSearchCell.class
