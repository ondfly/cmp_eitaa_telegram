  ...
  extends FrameLayout
{
  ...
  public void setItem(int paramInt1, int paramInt2, MessageObject paramMessageObject)
  {
    ...
    if (paramMessageObject != null)
    {
      ...
      else
      {
        for (;;)
        {
          ...
          else
          {
            ...
            localPhotoVideoView.imageView.setImage(null, null, null, ApplicationLoader.applicationContext.getResources().getDrawable(2130837888), null, paramMessageObject, "b", null, 0);
            return;
            bool = false;
            break;
          }
        ...
        label253:
        localPhotoVideoView.imageView.setImageResource(2130837888);
        return;
      }
      if (((paramMessageObject.messageOwner.media instanceof TLRPC.TL_messageMediaPhoto)) && (paramMessageObject.messageOwner.media.photo != null) && (!paramMessageObject.photoThumbs.isEmpty()))
      {
        ...
        localPhotoVideoView.imageView.setImage(null, null, null, ApplicationLoader.applicationContext.getResources().getDrawable(2130837888), null, paramMessageObject.location, "b", null, 0);
        return;
      }
      localPhotoVideoView.videoInfoContainer.setVisibility(4);
      localPhotoVideoView.imageView.setImageResource(2130837888);
    ...
    extends FrameLayout
  {
    ...
    public PhotoVideoView(Context paramContext)
    {
      ...
      this.videoInfoContainer.setBackgroundResource(2130837912);
      ...
      SharedPhotoVideoCell.this.setImageResource(2130837776);
      ...
      this.checkBox = new CheckBox(paramContext, 2130837960);
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/Cells/SharedPhotoVideoCell.class
