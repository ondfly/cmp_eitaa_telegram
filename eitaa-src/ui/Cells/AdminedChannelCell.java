  ...
  extends FrameLayout
{
  ...
  {
    super(paramContext);
    setBackgroundResource(2130837801);
    ...
    if (LocaleController.isRTL)
    {
      ...
      paramContext.setImageResource(2130837640);
  ...
  public void setChannel(TLRPC.Chat paramChat, boolean paramBoolean)
  {
    ...
    paramChat = new SpannableStringBuilder("eitaa.com/" + paramChat.username);
    paramChat.setSpan(new ForegroundColorSpan(-12876608), "eitaa.com/".length(), paramChat.length(), 33);
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/Cells/AdminedChannelCell.class
