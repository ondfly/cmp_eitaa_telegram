  ...
  extends FrameLayout
{
  ...
  public void setStickerSet(TLRPC.StickerSetCovered paramStickerSetCovered, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      this.addButton.setBackgroundResource(2130837639);
      this.addButton.setText(LocaleController.getString("StickersRemove", 2131166316).toUpperCase());
    }
    for (;;)
    {
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/Cells/FeaturedStickerSetInfoCell.class
