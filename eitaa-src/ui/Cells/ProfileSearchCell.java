  ...
  extends BaseCell
{
  ...
  public ProfileSearchCell(Context paramContext)
  {
    ...
    if (namePaint == null)
    {
      ...
      checkDrawable = getResources().getDrawable(2130837595);
    ...
    for (;;)
    {
      ...
      do
      {
        do
        {
          ...
          localObject1 = LocaleController.getString("HiddenName", 2131165732);
          break label188;
          ...
          localObject1 = LocaleController.getString("Online", 2131166049);
          break label523;
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/Cells/ProfileSearchCell.class
