  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    if (i2 < i6)
    {
      ...
      for (;;)
      {
        ...
        {
          m = i8 - i7;
          ir.eitaa.ui.ActionBar.Theme.cornerOuter[0].setBounds(m, k, m + i7, k + i7);
          ir.eitaa.ui.ActionBar.Theme.cornerOuter[0].draw(paramCanvas);
          m = i8 + i9;
          ir.eitaa.ui.ActionBar.Theme.cornerOuter[1].setBounds(m, k, m + i7, k + i7);
          ir.eitaa.ui.ActionBar.Theme.cornerOuter[1].draw(paramCanvas);
        }
        if (i4 != 0)
        {
          i = k + j + i - i7;
          m = i8 + i9;
          ir.eitaa.ui.ActionBar.Theme.cornerOuter[2].setBounds(m, i, m + i7, i + i7);
          ir.eitaa.ui.ActionBar.Theme.cornerOuter[2].draw(paramCanvas);
          m = i8 - i7;
          ir.eitaa.ui.ActionBar.Theme.cornerOuter[3].setBounds(m, i, m + i7, i + i7);
          ir.eitaa.ui.ActionBar.Theme.cornerOuter[3].draw(paramCanvas);
        }
        i = k + j;
        i2 += 1;
        break;
        ...
        if (i7 * 2 + i9 < k)
        {
          ...
          i4 = i8 - i7 * 2;
          ir.eitaa.ui.ActionBar.Theme.cornerInner[2].setBounds(i4, k, i4 + i7, k + i7);
          ir.eitaa.ui.ActionBar.Theme.cornerInner[2].draw(paramCanvas);
          i4 = i8 + i9 + i7;
          ir.eitaa.ui.ActionBar.Theme.cornerInner[3].setBounds(i4, k, i4 + i7, k + i7);
          ir.eitaa.ui.ActionBar.Theme.cornerInner[3].draw(paramCanvas);
          i4 = j;
          break label356;
        }
        ...
        if (i7 * 2 + i9 < i10)
        {
          ...
          n = k + i7;
          i1 = i8 - i7 * 2;
          ir.eitaa.ui.ActionBar.Theme.cornerInner[0].setBounds(i1, n, i1 + i7, n + i7);
          ir.eitaa.ui.ActionBar.Theme.cornerInner[0].draw(paramCanvas);
          i1 = i8 + i9 + i7;
          ir.eitaa.ui.ActionBar.Theme.cornerInner[1].setBounds(i1, n, i1 + i7, n + i7);
          ir.eitaa.ui.ActionBar.Theme.cornerInner[1].draw(paramCanvas);
          i5 = m;
        }
        else
        {
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/Cells/ChatActionCell.class
