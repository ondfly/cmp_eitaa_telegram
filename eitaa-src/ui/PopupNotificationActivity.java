  ...
  implements NotificationCenter.NotificationCenterDelegate
{
  ...
  private ViewGroup getViewForMessage(int paramInt, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      localObject3 = (TextView)((ViewGroup)localObject2).findViewById(2131492887);
      localBackupImageView = (BackupImageView)((ViewGroup)localObject2).findViewById(2131492900);
    ...
    for (;;)
    {
      ...
      ((ViewGroup)localObject2).addView(getLayoutInflater().inflate(2130903050, null));
      ...
      if (localMessageObject.type == 2)
      {
        ...
        for (;;)
        {
          ...
          break;
          localObject2 = new FrameLayoutAnimationListener(this);
          ((ViewGroup)localObject2).addView(getLayoutInflater().inflate(2130903048, null));
          ...
          localObject1 = (ViewGroup)((ViewGroup)localObject2).findViewById(2131492898);
      ...
      for (;;)
      {
        localObject2 = (TextView)((ViewGroup)localObject1).findViewById(2131492887);
        ...
        ((ViewGroup)localObject1).addView(getLayoutInflater().inflate(2130903051, null));
        ((ViewGroup)localObject1).setTag(Integer.valueOf(1));
        ((ViewGroup)localObject1).findViewById(2131492897).setOnClickListener(new View.OnClickListener()
        {
          public void onClick(View paramAnonymousView)
          {
            PopupNotificationActivity.this.openCurrentMessage();
  ...
  private void updateInterfaceForCurrentMessage(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (this.currentUser != null)
      {
        ...
        if ((int)l == 0)
        {
          this.nameTextView.setCompoundDrawablesWithIntrinsicBounds(2130837740, 0, 0, 0);
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.actionBar.setBackgroundColor(-1674199);
    this.actionBar.setItemsBackgroundColor(-3772928);
    ...
    this.countText = ((TextView)this.actionBar.createMenu().addItemResource(2, 2130903049).findViewById(2131492899));
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/PopupNotificationActivity.class
