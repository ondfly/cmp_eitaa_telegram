...
import ir.eitaa.messenger.support.widget.helper.ItemTouchHelper.Callback;
  ...
  implements NotificationCenter.NotificationCenterDelegate
{
  ...
  public View createView(Context paramContext)
  {
    ...
    if (this.currentType == 0) {
      this.actionBar.setTitle(LocaleController.getString("Stickers", 2131166313));
    }
    for (;;)
    {
    ...
    extends RecyclerView.Adapter
  {
    ...
    private void processSelectionOption(int paramInt, TLRPC.TL_messages_stickerSet paramTL_messages_stickerSet)
    {
      ...
      do
      {
        ...
        if (paramInt == 2) {
          try
          {
            ...
            ((Intent)localObject).putExtra("android.intent.extra.TEXT", String.format(Locale.US, "https://eitaa.com/addstickers/%s", new Object[] { paramTL_messages_stickerSet.set.short_name }));
            StickersActivity.this.getParentActivity().startActivityForResult(Intent.createChooser((Intent)localObject, LocaleController.getString("StickersShare", 2131166318)), 500);
            return;
          }
          catch (Exception paramTL_messages_stickerSet)
          {
            FileLog.e("TSMS", paramTL_messages_stickerSet);
            return;
          }
        }
      } while (paramInt != 3);
      try
      {
        ((ClipboardManager)ApplicationLoader.applicationContext.getSystemService("clipboard")).setPrimaryClip(ClipData.newPlainText("label", String.format(Locale.US, "https://eitaa.com/addstickers/%s", new Object[] { paramTL_messages_stickerSet.set.short_name })));
        Toast.makeText(StickersActivity.this.getParentActivity(), LocaleController.getString("LinkCopied", 2131165826), 0).show();
        return;
      }
      catch (Exception paramTL_messages_stickerSet)
      {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder paramViewHolder, int paramInt)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          {
            localObject1 = LocaleController.getString("FeaturedStickersInfo", 2131165636);
        ...
        ((TextInfoPrivacyCell)paramViewHolder.itemView).setText(LocaleController.getString("MasksInfo", 2131165853));
        return;
        if (paramInt == StickersActivity.this.featuredRow)
        {
          ...
          String str = LocaleController.getString("FeaturedStickers", 2131165635);
          if (paramInt != 0) {}
      ...
      ((TextSettingsCell)paramViewHolder.itemView).setText(LocaleController.getString("Masks", 2131165852), true);
    }
          ...
          public void onClick(View paramAnonymousView)
          {
            ...
            if (StickersActivity.this.currentType == 0) {
              if (localTL_messages_stickerSet.set.official)
              {
                ...
                paramAnonymousView[0] = LocaleController.getString("StickersHide", 2131166315);
              }
            }
            for (;;)
            {
              ...
              paramAnonymousView[0] = LocaleController.getString("StickersHide", 2131166315);
              paramAnonymousView[1] = LocaleController.getString("StickersRemove", 2131166316);
              paramAnonymousView[2] = LocaleController.getString("StickersShare", 2131166318);
              paramAnonymousView[3] = LocaleController.getString("StickersCopy", 2131166314);
              continue;
              if (localTL_messages_stickerSet.set.official)
              {
                arrayOfInt = new int[1];
                arrayOfInt[0] = 0;
                paramAnonymousView = new CharSequence[1];
                paramAnonymousView[0] = LocaleController.getString("StickersRemove", 2131166315);
              }
              else
              {
                arrayOfInt = new int[4];
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/StickersActivity.class
