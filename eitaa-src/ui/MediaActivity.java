...
import ir.eitaa.ui.Adapters.BaseSectionsAdapter;
...
import ir.eitaa.ui.Cells.SharedLinkCell.SharedLinkCellDelegate;
import ir.eitaa.ui.Cells.SharedMediaSectionCell;
import ir.eitaa.ui.Cells.SharedPhotoVideoCell;
import ir.eitaa.ui.Cells.SharedPhotoVideoCell.SharedPhotoVideoCellDelegate;
...
import ir.eitaa.ui.Components.SectionsListView;
  ...
  implements NotificationCenter.NotificationCenterDelegate, PhotoViewer.PhotoViewerProvider
{
  ...
  private void onItemClick(int paramInt1, View paramView, MessageObject paramMessageObject, int paramInt2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject3 = FileProvider.getUriForFile(getParentActivity(), "ir.eitaa.messenger.provider", (File)localObject1);
        if (paramView == null) {
          break label835;
        }
        ...
        localIntent.setDataAndType(FileProvider.getUriForFile(getParentActivity(), "ir.eitaa.messenger.provider", (File)localObject1), "text/plain");
        label727:
        getParentActivity().startActivityForResult(localIntent, 500);
        return;
      }
      ...
      paramView.setPositiveButton(LocaleController.getString("OK", 2131166047), null);
      paramView.setMessage(LocaleController.formatString("NoHandleAppInstalled", 2131165937, new Object[] { paramMessageObject.getDocument().mime_type }));
  ...
  private void switchToCurrentSelectedMode()
  {
    if ((this.searching) && (this.searchWas)) {
      ...
      {
        this.emptyTextView.setText(LocaleController.getString("NoResult", 2131165952));
    ...
    do
    {
      ...
      if (this.selectedMode == 0)
      {
        ...
        this.dropDown.setText(LocaleController.getString("SharedMediaTitle", 2131166289));
        this.emptyImageView.setImageResource(2130838002);
        if ((int)this.dialog_id == 0)
        {
          this.emptyTextView.setText(LocaleController.getString("NoMediaSecret", 2131165942));
        ...
        for (;;)
        {
          ...
          return;
          this.emptyTextView.setText(LocaleController.getString("NoMedia", 2131165940));
          break;
      ...
      if ((this.selectedMode == 1) || (this.selectedMode == 4))
      {
        if (this.selectedMode == 1)
        {
          ...
          if ((int)this.dialog_id == 0)
          {
            this.emptyTextView.setText(LocaleController.getString("NoSharedFilesSecret", 2131165956));
        ...
        for (;;)
        {
          this.listView.setPadding(0, 0, 0, AndroidUtilities.dp(4.0F));
          return;
          this.emptyTextView.setText(LocaleController.getString("NoSharedFiles", 2131165955));
          break;
          if (this.selectedMode != 4) {
            break;
          }
          ...
          if ((int)this.dialog_id == 0)
          {
            this.emptyTextView.setText(LocaleController.getString("NoSharedAudioSecret", 2131165954));
            break;
          }
          this.emptyTextView.setText(LocaleController.getString("NoSharedAudio", 2131165953));
          break;
          i = 8;
          break label481;
          i = 4;
    ...
    this.dropDown.setText(LocaleController.getString("LinksTitle", 2131165836));
    this.emptyImageView.setImageResource(2130838004);
    if ((int)this.dialog_id == 0)
    {
      this.emptyTextView.setText(LocaleController.getString("NoSharedLinksSecret", 2131165958));
      localActionBarMenuItem = this.searchItem;
    ...
    for (;;)
    {
      this.listView.setPadding(0, 0, 0, AndroidUtilities.dp(4.0F));
      return;
      this.emptyTextView.setText(LocaleController.getString("NoSharedLinks", 2131165957));
      break;
      label1088:
      i = 8;
      break label899;
  ...
  public View createView(Context paramContext)
  {
    ...
    this.dropDownContainer.addSubItem(1, LocaleController.getString("SharedMediaTitle", 2131166289), 0);
    this.dropDownContainer.addSubItem(2, LocaleController.getString("DocumentsTitle", 2131165589), 0);
    if ((int)this.dialog_id != 0)
    {
      this.dropDownContainer.addSubItem(5, LocaleController.getString("LinksTitle", 2131165836), 0);
    ...
    for (float f = 64.0F;; f = 56.0F)
    {
      ...
      this.dropDown.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130837721, 0);
      ...
      if ((int)this.dialog_id != 0) {
        this.actionModeViews.add(((ActionBarMenu)localObject1).addItem(3, 2130837711, -986896, null, AndroidUtilities.dp(54.0F)));
      }
      this.actionModeViews.add(((ActionBarMenu)localObject1).addItem(4, 2130837710, -986896, null, AndroidUtilities.dp(54.0F)));
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/MediaActivity.class
