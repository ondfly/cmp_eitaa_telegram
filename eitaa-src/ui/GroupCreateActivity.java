  ...
  implements NotificationCenter.NotificationCenterDelegate
{
  ...
  public View createView(Context paramContext)
  {
          ...
          public void afterTextChanged(Editable paramAnonymousEditable)
          {
            ...
            if (!GroupCreateActivity.this.ignoreChange)
            {
              ...
              catch (Exception localException)
              {
                ...
                GroupCreateActivity.this.actionBar.setSubtitle(LocaleController.formatString("MembersCount", 2131165867, new Object[] { Integer.valueOf(GroupCreateActivity.this.selectedContacts.size()), Integer.valueOf(GroupCreateActivity.this.maxCount) }));
            ...
            for (;;)
            {
              ...
              if (i != 0)
              {
                ...
                if (GroupCreateActivity.this.emptyTextView != null) {
                  GroupCreateActivity.this.emptyTextView.setText(LocaleController.getString("NoResult", 2131165952));
                }
            ...
            GroupCreateActivity.this.emptyTextView.setText(LocaleController.getString("NoContacts", 2131165935));
          }
    ...
    for (int i = 1;; i = 2)
    {
          ...
          do
          {
            ...
            for (;;)
            {
              ...
              if ((GroupCreateActivity.this.chatType == 0) && (GroupCreateActivity.this.selectedContacts.size() == MessagesController.getInstance().maxGroupCount))
              {
                ...
                paramAnonymousAdapterView.setMessage(LocaleController.getString("SoftUserLimitAlert", 2131166304));
                paramAnonymousAdapterView.setPositiveButton(LocaleController.getString("OK", 2131166047), null);
      ...
      if (this.chatType == 0) {}
      for (localObject1 = LocaleController.getString("NewGroup", 2131165920);; localObject1 = LocaleController.getString("NewBroadcastList", 2131165918))
      {
        ((ActionBar)localObject2).setTitle((CharSequence)localObject1);
        this.actionBar.setSubtitle(LocaleController.formatString("MembersCount", 2131165867, new Object[] { Integer.valueOf(this.selectedContacts.size()), Integer.valueOf(this.maxCount) }));
        break;
      }
      i = 3;
      break label345;
      ...
      if (this.isNeverShare)
      {
        if (this.isGroup)
        {
          this.userSelectEditText.setHint(LocaleController.getString("NeverAllowPlaceholder", 2131165914));
          break label417;
        }
        this.userSelectEditText.setHint(LocaleController.getString("NeverShareWithPlaceholder", 2131165916));
        break label417;
      }
      this.userSelectEditText.setHint(LocaleController.getString("SendMessageTo", 2131166244));
      break label417;
    }
  }
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/GroupCreateActivity.class
