  ...
  extends BaseFragment
{
      ...
      if (LocaleController.isRTL)
      {
        ...
        this.problemText.setOnClickListener(new View.OnClickListener()
        {
          public void onClick(View paramAnonymousView)
          {
            ...
            {
              ChangePhoneActivity.this.needShowAlert(LocaleController.getString("NoMailInstalled", 2131165938));
            }
          }
        });
                ...
                do
                {
                  for (;;)
                  {
                    ...
                    if (ChangePhoneActivity.LoginActivitySmsView.this.nextType == 2) {
                      ChangePhoneActivity.LoginActivitySmsView.this.timeText.setText(LocaleController.formatString("SmsText", 2131166303, new Object[] { Integer.valueOf(i), Integer.valueOf(j) }));
                    }
                  }
                  if (ChangePhoneActivity.LoginActivitySmsView.this.progressView != null) {
            ...
            public void run()
            {
              ...
              for (;;)
              {
                ...
                if (paramAnonymousTL_error.text != null) {
                  ...
                  {
                    ChangePhoneActivity.this.needShowAlert(LocaleController.getString("InvalidPhoneNumber", 2131165761));
                  }
                  else if ((paramAnonymousTL_error.text.contains("PHONE_CODE_EMPTY")) || (paramAnonymousTL_error.text.contains("PHONE_CODE_INVALID")))
                  {
                    ChangePhoneActivity.this.needShowAlert(LocaleController.getString("InvalidCode", 2131165757));
                  }
                  ...
                  {
                    ChangePhoneActivity.this.needShowAlert(LocaleController.getString("FloodWait", 2131165642));
                  }
                  else if (paramAnonymousTL_error.code != 64536)
                  {
                    ChangePhoneActivity.this.needShowAlert(LocaleController.getString("ErrorOccurred", 2131165629) + "\n" + paramAnonymousTL_error.text);
                  }
                }
              }
            }
    ...
    implements AdapterView.OnItemSelectedListener
  {
        ...
        this.codeField.addTextChangedListener(new TextWatcher()
        {
          public void afterTextChanged(Editable paramAnonymousEditable)
          {
            ...
            for (;;)
            {
              ...
              localObject1 = null;
              break label447;
              ChangePhoneActivity.PhoneView.this.countryButton.setText(LocaleController.getString("WrongCountry", 2131166409));
              ChangePhoneActivity.PhoneView.this.phoneField.setHintText(null);
    ...
    public void onNextPressed()
    {
      ...
      {
        ChangePhoneActivity.this.needShowAlert(LocaleController.getString("WrongCountry", 2131166409));
        return;
      }
      if (this.codeField.length() == 0)
      {
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/ChangePhoneActivity.class
