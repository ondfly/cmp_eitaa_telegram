...
import ir.eitaa.tgnet.TLRPC.TL_chatPhoto;
  ...
  implements AvatarUpdater.AvatarUpdaterDelegate, NotificationCenter.NotificationCenterDelegate
{
  ...
  private void updateTypeCell()
  {
    ...
    if ((this.currentChat.username == null) || (this.currentChat.username.length() == 0))
    {
      ...
      this.typeCell.setTextAndValue(LocaleController.getString("GroupType", 2131165723), str, false);
    }
    for (;;)
    {
  ...
  public View createView(Context paramContext)
  {
    ...
    this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick()
    {
      public void onItemClick(int paramAnonymousInt)
      {
        ...
        if (ChannelEditActivity.this.avatarUpdater.uploadingAvatar != null)
        {
          ...
          ChannelEditActivity.this.progressDialog.setMessage(LocaleController.getString("Loading", 2131165837));
    ...
    if (LocaleController.isRTL)
    {
      ...
      this.nameTextView.setHint(LocaleController.getString("GroupName", 2131165721));
      label359:
      ...
      if ((this.currentChat.megagroup) || (!this.currentChat.megagroup))
      {
        ...
        updateTypeCell();
        this.typeCell.setBackgroundResource(2130837798);
        ...
        ((TextCheckCell)localObject2).setBackgroundResource(2130837798);
        ...
        ((TextInfoPrivacyCell)localObject1).setBackgroundResource(2130837694);
      ...
      if (this.currentChat.creator)
      {
        ...
        ((TextSettingsCell)localObject2).setBackgroundResource(2130837798);
        if (!this.currentChat.megagroup) {
          break label1575;
        }
        ...
        ((TextSettingsCell)localObject2).setOnClickListener(new View.OnClickListener()
        {
          public void onClick(View paramAnonymousView)
          {
            ...
            if (ChannelEditActivity.this.currentChat.megagroup) {
              paramAnonymousView.setMessage(LocaleController.getString("MegaDeleteAlert", 2131165857));
            }
            for (;;)
            {
        ...
        paramContext.setBackgroundResource(2130837695);
        if (!this.currentChat.megagroup) {
          break label1593;
        }
        paramContext.setText(LocaleController.getString("MegaDeleteInfo", 2131165858));
        label1296:
    ...
    for (;;)
    {
      ...
      updateAdminCell();
      this.adminCell.setBackgroundResource(2130837798);
      ...
      ((ShadowSectionCell)localObject1).setBackgroundResource(2130837695);
      break label1140;
      label1575:
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/ChannelEditActivity.class
