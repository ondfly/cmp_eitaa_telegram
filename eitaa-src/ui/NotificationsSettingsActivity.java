...
import ir.eitaa.tgnet.TLRPC.TL_account_resetNotifySettings;
...
import ir.eitaa.ui.Components.ColorPickerView;
  ...
  implements NotificationCenter.NotificationCenterDelegate
{
  ...
  public View createView(Context paramContext)
  {
    ...
    this.actionBar.setTitle(LocaleController.getString("NotificationsAndSounds", 2131166034));
        ...
        for (bool1 = true;; bool1 = false)
        {
          ...
          do
          {
                ...
                AndroidUtilities.runOnUIThread(new Runnable()
                {
                  public void run()
                  {
                    ...
                    if (NotificationsSettingsActivity.this.getParentActivity() != null) {
                      Toast.makeText(NotificationsSettingsActivity.this.getParentActivity(), LocaleController.getString("ResetNotificationsText", 2131166185), 0).show();
                    }
                  }
                });
              }
            ...
            if (paramAnonymousInt == NotificationsSettingsActivity.this.badgeNumberRow)
            {
              paramAnonymousAdapterView = ApplicationLoader.applicationContext.getSharedPreferences("Notifications", 0);
              localObject1 = paramAnonymousAdapterView.edit();
              bool2 = paramAnonymousAdapterView.getBoolean("badgeNumber", false);
              if (!bool2)
              {
                bool1 = true;
          ...
          for (;;)
          {
            ...
            ((AlertDialog.Builder)localObject2).setTitle(LocaleController.getString("LedColor", 2131165822));
            ((AlertDialog.Builder)localObject2).setView(paramAnonymousAdapterView);
            ((AlertDialog.Builder)localObject2).setPositiveButton(LocaleController.getString("Set", 2131166262), new DialogInterface.OnClickListener()
            {
              public void onClick(DialogInterface paramAnonymous2DialogInterface, int paramAnonymous2Int)
              {
                ...
                if (paramAnonymousInt == NotificationsSettingsActivity.this.messageLedRow)
                {
                  ...
                  localTextColorCell.setTextAndColor(LocaleController.getString("LedColor", 2131165822), localObject1.getColor(), true);
                }
                for (;;)
                {
            ...
            ((AlertDialog.Builder)localObject2).setNeutralButton(LocaleController.getString("LedDisabled", 2131165823), new DialogInterface.OnClickListener()
            {
              public void onClick(DialogInterface paramAnonymous2DialogInterface, int paramAnonymous2Int)
              {
                paramAnonymous2DialogInterface = ApplicationLoader.applicationContext.getSharedPreferences("Notifications", 0).edit();
                ...
                if (paramAnonymousInt == NotificationsSettingsActivity.this.messageLedRow)
                {
                  ...
                  localTextColorCell.setTextAndColor(LocaleController.getString("LedColor", 2131165822), 0, true);
                }
                for (;;)
                {
                  paramAnonymous2DialogInterface.commit();
          ...
          if ((paramAnonymousInt == NotificationsSettingsActivity.this.messagePopupNotificationRow) || (paramAnonymousInt == NotificationsSettingsActivity.this.groupPopupNotificationRow))
          {
            ...
            paramAnonymousAdapterView.setTitle(LocaleController.getString("PopupNotification", 2131166141));
            localObject1 = LocaleController.getString("NoPopup", 2131165948);
            localObject2 = LocaleController.getString("OnlyWhenScreenOn", 2131166058);
            str1 = LocaleController.getString("OnlyWhenScreenOff", 2131166057);
          ...
          {
            paramAnonymousAdapterView = new AlertDialog.Builder(NotificationsSettingsActivity.this.getParentActivity());
            paramAnonymousAdapterView.setTitle(LocaleController.getString("Vibrate", 2131166385));
            localObject1 = LocaleController.getString("VibrationDisabled", 2131166387);
            localObject2 = LocaleController.getString("VibrationDefault", 2131166386);
            str1 = LocaleController.getString("Short", 2131166291);
            localObject3 = LocaleController.getString("Long", 2131165850);
            localObject4 = LocaleController.getString("OnlyIfSilent", 2131166056);
          ...
          {
            paramAnonymousAdapterView = new AlertDialog.Builder(NotificationsSettingsActivity.this.getParentActivity());
            paramAnonymousAdapterView.setTitle(LocaleController.getString("NotificationsPriority", 2131166037));
            localObject1 = LocaleController.getString("NotificationsPriorityDefault", 2131166038);
            localObject2 = LocaleController.getString("NotificationsPriorityHigh", 2131166039);
            str1 = LocaleController.getString("NotificationsPriorityMax", 2131166041);
          ...
          paramAnonymousAdapterView = new AlertDialog.Builder(NotificationsSettingsActivity.this.getParentActivity());
          paramAnonymousAdapterView.setTitle(LocaleController.getString("RepeatNotifications", 2131166157));
          localObject1 = LocaleController.getString("RepeatDisabled", 2131166156);
    ...
    if (paramInt2 == -1)
    {
      ...
      if (localUri != null)
      {
        ...
        if (localRingtone != null)
        {
          ...
          paramIntent = LocaleController.getString("SoundDefault", 2131166309);
          localRingtone.stop();
        }
      }
    ...
    extends BaseFragmentAdapter
  {
    ...
    public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
    {
      ...
      if (i == 0)
      {
        ...
        {
          ((HeaderCell)localObject1).setText(LocaleController.getString("MessageNotifications", 2131165880));
        ...
        do
        {
          do
          {
            do
            {
              do
              {
                do
                {
                  do
                  {
                    ...
                    {
                      ((HeaderCell)localObject1).setText(LocaleController.getString("GroupNotifications", 2131165722));
                      paramViewGroup = (ViewGroup)localObject1;
                      break;
                    }
                    if (paramInt == NotificationsSettingsActivity.this.inappSectionRow)
                    {
                      ((HeaderCell)localObject1).setText(LocaleController.getString("InAppNotifications", 2131165749));
                      paramViewGroup = (ViewGroup)localObject1;
                      break;
                    }
                    if (paramInt == NotificationsSettingsActivity.this.eventsSectionRow)
                    {
                      ((HeaderCell)localObject1).setText(LocaleController.getString("Events", 2131165630));
                      paramViewGroup = (ViewGroup)localObject1;
                      break;
                    }
                    if (paramInt == NotificationsSettingsActivity.this.otherSectionRow)
                    {
                      ((HeaderCell)localObject1).setText(LocaleController.getString("NotificationsOther", 2131166036));
                      paramViewGroup = (ViewGroup)localObject1;
                      break;
                    }
                    paramViewGroup = (ViewGroup)localObject1;
                    ...
                    ((HeaderCell)localObject1).setText(LocaleController.getString("Reset", 2131166173));
                    paramViewGroup = (ViewGroup)localObject1;
                    break;
                    ...
                    {
                      paramViewGroup.setTextAndCheck(LocaleController.getString("MessagePreview", 2131165881), ((SharedPreferences)localObject2).getBoolean("EnablePreviewAll", true), true);
                      return (View)localObject1;
                    }
                    if (paramInt == NotificationsSettingsActivity.this.groupPreviewRow)
                    {
                      paramViewGroup.setTextAndCheck(LocaleController.getString("MessagePreview", 2131165881), ((SharedPreferences)localObject2).getBoolean("EnablePreviewGroup", true), true);
                      return (View)localObject1;
                    }
                    if (paramInt == NotificationsSettingsActivity.this.inappSoundRow)
                    {
                      paramViewGroup.setTextAndCheck(LocaleController.getString("InAppSounds", 2131165751), ((SharedPreferences)localObject2).getBoolean("EnableInAppSounds", true), true);
                      return (View)localObject1;
                    }
                    if (paramInt == NotificationsSettingsActivity.this.inappVibrateRow)
                    {
                      paramViewGroup.setTextAndCheck(LocaleController.getString("InAppVibrate", 2131165752), ((SharedPreferences)localObject2).getBoolean("EnableInAppVibrate", true), true);
                      return (View)localObject1;
                    }
                    if (paramInt == NotificationsSettingsActivity.this.inappPreviewRow)
                    {
                      paramViewGroup.setTextAndCheck(LocaleController.getString("InAppPreview", 2131165750), ((SharedPreferences)localObject2).getBoolean("EnableInAppPreview", true), true);
                      return (View)localObject1;
                    }
                    if (paramInt == NotificationsSettingsActivity.this.inappPriorityRow)
                    {
                      paramViewGroup.setTextAndCheck(LocaleController.getString("NotificationsPriority", 2131166037), ((SharedPreferences)localObject2).getBoolean("EnableInAppPriority", false), false);
                      return (View)localObject1;
                    }
                    ...
                    {
                      paramViewGroup.setTextAndCheck(LocaleController.getString("PinnedMessages", 2131166129), ((SharedPreferences)localObject2).getBoolean("PinnedMessages", true), false);
                      return (View)localObject1;
                    }
                    ...
                    {
                      paramViewGroup.setTextAndValueAndCheck(LocaleController.getString("NotificationsService", 2131166042), LocaleController.getString("NotificationsServiceInfo", 2131166045), ((SharedPreferences)localObject2).getBoolean("pushService", true), true, true);
                      return (View)localObject1;
                    }
                    if (paramInt == NotificationsSettingsActivity.this.notificationsServiceConnectionRow)
                    {
                      paramViewGroup.setTextAndValueAndCheck(LocaleController.getString("NotificationsServiceConnection", 2131166043), LocaleController.getString("NotificationsServiceConnectionInfo", 2131166044), ((SharedPreferences)localObject2).getBoolean("pushConnection", true), true, true);
                      return (View)localObject1;
                    }
                    if (paramInt == NotificationsSettingsActivity.this.badgeNumberRow)
                    {
                      paramViewGroup.setTextAndCheck(LocaleController.getString("BadgeNumber", 2131165357), ((SharedPreferences)localObject2).getBoolean("badgeNumber", false), true);
                      return (View)localObject1;
                    }
                    paramView = (View)localObject1;
                  } while (paramInt != NotificationsSettingsActivity.this.inchatSoundRow);
                  paramViewGroup.setTextAndCheck(LocaleController.getString("InChatSound", 2131165753), ((SharedPreferences)localObject2).getBoolean("EnableInChatSound", true), true);
                  return (View)localObject1;
                  if (i != 2) {
                    break label1731;
                  }
                  ...
                  if ((paramInt == NotificationsSettingsActivity.this.messageSoundRow) || (paramInt == NotificationsSettingsActivity.this.groupSoundRow))
                  {
                    ...
                    if (paramInt == NotificationsSettingsActivity.this.messageSoundRow) {
                      paramView = paramViewGroup.getString("GlobalSound", LocaleController.getString("SoundDefault", 2131166309));
                    }
                    for (;;)
                    {
                      paramViewGroup = paramView;
                      if (paramView.equals("NoSound")) {
                        paramViewGroup = LocaleController.getString("NoSound", 2131165959);
                      }
                      ((TextDetailSettingsCell)localObject2).setTextAndValue(LocaleController.getString("Sound", 2131166308), paramViewGroup, true);
                      return (View)localObject1;
                      if (paramInt == NotificationsSettingsActivity.this.groupSoundRow) {
                        paramView = paramViewGroup.getString("GroupSound", LocaleController.getString("SoundDefault", 2131166309));
                      }
                    }
                  }
                  if (paramInt == NotificationsSettingsActivity.this.resetNotificationsRow)
                  {
                    ...
                    ((TextDetailSettingsCell)localObject2).setTextAndValue(LocaleController.getString("ResetAllNotifications", 2131166179), LocaleController.getString("UndoAllCustom", 2131166354), false);
                    return (View)localObject1;
                  }
                  if ((paramInt == NotificationsSettingsActivity.this.messagePopupNotificationRow) || (paramInt == NotificationsSettingsActivity.this.groupPopupNotificationRow))
                  {
                    ...
                    if (paramInt == NotificationsSettingsActivity.this.messagePopupNotificationRow)
                    {
                      ...
                      paramView = LocaleController.getString("NoPopup", 2131165948);
                    }
                    for (;;)
                    {
                      ((TextDetailSettingsCell)localObject2).setTextAndValue(LocaleController.getString("PopupNotification", 2131166141), paramView, true);
                      return (View)localObject1;
                      ...
                      break;
                      if (i == 1) {
                        paramView = LocaleController.getString("OnlyWhenScreenOn", 2131166058);
                      } else if (i == 2) {
                        paramView = LocaleController.getString("OnlyWhenScreenOff", 2131166057);
                      } else {
                  ...
                  while (i == 0)
                  {
                    ((TextDetailSettingsCell)localObject2).setTextAndValue(LocaleController.getString("Vibrate", 2131166385), LocaleController.getString("VibrationDefault", 2131166386), true);
                    return (View)localObject1;
                  ...
                  if (i == 1)
                  {
                    ((TextDetailSettingsCell)localObject2).setTextAndValue(LocaleController.getString("Vibrate", 2131166385), LocaleController.getString("Short", 2131166291), true);
                    return (View)localObject1;
                  }
                  if (i == 2)
                  {
                    ((TextDetailSettingsCell)localObject2).setTextAndValue(LocaleController.getString("Vibrate", 2131166385), LocaleController.getString("VibrationDisabled", 2131166387), true);
                    return (View)localObject1;
                  }
                  if (i == 3)
                  {
                    ((TextDetailSettingsCell)localObject2).setTextAndValue(LocaleController.getString("Vibrate", 2131166385), LocaleController.getString("Long", 2131165850), true);
                    return (View)localObject1;
                  }
                  paramView = (View)localObject1;
                } while (i != 4);
                ((TextDetailSettingsCell)localObject2).setTextAndValue(LocaleController.getString("Vibrate", 2131166385), LocaleController.getString("OnlyIfSilent", 2131166056), true);
                return (View)localObject1;
                if (paramInt == NotificationsSettingsActivity.this.repeatRow)
                {
                  ...
                  if (paramInt == 0) {
                    paramView = LocaleController.getString("RepeatNotificationsNever", 2131166158);
                  }
                  for (;;)
                  {
                    ((TextDetailSettingsCell)localObject2).setTextAndValue(LocaleController.getString("RepeatNotifications", 2131166157), paramView, false);
                    return (View)localObject1;
                    if (paramInt < 60) {
              ...
              while (i == 0)
              {
                ((TextDetailSettingsCell)localObject2).setTextAndValue(LocaleController.getString("NotificationsPriority", 2131166037), LocaleController.getString("NotificationsPriorityDefault", 2131166038), false);
                return (View)localObject1;
              ...
              if (i == 1)
              {
                ((TextDetailSettingsCell)localObject2).setTextAndValue(LocaleController.getString("NotificationsPriority", 2131166037), LocaleController.getString("NotificationsPriorityHigh", 2131166039), false);
                return (View)localObject1;
              }
              paramView = (View)localObject1;
            } while (i != 2);
            ((TextDetailSettingsCell)localObject2).setTextAndValue(LocaleController.getString("NotificationsPriority", 2131166037), LocaleController.getString("NotificationsPriorityMax", 2131166041), false);
            return (View)localObject1;
            if (i != 3) {
              break label1859;
            }
            ...
            {
              paramViewGroup.setTextAndColor(LocaleController.getString("LedColor", 2131165822), ((SharedPreferences)localObject2).getInt("MessagesLed", -16711936), true);
              return (View)localObject1;
            }
            paramView = (View)localObject1;
          } while (paramInt != NotificationsSettingsActivity.this.groupLedRow);
          paramViewGroup.setTextAndColor(LocaleController.getString("LedColor", 2131165822), ((SharedPreferences)localObject2).getInt("GroupLed", -16711936), true);
          return (View)localObject1;
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/NotificationsSettingsActivity.class
