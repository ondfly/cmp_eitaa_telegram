...
import ir.eitaa.tgnet.TLRPC.TL_wallPaperSolid;
  ...
  implements NotificationCenter.NotificationCenterDelegate
{
  ...
  public View createView(Context paramContext)
  {
    ...
    try
    {
      ((ProgressBar)localObject).setIndeterminateDrawable(paramContext.getResources().getDrawable(2130837803));
      ...
      ((RecyclerListView)localObject).setOnItemClickListener(new RecyclerListView.OnItemClickListener()
      {
        public void onItemClick(View paramAnonymousView, int paramAnonymousInt)
        {
          ...
          while ((paramAnonymousInt - 1 < 0) || (paramAnonymousInt - 1 >= WallpapersActivity.this.wallPapers.size()))
          {
            ...
            String str1 = LocaleController.getString("FromCamera", 2131165706);
            String str2 = LocaleController.getString("FromGalley", 2131165713);
                ...
                if (paramAnonymous2Int == 0) {
                  try
                  {
                    ...
                    if (localFile != null)
                    {
                      ...
                      paramAnonymous2DialogInterface.putExtra("output", FileProvider.getUriForFile(WallpapersActivity.this.getParentActivity(), "ir.eitaa.messenger.provider", localFile));
                  ...
                  {
                    FileLog.e("TSMS", paramAnonymous2DialogInterface);
                    return;
                  }
                }
  ...
  public void onActivityResultFragment(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    //   8: if_icmpne +209 -> 217
    //   11: aload_0
    //   12: getfield 87	ir/eitaa/ui/WallpapersActivity:currentPicturePath	Ljava/lang/String;
    //   15: invokestatic 545	ir/eitaa/messenger/AndroidUtilities:addMediaToGallery	(Ljava/lang/String;)V
    //   18: aconst_null
    //   19: astore 4
    //   21: aconst_null
    //   22: astore 5
    //   24: aload 4
    //   26: astore_3
    //   27: invokestatic 549	ir/eitaa/messenger/AndroidUtilities:getRealScreenSize	()Landroid/graphics/Point;
    //   30: astore 6
    //   32: aload 4
    //   34: astore_3
    //   35: aload_0
    //   36: getfield 87	ir/eitaa/ui/WallpapersActivity:currentPicturePath	Ljava/lang/String;
    //   39: aconst_null
    //   40: aload 6
    ...
    //   51: i2f
    //   52: iconst_1
    //   53: invokestatic 555	ir/eitaa/messenger/ImageLoader:loadBitmap	(Ljava/lang/String;Landroid/net/Uri;FFZ)Landroid/graphics/Bitmap;
    //   56: astore 6
    //   58: aload 4
    //   60: astore_3
    ...
    //   68: dup
    //   69: invokestatic 310	ir/eitaa/messenger/ApplicationLoader:getFilesDirFixed	()Ljava/io/File;
    //   72: ldc_w 312
    ...
    //   96: aload_0
    //   97: iconst_m1
    //   98: putfield 76	ir/eitaa/ui/WallpapersActivity:selectedBackground	I
    //   101: aload_0
    //   102: iconst_0
    //   103: putfield 83	ir/eitaa/ui/WallpapersActivity:selectedColor	I
    //   106: aload_0
    //   107: getfield 102	ir/eitaa/ui/WallpapersActivity:backgroundImage	Landroid/widget/ImageView;
    //   110: invokevirtual 229	android/widget/ImageView:getDrawable	()Landroid/graphics/drawable/Drawable;
    //   113: pop
    //   114: aload_0
    //   115: getfield 102	ir/eitaa/ui/WallpapersActivity:backgroundImage	Landroid/widget/ImageView;
    //   118: aload 6
    ...
    //   133: aload_0
    //   134: aconst_null
    //   135: putfield 87	ir/eitaa/ui/WallpapersActivity:currentPicturePath	Ljava/lang/String;
    //   138: return
    //   139: astore_3
    //   140: ldc_w 294
    //   143: aload_3
    //   144: invokestatic 300	ir/eitaa/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   147: goto -14 -> 133
    //   150: astore_3
    //   151: aload 5
    //   153: astore 4
    ...
    //   161: ldc_w 294
    //   164: aload 5
    //   166: invokestatic 300	ir/eitaa/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   169: aload 4
    //   171: ifnull -38 -> 133
    //   174: aload 4
    ...
    //   183: ldc_w 294
    //   186: aload_3
    //   187: invokestatic 300	ir/eitaa/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   190: goto -57 -> 133
    //   193: astore 4
    //   195: aload_3
    //   196: ifnull +7 -> 203
    ...
    //   207: ldc_w 294
    //   210: aload_3
    //   211: invokestatic 300	ir/eitaa/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   214: goto -11 -> 203
    //   217: iload_1
    //   218: bipush 11
    ...
    //   231: ifnull -93 -> 138
    //   234: invokestatic 549	ir/eitaa/messenger/AndroidUtilities:getRealScreenSize	()Landroid/graphics/Point;
    //   237: astore 4
    //   239: aconst_null
    //   240: aload_3
    ...
    //   255: i2f
    //   256: iconst_1
    //   257: invokestatic 555	ir/eitaa/messenger/ImageLoader:loadBitmap	(Ljava/lang/String;Landroid/net/Uri;FFZ)Landroid/graphics/Bitmap;
    //   260: astore_3
    //   261: new 557	java/io/FileOutputStream
    //   264: dup
    //   265: new 209	java/io/File
    //   268: dup
    //   269: invokestatic 310	ir/eitaa/messenger/ApplicationLoader:getFilesDirFixed	()Ljava/io/File;
    //   272: ldc_w 312
    ...
    //   295: aload_0
    //   296: iconst_m1
    //   297: putfield 76	ir/eitaa/ui/WallpapersActivity:selectedBackground	I
    //   300: aload_0
    //   301: iconst_0
    //   302: putfield 83	ir/eitaa/ui/WallpapersActivity:selectedColor	I
    //   305: aload_0
    //   306: getfield 102	ir/eitaa/ui/WallpapersActivity:backgroundImage	Landroid/widget/ImageView;
    //   309: invokevirtual 229	android/widget/ImageView:getDrawable	()Landroid/graphics/drawable/Drawable;
    //   312: pop
    //   313: aload_0
    //   314: getfield 102	ir/eitaa/ui/WallpapersActivity:backgroundImage	Landroid/widget/ImageView;
    //   317: aload_3
    ...
    //   323: ldc_w 294
    //   326: aload_3
    //   327: invokestatic 300	ir/eitaa/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   330: return
    //   331: astore 5
    //   333: aload 4
    //   335: astore_3
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/WallpapersActivity.class
