  ...
  extends BaseFragment
{
  public View createView(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      ((ImageView)localObject2).setImageResource(2130837879);
      ...
      try
      {
        ((TextView)localObject2).setText(AndroidUtilities.replaceTags(LocaleController.getString("PhoneNumberHelp", 2131166112)));
        ((LinearLayout)localObject1).addView((View)localObject2);
        ...
        paramContext.setText(LocaleController.getString("PhoneNumberChange", 2131166111));
        ...
        paramContext.setOnClickListener(new View.OnClickListener()
        {
          public void onClick(View paramAnonymousView)
          {
            ...
            paramAnonymousView.setMessage(LocaleController.getString("PhoneNumberAlert", 2131166110));
        ...
        localObject1 = LocaleController.getString("NumberUnknown", 2131166046);
      }
      catch (Exception localException)
      {
        for (;;)
        {
          ...
          ((TextView)localObject2).setText(LocaleController.getString("PhoneNumberHelp", 2131166112));
        }
      }
    }
  }
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/ChangePhoneHelpActivity.class
