    ...
    this.listView.setOnItemClickListener(new AdapterView.OnItemClickListener()
    {
      public void onItemClick(AdapterView<?> paramAnonymousAdapterView, final View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
      {
        ...
        if (paramAnonymousInt == ProfileNotificationsActivity.this.settingsVibrateRow)
        {
          ...
          paramAnonymousView = LocaleController.getString("VibrationDisabled", 2131166387);
          localObject1 = LocaleController.getString("SettingsDefault", 2131166274);
          localObject2 = LocaleController.getString("SystemDefault", 2131166326);
          localObject3 = LocaleController.getString("Short", 2131166291);
          localObject4 = LocaleController.getString("Long", 2131165850);
        ...
        do
        {
          do
          {
            ...
            localObject1 = LocaleController.getString("Enabled", 2131165605);
            localObject2 = LocaleController.getString("NotificationsDisabled", 2131166035);
          ...
          for (;;)
          {
            ...
            ((AlertDialog.Builder)localObject1).setTitle(LocaleController.getString("LedColor", 2131165822));
            ((AlertDialog.Builder)localObject1).setView(paramAnonymousAdapterView);
            ((AlertDialog.Builder)localObject1).setPositiveButton(LocaleController.getString("Set", 2131166262), new DialogInterface.OnClickListener()
            {
              public void onClick(DialogInterface paramAnonymous2DialogInterface, int paramAnonymous2Int)
              {
                paramAnonymous2DialogInterface = ApplicationLoader.applicationContext.getSharedPreferences("Notifications", 0).edit();
            ...
            ((AlertDialog.Builder)localObject1).setNeutralButton(LocaleController.getString("LedDisabled", 2131165823), new DialogInterface.OnClickListener()
            {
              public void onClick(DialogInterface paramAnonymous2DialogInterface, int paramAnonymous2Int)
              {
                paramAnonymous2DialogInterface = ApplicationLoader.applicationContext.getSharedPreferences("Notifications", 0).edit();
          ...
          if (paramAnonymousInt == ProfileNotificationsActivity.this.settingsPriorityRow)
          {
            ...
            paramAnonymousView = LocaleController.getString("SettingsDefault", 2131166274);
            ...
            localObject3 = LocaleController.getString("NotificationsPriorityMax", 2131166041);
        ...
        paramAnonymousView.setText(LocaleController.getString("SmartNotificationsSoundAtMost", 2131166300));
        ...
        ((TextView)localObject2).setText(LocaleController.getString("SmartNotificationsTimes", 2131166301));
        ...
        localObject2 = new TextView(ProfileNotificationsActivity.this.getParentActivity());
        ((TextView)localObject2).setText(LocaleController.getString("SmartNotificationsWithin", 2131166302));
        ((TextView)localObject2).setTextSize(1, 18.0F);
        ((LinearLayout)localObject1).addView((View)localObject2);
        ...
        ((TextView)localObject3).setText(LocaleController.getString("SmartNotificationsMinutes", 2131166299));
        ...
        localObject1 = new AlertDialog.Builder(ProfileNotificationsActivity.this.getParentActivity());
        ((AlertDialog.Builder)localObject1).setTitle(LocaleController.getString("SmartNotifications", 2131166296));
        ((AlertDialog.Builder)localObject1).setView(paramAnonymousAdapterView);
        ...
        ((AlertDialog.Builder)localObject1).setNegativeButton(LocaleController.getString("SmartNotificationsDisabled", 2131166297), new DialogInterface.OnClickListener()
        {
          public void onClick(DialogInterface paramAnonymous2DialogInterface, int paramAnonymous2Int)
          {
    ...
    public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
    {
      ...
      if (i == 0)
      {
        ...
        if (paramInt == ProfileNotificationsActivity.this.settingsVibrateRow)
        {
          ...
          if (paramInt == 0)
          {
            localTextDetailSettingsCell.setTextAndValue(LocaleController.getString("Vibrate", 2131166385), LocaleController.getString("SettingsDefault", 2131166274), true);
      ...
      do
      {
          ...
          do
          {
            do
            {
              do
              {
                ...
                if (paramInt == 1)
                {
                  localTextDetailSettingsCell.setTextAndValue(LocaleController.getString("Vibrate", 2131166385), LocaleController.getString("Short", 2131166291), true);
                  return paramViewGroup;
                }
                if (paramInt == 2)
                {
                  localTextDetailSettingsCell.setTextAndValue(LocaleController.getString("Vibrate", 2131166385), LocaleController.getString("VibrationDisabled", 2131166387), true);
                  return paramViewGroup;
                }
                if (paramInt == 3)
                {
                  localTextDetailSettingsCell.setTextAndValue(LocaleController.getString("Vibrate", 2131166385), LocaleController.getString("Long", 2131165850), true);
                  return paramViewGroup;
                }
                localObject = paramViewGroup;
              } while (paramInt != 4);
              localTextDetailSettingsCell.setTextAndValue(LocaleController.getString("Vibrate", 2131166385), LocaleController.getString("SystemDefault", 2131166326), true);
              return paramViewGroup;
              ...
              if (paramInt == 0)
              {
                localTextDetailSettingsCell.setTextAndValue(LocaleController.getString("Notifications", 2131166033), LocaleController.getString("Default", 2131165559), true);
                return paramViewGroup;
              }
              if (paramInt == 1)
              {
                localTextDetailSettingsCell.setTextAndValue(LocaleController.getString("Notifications", 2131166033), LocaleController.getString("Enabled", 2131165605), true);
                return paramViewGroup;
              }
              if (paramInt == 2)
              {
                localTextDetailSettingsCell.setTextAndValue(LocaleController.getString("Notifications", 2131166033), LocaleController.getString("NotificationsDisabled", 2131166035), true);
                return paramViewGroup;
              }
              localObject = paramViewGroup;
            } while (paramInt != 3);
            ...
            if (paramInt <= 0) {
              paramView = LocaleController.getString("Enabled", 2131165605);
            }
            while (paramView != null)
            {
              localTextDetailSettingsCell.setTextAndValue(LocaleController.getString("Notifications", 2131166033), paramView, true);
              return paramViewGroup;
              if (paramInt < 3600) {
                paramView = LocaleController.formatString("WillUnmuteIn", 2131166406, new Object[] { LocaleController.formatPluralString("Minutes", paramInt / 60) });
              } else if (paramInt < 86400) {
                paramView = LocaleController.formatString("WillUnmuteIn", 2131166406, new Object[] { LocaleController.formatPluralString("Hours", (int)Math.ceil(paramInt / 60.0F / 60.0F)) });
              } else if (paramInt < 31536000) {
                paramView = LocaleController.formatString("WillUnmuteIn", 2131166406, new Object[] { LocaleController.formatPluralString("Days", (int)Math.ceil(paramInt / 60.0F / 60.0F / 24.0F)) });
              } else {
                paramView = null;
              }
            }
            ...
            {
              localObject = paramView.getString("sound_" + ProfileNotificationsActivity.this.dialog_id, LocaleController.getString("SoundDefault", 2131166309));
              paramView = (View)localObject;
              if (((String)localObject).equals("NoSound")) {
                paramView = LocaleController.getString("NoSound", 2131165959);
              }
              localTextDetailSettingsCell.setTextAndValue(LocaleController.getString("Sound", 2131166308), paramView, true);
              return paramViewGroup;
            }
            ...
            if (paramInt == 0)
            {
              localTextDetailSettingsCell.setTextAndValue(LocaleController.getString("NotificationsPriority", 2131166037), LocaleController.getString("NotificationsPriorityDefault", 2131166038), true);
              return paramViewGroup;
            }
            if (paramInt == 1)
            {
              localTextDetailSettingsCell.setTextAndValue(LocaleController.getString("NotificationsPriority", 2131166037), LocaleController.getString("NotificationsPriorityHigh", 2131166039), true);
              return paramViewGroup;
            }
            if (paramInt == 2)
            {
              localTextDetailSettingsCell.setTextAndValue(LocaleController.getString("NotificationsPriority", 2131166037), LocaleController.getString("NotificationsPriorityMax", 2131166041), true);
              return paramViewGroup;
            }
            localObject = paramViewGroup;
          } while (paramInt != 3);
          localTextDetailSettingsCell.setTextAndValue(LocaleController.getString("NotificationsPriority", 2131166037), LocaleController.getString("SettingsDefault", 2131166274), true);
          return paramViewGroup;
          localObject = paramViewGroup;
        ...
        if (paramInt == 0)
        {
          localTextDetailSettingsCell.setTextAndValue(LocaleController.getString("SmartNotifications", 2131166296), LocaleController.getString("SmartNotificationsDisabled", 2131166297), true);
          return paramViewGroup;
        }
        paramView = LocaleController.formatPluralString("Times", paramInt);
        localObject = LocaleController.formatPluralString("Minutes", i / 60);
        localTextDetailSettingsCell.setTextAndValue(LocaleController.getString("SmartNotifications", 2131166296), LocaleController.formatString("SmartNotificationsInfo", 2131166298, new Object[] { paramView, localObject }), true);
        return paramViewGroup;
      ...
      {
        paramView.setTextAndColor(LocaleController.getString("LedColor", 2131165822), ((SharedPreferences)localObject).getInt("color_" + ProfileNotificationsActivity.this.dialog_id, -16711936), false);
        return paramViewGroup;
      }
      if ((int)ProfileNotificationsActivity.this.dialog_id < 0)
      {
        paramView.setTextAndColor(LocaleController.getString("LedColor", 2131165822), ((SharedPreferences)localObject).getInt("GroupLed", -16711936), false);
        return paramViewGroup;
      }
      paramView.setTextAndColor(LocaleController.getString("LedColor", 2131165822), ((SharedPreferences)localObject).getInt("MessagesLed", -16711936), false);
      return paramViewGroup;
    }
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/ProfileNotificationsActivity.class
