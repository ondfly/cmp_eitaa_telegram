  ...
  extends FrameLayout
{
  ...
  public PasscodeView(Context paramContext)
  {
    ...
    ((ImageView)localObject).setImageResource(2130837873);
    ...
    if (AndroidUtilities.density < 1.0F)
    {
      ...
      this.checkImage.setImageResource(2130837871);
      this.checkImage.setScaleType(ImageView.ScaleType.CENTER);
      this.checkImage.setBackgroundResource(2130837547);
    ...
    this.eraseView.setImageResource(2130837872);
    ...
    {
      localObject = new FrameLayout(paramContext);
      ((FrameLayout)localObject).setBackgroundResource(2130837547);
    ...
    catch (Exception localException1)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          ((TextView)localObject2).setText(LocaleController.getString("FingerprintInfo", 2131165639));
          ...
          this.fingerprintImageView.setImageResource(2130837735);
          ...
          this.fingerprintStatusTextView.setText(LocaleController.getString("FingerprintHelp", 2131165638));
          ...
          try
          {
            ...
            localFingerprintManagerCompat.authenticate(null, 0, this.cancellationSignal, new FingerprintManagerCompat.AuthenticationCallback()
            {
              ...
              {
                PasscodeView.this.showFingerprintError(LocaleController.getString("FingerprintNotRecognized", 2131165640));
              }
  ...
  {
    this.fingerprintImageView.setImageResource(2130837734);
  ...
  public void onShow()
  {
    ...
    {
      this.backgroundFrameLayout.setBackgroundColor(ContextCompat.getColor(ApplicationLoader.applicationContext, 2131361802));
      this.passcodeTextView.setText(LocaleController.getString("EnterYourPasscode", 2131165628));
      if (UserConfig.passcodeType != 0) {
        break label283;
      }
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/Components/PasscodeView.class
