  ...
  extends LinearLayout
{
  ...
  public ChatBigEmptyView(Context paramContext, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      ((TextView)localObject).setText(LocaleController.getString("EncryptedDescriptionTitle", 2131165613));
    ...
    for (;;)
    {
      ...
      ((ImageView)localObject).setImageResource(2130837603);
      ...
      if (paramBoolean)
      {
        localTextView.setText(LocaleController.getString("EncryptedDescription1", 2131165609));
        break label376;
      }
      ...
      if (paramBoolean)
      {
        localTextView.setText(LocaleController.getString("EncryptedDescription2", 2131165610));
        break label376;
      }
      ...
      if (paramBoolean)
      {
        localTextView.setText(LocaleController.getString("EncryptedDescription3", 2131165611));
        break label376;
      }
      ...
      if (paramBoolean)
      {
        localTextView.setText(LocaleController.getString("EncryptedDescription4", 2131165612));
        break label376;
      }
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/Components/ChatBigEmptyView.class
