  ...
  extends FrameLayout
{
  ...
  public Bitmap getBitmap()
  {
    ...
    if (Build.VERSION.SDK_INT >= 21)
    {
      ...
      float f5 = i;
      f3 = (getWidth() - f2) / 2.0F;
      f4 = this.bitmapGlobalX;
      f5 = (getHeight() - f1 + f5) / 2.0F;
      float f6 = this.bitmapGlobalY;
      f3 = (this.rectX - (f3 + f4)) / f2;
      f4 = (this.rectY - (f5 + f6)) / f1;
  ...
  public float getRectY()
  {
    ...
    {
      float f = i;
      return this.rectY - AndroidUtilities.dp(14.0F) - f;
    }
  }
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    paramInt2 = getWidth() - AndroidUtilities.dp(28.0F);
    paramInt3 = getHeight();
    paramInt4 = AndroidUtilities.dp(28.0F);
    float f2;
    float f1;
    label133:
    float f3;
    ...
    if (Build.VERSION.SDK_INT >= 21)
    {
      ...
      this.bitmapX = ((int)Math.ceil((paramInt2 - this.bitmapWidth) / 2 + AndroidUtilities.dp(14.0F)));
      paramInt4 = (paramInt3 - this.bitmapHeight) / 2;
    ...
    {
      this.bitmapY = ((int)Math.ceil(paramInt1 + (i + paramInt4)));
    ...
    {
      this.rectY = this.bitmapY;
      this.rectX = ((paramInt2 - this.bitmapHeight) / 2 + AndroidUtilities.dp(14.0F));
      this.rectSizeX = this.bitmapHeight;
      this.rectSizeY = this.bitmapHeight;
      return;
    }
    this.rectX = this.bitmapX;
    paramInt2 = (paramInt3 - this.bitmapWidth) / 2;
    paramInt3 = AndroidUtilities.dp(14.0F);
    if (Build.VERSION.SDK_INT >= 21) {}
    for (paramInt1 = AndroidUtilities.statusBarHeight;; paramInt1 = 0)
    {
      this.rectY = (paramInt1 + (paramInt3 + paramInt2));
      this.rectSizeX = this.bitmapWidth;
      ...
      if (this.draggingState != 0)
      {
        ...
        else if ((paramMotionEvent.getAction() == 2) && (this.draggingState != 0))
        {
          ...
          if (Build.VERSION.SDK_INT >= 21)
          {
            i = AndroidUtilities.statusBarHeight;
            f4 = i;
            f9 = (getWidth() - f7) / 2.0F + this.bitmapGlobalX;
            f4 = (getHeight() - f3 + f4) / 2.0F + this.bitmapGlobalY;
            f10 = f9 + f7;
            f8 = f4 + f3;
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/Components/PhotoCropView.class
