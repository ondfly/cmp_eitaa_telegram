  ...
  extends Drawable
{
  ...
  public TimerDrawable(Context paramContext)
  {
    ...
    {
      emptyTimerDrawable = paramContext.getResources().getDrawable(2130837701);
      timerDrawable = paramContext.getResources().getDrawable(2130837702);
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/Components/TimerDrawable.class
