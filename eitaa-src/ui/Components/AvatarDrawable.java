  ...
  extends Drawable
{
  ...
  static
  {
    ...
    arrColorsProfiles = new int[] { -2592923, -615071, -7570990, -9981091, -11099461, 48947, -7570990, -819290 };
    arrColorsProfilesBack = new int[] { -3514282, -947900, -8557884, -11099828, -12283220, 39972, -8557884, -11762506 };
    arrColorsProfilesText = new int[] { -406587, -139832, -3291923, -4133446, -4660496, 65407, -3291923, -4990985 };
  ...
  public AvatarDrawable()
  {
    if (namePaint == null)
    {
      ...
      broadcastDrawable = ApplicationLoader.applicationContext.getResources().getDrawable(2130837582);
    }
  ...
  public void setDrawPhoto(boolean paramBoolean)
  {
    if ((paramBoolean) && (photoDrawable == null)) {
      photoDrawable = ApplicationLoader.applicationContext.getResources().getDrawable(2130837894);
    }
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/Components/AvatarDrawable.class
