...
import ir.eitaa.ui.PhotoAlbumPickerActivity.PhotoAlbumPickerActivityDelegate;
import ir.eitaa.ui.PhotoCropActivity;
import ir.eitaa.ui.PhotoCropActivity.PhotoEditActivityDelegate;
  ...
  public void openCamera()
  {
    try
    {
      ...
      if (localFile != null)
      {
        ...
        localIntent.putExtra("output", FileProvider.getUriForFile(this.parentFragment.getParentActivity(), "ir.eitaa.messenger.provider", localFile));
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/Components/AvatarUpdater.class
