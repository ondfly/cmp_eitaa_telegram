...
import ir.eitaa.ui.Cells.PhotoEditToolCell;
  ...
  extends FrameLayout
{
  ...
  public PhotoFilterView(Context paramContext, Bitmap paramBitmap, int paramInt)
  {
    ...
    this.recyclerListView.setOnItemClickListener(new RecyclerListView.OnItemClickListener()
    {
      public void onItemClick(View paramAnonymousView, int paramAnonymousInt)
      {
        ...
        if (paramAnonymousInt == PhotoFilterView.this.enhanceTool)
        {
          ...
          PhotoFilterView.this.paramTextView.setText(LocaleController.getString("Enhance", 2131165621));
        }
        for (;;)
        {
          ...
          if (paramAnonymousInt == PhotoFilterView.this.highlightsTool)
          {
            ...
            PhotoFilterView.this.paramTextView.setText(LocaleController.getString("Highlights", 2131165733));
          }
          ...
          else if (paramAnonymousInt == PhotoFilterView.this.exposureTool)
          {
            ...
            PhotoFilterView.this.valueSeekBar.setMinMax(-100, 100);
            PhotoFilterView.this.paramTextView.setText(LocaleController.getString("Exposure", 2131165631));
          }
          else if (paramAnonymousInt == PhotoFilterView.this.warmthTool)
          {
            ...
            PhotoFilterView.this.valueSeekBar.setMinMax(-100, 100);
            PhotoFilterView.this.paramTextView.setText(LocaleController.getString("Warmth", 2131166391));
          }
          else if (paramAnonymousInt == PhotoFilterView.this.saturationTool)
          {
            ...
            PhotoFilterView.this.valueSeekBar.setMinMax(-100, 100);
            PhotoFilterView.this.paramTextView.setText(LocaleController.getString("Saturation", 2131166201));
          }
          else if (paramAnonymousInt == PhotoFilterView.this.vignetteTool)
          {
            ...
            PhotoFilterView.this.valueSeekBar.setMinMax(0, 100);
            PhotoFilterView.this.paramTextView.setText(LocaleController.getString("Vignette", 2131166389));
          }
          else if (paramAnonymousInt == PhotoFilterView.this.shadowsTool)
          {
            ...
            PhotoFilterView.this.valueSeekBar.setMinMax(-100, 100);
            PhotoFilterView.this.paramTextView.setText(LocaleController.getString("Shadows", 2131166275));
          }
          else if (paramAnonymousInt == PhotoFilterView.this.grainTool)
          {
            ...
            PhotoFilterView.this.valueSeekBar.setMinMax(0, 100);
            PhotoFilterView.this.paramTextView.setText(LocaleController.getString("Grain", 2131165720));
          }
          else if (paramAnonymousInt == PhotoFilterView.this.fadeTool)
          {
            ...
            PhotoFilterView.this.valueSeekBar.setMinMax(0, 100);
            PhotoFilterView.this.paramTextView.setText(LocaleController.getString("Fade", 2131165633));
          }
          else if (paramAnonymousInt == PhotoFilterView.this.sharpenTool)
          {
            ...
            PhotoFilterView.this.valueSeekBar.setMinMax(0, 100);
            PhotoFilterView.this.paramTextView.setText(LocaleController.getString("Sharpen", 2131166290));
          }
    ...
    ((ImageView)localObject).setImageResource(2130837662);
    ...
    localObject = new ImageView(paramContext);
    ((ImageView)localObject).setImageResource(2130837663);
    ((ImageView)localObject).setBackgroundDrawable(Theme.createBarSelectorDrawable(-12763843, false));
    ...
    this.tintShadowsButton.setText(LocaleController.getString("TintShadows", 2131166345).toUpperCase());
    ...
    this.tintHighlightsButton.setText(LocaleController.getString("TintHighlights", 2131166344).toUpperCase());
    ...
    this.blurOffButton.setCompoundDrawablesWithIntrinsicBounds(0, 2130837556, 0, 0);
  ...
  private void fixLayout(int paramInt1, int paramInt2)
  {
    ...
    paramInt2 -= AndroidUtilities.dp(154.0F) + AndroidUtilities.statusBarHeight;
    float f2;
    float f1;
    label76:
    float f3;
    ...
    for (;;)
    {
      ...
      int j = (int)Math.ceil((paramInt2 - f1) / 2.0F + AndroidUtilities.dp(14.0F) + AndroidUtilities.statusBarHeight);
  ...
  private void updateSelectedBlurType()
  {
    ...
    do
    {
      ...
      if (this.blurType == 1)
      {
        ...
        this.blurRadialButton.setCompoundDrawablesWithIntrinsicBounds(0, 2130837558, 0, 0);
    ...
    this.blurRadialButton.setCompoundDrawablesWithIntrinsicBounds(0, 2130837557, 0, 0);
    this.blurRadialButton.setTextColor(-1);
    this.blurLinearButton.setCompoundDrawablesWithIntrinsicBounds(0, 2130837554, 0, 0);
  ...
  public void setEditViewFirst()
  {
    ...
    this.paramTextView.setText(LocaleController.getString("Enhance", 2131165621));
  ...
  public void switchToOrFromEditMode()
  {
    ...
    for (;;)
    {
      ...
      this.infoTextView.setText(LocaleController.getString("Tint", 2131166343));
      break label173;
    ...
    extends RecyclerView.Adapter
  {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder paramViewHolder, int paramInt)
    {
      ...
      if (paramInt == PhotoFilterView.this.enhanceTool) {
        ((PhotoEditToolCell)((Holder)localObject).itemView).setIconAndTextAndValue(2130838012, LocaleController.getString("Enhance", 2131165621), PhotoFilterView.this.enhanceValue);
      }
      do
      {
        return;
        ...
        {
          ((PhotoEditToolCell)((Holder)localObject).itemView).setIconAndTextAndValue(2130838015, LocaleController.getString("Highlights", 2131165733), PhotoFilterView.this.highlightsValue);
          return;
        }
        ...
        {
          ((PhotoEditToolCell)((Holder)localObject).itemView).setIconAndTextAndValue(2130838007, LocaleController.getString("Exposure", 2131165631), PhotoFilterView.this.exposureValue);
          return;
        }
        if (paramInt == PhotoFilterView.this.warmthTool)
        {
          ((PhotoEditToolCell)((Holder)localObject).itemView).setIconAndTextAndValue(2130838021, LocaleController.getString("Warmth", 2131166391), PhotoFilterView.this.warmthValue);
          return;
        }
        if (paramInt == PhotoFilterView.this.saturationTool)
        {
          ((PhotoEditToolCell)((Holder)localObject).itemView).setIconAndTextAndValue(2130838017, LocaleController.getString("Saturation", 2131166201), PhotoFilterView.this.saturationValue);
          return;
        }
        if (paramInt == PhotoFilterView.this.vignetteTool)
        {
          ((PhotoEditToolCell)((Holder)localObject).itemView).setIconAndTextAndValue(2130838020, LocaleController.getString("Vignette", 2131166389), PhotoFilterView.this.vignetteValue);
          return;
        }
        if (paramInt == PhotoFilterView.this.shadowsTool)
        {
          ((PhotoEditToolCell)((Holder)localObject).itemView).setIconAndTextAndValue(2130838018, LocaleController.getString("Shadows", 2131166275), PhotoFilterView.this.shadowsValue);
          return;
        }
        if (paramInt == PhotoFilterView.this.grainTool)
        {
          ((PhotoEditToolCell)((Holder)localObject).itemView).setIconAndTextAndValue(2130838014, LocaleController.getString("Grain", 2131165720), PhotoFilterView.this.grainValue);
          return;
        }
        if (paramInt == PhotoFilterView.this.sharpenTool)
        {
          ((PhotoEditToolCell)((Holder)localObject).itemView).setIconAndTextAndValue(2130838011, LocaleController.getString("Sharpen", 2131166290), PhotoFilterView.this.sharpenValue);
          return;
        }
        String str;
        if (paramInt == PhotoFilterView.this.tintTool)
        {
          ...
          str = LocaleController.getString("Tint", 2131166343);
        ...
        {
          ((PhotoEditToolCell)((Holder)localObject).itemView).setIconAndTextAndValue(2130838013, LocaleController.getString("Fade", 2131165633), PhotoFilterView.this.fadeValue);
          return;
        }
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/Components/PhotoFilterView.class
