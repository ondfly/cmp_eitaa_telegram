  ...
  implements NotificationCenter.NotificationCenterDelegate
{
      ...
      public void run(final TLObject paramAnonymousTLObject, final TLRPC.TL_error paramAnonymousTL_error)
      {
        AndroidUtilities.runOnUIThread(new Runnable()
        {
          public void run()
          {
            ...
            Toast.makeText(StickersAlert.this.getContext(), LocaleController.getString("ErrorOccurred", 2131165629) + "\n" + paramAnonymousTL_error.text, 0).show();
            StickersAlert.this.dismiss();
          }
        });
      }
  ...
  private void init(Context paramContext)
  {
    ...
    this.shadow[0].setBackgroundResource(2130837699);
    ...
    this.shadow[1].setBackgroundResource(2130837700);
    ...
    ((ImageView)localObject1).setImageResource(2130837640);
    ...
    this.previewSendButtonShadow.setBackgroundResource(2130837700);
    ...
    if (this.stickerSet != null)
    {
                  ...
                  public void run()
                  {
                    for (;;)
                    {
                      ...
                      catch (Exception localException)
                      {
                        ...
                        continue;
                        Toast.makeText(StickersAlert.this.getContext(), LocaleController.getString("ErrorOccurred", 2131165629), 0).show();
                        continue;
                        int i = 0;
                        continue;
                      }
      ...
      for (;;)
      {
        ...
        if (this.stickerSet.set.official) {
          ...
          }, LocaleController.getString("StickersRemove", 2131166315), -3319206, false);
        } else {
          setRightButton(new View.OnClickListener()
          {
            public void onClick(View paramAnonymousView)
          ...
          }, LocaleController.getString("StickersRemove", 2131166316), -3319206, false);
        }
      }
    }
  ...
  private void updateSendButton()
  {
    ...
    {
      this.previewSendButton.setText(LocaleController.getString("SendSticker", 2131166248).toUpperCase());
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/Components/StickersAlert.class
