  ...
  extends FrameLayout
{
  ...
  public EmptyTextProgressView(Context paramContext)
  {
    ...
    this.textView.setText(LocaleController.getString("NoResult", 2131165952));
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/Components/EmptyTextProgressView.class
