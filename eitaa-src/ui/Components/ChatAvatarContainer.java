  ...
  extends FrameLayout
{
  ...
  public ChatAvatarContainer(Context paramContext, ChatActivity paramChatActivity, boolean paramBoolean)
  {
    ...
    paramChatActivity = this.titleTextView;
    int i;
    if (LocaleController.isRTL)
    {
      i = 5;
      paramChatActivity.setGravity(i);
      ...
      paramChatActivity = this.subtitleTextView;
      if (!LocaleController.isRTL) {
        break label423;
      }
      i = 5;
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    for (paramInt1 = AndroidUtilities.statusBarHeight;; paramInt1 = 0)
    {
      ...
      this.avatarImageView.layout(AndroidUtilities.dp(16.0F) + this.titleTextView.getMeasuredWidth(), paramInt1, this.titleTextView.getMeasuredWidth() + AndroidUtilities.dp(58.0F), AndroidUtilities.dp(42.0F) + paramInt1);
      this.titleTextView.layout(AndroidUtilities.dp(8.0F), AndroidUtilities.dp(1.3F) + paramInt1, this.titleTextView.getMeasuredWidth() + AndroidUtilities.dp(12.0F), this.titleTextView.getTextHeight() + paramInt1 + AndroidUtilities.dp(1.3F));
      if (this.timeItem != null) {
        this.timeItem.layout(AndroidUtilities.dp(8.0F), AndroidUtilities.dp(15.0F) + paramInt1, AndroidUtilities.dp(58.0F), AndroidUtilities.dp(49.0F) + paramInt1);
      }
      this.subtitleTextView.layout(AndroidUtilities.dp(8.0F), AndroidUtilities.dp(24.0F) + paramInt1, this.subtitleTextView.getMeasuredWidth() + AndroidUtilities.dp(12.0F), this.subtitleTextView.getTextHeight() + paramInt1 + AndroidUtilities.dp(24.0F));
      return;
    }
  ...
  public void updateSubtitle()
  {
    ...
    if ((localObject1 == null) || (((CharSequence)localObject1).length() == 0) || ((ChatObject.isChannel(localChat)) && (!localChat.megagroup)))
    {
      ...
      while (localUser == null)
      {
        ...
        {
          this.subtitleTextView.setText(LocaleController.getString("Loading", 2131165837).toLowerCase());
          return;
        }
        ...
        {
          this.subtitleTextView.setText(LocaleController.getString("YouWereKicked", 2131166422));
          return;
        }
        if (ChatObject.isLeftFromChat(localChat))
        {
          this.subtitleTextView.setText(LocaleController.getString("YouLeft", 2131166421));
          return;
        }
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/Components/ChatAvatarContainer.class
