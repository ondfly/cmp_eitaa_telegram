  ...
  implements NotificationCenter.NotificationCenterDelegate
{
  ...
  private void updateStickerTabs()
  {
    ...
    {
      this.scrollSlidingTabStrip.addIconTab(2130837741);
      ...
      if (!this.recentStickers[this.currentType].isEmpty())
      {
        ...
        this.scrollSlidingTabStrip.addIconTab(2130837742);
      }
    ...
    for (;;)
    {
      i += 1;
      break label132;
      this.scrollSlidingTabStrip.addIconTab(2130837745);
      this.stickersEmptyView.setText(LocaleController.getString("NoMasks", 2131165939));
      break;
      label216:
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/Components/StickerMasksView.class
