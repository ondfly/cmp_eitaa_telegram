...
import ir.eitaa.ui.AudioPlayerActivity;
  ...
  implements NotificationCenter.NotificationCenterDelegate
{
  ...
  public PlayerView(Context paramContext, BaseFragment paramBaseFragment)
  {
    ...
    paramBaseFragment.setBackgroundResource(2130837699);
    ...
    paramContext.setImageResource(2130837830);
  ...
  private void checkPlayer(boolean paramBoolean)
  {
    ...
    if (MediaController.getInstance().isAudioPaused())
    {
      this.playButton.setImageResource(2130837832);
      label413:
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/Components/PlayerView.class
