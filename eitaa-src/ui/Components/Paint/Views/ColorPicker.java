  ...
  extends FrameLayout
{
  ...
  public ColorPicker(Context paramContext)
  {
    ...
    this.shadowDrawable = getResources().getDrawable(2130837788);
    ...
    this.settingsButton.setImageResource(2130837886);
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/Components/Paint/Views/ColorPicker.class
