  ...
  implements NotificationCenter.NotificationCenterDelegate, SizeNotifierFrameLayoutPhoto.SizeNotifierFrameLayoutPhotoDelegate
{
  ...
  private final int captionMaxLength = 400;
  ...
  public PhotoViewerCaptionEnterView(Context paramContext, SizeNotifierFrameLayoutPhoto paramSizeNotifierFrameLayoutPhoto, View paramView)
  {
    ...
    this.emojiButton.setImageResource(2130837754);
    ...
    paramContext = new InputFilter.LengthFilter(400);
    ...
    if (paramInt == 1)
    {
      if (this.emojiView == null)
      {
        ...
        this.emojiView.setListener(new EmojiView.Listener()
        {
          ...
          {
            if (PhotoViewerCaptionEnterView.this.messageEditText.length() + paramAnonymousString.length() > 400) {
              return;
            }
      ...
      if (AndroidUtilities.displaySize.x > AndroidUtilities.displaySize.y)
      {
        ...
        if (this.sizeNotifierLayout != null)
        {
          ...
          this.emojiButton.setImageResource(2130837737);
          onWindowSizeChanged();
        }
      }
    }
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/ui/Components/PhotoViewerCaptionEnterView.class
