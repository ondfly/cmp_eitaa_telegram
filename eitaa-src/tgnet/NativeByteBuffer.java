  ...
  extends AbstractSerializedData
{
  ...
  public static NativeByteBuffer wrap(int paramInt)
  {
    ...
    if (paramInt != 0)
    {
      if (!localNativeByteBuffer.reused) {
        FileLog.e("TSMS", "forgot to reuse?");
      }
  ...
  public byte[] readByteArray(boolean paramBoolean)
  {
    ...
    //   2: aload_0
    //   3: aload_0
    //   4: getfield 43	ir/eitaa/tgnet/NativeByteBuffer:buffer	Ljava/nio/ByteBuffer;
    //   7: invokevirtual 145	java/nio/ByteBuffer:get	()B
    //   10: invokevirtual 147	ir/eitaa/tgnet/NativeByteBuffer:getIntFromByte	(B)I
    //   13: istore 4
    //   15: iload 4
    //   17: istore_3
    //   18: iload 4
    ...
    //   26: aload_0
    //   27: aload_0
    //   28: getfield 43	ir/eitaa/tgnet/NativeByteBuffer:buffer	Ljava/nio/ByteBuffer;
    //   31: invokevirtual 145	java/nio/ByteBuffer:get	()B
    //   34: invokevirtual 147	ir/eitaa/tgnet/NativeByteBuffer:getIntFromByte	(B)I
    //   37: aload_0
    //   38: aload_0
    //   39: getfield 43	ir/eitaa/tgnet/NativeByteBuffer:buffer	Ljava/nio/ByteBuffer;
    //   42: invokevirtual 145	java/nio/ByteBuffer:get	()B
    //   45: invokevirtual 147	ir/eitaa/tgnet/NativeByteBuffer:getIntFromByte	(B)I
    //   48: bipush 8
    //   50: ishl
    //   51: ior
    //   52: aload_0
    //   53: aload_0
    //   54: getfield 43	ir/eitaa/tgnet/NativeByteBuffer:buffer	Ljava/nio/ByteBuffer;
    //   57: invokevirtual 145	java/nio/ByteBuffer:get	()B
    //   60: invokevirtual 147	ir/eitaa/tgnet/NativeByteBuffer:getIntFromByte	(B)I
    //   63: bipush 16
    //   65: ishl
    //   66: ior
    //   67: istore_3
    ...
    //   73: astore 6
    //   75: aload_0
    //   76: getfield 43	ir/eitaa/tgnet/NativeByteBuffer:buffer	Ljava/nio/ByteBuffer;
    //   79: aload 6
    ...
    //   94: ifeq +48 -> 142
    //   97: aload_0
    //   98: getfield 43	ir/eitaa/tgnet/NativeByteBuffer:buffer	Ljava/nio/ByteBuffer;
    ...
    //   130: ldc 88
    //   132: ldc -104
    //   134: invokestatic 96	ir/eitaa/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   137: iconst_0
  ...
  public NativeByteBuffer readByteBuffer(boolean paramBoolean)
  {
    ...
    //   68: iconst_4
    //   69: istore_2
    //   70: new 2	ir/eitaa/tgnet/NativeByteBuffer
    //   73: dup
    //   74: iload_3
    //   75: invokespecial 159	ir/eitaa/tgnet/NativeByteBuffer:<init>	(I)V
    //   78: astore 6
    //   80: aload_0
    //   81: getfield 43	ir/eitaa/tgnet/NativeByteBuffer:buffer	Ljava/nio/ByteBuffer;
    //   84: invokevirtual 103	java/nio/ByteBuffer:limit	()I
    //   87: istore 4
    //   89: aload_0
    //   90: getfield 43	ir/eitaa/tgnet/NativeByteBuffer:buffer	Ljava/nio/ByteBuffer;
    //   93: aload_0
    //   94: getfield 43	ir/eitaa/tgnet/NativeByteBuffer:buffer	Ljava/nio/ByteBuffer;
    ...
    //   105: pop
    //   106: aload 6
    //   108: getfield 43	ir/eitaa/tgnet/NativeByteBuffer:buffer	Ljava/nio/ByteBuffer;
    //   111: aload_0
    //   112: getfield 43	ir/eitaa/tgnet/NativeByteBuffer:buffer	Ljava/nio/ByteBuffer;
    //   115: invokevirtual 127	java/nio/ByteBuffer:put	(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    //   118: pop
    //   119: aload_0
    //   120: getfield 43	ir/eitaa/tgnet/NativeByteBuffer:buffer	Ljava/nio/ByteBuffer;
    //   123: iload 4
    //   125: invokevirtual 52	java/nio/ByteBuffer:limit	(I)Ljava/nio/Buffer;
    //   128: pop
    //   129: aload 6
    //   131: getfield 43	ir/eitaa/tgnet/NativeByteBuffer:buffer	Ljava/nio/ByteBuffer;
    //   134: iconst_0
    ...
    //   148: ifeq +46 -> 194
    //   151: aload_0
    //   152: getfield 43	ir/eitaa/tgnet/NativeByteBuffer:buffer	Ljava/nio/ByteBuffer;
    ...
    //   184: ldc 88
    //   186: ldc -104
    //   188: invokestatic 96	ir/eitaa/messenger/FileLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   191: aconst_null
    //   192: astore 5
    //   194: aload 5
    //   196: areturn
  ...
  public long readInt64(boolean paramBoolean)
  {
    ...
    catch (Exception localException)
    {
      ...
      FileLog.e("TSMS", "read int64 error");
    }
    return 0L;
  }
  ...
  public String readString(boolean paramBoolean)
  {
    ...
    catch (Exception localException)
    {
      ...
      FileLog.e("TSMS", "read string error");
    }
    return "";
  }
  ...
  public void writeByte(byte paramByte)
  {
    ...
    {
      FileLog.e("TSMS", "write byte error");
    }
  }
  ...
  public void writeByteArray(byte[] paramArrayOfByte)
  {
    for (;;)
    {
      ...
      {
        FileLog.e("TSMS", "write byte array error");
      }
      if (!this.justCalc)
      {
  ...
  public void writeByteBuffer(NativeByteBuffer paramNativeByteBuffer)
  {
    for (;;)
    {
      ...
      {
        FileLog.e("TSMS", paramNativeByteBuffer);
      }
      if (!this.justCalc)
      {
        this.buffer.put((byte)-2);
  ...
  public void writeBytes(byte[] paramArrayOfByte)
  {
    ...
    {
      FileLog.e("TSMS", "write raw error");
    }
  }
  ...
  public void writeDouble(double paramDouble)
  {
    ...
    {
      FileLog.e("TSMS", "write double error");
    }
  }
  ...
  public void writeInt32(int paramInt)
  {
    ...
    {
      FileLog.e("TSMS", "write int32 error");
    }
  }
  ...
  public void writeInt64(long paramLong)
  {
    ...
    {
      FileLog.e("TSMS", "write int64 error");
    }
  }
  ...
  public void writeString(String paramString)
  {
    ...
    {
      FileLog.e("TSMS", "write string error");
    }
  }
}


/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/tgnet/NativeByteBuffer.class
