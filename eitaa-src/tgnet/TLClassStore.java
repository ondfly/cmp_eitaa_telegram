...
public class TLClassStore
{
  ...
  public TLClassStore()
  {
    ...
    this.classStore.put(Integer.valueOf(TLRPC.TL_updates_token.constructor), TLRPC.TL_updates_token.class);
    this.classStore.put(Integer.valueOf(TLRPC.TL_updates_ExpireToken.constructor), TLRPC.TL_updates_ExpireToken.class);
    this.classStore.put(Integer.valueOf(TLRPC.TL_tokenUpdateing.constructor), TLRPC.TL_tokenUpdateing.class);
  }
  ...
  public TLObject TLdeserialize(AbsSerializedJson paramAbsSerializedJson, int paramInt, boolean paramBoolean)
  {
    ...
    if (localObject != null) {
      try
      {
        ...
        ((TLObject)localObject).readParams(paramAbsSerializedJson, paramBoolean);
        return (TLObject)localObject;
      }
      catch (Throwable paramAbsSerializedJson)
      {
        FileLog.e("tmessages", paramAbsSerializedJson);
        return null;
      }
    }
    return null;
  ...
  public TLObject TLdeserialize(AbstractSerializedData paramAbstractSerializedData, int paramInt, boolean paramBoolean)
  {
    Object localObject = (Class)this.classStore.get(Integer.valueOf(paramInt));
    if (localObject != null) {
      try
      {
        localObject = (TLObject)((Class)localObject).newInstance();
        ((TLObject)localObject).readParams(paramAbstractSerializedData, paramBoolean);
        return (TLObject)localObject;
      }
      catch (Throwable paramAbstractSerializedData)
      {
        FileLog.e("tmessages", paramAbstractSerializedData);
        return null;
      }
    }
    return null;
...
/* Location:              /dex2jar/eitaa-dex2jar.jar!/ir/eitaa/tgnet/TLClassStore.class
